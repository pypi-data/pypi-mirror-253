...
class Ui:
    """The UI object represents the user interface in CANalyzer.
    """
    ...
    @property
    def write(self):
        """Returns the Write object of CANalyzer.
        """
...
class Write:
    """The Write object represents the Write Window in CANalyzer.
