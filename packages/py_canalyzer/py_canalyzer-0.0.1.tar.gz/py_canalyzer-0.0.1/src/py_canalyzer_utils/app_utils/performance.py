...
class Performance:
    ...
    def max_num_meas_setup_threads(self):
        """The maximum number of threads CANalyzer will use.
        """
    ...
    def max_num_meas_setup_threads(self, num: int):
        ...
        Args:
            num (int): The maximum number of threads CANalyzer will use. By default, this value is calculated from the number of processor cores.
        """
