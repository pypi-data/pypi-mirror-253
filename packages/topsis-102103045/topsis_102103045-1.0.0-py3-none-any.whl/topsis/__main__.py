...
def topsis(datasetwithheaing,dataset,decisionMatrix, weights, impacts,name):
    """ it will take dataset from the main function perform necessary actions to calculate rank as well as TOPOSIS score.         
...
def main():      
    """it will read the 5 inputs from the cmd(commmand line input).     
