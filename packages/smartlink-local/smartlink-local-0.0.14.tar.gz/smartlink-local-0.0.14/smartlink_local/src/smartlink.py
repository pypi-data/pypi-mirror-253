...
class SmartLinkLocal(QueueWorker):
    ...
    def insert_smartlink_type(self, name: str = None, action_id: int = None, dialog_workflow_script_id: int = None,
                              expiration_value: int = None, expiration_unit: str = None) -> int:
        data_json = {
            "name": name,
            "action_id": action_id,
            "dialog_workflow_script_id": dialog_workflow_script_id,
            "expiration_value": expiration_value,
            "expiration_unit": expiration_unit,
        }
        return super().insert(table_name="smartlink_type_table", data_json=data_json)
