...
int main(int argc, char **argv) {
    ...
    opts.append(" opts%rt_ir%co2_data 1 ");
    ...
    opts.append(" file_coef ../rtcoef_rttov12/rttov8pred54L/rtcoef_noaa_19_hirs.dat ");
    opts.append(" file_sccld ../rtcoef_rttov12/cldaer_ir/sccldcoef_noaa_19_hirs.dat ");
    ...
    // Initialise to negative values: RTTOV will supply emissivity and BRDF values
