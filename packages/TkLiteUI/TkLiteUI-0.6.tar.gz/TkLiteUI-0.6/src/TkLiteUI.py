...
def add_button(**kwargs):
    ...
    Örnek kullanım:
        Bu verilerin hepsi girilmek zorunda değil. Zaten içeride hepsinin default ayarları var.
    ...
    Btn_Name = add_button(pencere=Pencere_1, text="Bağlantı Kur", bg="gray", fg="black", font=("Arial", 11, "bold"),
                             ...
                             on_click={'action': lambda: Buton_Event(Btn_Name)})          /def ile bir click_event oluştur
    """
...
def add_label(**kwargs):
    ...
    Örnek kullanım:
        ...
        Label_1 = add_label(pencere=WindowName, text="Bağlantı Bilgisi:", bg="lightblue", fg="darkblue",
...
def add_entry(**kwargs):
    ...
    \\===============================//
        ...
        Örnek kullanım:
            ...
            EntryName = add_entry(pencere=WindowName, bg="lightyellow", fg="darkblue",
...
def WindowStart(Pencere):
    ...
    \\===============================//
        ...
        Örnek kullanım:
            ...
            Başlatılacak bencere adı buraya yazılacak
            WindowStart(WindowName)

             """
    Pencere.mainloop()


def WindowStop(Pencere):
    """
    ...
    \\===============================//
        ...
        Örnek kullanım:
            ...
            Kapatılacak bencere adı buraya yazılacak

            WindowStop(WindowName)
