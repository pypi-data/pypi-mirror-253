...
class LsrTree:
    ...
    def list_files_json(self):
        ...
        data = {}
        idx = 0
        for s0, d0, f0 in os.walk(self.path):
            if s0.startswith(self.path):
                s1 = s0.replace(self.path, "")
            else:
                s1 = s0
            n1 = s1.count(os.sep)
    ...
    def list_files_tree(self):
        ...
        Returns:
            list: The tree structure representing the file list.
        """
