...
DEEPL_LANGUAGES = json.load("./data/deepl_languages.json")
GOOGLE_LANGUAGES = json.load("./data/google_languages.json")
GENERAL_LANGUAGES = json.load("./data/general_languages.json")
