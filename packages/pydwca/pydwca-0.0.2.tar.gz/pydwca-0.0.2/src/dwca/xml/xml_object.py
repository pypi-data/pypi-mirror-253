...
class XMLObject(ABC):
    """
    Abstract class for XML Object, to be parsed on the read
    of the Darwin Core Archive file
    """
    ...
    """
    Dict[str, str] : Namespaces to use on the particular XML portion that represent
    the object
    """
    ...
    def get_principal_tag(self) -> str:
        """
        Returns the principal tag with namespaces if it is present in the
