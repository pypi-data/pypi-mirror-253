...
@pytest.mark.parametrize('season_job, exp_season', ((Mock(output=()), None), (Mock(output=('3',)), '3')), ids=('Movie', 'TV'))
...
def test_post_data(
    ...
    job_outputs = {
        ...
        uhd_tracker_jobs.season_job: exp_season,
    }
    ...
    assert uhd_tracker_jobs.post_data == {
        ...
        'title': (
            f'{uhd_tracker_jobs.release_name.title} Season {int(exp_season):02d}'
            if exp_season else
    ...
    if season_job.output:
        exp_get_job_output_calls.insert(0, call(uhd_tracker_jobs.season_job, slice=0))
