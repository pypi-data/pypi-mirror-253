...
class PtpTrackerJobs(TrackerJobsBase):
    ...
    autodetect_edition_map = {
        ...
        'feature.4k_restoration': lambda self: '4k Restored' in self.release_name.edition,
        'feature.10bit': lambda self: utils.video.bit_depth(self.content_path, default=None) == 10,
        # 'feature.extras': lambda self: False,
        'feature.4K_remaster': lambda self: '4k Remastered' in self.release_name.edition,
    ...
    def _post_data_common_edition(self):
        return {
            ...
            'remaster_title': self.get_job_output(self.edition_job, slice=0),
            # 'remaster_year': ...,
