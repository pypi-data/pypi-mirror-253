...
if __name__ == "__main__":
    basler = BaslerDevice_a2A5328_15ucBAS()
    basler.AutoExposure = 0.15
    print(basler.AutoExposure)
    print(dir(basler))
    print(basler.throughputMode)
    basler.throughputMode = "Off"
    print(basler.throughputMode)
    print(basler.pixelDepth)
    print(basler.pixelFormat)
    basler.viewCameraStream()
