...
class Database(Construct):
    ...
    Args:
        ...
        cloudwatch_audit_log (str): Applicable only to Oracle and Neptune instances. Oracle: If to enable audit logs export in S3. The default is no log exports. Specify this param in case you want to have the audit log export enabled. Neptune: if you also pass a custom cluster parameter group remember to add "neptune_enable_audit_log": "1" to it. If no cluster parameter group is provided it will be added automatically.
    ...
    def __init__(
        ...
        database_engine_version: Union[
            str, _rds.DatabaseClusterEngine, _neptune.EngineVersion
        ] = None,
