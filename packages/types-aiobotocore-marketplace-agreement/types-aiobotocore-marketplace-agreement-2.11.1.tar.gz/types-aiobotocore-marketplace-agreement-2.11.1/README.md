...
[aiobotocore.AgreementService 2.11.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/marketplace-agreement.html#AgreementService)
...
Install `types-aiobotocore-lite[marketplace-agreement]` in your environment:
