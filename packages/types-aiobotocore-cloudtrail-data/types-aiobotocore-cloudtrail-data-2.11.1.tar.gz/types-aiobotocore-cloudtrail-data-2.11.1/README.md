...
[aiobotocore.CloudTrailDataService 2.11.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/cloudtrail-data.html#CloudTrailDataService)
...
Install `types-aiobotocore-lite[cloudtrail-data]` in your environment:
