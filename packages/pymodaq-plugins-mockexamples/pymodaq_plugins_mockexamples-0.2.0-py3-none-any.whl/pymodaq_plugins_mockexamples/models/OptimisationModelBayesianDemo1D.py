...
from pymodaq.utils.plotting.data_viewers import Viewer1D, ViewersEnum
...
class OptimisationModelBayesianDemo1D(OptimisationModelGeneric):
    ...
    params = [
        ...
        {'title': 'reset algo', 'name': 'reset_algo', 'type': 'bool_push', 'label': 'Reset Algo'},
    ...
    def __init__(self, optimisation_controller: 'Optimisation'):
        ...
        self.viewer_target = Viewer1D(widget_target)
    ...
    def update_function(self):
        ...
        dwa = self.modules_manager.detectors[0].controller.get_random_lorentzian_1D()
    ...
    def convert_output(self, outputs: List[np.ndarray]) -> DataToActuatorOpti:
        ...
        """
        try:
            self.viewer_target.double_clicked(float(self.optimisation_algorithm.best_individual[0]))
        except KeyError:
            pass
