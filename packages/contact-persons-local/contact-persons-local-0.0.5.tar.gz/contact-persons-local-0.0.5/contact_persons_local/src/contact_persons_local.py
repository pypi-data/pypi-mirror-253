...
class ContactPersonsLocal(GenericMapping):
    ...
    def get_person_ids_by_contact_id(self, contact_id: int, limit: int = 1, order_by: str = "contact_person_id DESC") -> int:
        """
        ...
        person_id = self.select_multi_tuple_by_id(select_clause_value="person_id",
