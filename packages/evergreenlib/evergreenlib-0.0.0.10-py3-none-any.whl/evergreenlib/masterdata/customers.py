...
class GetCustomers:
    def __init__(self, filepath, value):
        ...
        self.ASPT_retail.rename(columns={"Допустимое число дней дебиторской задолженности":'Отсрочка платежа'}, inplace=True)
        ...
        self.ASPT_opt.rename(columns={"Допустимое число дней дебиторской задолженности":'Отсрочка платежа'}, inplace=True)
...
if __name__ == '__main__':
    parse_data = GetCustomers(filepath=r'\\hms-dfs-01\\root$\\FinDep\\Incoming\\test\\DevOps\\References\\KNA1 26012024.txt',
                              value='KUNNR')
