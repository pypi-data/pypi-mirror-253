...
if __name__ == '__main__':
    ...
    x = Df3Parser(
        filepath=r'V:\Findep\Incoming\test\DevOps\ARAP Project\Project\Accounting Input Data\YTD09_2023\Оборотно-сальдовая ведомость за 9 months of 2023 ООО  ХЕНДЭ МОБИЛИТИ ЛАБ.xls',
