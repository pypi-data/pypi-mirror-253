...
class MakePivots:
    ...
    def create_pt_table(self, pt_sheet_name: str = None, pt_name: str = None, exclude_items: tuple = None):
        ...
        pt.PivotFields("Category").Orientation = 3
        pt.PivotFields("Category").Position = 1
        pt.PivotFields("Category").PivotItems(exclude_items[0]).Visible = False
        pt.PivotFields("Category").PivotItems(exclude_items[1]).Visible = False
        pt.PivotFields("Category").PivotItems(exclude_items[2]).Visible = False
