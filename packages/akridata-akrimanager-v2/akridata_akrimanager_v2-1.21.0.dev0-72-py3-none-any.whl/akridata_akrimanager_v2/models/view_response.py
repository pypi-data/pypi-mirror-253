...
class ViewResponse(object):
    ...
    def __init__(self, view_id=None, view_name=None, dataset_id=None, description=None, tables=None, columns=None, udf_columns=[], udfs_info=[], invalid=False, created_at=None, created_by=None, ds_job_id=None, ds_job_task_id=None, local_vars_configuration=None):  # noqa: E501
