...
class PageDaily(BaseModel):
    ...
    content: Optional[List[Daily]] = None
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PageDaily from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PageDaily from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "content": [Daily.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
