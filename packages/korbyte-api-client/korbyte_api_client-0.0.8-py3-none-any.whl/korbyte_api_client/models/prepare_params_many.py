...
class PrepareParamsMany(BaseModel):
    """
    PrepareParamsMany
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["limit", "order", "precision", "timespan", "fields"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PrepareParamsMany from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PrepareParamsMany from a dict"""
        if obj is None:
            return None
