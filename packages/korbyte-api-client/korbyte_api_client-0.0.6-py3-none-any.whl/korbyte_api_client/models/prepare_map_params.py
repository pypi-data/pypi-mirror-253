...
class PrepareMapParams(BaseModel):
    """
    PrepareMapParams
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["symbol", "limit", "order", "timespan", "fields"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PrepareMapParams from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PrepareMapParams from a dict"""
        if obj is None:
            return None
