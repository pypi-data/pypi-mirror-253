...
class WingWeight(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        if self.options["spar_model"] == "pipe":
            ...
            self.add_design_var(
                "optimization:variables:structures:wing:spar:diameter:k", lower=0.01, upper=0.99, ref=0.9, units=None
            )
            ...
            self.add_constraint("optimization:constraints:structures:wing:spar:diameter", lower=0.0)

        elif self.options["spar_model"] == "I_beam":
            self.add_input("optimization:variables:structures:wing:spar:depth:k", val=0.1, units=None)
            self.add_design_var(
                "optimization:variables:structures:wing:spar:depth:k", lower=0.01, upper=0.99, ref=0.1, units=None
            )
            ...
            self.add_constraint("optimization:constraints:structures:wing:spar:depth", lower=0.0, units=None)
    ...
    def compute(self, inputs, outputs):
        ...
        m_spar = 0
        if self.options["spar_model"] == "pipe":
            k_d = inputs["optimization:variables:structures:wing:spar:diameter:k"]
            ...
            k_a = inputs["optimization:variables:structures:wing:spar:depth:k"]
...
class HorizontalTailWeight(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        # self.add_output("data:weight:airframe:tail:horizontal:skin:mass", units="kg", lower=0.0)
        # self.add_input("mission:sizing:load_factor:ultimate", val=4.5, units=None)
        # self.add_input("optimization:variables:weight:mtow:guess", val=np.nan, units="kg")
        # self.add_input("data:geometry:wing:surface", val=np.nan, units="m**2")
        # self.add_input("data:geometry:tail:horizontal:MAC:y:local", val=np.nan, units="m")
        # self.add_input("optimization:variables:structures:wing:spar:diameter:k", val=np.nan, units=None)
        # self.add_input("data:structures:wing:spar:stress:max", val=np.nan, units="N/m**2")
        # self.add_input("data:weight:airframe:wing:spar:density", val=np.nan, units="kg/m**3")
        ...
        # self.add_input("data:structures:wing:ribs:thickness", val=np.nan, units="m")
        # self.add_input("data:weight:airframe:wing:ribs:density", val=np.nan, units="kg/m**3")
        # self.add_output("data:weight:airframe:tail:horizontal:ribs:mass", units="kg", lower=0.0)
        # self.add_output("data:structures:tail:horizontal:ribs:number", units=None, lower=0.0)
        # self.add_output("data:weight:airframe:tail:horizontal:spar:mass", units="kg", lower=0.0)
    ...
    def compute(self, inputs, outputs):
        ...
        # F_max = S_ht / S_w * n_ult * m_uav_guess * g / 2  # ultimate load to be supported by (half) HT [N]
        ...
        # outputs["data:weight:airframe:tail:horizontal:skin:mass"] = 2 * m_skin
        # outputs["data:weight:airframe:tail:horizontal:ribs:mass"] = 2 * m_ribs
        # outputs["data:structures:tail:horizontal:ribs:number"] = N_ribs
        # outputs["data:weight:airframe:tail:horizontal:spar:mass"] = 2 * m_spar
...
class VerticalTailWeight(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        # self.add_output("data:weight:airframe:tail:vertical:skin:mass", units="kg", lower=0.0)
        # self.add_output("data:weight:airframe:tail:vertical:ribs:mass", units="kg", lower=0.0)
        ...
        # self.add_input("mission:sizing:main_route:cruise:atmosphere:density", val=np.nan, units="kg/m**3")
        ...
        # self.add_output("data:weight:airframe:tail:vertical:spar:mass", units="kg", lower=0.0)
    ...
    def compute(self, inputs, outputs):
        ...
        # sig_max = inputs["data:structures:wing:spar:stress:max"]
        # rho_spar = inputs["data:weight:airframe:wing:spar:density"]
        # V_cruise = inputs["mission:sizing:main_route:cruise:speed"]
        # rho_air = inputs["mission:sizing:main_route:cruise:atmosphere:density"]
        ...
        # outputs["data:weight:airframe:tail:vertical:skin:mass"] = m_skin
        # outputs["data:weight:airframe:tail:vertical:ribs:mass"] = m_ribs
        # outputs["data:structures:tail:vertical:ribs:number"] = N_ribs
        # outputs["data:weight:airframe:tail:vertical:spar:mass"] = m_spar
...
class Constraints(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_output("optimization:constraints:structures:wing:spar:diameter", units=None)
        # self.add_output("optimization:constraints:structures:tail:horizontal:spar:diameter", units=None)
        # self.add_output("optimization:constraints:structures:tail:vertical:spar:diameter", units=None)
    ...
    def compute(self, inputs, outputs):
        ...
        outputs["optimization:constraints:structures:wing:spar:diameter"] = spar_cnstr_wing
        # outputs["optimization:constraints:structures:tail:horizontal:spar:diameter"] = spar_cnstr_ht
        # outputs["optimization:constraints:structures:tail:vertical:spar:diameter"] = spar_cnstr_vt
