...
class Power(om.ExplicitComponent):
    ...
    def compute(self, inputs, outputs):
        k_pesc = inputs["optimization:variables:propulsion:esc:power:k"]
...
class Voltage(om.ExplicitComponent):
    ...
    def compute(self, inputs, outputs):
        k_vesc = inputs["optimization:variables:propulsion:esc:voltage:k"]
        U_bat = inputs["data:propulsion:battery:voltage"]
...
class Voltage_2(om.ExplicitComponent):
    ...
    def setup(self):
        self.add_input("models:propulsion:esc:power:reference", val=3180.0, units="W")
        self.add_input("models:propulsion:esc:voltage:reference", val=44.4, units="V")
    ...
    def compute(self, inputs, outputs):
        ...
        U_esc_ref = inputs["models:propulsion:esc:voltage:reference"]
