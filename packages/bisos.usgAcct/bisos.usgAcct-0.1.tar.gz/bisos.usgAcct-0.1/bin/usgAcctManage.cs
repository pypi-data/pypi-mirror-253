...
#+END_SRC
#+RESULTS:
| bisos.b.cs.ro | blee.icmPlayer.bleep | bisos.usgAcct |
#+end_org """
...
from bisos import usgAcct


csuList = [ 'bisos.b.cs.ro', 'blee.icmPlayer.bleep', 'bisos.usgAcct', ]
...
"""
        usgAcct.examples_csu(sectionTitle="default")
