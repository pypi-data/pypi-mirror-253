...
def test_Round_sparse(mask_rate):
    ...
    assert_identical_ndarrays(delayedarray.extract_dense_array(z), numpy.round(densed))
...
def test_Round_decimals(mask_rate):
    ...
    assert_identical_ndarrays(delayedarray.extract_dense_array(z), numpy.round(y, decimals=1))
