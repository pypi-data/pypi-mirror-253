...
class RosMessageParser(Parser):
    ...
    class Field_declarationContext(ParserRuleContext):
        ...
        def type_(self):
            return self.getTypedRuleContext(RosMessageParser.TypeContext, 0)
    ...
    class TypeContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return RosMessageParser.RULE_type
    ...
    def type_(self):
        ...
        localctx = RosMessageParser.TypeContext(self, self._ctx, self.state)
