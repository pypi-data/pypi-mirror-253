...
from lamini.api.utils.shutdown import shutdown
...
class Lamini:
    ...
    def upload_data(self, data: Iterable[Dict[str, Union[int, float, str, bool, Dict, List]]]):
        def get_data_str(d):
            for item in d:
        ...
        print(f"\nYour dataset id is: {dataset_id}. Please use this in the future to train using the same data.")
    ...
    def train(
        self,
        data: Optional[Iterable[Dict[str, Union[int, float, str, bool, Dict, List]]]] = None,
