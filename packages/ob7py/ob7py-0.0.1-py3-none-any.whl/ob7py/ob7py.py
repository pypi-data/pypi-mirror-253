"""
single line description of module in this module level docstring.

more verbose commentary here, as in what does the module do etc

examples of instatiating the main class and using some methods
...
class ModbusClient_:
    ...
    def movej(self, j1, j2, j3, j4, j5, j6, j7):
    ...
    def dis_units(self, arg=None):
        ...
        if arg is None:
            return units_tuple[int(self.read_uint16(771))]  # CHECK THIS -MD
        elif 0 <= arg <= 4:
    ...
    def weight_units(self, arg=None):
        ...
        if arg is None:
            return units_tuple[int(self.read_uint16(772))]  # CHECK THIS -MD
        elif 0 <= arg <= 2:
...
def main():
    ...
    dummy
    if dummy == "y":
        modbus_client = ModbusClient_("127.0.0.3", 5020)
