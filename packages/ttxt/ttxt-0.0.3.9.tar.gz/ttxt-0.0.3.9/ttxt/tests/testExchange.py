...
def test(exchangeName="", params={}):
    ...
    if "create_market_order" in params and params["create_market_order"]:
        ...
        try:
            resp = ttxtExchange.create_market_order(symbol=tickerToTest, side="sell", amount=9)
    ...
    if "cancelOrder" in params and params["cancelOrder"]:
        ...
        try:
            resp = ttxtExchange.cancel_order(id=404932207747, symbol=tickerToTest)
...
if __name__ == "__main__":
    ...
    testingParams = {"ticker": False, "balance": False, "ohlcv": False, "createOrder": False, "fetchOrder": False, 
                     ...
                     "createMarketSellOrder": False, "createMarketBuyOrder": False, "orderbook": False, "candlestick": False,
                     "create_market_order": True, "cancelAllOrders": False}
