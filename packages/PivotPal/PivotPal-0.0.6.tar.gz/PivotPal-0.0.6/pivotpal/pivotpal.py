...
def duplicates(df):
    ...
    # Create a pivot table to count the occurrences of each duplicate row
    pivot_table = duplicate_rows.groupby(list(duplicate_rows.columns)).size().reset_index(name='Count')
