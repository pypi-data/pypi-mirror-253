...
class DeleteAnalyzerResult(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, status, creation_timestamp, updated_timestamp, org_id, dataset_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, status, creation_timestamp, updated_timestamp, org_id, dataset_id, *args, **kwargs):  # noqa: E501
        """DeleteAnalyzerResult - a model defined in OpenAPI
