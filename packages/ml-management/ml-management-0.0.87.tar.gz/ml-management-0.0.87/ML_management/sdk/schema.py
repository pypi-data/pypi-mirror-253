...
class ExecutionJob(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('name', 'periodic_type', 'status', 'registration_timestamp', 'start_timestamp', 'end_timestamp', 'exception', 'params', 'run', 'experiment', 'list_init_role_model_version', 'dataset_loader_version', 'executor_version', 'build_job', 'list_result_model_version')
    name = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='name')
