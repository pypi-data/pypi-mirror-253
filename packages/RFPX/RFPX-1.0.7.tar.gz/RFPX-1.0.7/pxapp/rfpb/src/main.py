...
my_own_mcbook_locations = {'travel_img_location': (207.0, 183),
                           ...
                           'buy_max_button_location': (917.9999999999999, 643.0878661087866),
...
class PixelsUser:
    def __init__(self, my_driver=None, operation_system='windows'):
        ...
        self.range_middle_x = (745, 810)
        self.range_middle_y = (545, 600)
        ...
        if operation_system == 'macOS':
            ...
            self.COLORS = {
                ...
                "dominant_colors": {
                    "Popberry": [(137, 185, 187), (127, 188, 203), (138, 186, 187), (124, 188, 188), (142, 189, 188)],
    ...
    def find_first_pixel(self, target_color, image=None, from_arrange=False):
    ...
    def highlight_with_mouse(self, start='buy_input_quantity_location'):
        self.errors_notifier = 7
        ...
        start_x, start_y = self.LOCATIONS[start]
    ...
    def get_code_from_mail_7(self, mail7_mail):
        ...
        while not code:
            try:
                ...
                self.record_error(f"Error trying to get the code from mail 7 {getting_code_from_mail_7}")
                self.driver.refresh()
                continue
            else:
                sleep(6)
    ...
    def center_terravilla(self):
        ...
        self.get_to_color(target_color=self.COLORS["fountain_color"])
    ...
    def arrange_inventory_details(self):
        """
        ...
        for square in all_items_in_the_inventory:
            sleep(0.5)
            ...
            try:
                ...
                left = location['x']
                top = location['y']
                right = location['x'] + size['width'] * x_sel_real_ratio
                bottom = location['y'] + size['height'] * y_sel_real_ratio
                print(
                    f"inventory location: {location_in_inventory}. absolute x, y {absolute_left_x}, {absolute_left_y}. multiplier x, y {multiplier_x}, {multiplier_y}. location x {left} top y {top}")
                ...
                for key, value in self.COLORS["dominant_colors"].items():
                    for color in value:
                        if bool(self.find_first_pixel(target_color=color, image=element_screenshot, from_arrange=True)):
                            ...
                            print(
                                f"This is square quantity {square_quantity}, this is square quantity.text {square_quantity.text}")
            ...
            for key, value in items_to_sell_dict.items():
                ...
                try:
                    ...
                    if quantity_to_sell == 'max':
                        ...
                        self.highlight_with_mouse(start='sell_input_quantity_location')
                        sleep(2)
