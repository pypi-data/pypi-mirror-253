...
from jejudo.core.shim.paginator_base import EmojiSettings
from jejudo.core.work.types import ContextA

# Version detection
if discord.version_info >= (2, 0, 0):
    from jejudo.core.shim.paginator_200 import PaginatorEmbedInterface, PaginatorInterface
else:
    from jejudo.core.shim.paginator_170 import PaginatorEmbedInterface, PaginatorInterface
