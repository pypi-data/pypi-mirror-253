...
class SageMakerPlugin(BosunPluginBase):
    ...
    def get_aws_client(
        ...
        self._logger.info("Configuring AWS SageMaker client...")
    ...
    def deployment_list(self):
        self._logger.info("SageMaker Plugin deployment_list called")
    ...
    def pe_status(self):
        ...
        :return: ActionStatusInfo
        """
        self._logger.info("SageMaker Plugin pe_status called")
        try:
    ...
    def deployment_status(self, di: DeploymentInfo):
        ...
        :return: ActionStatusInfo
        """
        self._logger.info("SageMaker Plugin deployment_status called")
        try:
            aws_client = self.get_aws_client()
