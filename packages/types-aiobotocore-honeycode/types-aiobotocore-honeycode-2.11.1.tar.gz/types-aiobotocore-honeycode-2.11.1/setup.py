...
setup(
    ...
    description="Type annotations for aiobotocore.Honeycode 2.11.1 service generated with mypy-boto3-builder 7.23.1",
    classifiers=[
    ...
    python_requires=">=3.8",
    project_urls={
        "Documentation": "https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_honeycode/",
