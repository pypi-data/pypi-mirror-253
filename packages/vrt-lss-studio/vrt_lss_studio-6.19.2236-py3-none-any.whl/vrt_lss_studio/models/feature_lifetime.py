...
class FeatureLifetime(BaseModel):
    ...
    time_windows: Annotated[List[TimeWindow], Field(min_length=0, max_length=4)] = Field(description="A list of time windows within which the specified tag exists. If compatibility is affected by several features with different windows - entities will be considered compatible within the intersection of windows. ")
