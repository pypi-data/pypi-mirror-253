...
class HardlinksApi:
    ...
    @validate_arguments
    def disable_hardlinks(self, experiment_key : Annotated[StrictStr, Field(description="Key, unique identifier.")], request_body : Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(min_length=0, max_length=15001, description="Disable hardlinks request.")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def enable_hardlinks(self, experiment_key : Annotated[StrictStr, Field(description="Key, unique identifier.")], request_body : Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(min_length=0, max_length=15001, description="Enable hardlinks request.")], **kwargs) -> None:  # noqa: E501
