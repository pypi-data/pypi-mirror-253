...
class TransportsApi:
    ...
    @validate_arguments
    def disable_transports(self, experiment_key : Annotated[StrictStr, Field(description="Key, unique identifier.")], request_body : Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(min_length=0, max_length=15001, description="Disable transports request.")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def disable_transports_with_http_info(self, experiment_key : Annotated[StrictStr, Field(description="Key, unique identifier.")], request_body : Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(min_length=0, max_length=15001, description="Disable transports request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Disable transports  # noqa: E501
    ...
    @validate_arguments
    def enable_transports(self, experiment_key : Annotated[StrictStr, Field(description="Key, unique identifier.")], request_body : Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(min_length=0, max_length=15001, description="Enable transports request.")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def enable_transports_with_http_info(self, experiment_key : Annotated[StrictStr, Field(description="Key, unique identifier.")], request_body : Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(min_length=0, max_length=15001, description="Enable transports request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Enable transports  # noqa: E501
