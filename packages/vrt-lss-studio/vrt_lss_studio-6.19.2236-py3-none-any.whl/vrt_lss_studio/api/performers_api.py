...
class PerformersApi:
    ...
    @validate_arguments
    def disable_performers(self, experiment_key : Annotated[StrictStr, Field(description="Key, unique identifier.")], request_body : Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(min_length=0, max_length=15001, description="Disable performers request.")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def disable_performers_with_http_info(self, experiment_key : Annotated[StrictStr, Field(description="Key, unique identifier.")], request_body : Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(min_length=0, max_length=15001, description="Disable performers request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Disable performers  # noqa: E501
    ...
    @validate_arguments
    def enable_performers(self, experiment_key : Annotated[StrictStr, Field(description="Key, unique identifier.")], request_body : Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(min_length=0, max_length=15001, description="Enable performers request.")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def enable_performers_with_http_info(self, experiment_key : Annotated[StrictStr, Field(description="Key, unique identifier.")], request_body : Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(min_length=0, max_length=15001, description="Enable performers request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Enable performers  # noqa: E501
