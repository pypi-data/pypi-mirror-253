...
class ParsimEventCircuit:
    ...
    def __write_RQ(self, event: DataEventCircuit, t_after_PC_off: float = 500.0, event_counter: int = 0):
        ...
        for i in range(2):
            ...
            circuit_family_name = self.__get_circuit_family_name(circuit_name_1)
            ...
            if event_counter == 0:
                ...
                event_dict['GlobalParameters.global_parameters.t_EE'] = self.PC_switchoff_time + event.EnergyExtractionSystem[circuit_name].delta_t_EE_PIC[i] * 0.001 - event.PoweredCircuits[circuit_name].delta_t_FGC_PIC * 0.001 - self.t_EE_switch
                #event.EnergyExtractionSystem[circuit_name].delta_t_EE_PIC = [event_dict['GlobalParameters.global_parameters.t_EE']]
