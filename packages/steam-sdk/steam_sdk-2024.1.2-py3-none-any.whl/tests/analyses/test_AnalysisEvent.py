...
class TestAnalysisEvent(unittest.TestCase):
    ...
    def test_get_circuit_family_from_circuit_name(self):
        ...
        dict_tests = {
            ...
            'RQX.L2v': {'target_circuit_family': 'RQX'},
        }

        for circuit_name, value in dict_tests.items():
            target_circuit_family = value['target_circuit_family']
            self.try_get_circuit_family_from_circuit_name(circuit_name = circuit_name, target_circuit_family = target_circuit_family)
    ...
    def test_get_number_of_magnets(self):
        ...
        **Test case for the get_number_of_magnets function.
        ...
        #arrange
        test_scenarios = [
            {'circuit_name': "RCS", 'simulation_name': 'Simulation_RCS', 'circuit_type': "RCS", 'target_magnet_number': 154},
            {'circuit_name': "RB", 'simulation_name': 'Simulation_RB', 'circuit_type': "RB", 'target_magnet_number': 154},
            {'circuit_name': "RQ6.ABC", 'simulation_name': 'Simulation_RQ6_ABC', 'circuit_type': "RQ6.ABC", 'target_magnet_number': None},
            {'circuit_name': "RQ6.ABCD", 'simulation_name': 'Simulation_RQ6_ABC', 'circuit_type': "RQ6.ABC",'target_magnet_number': 6},
            {'circuit_name': "RQS.RXYZ", 'simulation_name': 'Simulation_RQS_RXYZ', 'circuit_type': "RQS.R", 'target_magnet_number': 2},
            {'circuit_name': "RQX", 'simulation_name': 'Simulation_RQX', 'circuit_type': "RQX", 'target_magnet_number': 4},
            {'circuit_name': "RQTD", 'simulation_name': 'Simulation_RQTD', 'circuit_type': "RQTD", 'target_magnet_number': 8},
            {'circuit_name': "RCBH", 'simulation_name': 'Simulation_60A', 'circuit_type': "60A", 'target_magnet_number': 1},
            {'circuit_name': "RQ4", 'simulation_name': 'IPQ_RQ4_4_2xRPHH_4xMQY', 'circuit_type': "IPQ", 'target_magnet_number': 2}  # Assuming _10_ divided by 2 equals 5
        ]
        ...
        for scenario in test_scenarios:
            ...
            # act
            magnet_number = get_number_of_magnets(circuit_name, simulation_name, circuit_type)
    ...
    def try_get_circuit_family_from_circuit_name(self,circuit_name: str, target_circuit_family: str):
        '''
        **Check that the function try_get_circuit_family_from_circuit_name returns the right circuit family for a certain circuit name
        '''
        #act
        circuit_family = get_circuit_family_from_circuit_name(circuit_name = circuit_name)
        #assert
