...
from dreifus.util.mesh import subdivide
from scipy.spatial import KDTree
from trimesh import Trimesh

from famudy.data import FamudySequenceDataManager
from famudy.provider.expression_animation_provider import ExpressionAnimationManager
from famudy.provider.mesh_provider import MeshProvider, MeshProviderConfig
from famudy.util.quantization import CanonicalCoordinatesQuantizer, to_spherical
...
class NPHMProvider(MeshProvider):
    ...
    def __init__(self,
        ...
        self._data_manager = FamudySequenceDataManager(participant_id, sequence)
