...
from famudy.config.model.flame import FlameConfig
from famudy.env_data import FAMUDY_FLAME_MODEL_PATH
...
class FLAME(nn.Module):
    ...
    def __init__(self, config: FlameConfig):
        ...
        flame_model_path = f"{FAMUDY_FLAME_MODEL_PATH}/{config.flame_version}"
        static_landmark_embedding_path = f"{FAMUDY_FLAME_MODEL_PATH}/flame_static_embedding.pkl"
        dynamic_landmark_embedding_path = f"{FAMUDY_FLAME_MODEL_PATH}/flame_dynamic_embedding.npy"
...
class FlameTexConfig:
    tex_space_path: str = f"{FAMUDY_FLAME_MODEL_PATH}/FLAME_texture.npz"
    tex_params: int = 200
