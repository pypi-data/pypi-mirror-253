...
# Query params
UseSmallDocSchema = schemas.BoolSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'useSmallDoc': typing.Union[UseSmallDocSchema, bool, ],
    }
)
...
request_query_use_small_doc = api_client.QueryParameter(
    name="useSmallDoc",
    style=api_client.ParameterStyle.FORM,
    schema=UseSmallDocSchema,
    required=True,
    explode=True,
)
# Path params
...
class BaseApi(api_client.Api):
    @typing.overload
    def _test_signature_template_oapg(
        self,
...
class TestSignatureTemplate(BaseApi):
    ...
    def test_signature_template(
        ...
        return self._test_signature_template_oapg(
