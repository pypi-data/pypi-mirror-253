...
class PageableObject(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["pageNumber", "pageSize", "paged", "unpaged", "offset", "sort", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["pageNumber", "pageSize", "paged", "unpaged", "offset", "sort", ], str]):
