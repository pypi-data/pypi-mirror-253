...
class DatasetCypher:
    @abstractmethod
    @overload
    def decrypt_dataset(self,dataset: Dataset) -> Dataset: ...

    @abstractmethod
    @overload
    def decrypt_dataset(self,dataset: DatasetDict) -> DatasetDict: ...

    @abstractmethod
    @overload
    def decrypt_dataset(self,dataset: IterableDatasetDict) -> IterableDatasetDict: ...

    @abstractmethod
    @overload
    def decrypt_dataset(self,dataset: IterableDataset) -> IterableDataset: ...
    
    @abstractmethod
    def decrypt_dataset(self, dataset: Dataset | DatasetDict | IterableDatasetDict | IterableDataset):
        raise NotImplementedError()

    @abstractmethod
    @overload
    def encrypt_dataset(self, dataset: Dataset) -> Dataset: ...
    
    @abstractmethod
    @overload
    def encrypt_dataset(self, dataset: DatasetDict) -> DatasetDict: ...
    
    @abstractmethod
    @overload
    def encrypt_dataset(self, dataset: IterableDatasetDict) -> IterableDatasetDict: ...
    
    @abstractmethod
    @overload
    def encrypt_dataset(self, dataset: IterableDataset) -> IterableDataset: ...

    @abstractmethod
    def encrypt_dataset(self, dataset:  Dataset | DatasetDict | IterableDatasetDict | IterableDataset):
        raise NotImplementedError()
