...
[aiobotocore.OpenSearchIngestion 2.11.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/osis.html#OpenSearchIngestion)
...
Install `types-aiobotocore-lite[osis]` in your environment:
