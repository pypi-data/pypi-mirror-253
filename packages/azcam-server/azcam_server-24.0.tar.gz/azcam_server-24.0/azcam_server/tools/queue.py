"""
AzCam observing queue.

This started as the server-side implementation of the client-side observe command.
"""
...
class Queue(Tools):
    """
    Defines the queue observing script class.
    """

    def __init__(self, tool_id="queue", description="azcam observing queue"):
    ...
    def read_file(self, script_file):
        """
        Read an observing script file into command dictionary.
