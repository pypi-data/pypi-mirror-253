...
class Focus(Tools):
    ...
    def save_keywords(self):
        ...
        if self.focus_component == "instrument":
            ...
            self.instrument.set_keyword("FOCSTART", reply, "starting focus value", "str")
            self.instrument.set_keyword("FOCSTEP", self.focus_step, "focus step size", "float")
            ...
            self.telescope.set_keyword("FOCSTEP", self.focus_step, "focus step size", "float")
