...
export declare function getDatasFromKernelBySql(fieldMetas: any): (payload: IDataQueryPayload) => Promise<IRow[] | undefined>;
export declare function getDatasFromKernelByPayload(payload: IDataQueryPayload): Promise<IRow[] | undefined>;
export {};
