...
from ..misc import filter_custom_config_by_auth_state_keys
...
class CustomGenericOAuthenticator(GenericOAuthenticator):
    ...
    async def update_auth_state_custom_config(self, authentication, force=False):
        ...
        if (
            ...
            """
            custom_config = get_custom_config()
            filtered_config = filter_custom_config_by_auth_state_keys()
            authentication["auth_state"]["custom_config"] = filtered_config
