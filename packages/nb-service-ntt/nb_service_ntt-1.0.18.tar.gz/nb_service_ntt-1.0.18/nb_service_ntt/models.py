...
class Service(ChangeLoggedModel):
    ...
    def get_absolute_url(self):
        return reverse("plugins:nb_service_ntt:service", kwargs={"pk": self.pk})
...
class Application(ChangeLoggedModel):
    ...
    def get_absolute_url(self):
        return reverse("plugins:nb_service_ntt:application", kwargs={"pk": self.pk})
...
class IC(ChangeLoggedModel):
    ...
    @property
    def name(self):
        if self.assigned_object_type.name is "circuit":
            return self.assigned_object.cid
        elif self.assigned_object is not None:
    ...
    def get_absolute_url(self):
        url = reverse("plugins:nb_service_ntt:service", kwargs={"pk": self.service.pk})
        try:
