...
def Scan(
        searchDirectory: str,
        includeDirs=True, includeFiles=True, skipLinks=True,
    ...
    :param includeSymlinks: Specifies wheter to yield symlinks, when this is set to false, symlink directories wont even be scanned.
            ...
            try:
                with _os.scandir(currentFolder) as entries:
                    for entry in entries:
                        ...
                        if(skipLinks and entry.is_symlink()):
                            continue
