...
import { f as fetchMe, a as fetchEntity, b as fetchSentDocuments, r as refreshToken } from './index-aa6058ba.js';
  ...
  render() {
    return [
      ...
      h("limel-dialog", { open: this.isOpen, closingActions: { escapeKey: true, scrimClick: false }, onClose: () => {
          this.isOpen = false;
        }, class: { aside: this.checkIsAside() } }, h("div", { class: "ga-top-bar" }, this.renderLogo(this.showWorkflow()), h("limel-icon", { class: "close", name: "cancel", size: "small", onClick: () => {
          this.isOpen = false;
        } }), (() => {
      ...
      })()), h("div", { class: "ga-body" }, this.renderLayout()), h("div", { class: "ga-version" }, h("span", null, "Version: 1.3.4")), h("limel-button-group", { slot: "button" }, h("limel-button", { label: "Cancel", onClick: () => {
          this.isOpen = false;
