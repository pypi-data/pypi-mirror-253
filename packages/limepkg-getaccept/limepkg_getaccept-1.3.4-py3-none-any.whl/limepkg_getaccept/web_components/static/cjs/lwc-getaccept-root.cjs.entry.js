...
const index$1 = require('./index-dd6def2a.js');
  ...
  render() {
    return [
      ...
      index.h("limel-dialog", { open: this.isOpen, closingActions: { escapeKey: true, scrimClick: false }, onClose: () => {
          this.isOpen = false;
        }, class: { aside: this.checkIsAside() } }, index.h("div", { class: "ga-top-bar" }, this.renderLogo(this.showWorkflow()), index.h("limel-icon", { class: "close", name: "cancel", size: "small", onClick: () => {
          this.isOpen = false;
        } }), (() => {
      ...
      })()), index.h("div", { class: "ga-body" }, this.renderLayout()), index.h("div", { class: "ga-version" }, index.h("span", null, "Version: 1.3.4")), index.h("limel-button-group", { slot: "button" }, index.h("limel-button", { label: "Cancel", onClick: () => {
          this.isOpen = false;
  ...
  renderLayout() {
    switch (this.activeView) {
      case EnumViews.EnumViews.home:
        return (index.h("layout-overview", { platform: this.platform, session: this.session, externalId: this.externalId, documents: this.documents, isAside: this.checkIsAside() }));
      ...
      case EnumViews.EnumViews.recipient:
        return (index.h("layout-select-recipient", { platform: this.platform, document: this.documentData, context: this.context, isAside: this.checkIsAside() }));
      ...
      case EnumViews.EnumViews.sendDocument:
        return (index.h("layout-send-document", { context: this.context, document: this.documentData, limeDocument: this.limeDocument, template: this.template, session: this.session, platform: this.platform }));
