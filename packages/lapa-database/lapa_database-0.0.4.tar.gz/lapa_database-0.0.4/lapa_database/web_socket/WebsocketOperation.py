...
def run_listen_for_changes(table_name: str,
                           database_name: str,
                           schema_name: str,
    ...
    try:
        ...
        loop.run_until_complete(listen_for_changes(table_name, database_name, schema_name, result_queue))

    except Exception:
        raise


async def listen_for_changes(table_name: str,
                             database_name: str,
                             schema_name: str,
                             result_queue: asyncio.Queue):
    """
    ...
    try:
        ...
        lobj_connection.set_isolation_level(psycopg2.extensions.ISOLATION_LEVEL_AUTOCOMMIT)
            ...
            while True:
                ...
                while lobj_connection.notifies:
                    ...
                    if lobj_notify.channel == lstr_channel_name:
                        ...
                        # ================================================================
                        update_message = json.dumps({'type': 'updated', 'data': update_data}, default=str)
