...
T = TypeVar("T", bound="PlayByPlaySituationHomeTeam")


@_attrs_define
class PlayByPlaySituationHomeTeam:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        play_by_play_situation_home_team = cls(
            abbrev=abbrev,
            situation_descriptions=situation_descriptions,
            strength=strength,
        )

        play_by_play_situation_home_team.additional_properties = d
        return play_by_play_situation_home_team
