...
T = TypeVar("T", bound="ScoreDetailsGamesItemClock")


@_attrs_define
class ScoreDetailsGamesItemClock:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        score_details_games_item_clock = cls(
        ...
        score_details_games_item_clock.additional_properties = d
        return score_details_games_item_clock
