...
T = TypeVar("T", bound="GetV1Player8476453LandingResponse200CareerTotalsPlayoffs")


@_attrs_define
class GetV1Player8476453LandingResponse200CareerTotalsPlayoffs:
    """
    Attributes:
        games_played (int):
        goals (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_v1_player_8476453_landing_response_200_career_totals_playoffs = cls(
        ...
        get_v1_player_8476453_landing_response_200_career_totals_playoffs.additional_properties = d
        return get_v1_player_8476453_landing_response_200_career_totals_playoffs
