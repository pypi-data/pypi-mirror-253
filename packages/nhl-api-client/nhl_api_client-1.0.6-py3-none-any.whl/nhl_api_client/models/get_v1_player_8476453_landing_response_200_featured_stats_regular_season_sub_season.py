...
T = TypeVar("T", bound="GetV1Player8476453LandingResponse200FeaturedStatsRegularSeasonSubSeason")


@_attrs_define
class GetV1Player8476453LandingResponse200FeaturedStatsRegularSeasonSubSeason:
    """
    Attributes:
        games_played (int):
        goals (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_v1_player_8476453_landing_response_200_featured_stats_regular_season_sub_season = cls(
        ...
        get_v1_player_8476453_landing_response_200_featured_stats_regular_season_sub_season.additional_properties = d
        return get_v1_player_8476453_landing_response_200_featured_stats_regular_season_sub_season
