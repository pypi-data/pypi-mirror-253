...
T = TypeVar("T", bound="ScoreDetailsGamesItemAwayTeam")


@_attrs_define
class ScoreDetailsGamesItemAwayTeam:
    """
    Attributes:
        id (Union[Unset, int]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        score_details_games_item_away_team = cls(
            id=id,
            name=name,
            abbrev=abbrev,
            score=score,
        ...
        score_details_games_item_away_team.additional_properties = d
        return score_details_games_item_away_team
