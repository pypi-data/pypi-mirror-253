...
if TYPE_CHECKING:
    from ..models.play_by_play_home_team_on_ice_item import PlayByPlayHomeTeamOnIceItem
    from ..models.language_string import LanguageString


T = TypeVar("T", bound="PlayByPlayHomeTeam")


@_attrs_define
class PlayByPlayHomeTeam:
    """
    Attributes:
        id (Union[Unset, int]):
        ...
        sog (Union[Unset, int]):
        on_ice (Union[Unset, List['PlayByPlayHomeTeamOnIceItem']]):
    """
    ...
    sog: Union[Unset, int] = UNSET
    on_ice: Union[Unset, List["PlayByPlayHomeTeamOnIceItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for on_ice_item_data in _on_ice or []:
            on_ice_item = PlayByPlayHomeTeamOnIceItem.from_dict(on_ice_item_data)

            on_ice.append(on_ice_item)

        play_by_play_home_team = cls(
            id=id,
            abbrev=abbrev,
            logo=logo,
            dark_logo=dark_logo,
        ...
        play_by_play_home_team.additional_properties = d
        return play_by_play_home_team
