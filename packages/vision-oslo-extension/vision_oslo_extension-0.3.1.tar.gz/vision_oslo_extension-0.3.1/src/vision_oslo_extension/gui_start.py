...
class SampleApp(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        getmenu.add_command(label= 'Excel - For Average Power',command = lambda: SharedMethods.copy_example_files('power_template.xlsx'))
        getmenu.add_command(label= 'Excel - For IF Protection',command = lambda: SharedMethods.copy_example_files('protection_template.xlsx'))
        getmenu.add_command(label= 'Excel - For New SP Connect',command = lambda: SharedMethods.copy_example_files('new_connection_template.xlsx'))
        getmenu.add_command(label= 'Excel - For OLE Rating',command = lambda: SharedMethods.copy_example_files('ole_rating_template.xlsx'))
