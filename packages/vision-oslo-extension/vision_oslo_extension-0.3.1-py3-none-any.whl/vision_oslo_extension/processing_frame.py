...
from vision_oslo_extension.shared_contents import SharedVariables, Local_Shared
from vision_oslo_extension.base_frame import BasePage
from vision_oslo_extension import post_processing, batch_processing,average_load,protection_if,grid_connection,ole_processing
...
class P03(BasePage):
    def __init__(self, parent, controller):
        ...
        choice3 = tk.Radiobutton(master=self.optionframe, text = 'Option 3: Update spreadsheet only. (Require all .df files and .mxn files)', value="3", variable=option1)
        choice3.grid(row = 2, column = 0, sticky = "w", padx=5, pady=5)
