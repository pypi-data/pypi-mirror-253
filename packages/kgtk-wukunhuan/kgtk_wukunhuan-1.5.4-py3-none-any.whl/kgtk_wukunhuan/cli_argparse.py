...
from kgtk_wukunhuan.exceptions import KGTKArgumentParseException, KGTKSyntaxException, KGTKDependencyException
...
class CheckDepsAction(_StoreTrueAction):
    ...
    def __call__(self, parser, namespace, values, option_string=None):
        from kgtk_wukunhuan.dependencies import check_dependencies
