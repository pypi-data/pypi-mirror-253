...
def test_service_rollout(  # noqa: PLR0913
    ...
    """
    service_controller = ServiceController()
    service_controller.api_client.apply_service_api_v2_services_v2_apply_put = Mock(
        return_value=Mock(
            result=(
                Mock(
                    versions=[
    ...
    service_controller.api_client.apply_service_api_v2_services_v2_apply_put.assert_called_once_with(
        service_v2_config
    )
