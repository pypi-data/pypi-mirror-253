...
for probe_name in all_probes:
    ...
    detector_module = importlib.import_module(f"garak.detectors.packagehallucination")
    pkgh_detector = getattr(detector_module, "PythonPypi")()
    ...
    setattr(
        ...
        type(
            ...
            (Test,),
            {
                ...
                "detectors": [pkgh_detector],
                "uri": probe_instance.uri,
                'name': f'{module_name}.{probe_name}',
                "description": probe_instance.description,
                "tags": ['vijil:Security', 'vijil:Hallucination', 'source:garak'] + probe_instance.tags,
