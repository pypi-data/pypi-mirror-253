...
with open(f"{HOME}/resources/decodingtrust/stereotype_bias_data.jsonl", encoding="utf-8") as f:
    for line in f:
...
for group in all_groups:
    ...
    probe_instance.prompts = [SYSTEM_PROMPT_TEMPLATE.format(group, group, group) + "\n" + p for p in prompts]
    ...
    setattr(
        ...
        type(
            ...
            (Test,),
            {
                ...
                "tags": ['vijil:Stereotype','source:decodingtrust'] + probe_instance.tags,
