...
inline const ::xla::HloModuleProto& CompilationResultProto::hlo_module() const {
  // @@protoc_insertion_point(field_get:xla.gpu.CompilationResultProto.hlo_module)
...
inline void CompilationResultProto::unsafe_arena_set_allocated_hlo_module(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:xla.gpu.CompilationResultProto.hlo_module)
}
...
inline ::xla::HloModuleProto* CompilationResultProto::unsafe_arena_release_hlo_module() {
  // @@protoc_insertion_point(field_release:xla.gpu.CompilationResultProto.hlo_module)
...
inline ::xla::HloModuleProto* CompilationResultProto::mutable_hlo_module() {
  ...
  // @@protoc_insertion_point(field_mutable:xla.gpu.CompilationResultProto.hlo_module)
  return _msg;
}
inline void CompilationResultProto::set_allocated_hlo_module(::xla::HloModuleProto* hlo_module) {
  ...
  _impl_.hlo_module_ = hlo_module;
  // @@protoc_insertion_point(field_set_allocated:xla.gpu.CompilationResultProto.hlo_module)
}
