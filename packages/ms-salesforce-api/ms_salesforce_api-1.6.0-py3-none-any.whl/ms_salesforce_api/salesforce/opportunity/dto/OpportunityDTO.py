class OpportunityLineItemDTO(object):
    ...
    def from_salesforce_record(line_item_record, opportunity_id):
        ...
        return OpportunityLineItemDTO(
            ...
            profit_center_name=profit_center.get("Name", "")
            if profit_center
            else None,
            country=profit_center.get("PCK_Country__c", "")
            if profit_center
            else None,
            jira_task_url=line_item_record.get("JiraComponentURL__c", ""),
