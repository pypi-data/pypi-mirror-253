        ...
        if country == 'UAE':
            ...
            if is_colored1:
                try:
                    ...
                    id_card, tampered_result = detect_id_card(self.client, image_data, front_id_text)
        ...
        if country=='UAE':
            ...
            if is_colored2:
                # try:
                    ...
                    id_card, part_img, third_part_text, tampered_result = detect_id_card(self.client, image_data, id_infos, part='third')
