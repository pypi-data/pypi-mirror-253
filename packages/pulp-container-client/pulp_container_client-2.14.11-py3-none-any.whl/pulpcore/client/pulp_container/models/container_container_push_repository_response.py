...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, description=None, versions_href=None, retain_repo_versions=None, name=None, pulp_href=None, pulp_created=None, latest_version_href=None, pulp_labels=None, manifest_signing_service=None, local_vars_configuration=None):  # noqa: E501
