...
class MultiMarkets(Inserts):
    def __init__(self, user, database, port, host, password):
        ...
        self.markets = [Market.Stocks, Market.Options, Market.Crypto, Market.Forex, Market.Indices] #Market.Forex]# Market.Indices]
                    ...
                    if len(self.agg_tickers) == 250:
                        ...
                        async for df in self.process_batches(tickers_string):
                            ...
                            for i,row in df.head(5).iterrows():
                                ...
                                data_dict = { 
                                    'option_symbol': underlying_symbol_value,
                                    'strike': strike,
                                    'call_put': call_put_value,
                                    'expiry': expiry_value,
                                    'theta': theta_value,
                                    ...
                                    'intrinsic_value': in_value_value,
                                    'extrinsic_value': ex_value_value,
                                    'oi': oi_value,
                                    'volume': vol_value,
                                    'iv': iv_value,
                                    'iv_percentile': iv_percentile_value,  
                                    'profit_potential': profit_potential_value,
                                                                    }
                                ...
                                if oi_value >= 100000:
                                    ...
                                    asyncio.create_task(self.insert_theta_resistant(df, 'oi_100k_plus', unique_columns='option_symbol'))
                                ...
                                if oi_value >= 10000 and oi_value <= 49999:
                                    ...
                                    asyncio.create_task(self.analyzer.send_hook(hook, embed))
                                    asyncio.create_task(self.db.batch_insert_dataframe(df, 'oi_10k_50k', unique_columns='option_symbol'))
                                ...
                                if oi_value >= 50000 and oi_value <= 99999:
                                    ...
                                    asyncio.create_task(self.db.batch_insert_dataframe(df, 'oi_50k_100k', unique_columns='option_symbol'))
                                ...
                                if theta_value <= -0.01 and theta_value >= -0.03 and ask_value >= 0.18 and ask_value <= 1.50:
                                    ...
                                    asyncio.create_task(self.analyzer.send_hook(hook, embed))
                                    asyncio.create_task(asyncio.sleep(1))
                                    asyncio.create_task(self.insert_theta_resistant(df, 'theta_resistant', unique_columns='option_symbol'))
