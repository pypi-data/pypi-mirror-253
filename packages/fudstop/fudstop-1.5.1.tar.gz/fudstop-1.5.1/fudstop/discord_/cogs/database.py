...
options = WebullOptions(user='chuck', host='localhost', port=5432, password='fud', database='markets')
...
class DatabaseCOG(commands.Cog):
    def __init__(self, bot):
        self.bot=bot
        self.db = PolygonDatabase(user='chuck', database='markets', host='localhost', password='fud', port=5432)
