...
from online_shop.categories.serializers import (
...
class CategoryListView(ListAPIView):
    """A view that returns a list of all online_shop.categories.
...
class CategoryCreateView(CreateAPIView):
    ...
    queryset: The queryset used for retrieving the existing online_shop.categories.
    """
