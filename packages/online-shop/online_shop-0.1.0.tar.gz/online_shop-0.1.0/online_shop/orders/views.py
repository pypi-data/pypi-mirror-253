...
from online_shop.orders.serializers import OrderSerializer, OrderStatusSerializer
from online_shop.products.models import Review


class OrderListView(ListAPIView):
    """A view for retrieving and creating online_shop.orders.

    Inherits from ListAPIView to provide a list of online_shop.orders.
