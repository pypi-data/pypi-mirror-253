...
from online_shop.categories.models import Category
from online_shop.products.models import Product, Review
from online_shop.products.serializers import ProductSerializer, ReviewSerializer
...
class ProductListView(ListAPIView):
    ...
    - sort: The sorting order of the online_shop.products. Possible values are:
