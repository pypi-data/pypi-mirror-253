from RikPy.commonheroku import heroku_upload_file_from_url, heroku_list_files_in_folder, heroku_download_files_in_folder, heroku_delete_file
from RikPy.commonshopify import Shopify_get_metaobject_gid, Shopify_update_metaobject
from RikPy.commons3 import s3_list_files_in_folder, s3_environment, s3_upload_local_file, s3_delete_file, s3_upload_file_from_url
import boto3
...
if b_test_s3:
    ...
    S3_ACCESS_KEY_ID = 'AKIAVRUVVBONDCWNZQLM'
    S3_SECRET_ACCESS_KEY = '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'
