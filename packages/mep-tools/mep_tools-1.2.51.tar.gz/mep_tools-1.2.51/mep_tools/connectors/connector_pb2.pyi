...
class DispatcherParams(_message.Message):
    __slots__ = ["start_date", "end_date", "filters"]
    ...
    def __init__(self, start_date: _Optional[str] = ..., end_date: _Optional[str] = ..., filters: _Optional[_Iterable[_Union[DispatcherFilter, _Mapping]]] = ...) -> None: ...
