...
class XYZ(FileManager):
    ...
    def export_as_xyz(self, file_location:str=None, save_to_file:str='w', verbose:bool=False,
        ...
        time = time if self.time is not None else False
        ...
        time_str = f'{time_tag}={time}' if time else ''

        xyz_content += f'{lattice_str} Properties={species_str}{position_str}{forces_str}{charge_str}{magnetization_str} {energy_str} {pbc_str} {time_str}\n'
    ...
    def read_XYZ(self, file_location: str = None, lines: list = None, energy_key: str = 'energy', 
                       ...
                       species_key: str = 'species', PBC_key: str = 'pbc', time_key: str = 'time', 
                       verbose: bool = False):
        """
