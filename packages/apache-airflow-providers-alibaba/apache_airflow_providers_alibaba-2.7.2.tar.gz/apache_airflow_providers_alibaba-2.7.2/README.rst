...
in the `documentation <https://airflow.apache.org/docs/apache-airflow-providers-alibaba/2.7.2/>`_.
...
`changelog <https://airflow.apache.org/docs/apache-airflow-providers-alibaba/2.7.2/changelog.html>`_.