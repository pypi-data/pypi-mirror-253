...
from epias.epys.utils.tgt import RequestFunctions
from epias.epys.invoice.data import Invoice
from epias.epys.reconciliation.settlement import Settlement
from epias.epys.reconciliation.reports import Reports
from epias.epys.reconciliation.settlementdata import SettlementData


class WebServiceEPYS(RequestFunctions, Invoice, Settlement, Reports, SettlementData): 
