...
from .const import DEFAULT_USER_AGENT, DEFAULT_AUTH_COOKIE_FILE, LOGIN_URL, BASE_URL, AUTH_COOKIE_NAME
...
class HowDidIDoSession(requests.sessions.Session):
    ...
    def login(self, persistent: bool = True) -> Cookie:
        ...
        res = self.post(post_url, headers=headers, data=form_data, allow_redirects=False)
        res.raise_for_status()
