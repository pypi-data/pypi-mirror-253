...
from .const import BOOKING_URL, REQUEST_TIMEOUT
from .types import BookedEvent, BookableEvent, Bookings

logger = logging.getLogger(__name__)


class HowDidIDoBookingMixin:
    def get_bookings(self: requests.sessions.Session) -> Bookings:
        """Get bookings"""
