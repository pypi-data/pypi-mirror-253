...
class SyncForexClient(base_client.BaseClient):
    ...
    def real_time_currency_conversion(
        self, from_symbol: str, to_symbol: str, amount: float, precision: int = 2, raw_response: bool = False
    ):
        """
        ...
        _data = {"amount": amount, "precision": precision}
    ...
    def get_sma(
        ...
        :param symbol: The option symbol. You can pass it with or without the prefix ``C:``.
...
class AsyncForexClient(base_client.BaseAsyncClient):
    ...
    async def get_last_quote(self, from_symbol: str, to_symbol: str, raw_response: bool = False):
        """
    ...
    async def real_time_currency_conversion(
        self, from_symbol: str, to_symbol: str, amount: float, precision: int = 2, raw_response: bool = False
    ):
        """
        Get currency conversions using the latest market conversion rates. Note than you can convert in both directions.
