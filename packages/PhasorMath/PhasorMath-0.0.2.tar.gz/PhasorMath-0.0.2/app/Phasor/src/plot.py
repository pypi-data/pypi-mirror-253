...
class Plot:
    ...
    def __init__(self,*phasor,theme = 0):
        ...
        Args:
            *phasor (Phasor/SCtoU/UtoSC): phasor objects to visualize
        ...
        self.fig.show(config={'scrollZoom': True,'displaylogo': False})
