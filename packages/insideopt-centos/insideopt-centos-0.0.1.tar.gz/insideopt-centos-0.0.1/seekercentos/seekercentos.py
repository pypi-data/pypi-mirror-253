...
def __bootstrap__():
   ...
   so_file = os.path.join(os.path.dirname(__file__),f"seekercentos.1.0.0.cpython-{py_version}-{os_name}.so")
   spec = importlib.util.spec_from_file_location("seekercentos", so_file)
