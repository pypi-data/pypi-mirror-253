...
@LastEditTime: 2023-12-26 18:54:49
            ...
            if self._request_source_type() == 2:
                ...
                if user_nick:
                    ...
                    if store_user_nick:
                        ...
                        app_info_dict = app_info_model.get_cache_dict(where=condition_where.to_string(), limit="1", field="app_id", params=params)
                        if app_info_dict:
                ...
                elif share_config.get_value("is_app_relation", False) == True:
                    app_relation_model = AppRelationModel(context=self)
                    app_relation_dict = app_relation_model.get_cache_dict(where="ref_app_id=%s", limit="1", field="app_id", params=[app_id])
