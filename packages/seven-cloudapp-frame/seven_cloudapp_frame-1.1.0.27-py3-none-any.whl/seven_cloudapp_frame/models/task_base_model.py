...
@LastEditTime: 2024-01-19 18:10:59
...
class TaskBaseModel(FrameBaseModel):
    ...
    :description: 任务业务模型
    """
    def __init__(self, context=None, logging_error=None, logging_info=None, check_app_user_info=False):
        ...
        super(TaskBaseModel, self).__init__(context, check_app_user_info)
