...
@LastEditTime: 2023-05-17 14:58:09
...
class ActBaseModel():
    ...
    def _delete_act_info_dependency_key(self,app_id,act_id,delay_delete_time=0.01):
        ...
        ActInfoModel().delete_dependency_key(dependency_key_list, delay_delete_time)
    ...
    def get_act_info_dict(self,act_id,is_cache=True,is_filter=True, field="*"):
        ...
        if is_cache:
            ...
            act_info_dict = act_info_model.get_cache_dict_by_id(primary_key_id=act_id, dependency_key=dependency_key, field=field)
        else:
    ...
    def get_act_info_list(self, app_id, act_name, is_del, page_size, page_index, is_cache=True, act_type=-1, is_release=-1, order_by="id asc"):
        """
        ...
        if is_cache:
            page_list, total = ActInfoModel(context=self.context).get_cache_dict_page_list(field="*", page_index=page_index, page_size=page_size, where=condition_where.to_string(), group_by="", order_by=order_by, params=params,dependency_key=DependencyKey.act_info_list(app_id))
        else:
    ...
    def add_act_info(self, app_id, act_name, act_type, theme_id, share_desc_json, rule_desc_json, close_word="抱歉，程序维护中", is_share=-1, is_rule=-1, is_release=-1, start_date=None, end_date=None, is_black=-1, refund_count=-1, join_ways=-1, is_fictitious=-1, store_url=None, i1=-1, i2=-1, i3=-1, i4=-1, i5=-1, s1=None, s2=None, s3=None, s4=None, s5=None, d1=None, d2=None, is_visit_store=-1, agreement_json=[], brand_json={}):
        """
        :description: 添加活动信息
        :param app_id: 应用标识
        :param act_name: 活动名称
    ...
    def update_act_info(self, app_id, act_id, act_name, theme_id, is_share, share_desc_json, is_rule, rule_desc_json, is_release, start_date, end_date, is_black, refund_count, join_ways, is_fictitious, close_word="抱歉，程序维护中", store_url=None, i1=-1, i2=-1, i3=-1, i4=-1, i5=-1, s1=None, s2=None, s3=None, s4=None, s5=None, d1=None, d2=None, is_visit_store=-1, agreement_json=[], brand_json={}):
        """
        :description: 修改活动信息
        :param app_id: 应用标识
        :param act_id：活动标识
