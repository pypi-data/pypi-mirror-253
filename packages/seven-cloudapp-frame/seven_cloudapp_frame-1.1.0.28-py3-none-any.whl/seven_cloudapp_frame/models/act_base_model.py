...
@LastEditTime: 2023-12-27 09:48:34
...
class ActBaseModel():
    ...
    def update_act_info(self, app_id, act_id, act_name, theme_id, is_share, share_desc_json, is_rule, rule_desc_json, is_release, start_date, end_date, is_black, refund_count, join_ways, is_fictitious, close_word="抱歉，程序维护中", store_url=None, i1=-1, i2=-1, i3=-1, i4=-1, i5=-1, s1=None, s2=None, s3=None, s4=None, s5=None, d1=None, d2=None, is_visit_store=-1, agreement_json=[], brand_json={}, business_type=-1):
        """
        :description: 修改活动信息
        :param app_id: 应用标识
        :param act_id：活动标识
