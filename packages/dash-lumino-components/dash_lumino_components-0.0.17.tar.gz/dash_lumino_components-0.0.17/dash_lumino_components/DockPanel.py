...
- widgetEvent (boolean | number | string | dict | list; optional):
    ...
    _type = 'DockPanel'
    @_explicitize_args
    def __init__(self, children=None, id=Component.REQUIRED, mode=Component.UNDEFINED, spacing=Component.UNDEFINED, addToDom=Component.UNDEFINED, widgetEvent=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'addToDom', 'mode', 'spacing', 'widgetEvent']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'addToDom', 'mode', 'spacing', 'widgetEvent']
