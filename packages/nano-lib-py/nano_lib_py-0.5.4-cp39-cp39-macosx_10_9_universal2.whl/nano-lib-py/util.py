...
def nbase32_to_bytes(nbase32):
    ...
    :rtype: bytes
    """
    return nano-lib-py._nbase32.nbase32_to_bytes(bytes(nbase32, "utf-8"))
...
def bytes_to_nbase32(b):
    ...
    :rtype: str
    """
    return nano-lib-py._nbase32.bytes_to_nbase32(b).decode("utf-8")
