...
class Block(object):
    ...
    def has_valid_work(self):
        ...
        .. note::
           ...
           other case use :meth:`nano-lib-py.blocks.Block.verify_work`
           instead.
    ...
    def work_block_hash(self):
        ...
        :attr:`nano-lib-py.blocks.Block.account`. For other types of blocks,
        :attr:`nano-lib-py.blocks.Block.previous` is used as the hash.
    ...
    def work_value(self):
        ...
        or higher than :attr:`nano-lib-py.blocks.Block.difficulty`
