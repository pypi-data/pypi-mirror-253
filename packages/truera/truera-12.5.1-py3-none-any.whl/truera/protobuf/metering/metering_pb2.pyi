...
class MeteringIngestionStatsRequest(_message.Message):
    __slots__ = ["tenant_id", "metering_window", "report_granularity"]
    ...
    def __init__(self, tenant_id: _Optional[str] = ..., metering_window: _Optional[_Union[MeteringWindow, _Mapping]] = ..., report_granularity: _Optional[_Union[ReportGranularity, str]] = ...) -> None: ...
