...
class QueryRequest(_message.Message):
    __slots__ = ["id", "project_id", "sql_query", "raw_data_request", "prediction_request", "feature_influence_request", "filter_data_request", "model_comparison_request", "model_bias_request", "bucketized_stats_request", "drift_request", "isp_request", "return_rot_metadata_only"]
...
class QueryResponse(_message.Message):
    __slots__ = ["request_id", "row_major_value_table", "page_number", "rot_metadata_used"]
    REQUEST_ID_FIELD_NUMBER: _ClassVar[int]
    ROW_MAJOR_VALUE_TABLE_FIELD_NUMBER: _ClassVar[int]
    PAGE_NUMBER_FIELD_NUMBER: _ClassVar[int]
    ROT_METADATA_USED_FIELD_NUMBER: _ClassVar[int]
    request_id: str
    row_major_value_table: RowMajorValueTable
    page_number: int
    rot_metadata_used: _containers.RepeatedCompositeFieldContainer[_read_optimized_table_messages_pb2.RotMetadata]
    def __init__(self, request_id: _Optional[str] = ..., row_major_value_table: _Optional[_Union[RowMajorValueTable, _Mapping]] = ..., page_number: _Optional[int] = ..., rot_metadata_used: _Optional[_Iterable[_Union[_read_optimized_table_messages_pb2.RotMetadata, _Mapping]]] = ...) -> None: ...

class QuerySpec(_message.Message):
    __slots__ = ["split_id", "selection_options", "filter", "operation_types", "aggregation_types", "select_columns", "skip_initial_rows", "ranking_options"]
...
class AccuracyRequest(_message.Message):
    __slots__ = ["project_id", "model_id", "accuracy_type", "query_spec", "qoi", "classification_threshold", "include_confusion_matrix", "request_id", "include_compute_record_count", "threshold_context", "return_rot_metadata_only"]
    PROJECT_ID_FIELD_NUMBER: _ClassVar[int]
    MODEL_ID_FIELD_NUMBER: _ClassVar[int]
...
class QueryItemResult(_message.Message):
    __slots__ = ["row_major_value_table", "error_code", "rot_metadata_used"]
    ...
    rot_metadata_used: _containers.RepeatedCompositeFieldContainer[_read_optimized_table_messages_pb2.RotMetadata]
    def __init__(self, row_major_value_table: _Optional[_Union[RowMajorValueTable, _Mapping]] = ..., error_code: _Optional[_Union[QueryItemResult.QueryError, str]] = ..., rot_metadata_used: _Optional[_Iterable[_Union[_read_optimized_table_messages_pb2.RotMetadata, _Mapping]]] = ...) -> None: ...
