...
class GetRotOperationRequest(_message.Message):
    __slots__ = ["rot_operation_id"]
    ROT_OPERATION_ID_FIELD_NUMBER: _ClassVar[int]
    rot_operation_id: str
    def __init__(self, rot_operation_id: _Optional[str] = ...) -> None: ...

class GetRotOperationResponse(_message.Message):
