...
class FeedbackFunctionAggregate(_message.Message):
    __slots__ = ["name", "function_id", "average_score", "num_passed", "num_failed", "num_total"]
    ...
    num_failed: int
    num_total: int
    def __init__(self, name: _Optional[str] = ..., function_id: _Optional[str] = ..., average_score: _Optional[float] = ..., num_passed: _Optional[int] = ..., num_failed: _Optional[int] = ..., num_total: _Optional[int] = ...) -> None: ...

class FeedbackFunctionEval(_message.Message):
    __slots__ = ["name", "function_id", "score", "passed", "args"]
    ...
    def __init__(self, name: _Optional[str] = ..., function_id: _Optional[str] = ..., score: _Optional[float] = ..., passed: bool = ..., args: _Optional[_Mapping[str, _any_pb2.Any]] = ...) -> None: ...

class ApplicationAggregate(_message.Message):
    __slots__ = ["name", "id", "description", "latency", "total_cost", "total_tokens", "num_traces", "created_on", "tags", "feedback_function_aggregates"]
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    feedback_function_aggregates: _containers.RepeatedCompositeFieldContainer[FeedbackFunctionAggregate]
    def __init__(self, name: _Optional[str] = ..., id: _Optional[str] = ..., description: _Optional[str] = ..., latency: _Optional[float] = ..., total_cost: _Optional[float] = ..., total_tokens: _Optional[int] = ..., num_traces: _Optional[int] = ..., created_on: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., tags: _Optional[_Iterable[str]] = ..., feedback_function_aggregates: _Optional[_Iterable[_Union[FeedbackFunctionAggregate, _Mapping]]] = ...) -> None: ...

class TraceData(_message.Message):
    __slots__ = ["id", "created_on", "feedback_function_aggregates", "feedback_function_evaluations", "input", "output", "num_tokens", "cost", "span_data"]
    ID_FIELD_NUMBER: _ClassVar[int]
    CREATED_ON_FIELD_NUMBER: _ClassVar[int]
    FEEDBACK_FUNCTION_AGGREGATES_FIELD_NUMBER: _ClassVar[int]
    FEEDBACK_FUNCTION_EVALUATIONS_FIELD_NUMBER: _ClassVar[int]
    ...
    created_on: _timestamp_pb2.Timestamp
    feedback_function_aggregates: _containers.RepeatedCompositeFieldContainer[FeedbackFunctionAggregate]
    feedback_function_evaluations: _containers.RepeatedCompositeFieldContainer[FeedbackFunctionEval]
    input: str
    output: str
    num_tokens: int
    cost: float
    span_data: _struct_pb2.Value
    def __init__(self, id: _Optional[str] = ..., created_on: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., feedback_function_aggregates: _Optional[_Iterable[_Union[FeedbackFunctionAggregate, _Mapping]]] = ..., feedback_function_evaluations: _Optional[_Iterable[_Union[FeedbackFunctionEval, _Mapping]]] = ..., input: _Optional[str] = ..., output: _Optional[str] = ..., num_tokens: _Optional[int] = ..., cost: _Optional[float] = ..., span_data: _Optional[_Union[_struct_pb2.Value, _Mapping]] = ...) -> None: ...

class DatasetMetadata(_message.Message):
    __slots__ = ["name", "id", "created_on", "last_updated", "type"]
    ...
    def __init__(self, name: _Optional[str] = ..., id: _Optional[str] = ..., created_on: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., last_updated: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., type: _Optional[_Union[DatasetMetadata.DatasetType, str]] = ...) -> None: ...
...
class ApplicationAggregateRequest(_message.Message):
    ...
    MODEL_ID_FIELD_NUMBER: _ClassVar[int]
    model_id: ModelId
    def __init__(self, model_id: _Optional[_Union[ModelId, _Mapping]] = ...) -> None: ...
...
class ApplicationDatasetMetadataRequest(_message.Message):
    __slots__ = ["model_id"]
    MODEL_ID_FIELD_NUMBER: _ClassVar[int]
    model_id: ModelId
    def __init__(self, model_id: _Optional[_Union[ModelId, _Mapping]] = ...) -> None: ...

class ApplicationDatasetMetadataResponse(_message.Message):
    __slots__ = ["dataset_metadata"]
    DATASET_METADATA_FIELD_NUMBER: _ClassVar[int]
    dataset_metadata: _containers.RepeatedCompositeFieldContainer[DatasetMetadata]
    def __init__(self, dataset_metadata: _Optional[_Iterable[_Union[DatasetMetadata, _Mapping]]] = ...) -> None: ...

class DatasetDataRequest(_message.Message):
    __slots__ = ["model_id", "dataset_id"]
    MODEL_ID_FIELD_NUMBER: _ClassVar[int]
    DATASET_ID_FIELD_NUMBER: _ClassVar[int]
    model_id: ModelId
    dataset_id: str
    def __init__(self, model_id: _Optional[_Union[ModelId, _Mapping]] = ..., dataset_id: _Optional[str] = ...) -> None: ...

class DatasetDataResponse(_message.Message):
    __slots__ = ["dataset_metadata", "traces"]
    DATASET_METADATA_FIELD_NUMBER: _ClassVar[int]
    TRACES_FIELD_NUMBER: _ClassVar[int]
    dataset_metadata: DatasetMetadata
    traces: _containers.RepeatedCompositeFieldContainer[TraceData]
    def __init__(self, dataset_metadata: _Optional[_Union[DatasetMetadata, _Mapping]] = ..., traces: _Optional[_Iterable[_Union[TraceData, _Mapping]]] = ...) -> None: ...

class TraceDataRequest(_message.Message):
    __slots__ = ["model_id", "dataset_id", "trace_id"]
    MODEL_ID_FIELD_NUMBER: _ClassVar[int]
    DATASET_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    dataset_id: str
    trace_id: str
    def __init__(self, model_id: _Optional[_Union[ModelId, _Mapping]] = ..., dataset_id: _Optional[str] = ..., trace_id: _Optional[str] = ...) -> None: ...

class TraceDataResponse(_message.Message):
    __slots__ = ["trace_data"]
    TRACE_DATA_FIELD_NUMBER: _ClassVar[int]
    trace_data: TraceData
    def __init__(self, trace_data: _Optional[_Union[TraceData, _Mapping]] = ...) -> None: ...
...
class AccuracyRequest(_message.Message):
    __slots__ = ["model_id", "model_input_spec", "accuracy_types", "include_precision_recall_curve", "include_roc_curve", "include_confusion_matrix", "dont_compute_predictions", "estimate_type", "baseline_input_spec"]
    MODEL_ID_FIELD_NUMBER: _ClassVar[int]
    MODEL_INPUT_SPEC_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, model_id: _Optional[_Union[ModelId, _Mapping]] = ..., model_input_spec: _Optional[_Union[ModelInputSpec, _Mapping]] = ..., accuracy_types: _Optional[_Iterable[_Union[_accuracy_pb2.AccuracyType.Type, str]]] = ..., include_precision_recall_curve: bool = ..., include_roc_curve: bool = ..., include_confusion_matrix: bool = ..., dont_compute_predictions: bool = ..., estimate_type: _Optional[_Union[_accuracy_pb2.EstimateType, str]] = ..., baseline_input_spec: _Optional[_Union[ModelInputSpec, _Mapping]] = ...) -> None: ...
...
class BatchAccuracyRequest(_message.Message):
    __slots__ = ["project_id", "model_data", "accuracy_types", "dont_compute_predictions"]
    PROJECT_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    accuracy_types: _containers.RepeatedScalarFieldContainer[_accuracy_pb2.AccuracyType.Type]
    dont_compute_predictions: bool
    def __init__(self, project_id: _Optional[str] = ..., model_data: _Optional[_Iterable[_Union[AccuracyRequestMapping, _Mapping]]] = ..., accuracy_types: _Optional[_Iterable[_Union[_accuracy_pb2.AccuracyType.Type, str]]] = ..., dont_compute_predictions: bool = ...) -> None: ...
...
class GetBucketizedStatsRequest(_message.Message):
    __slots__ = ["model_id", "model_input_spec", "feature", "type", "numerical_bucket_params", "categorical_bucket_params"]
    MODEL_ID_FIELD_NUMBER: _ClassVar[int]
    MODEL_INPUT_SPEC_FIELD_NUMBER: _ClassVar[int]
    FEATURE_FIELD_NUMBER: _ClassVar[int]
    TYPE_FIELD_NUMBER: _ClassVar[int]
    NUMERICAL_BUCKET_PARAMS_FIELD_NUMBER: _ClassVar[int]
    CATEGORICAL_BUCKET_PARAMS_FIELD_NUMBER: _ClassVar[int]
    model_id: ModelId
    model_input_spec: ModelInputSpec
    feature: str
    type: BucketizedStatsType.Type
    numerical_bucket_params: NumericalBucketParams
    categorical_bucket_params: CategoricalBucketParams
    def __init__(self, model_id: _Optional[_Union[ModelId, _Mapping]] = ..., model_input_spec: _Optional[_Union[ModelInputSpec, _Mapping]] = ..., feature: _Optional[str] = ..., type: _Optional[_Union[BucketizedStatsType.Type, str]] = ..., numerical_bucket_params: _Optional[_Union[NumericalBucketParams, _Mapping]] = ..., categorical_bucket_params: _Optional[_Union[CategoricalBucketParams, _Mapping]] = ...) -> None: ...
...
class DataSummaryRequest(_message.Message):
    __slots__ = ["project_id", "data_collection_id", "input_spec", "artifact_type", "pre_operation_types", "aggregation_types", "columns_to_summarize", "model_id", "prediction_options", "feature_influence_options"]
...
class BatchDataSummaryRequest(_message.Message):
    __slots__ = ["project_id", "data_collection_id", "request_entries"]
    PROJECT_ID_FIELD_NUMBER: _ClassVar[int]
    DATA_COLLECTION_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, project_id: _Optional[str] = ..., data_collection_id: _Optional[str] = ..., request_entries: _Optional[_Iterable[_Union[BatchDataSummaryRequestEntry, _Mapping]]] = ...) -> None: ...
...
class BatchISPRequest(_message.Message):
    __slots__ = ["project_id", "data_collection_id", "model_id", "input_spec", "features", "feature_influence_options"]
    PROJECT_ID_FIELD_NUMBER: _ClassVar[int]
    DATA_COLLECTION_ID_FIELD_NUMBER: _ClassVar[int]
    MODEL_ID_FIELD_NUMBER: _ClassVar[int]
    INPUT_SPEC_FIELD_NUMBER: _ClassVar[int]
    ...
    features: _containers.RepeatedScalarFieldContainer[str]
    feature_influence_options: _common_pb2.FeatureInfluenceOptions
    def __init__(self, project_id: _Optional[str] = ..., data_collection_id: _Optional[str] = ..., model_id: _Optional[str] = ..., input_spec: _Optional[_Union[ModelInputSpec, _Mapping]] = ..., features: _Optional[_Iterable[str]] = ..., feature_influence_options: _Optional[_Union[_common_pb2.FeatureInfluenceOptions, _Mapping]] = ...) -> None: ...
...
class HistogramRequest(_message.Message):
    __slots__ = ["project_id", "data_collection_id", "input_spec", "data_type", "model_id", "prediction_options", "feature_influence_options", "feature_name"]
    ...
    feature_influence_options: _common_pb2.FeatureInfluenceOptions
    feature_name: str
    def __init__(self, project_id: _Optional[str] = ..., data_collection_id: _Optional[str] = ..., input_spec: _Optional[_Union[ModelInputSpec, _Mapping]] = ..., data_type: _Optional[_Union[HistogramRequest.HistogramDataType, str]] = ..., model_id: _Optional[str] = ..., prediction_options: _Optional[_Union[_common_pb2.PredictionOptions, _Mapping]] = ..., feature_influence_options: _Optional[_Union[_common_pb2.FeatureInfluenceOptions, _Mapping]] = ..., feature_name: _Optional[str] = ...) -> None: ...
