...
class CreateUserActivityReportRequest(_message.Message):
    __slots__ = ["tenant_id", "user_id", "time_window", "user_activity_type"]
    ...
    def __init__(self, tenant_id: _Optional[str] = ..., user_id: _Optional[str] = ..., time_window: _Optional[_Union[_time_range_pb2.TimeRange, _Mapping]] = ..., user_activity_type: _Optional[_Iterable[_Union[UserActivityType, str]]] = ...) -> None: ...
...
class CreateUsageReportRequest(_message.Message):
    __slots__ = ["tenant_id", "time_window", "usage_report_type"]
    TENANT_ID_FIELD_NUMBER: _ClassVar[int]
    TIME_WINDOW_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, tenant_id: _Optional[str] = ..., time_window: _Optional[_Union[_time_range_pb2.TimeRange, _Mapping]] = ..., usage_report_type: _Optional[_Union[UsageReportType, str]] = ...) -> None: ...
...
class CreateUserActivityUberReportRequest(_message.Message):
    __slots__ = ["tenant_id", "time_window", "user_ids"]
    TENANT_ID_FIELD_NUMBER: _ClassVar[int]
    TIME_WINDOW_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, tenant_id: _Optional[str] = ..., time_window: _Optional[_Union[_time_range_pb2.TimeRange, _Mapping]] = ..., user_ids: _Optional[_Iterable[str]] = ...) -> None: ...
