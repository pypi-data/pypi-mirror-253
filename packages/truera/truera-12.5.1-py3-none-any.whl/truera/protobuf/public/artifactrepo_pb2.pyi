...
class PutMetadataRequest(_message.Message):
    __slots__ = ["project", "model", "data_collection", "split", "feature_list", "data_source", "cache", "insert_only", "workspace_id"]
    PROJECT_FIELD_NUMBER: _ClassVar[int]
    MODEL_FIELD_NUMBER: _ClassVar[int]
    DATA_COLLECTION_FIELD_NUMBER: _ClassVar[int]
    ...
    insert_only: bool
    workspace_id: str
    def __init__(self, project: _Optional[_Union[_metadata_message_types_pb2.ProjectMetadata, _Mapping]] = ..., model: _Optional[_Union[_metadata_message_types_pb2.ModelMetadata, _Mapping]] = ..., data_collection: _Optional[_Union[_metadata_message_types_pb2.DataCollectionMetadata, _Mapping]] = ..., split: _Optional[_Union[_metadata_message_types_pb2.DataSplitMetadata, _Mapping]] = ..., feature_list: _Optional[_Union[_feature_pb2.FeatureList, _Mapping]] = ..., data_source: _Optional[_Union[_metadata_message_types_pb2.DataSourceWrapper, _Mapping]] = ..., cache: _Optional[_Union[_metadata_message_types_pb2.CacheMetadata, _Mapping]] = ..., insert_only: bool = ..., workspace_id: _Optional[str] = ...) -> None: ...
...
class GetMetadataForEntityRequestResponse(_message.Message):
    __slots__ = ["project", "model", "data_collection", "split", "feature_list", "data_source"]
    PROJECT_FIELD_NUMBER: _ClassVar[int]
    MODEL_FIELD_NUMBER: _ClassVar[int]
    DATA_COLLECTION_FIELD_NUMBER: _ClassVar[int]
    SPLIT_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, project: _Optional[_Union[_metadata_message_types_pb2.ProjectMetadata, _Mapping]] = ..., model: _Optional[_Union[_metadata_message_types_pb2.ModelMetadata, _Mapping]] = ..., data_collection: _Optional[_Union[_metadata_message_types_pb2.DataCollectionMetadata, _Mapping]] = ..., split: _Optional[_Union[_metadata_message_types_pb2.DataSplitMetadata, _Mapping]] = ..., feature_list: _Optional[_Union[_feature_pb2.FeatureList, _Mapping]] = ..., data_source: _Optional[_Union[_metadata_message_types_pb2.DataSource, _Mapping]] = ...) -> None: ...
