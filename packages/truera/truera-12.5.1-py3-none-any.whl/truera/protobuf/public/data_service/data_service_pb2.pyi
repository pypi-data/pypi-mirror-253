...
class MaterializeDataResponse(_message.Message):
    __slots__ = ["materialize_operation_id", "rowset_id", "project_id", "output_split_data_collection_id", "output_split_id", "output_split_name", "operation_started_time", "output_size_kb", "status", "error", "original_request"]
    MATERIALIZE_OPERATION_ID_FIELD_NUMBER: _ClassVar[int]
    ROWSET_ID_FIELD_NUMBER: _ClassVar[int]
    PROJECT_ID_FIELD_NUMBER: _ClassVar[int]
