...
class ProjectMetadata(_message.Message):
    __slots__ = ["id", "name", "created_at", "documentation", "settings"]
    ...
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., created_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., documentation: _Optional[_Union[_project_pb2.ProjectDocumentation, _Mapping]] = ..., settings: _Optional[_Union[ProjectLevelSettings, _Mapping]] = ...) -> None: ...
...
class DataCollectionMetadata(_message.Message):
    __slots__ = ["id", "name", "project_id", "base_split_id", "feature_transform_type", "tags", "description", "ground_truth_labels", "schemas", "created_at"]
    ID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    PROJECT_ID_FIELD_NUMBER: _ClassVar[int]
