...
class TrueraEntityIdentifier(_message.Message):
    __slots__ = ["project_id", "data_collection_id", "data_source_id", "data_split_id", "model_id", "dashboard_id", "report_id"]
    ...
    dashboard_id: str
    report_id: str
    def __init__(self, project_id: _Optional[str] = ..., data_collection_id: _Optional[str] = ..., data_source_id: _Optional[str] = ..., data_split_id: _Optional[str] = ..., model_id: _Optional[str] = ..., dashboard_id: _Optional[str] = ..., report_id: _Optional[str] = ...) -> None: ...
