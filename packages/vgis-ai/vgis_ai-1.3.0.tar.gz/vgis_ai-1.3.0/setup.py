...
setup(
    ...
    install_requires=["opencv-python", "Pillow", "numpy", "pandas", "loguru", "scikit-learn", "scipy", "torch",
                      "baidu-aip", "imgaug", "shapely", "pycocotools", "cityscapesscripts",
                      "requests", "vgis_utils", "vgis_log", "vgis_gis"],
    # Optional 第三方依赖库
