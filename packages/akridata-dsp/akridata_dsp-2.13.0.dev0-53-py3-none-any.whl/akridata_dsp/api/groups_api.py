...
class GroupsApi(object):
    ...
    def put_groups(self, groupname, **kwargs):  # noqa: E501
        """put_groups  # noqa: E501

        Add Group  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.put_groups(groupname, async_req=True)
        >>> result = thread.get()
        ...
        return self.put_groups_with_http_info(groupname, **kwargs)  # noqa: E501

    def put_groups_with_http_info(self, groupname, **kwargs):  # noqa: E501
        """put_groups  # noqa: E501
        ...
        >>> thread = api.put_groups_with_http_info(groupname, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method put_groups" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'groupname' is set
        if self.api_client.client_side_validation and local_var_params.get('groupname') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `groupname` when calling `put_groups`")  # noqa: E501
