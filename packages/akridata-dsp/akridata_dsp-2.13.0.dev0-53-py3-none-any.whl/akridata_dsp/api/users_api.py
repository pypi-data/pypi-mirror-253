...
class UsersApi(object):
    ...
    def put_users(self, username, **kwargs):  # noqa: E501
        """put_users  # noqa: E501
        ...
        >>> thread = api.put_users(username, async_req=True)
        >>> result = thread.get()
        ...
        return self.put_users_with_http_info(username, **kwargs)  # noqa: E501

    def put_users_with_http_info(self, username, **kwargs):  # noqa: E501
        """put_users  # noqa: E501
        ...
        >>> thread = api.put_users_with_http_info(username, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method put_users" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'username' is set
        if self.api_client.client_side_validation and local_var_params.get('username') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `username` when calling `put_users`")  # noqa: E501
