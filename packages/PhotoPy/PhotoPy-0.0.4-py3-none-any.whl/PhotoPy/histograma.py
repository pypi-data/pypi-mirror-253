...
def descritor_histograma(imagem):
    """
        Transforma a imagem e escala de cinza e calcula descritores estatísticos e de histograma para uma imagem em escala de cinza.

        Parameters:
        - imagem: array numpy, imagem de entrada colorida.
