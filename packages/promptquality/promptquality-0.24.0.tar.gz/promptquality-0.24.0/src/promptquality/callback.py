...
class GalileoPromptCallback(BaseCallbackHandler):
    ...
    def on_retriever_start(
        ...
        **kwargs: Any,
        ...
        self.set_relationships(run_id, node_type=ChainNodeType.retriever, parent_run_id=parent_run_id)
    ...
    def on_tool_start(
        ...
        **kwargs: Any,
        ...
        self.set_relationships(run_id, node_type=ChainNodeType.tool, parent_run_id=parent_run_id)
    ...
    def on_agent_finish(
        ...
        **kwargs: Any,
        ...
        """
        self.rows[run_id].node_type = ChainNodeType.agent
    ...
    def on_chain_start(
        ...
        **kwargs: Any,
        ...
        if isinstance(inputs, str):
            ...
            node_input = inputs = {key: value for key, value in inputs.items() if value and isinstance(value, str)}
