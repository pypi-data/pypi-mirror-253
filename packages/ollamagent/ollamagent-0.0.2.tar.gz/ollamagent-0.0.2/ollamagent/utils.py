...
They facilitate cross-domain usual tasks in a DRY manner through decorators and higher order functions.
"""
...
def handle_errors(
    ...
    Raises:
        HTTPException: If an exception is raised by the decorated function, it is caught and re-raised as an HTTPException with a status code of 500.
    """
