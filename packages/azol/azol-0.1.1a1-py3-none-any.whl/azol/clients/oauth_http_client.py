...
class OAuthHTTPClient:
    ...
    def __init__( self, tenant, oauth_resource, base_url,
                  credential_object, azol_id=None, oauth_flow=None, secrets_provider=None,
        ...
        if oauth_flow is None:
            oauth_flow=credential_object.get_default_oauth_flow()

        self.token_service = tService( credential_object, tenant_id=tenant, oauth_flow=oauth_flow,
    ...
    def _send_request( self, path=None, query_parameters=None, data=None, method="GET",
        ...
        if access_token is None and self._auto_refresh is False:
            ...
            self._set_current_token(access_token)
