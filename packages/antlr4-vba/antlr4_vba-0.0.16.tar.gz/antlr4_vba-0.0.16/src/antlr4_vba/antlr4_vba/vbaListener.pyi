...
class vbaListener(ParseTreeListener):
    ...
    def enterVsRelational(self, ctx: vbaParser.VsRelationalContext): ...
    def exitVsRelational(self, ctx: vbaParser.VsRelationalContext): ...
    def enterVsAddMinus(self, ctx: vbaParser.VsAddMinusContext): ...
    def exitVsAddMinus(self, ctx: vbaParser.VsAddMinusContext): ...
    def enterVsXor(self, ctx: vbaParser.VsXorContext): ...
    def exitVsXor(self, ctx: vbaParser.VsXorContext): ...
    def enterVsDivMult(self, ctx: vbaParser.VsDivMultContext): ...
    def exitVsDivMult(self, ctx: vbaParser.VsDivMultContext): ...
