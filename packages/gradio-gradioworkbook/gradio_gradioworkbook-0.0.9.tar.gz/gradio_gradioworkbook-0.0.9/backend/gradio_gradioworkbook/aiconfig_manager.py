...
class AIConfigManager:
    ...
    def __init__(self, filepath: str):
        ...
        self.session_data_map = {
            "original": SessionData(
                config=self._create_or_load_aiconfig(filepath),
    ...
    def _register_model_parsers(self):
        ...
        By default, we register the main remote HuggingFace parsers, since
        local models take too long to load for a reasonable UX.

        TODO: Support user-provider parser registration (including pre-loaded local models)
        """
    ...
    def delete_session_id(self, session_id: str) -> None:
        """Delete the session_id from the session_to_config_map map"""
        self.session_to_config_map.pop(session_id, None)
    ...
    def get_config_json(self, session_id: str) -> str:
    ...
    def _create_or_load_aiconfig(self, filepath: str) -> AIConfigRuntime:
        """
