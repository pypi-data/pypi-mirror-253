<script lang="ts">
  ...
  export let gradio: Gradio<{
    ...
    share_config: EventWithSessionIdData;
  ...
  // TODO: Remove _config param after we update and publish editor client package
  async function handleDownload(_config: AIConfig) {
    const client = await getClient();
