...
from dataclasses_json_speakeasy.cfg import config, LetterCase
from dataclasses_json_speakeasy.core import (Json, _ExtendedEncoder, _asdict,
                                             _decode_dataclass)
from dataclasses_json_speakeasy.mm import (JsonData, SchemaType, build_schema)
from dataclasses_json_speakeasy.undefined import Undefined
from dataclasses_json_speakeasy.utils import (_handle_undefined_parameters_safe,
...
def _process_class(cls: Type[T], letter_case: Optional[LetterCase],
    ...
    if letter_case is not None or undefined is not None:
        cls.dataclass_json_config = config(letter_case=letter_case,  # type: ignore[attr-defined]
                                           undefined=undefined)['dataclasses_json_speakeasy']
