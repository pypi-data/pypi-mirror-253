...
from dataclasses_json_speakeasy.core import (_is_supported_generic, _decode_dataclass,
                                             _ExtendedEncoder, _user_overrides_or_exts)
from dataclasses_json_speakeasy.utils import (_is_collection, _is_optional,
...
def schema(cls, mixin, infer_missing):
    ...
    for field in dc_fields(cls):
        ...
        if metadata.mm_field is not None:
            ...
            if field.metadata.get('dataclasses_json_speakeasy', {}).get('decoder'):
