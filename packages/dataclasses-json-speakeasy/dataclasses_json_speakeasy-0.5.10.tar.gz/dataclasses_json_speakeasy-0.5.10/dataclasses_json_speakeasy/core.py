...
from dataclasses_json_speakeasy import cfg
from dataclasses_json_speakeasy.utils import (_get_type_cons, _get_type_origin,
...
def _user_overrides_or_exts(cls):
    ...
    for field in fields(cls):
        ...
        field_config.update(field.metadata.get('dataclasses_json_speakeasy', {}))
