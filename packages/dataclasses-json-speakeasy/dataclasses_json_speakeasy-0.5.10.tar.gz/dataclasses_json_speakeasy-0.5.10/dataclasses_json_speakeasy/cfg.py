...
from dataclasses_json_speakeasy.stringcase import (camelcase, pascalcase, snakecase,
                                                   spinalcase)  # type: ignore
from dataclasses_json_speakeasy.undefined import Undefined, UndefinedParameterError
...
def config(metadata: Optional[dict] = None, *,
    ...
    lib_metadata = metadata.setdefault('dataclasses_json_speakeasy', {})
