...
def download_model(model_id, hf_url='https://hf-mirror.com/', exclude=None):
    if model_id.find('/') < 1:
        print('model_id格式不对！')
        return None
...
def download_model_cmd():
    ...
    download_model(model_id=args.model_id, hf_url=args.hf_url, exclude=exclude)


def download_dataset(model_id, hf_url='https://hf-mirror.com/', exclude=None):
    if model_id.find('/') < 1:
        print('model_id格式不对！')
        return None
...
def download_dataset_cmd():
    ...
    exclude = None if args.exclude is None else args.exclude.split(',')
    download_dataset(model_id=args.model_id, hf_url=args.hf_url, exclude=exclude)


if __name__ == '__main__':
    download_model('facebook/detr-resnet-50')
