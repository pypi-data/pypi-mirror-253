...
def download_model(model_id, threads=8, parallels=1, exclude=None):
...
def download_model_cmd():
    ...
    download_model(model_id=args.model_id, threads=args.threads, parallels=args.parallels, exclude=exclude)
