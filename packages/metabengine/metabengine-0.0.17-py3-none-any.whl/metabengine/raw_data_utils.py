...
class MSData:
    ...
    def plot_eic(self, target_mz, mz_tol=0.005, target_rt=None, rt_tol=0.3, output=False):
        """
        Function to plot EIC of a target m/z.
        """

        # get the eic data
        eic_rt, eic_int, _, _ = self.get_eic_data(target_mz, mz_tol=mz_tol, target_rt=target_rt, rt_tol=rt_tol)
