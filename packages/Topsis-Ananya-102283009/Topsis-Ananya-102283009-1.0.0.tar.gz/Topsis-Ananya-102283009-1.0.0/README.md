...
for: *Project-1 (UCS633)* submitted by: *Ananya Gupta* Roll no: 102283009 Group: *3COE16*

Topsis-Ananya-102283009 is a Python library for dealing with Multiple Criteria Decision Making(MCDM) problems by using Technique for Order of Preference by Similarity to Ideal Solution(TOPSIS).
