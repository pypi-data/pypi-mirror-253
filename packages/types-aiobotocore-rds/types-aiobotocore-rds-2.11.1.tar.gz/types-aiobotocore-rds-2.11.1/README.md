...
[aiobotocore.RDS 2.11.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/rds.html#RDS)
...
async with session.create_client("rds") as client:
    ...
    describe_db_instance_automated_backups_paginator: (
        DescribeDBInstanceAutomatedBackupsPaginator
