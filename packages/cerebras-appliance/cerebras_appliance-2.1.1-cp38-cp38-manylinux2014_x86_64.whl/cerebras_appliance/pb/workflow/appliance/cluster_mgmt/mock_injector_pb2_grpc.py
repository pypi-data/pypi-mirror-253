...
from cerebras_appliance.pb.workflow.appliance.cluster_mgmt import mock_injector_pb2 as cerebras_dot_pb_dot_workflow_dot_appliance_dot_cluster__mgmt_dot_mock__injector__pb2
