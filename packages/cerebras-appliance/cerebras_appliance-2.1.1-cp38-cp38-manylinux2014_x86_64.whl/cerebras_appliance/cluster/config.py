...
class CSClusterConfig:
    ...
    def get_namespace_certificate_authority(
        ...
        raise ClusterConfigError(
            f"config error: namespace {namespace} does not exist in {CSCONFIG_PATH}"
        )
...
def load_cs_cluster_config() -> CSClusterConfig:
    ...
    Returns:
        The CSConfig with mgmt address, a list of namespaces and corresponding
