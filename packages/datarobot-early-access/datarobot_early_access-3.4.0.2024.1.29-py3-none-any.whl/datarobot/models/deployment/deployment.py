...
class Deployment(APIObject, MonitoringDataQueryBuilderMixin, BrowserMixin):
    ...
    def get_challenger_replay_settings(self) -> ChallengerReplaySettings:
        ...
        settings : dict in the following format:
            enabled : bool
                Is ''True'' if challenger replay is enabled for this deployment.
            sample_size : int
                The number of predictions to be sampled for each challenger model.
            sampling_method : str
                The sampling method used to select predictions for each challenger model.
            schedule : datetime
                The schedule for the challenger replay job.
        """
