...
class CkptVersion:
    ...
    def __post_init__(self):
        ...
        if not isinstance(self.cstorch_version, str):
            raise TypeError(
    ...
    def to_file(self, fp: Union[str, h5.File]) -> None:
        ...
        ctx = nullcontext(fp) if isinstance(fp, h5.File) else h5.File(fp, "a")
        with ctx as f:
...
class PyTorchH5Saver(H5Saver):
    ...
    def save(
        self, ckpt_file: str, state_dict: dict, save_metadata: bool = True,
    ):
        ...
        super().save(ckpt_file, flattened, save_metadata=save_metadata)
