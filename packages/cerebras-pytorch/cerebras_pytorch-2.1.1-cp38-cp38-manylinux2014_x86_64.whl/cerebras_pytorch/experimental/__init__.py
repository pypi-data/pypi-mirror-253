...
def run_implicit_autoregressive_loop(
    ...
    This is equivalent to the following pseudocode for one loop:
        ...
        def inner_loop(input_tensor, loop_dim, start_token, stop_token, model):
    ...
    Args:
        ...
        start_token: For LM autoregessive use, this token in the input marks
                     ...
                     unmodified.
        stop_token:  For LM autoregessive use, this token in the output marks
                     the end of generation. Once it is seen, the inner
                     autorgressive loop is exited.
    """
