...
You can `create your own steps <pages/advanced_usage/creating_a_new_datadreamer_.../step.html>`_ to
...
.. dropdown:: Training
    ...
    See the `trainers <./datadreamer.trainers.html>`_ page for more
