...
class Client:
    ...
    def log_spans(
        ...
        try:
            ...
            from .tracing.validation import validator as tracing_validator
        except ImportError:
            msg = (
        ...
        errors = tracing_validator.validate_argument_types(
            dataframe=dataframe,
            model_id=model_id,
        ...
        if validate:
            ...
            errors = tracing_validator.validate_dataframe_form(dataframe)
            if errors:
                for e in errors:
                    logger.error(e)
                raise err.ValidationFailure(errors)
        ...
        if validate:
            ...
            errors = tracing_validator.validate_values(
