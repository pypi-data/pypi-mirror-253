...
info(f'Official GitHub repo of SLogger - {BuildInfo.gitHubLink}')class BuildInfo():
    version = '1.0' # Version
    buildType = 'Release' # Build type
    branding = 'SLogger' # Branding
    brandingInLogs = f'[{branding}]' # Branding in logs
...
log(f'{BuildInfo.branding} {BuildInfo.version} {BuildInfo.buildType} started')
info(f'Official GitHub repo of SLogger - {BuildInfo.gitHubLink}')