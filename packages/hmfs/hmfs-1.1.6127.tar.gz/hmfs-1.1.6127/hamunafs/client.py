...
class Client(Singleton):
    def __init__(self, host, redis_client, cache_path='../cache', workers=8, put_topic='fs_put', get_topic='fs_get') -> None:
        ...
        if os.path.isfile('hmfs.conf'):
            try:
                conf = json.load(open('hmfs.conf', 'r'))
