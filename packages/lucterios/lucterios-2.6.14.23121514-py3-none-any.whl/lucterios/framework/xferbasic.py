...
class XferContainerAbstract(View):
    ...
    def getparam(self, key, default_value=None):
        try:
            ...
            elif param_value == NULL_VALUE:
                param_value = None
            if (param_value is None) and (default_value == NULL_VALUE):
    ...
    def _search_model(self):
        self.has_changed = self.getparam(FORCE_CHANGED, False)
    ...
    def _get_params(self):
        params = {}
        import inspect
        spec = inspect.getfullargspec(self.fillresponse)
