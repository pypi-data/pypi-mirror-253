...
class ModalClientBase(abc.ABC):
    ...
    @abc.abstractmethod
    async def TokenWorkspaceLookup(self, stream: 'grpclib.server.Stream[modal_proto.api_pb2.TokenWorkspaceLookupRequest, modal_proto.api_pb2.TokenWorkspaceLookupResponse]') -> None:
        pass
    ...
    def __mapping__(self) -> typing.Dict[str, grpclib.const.Handler]:
        return {
            ...
            '/modal.client.ModalClient/TokenWorkspaceLookup': grpclib.const.Handler(
                self.TokenWorkspaceLookup,
                grpclib.const.Cardinality.UNARY_UNARY,
                modal_proto.api_pb2.TokenWorkspaceLookupRequest,
                modal_proto.api_pb2.TokenWorkspaceLookupResponse,
            ),
...
class ModalClientStub:
    ...
    def __init__(self, channel: grpclib.client.Channel) -> None:
        ...
        self.TokenWorkspaceLookup = grpclib.client.UnaryUnaryMethod(
            channel,
