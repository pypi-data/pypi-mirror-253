...
class ModalClientStub(object):
    ...
    def __init__(self, channel):
        ...
        self.TokenWorkspaceLookup = channel.unary_unary(
                '/modal.client.ModalClient/TokenWorkspaceLookup',
                request_serializer=modal__proto_dot_api__pb2.TokenWorkspaceLookupRequest.SerializeToString,
                response_deserializer=modal__proto_dot_api__pb2.TokenWorkspaceLookupResponse.FromString,
                )
...
class ModalClientServicer(object):
    ...
    def TokenWorkspaceLookup(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_ModalClientServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'TokenWorkspaceLookup': grpc.unary_unary_rpc_method_handler(
                    servicer.TokenWorkspaceLookup,
                    request_deserializer=modal__proto_dot_api__pb2.TokenWorkspaceLookupRequest.FromString,
                    response_serializer=modal__proto_dot_api__pb2.TokenWorkspaceLookupResponse.SerializeToString,
            ),
...
class ModalClient(object):
    ...
    @staticmethod
    def TokenWorkspaceLookup(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/modal.client.ModalClient/TokenWorkspaceLookup',
            modal__proto_dot_api__pb2.TokenWorkspaceLookupRequest.SerializeToString,
            modal__proto_dot_api__pb2.TokenWorkspaceLookupResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
