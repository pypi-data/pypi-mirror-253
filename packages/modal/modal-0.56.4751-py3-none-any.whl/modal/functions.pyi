...
class _Function(modal.object._Object):
    ...
    @classmethod
    async def lookup(cls: typing.Type[_Function], app_name: str, tag: typing.Union[str, None] = None, namespace=1, client: typing.Union[modal.client._Client, None] = None, environment_name: typing.Union[str, None] = None) -> _Function:
        ...
...
class Function(modal.object.Object):
    ...
    @classmethod
    def lookup(cls: typing.Type[Function], app_name: str, tag: typing.Union[str, None] = None, namespace=1, client: typing.Union[modal.client.Client, None] = None, environment_name: typing.Union[str, None] = None) -> Function:
        ...
