...
class ModalClientStub(object):
    ...
    def __init__(self, channel):
        ...
        self.WorkspaceLookup = channel.unary_unary(
                '/modal.client.ModalClient/WorkspaceLookup',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=modal__proto_dot_api__pb2.WorkspaceLookupResponse.FromString,
                )
...
class ModalClientServicer(object):
    ...
    def WorkspaceLookup(self, request, context):
        """Workspaces
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
...
def add_ModalClientServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'WorkspaceLookup': grpc.unary_unary_rpc_method_handler(
                    servicer.WorkspaceLookup,
                    request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                    response_serializer=modal__proto_dot_api__pb2.WorkspaceLookupResponse.SerializeToString,
            ),
    }
...
class ModalClient(object):
    ...
    def WorkspaceLookup(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/modal.client.ModalClient/WorkspaceLookup',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            modal__proto_dot_api__pb2.WorkspaceLookupResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
