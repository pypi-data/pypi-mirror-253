...
class ModalClientBase(abc.ABC):
    ...
    @abc.abstractmethod
    async def WorkspaceLookup(self, stream: 'grpclib.server.Stream[google.protobuf.empty_pb2.Empty, modal_proto.api_pb2.WorkspaceLookupResponse]') -> None:
        pass
    ...
    def __mapping__(self) -> typing.Dict[str, grpclib.const.Handler]:
        return {
            ...
            '/modal.client.ModalClient/WorkspaceLookup': grpclib.const.Handler(
                self.WorkspaceLookup,
                grpclib.const.Cardinality.UNARY_UNARY,
                google.protobuf.empty_pb2.Empty,
                modal_proto.api_pb2.WorkspaceLookupResponse,
            ),
        }
...
class ModalClientStub:
    ...
    def __init__(self, channel: grpclib.client.Channel) -> None:
        ...
        self.WorkspaceLookup = grpclib.client.UnaryUnaryMethod(
            channel,
