...
class BcManager(wx.Frame):
    ...
    def _update_buffer(self):
        ...
        if self.VBO is  None:
            ...
            # glBufferData(GL_ARRAY_BUFFER, self.buf_vertices.nbytes + self.buf_colors.nbytes, None, GL_STATIC_DRAW)
            # # Unbind VAO
        ...
        # glBufferData(GL_ARRAY_BUFFER, self.buf_vertices.nbytes + self.buf_colors.nbytes, np.concatenate((self.buf_vertices, self.buf_colors)), GL_STATIC_DRAW)
