...
def _compile_query(query):
    comp = query.statement.compile(dialect=mysql.dialect(), compile_kwargs={"literal_binds": True})
...
def _unsafe_apply_query_filter(query, trading_dates):
    # TODO this is a hack
    limit_clause, offset_clause = query._limit_clause, query._offset_clause
    ...
    if query._order_by_clauses:
        ...
        for creterion in query._order_by_clauses:
