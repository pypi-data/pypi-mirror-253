...
EQDB_MODEL_TO_NED = {
    ...
    "^WS-C": "cisco-ios-cli-6.80",
    "^CDB-8U$": "cisco-ios-cli-6.80",
    "^C9[23]00": "cisco-ios-cli-6.80",
    "^ME-3800X": "cisco-ios-cli-6.80",
    "^C1000": "cisco-ios-cli-6.80",
    "^C3560": "cisco-ios-cli-6.80",
}
...
def handle_commit(
    ...
    # for now we're doing "no networking" commits!
