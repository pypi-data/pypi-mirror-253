...
def test_capacity_penalty_update_decrease():
    ...
    """
    num_registrations = 4
    params = PenaltyParams(4, 1, 1, num_registrations, 1.1, 0.9, 0.5)
    pm = PenaltyManager(params)
...
def test_time_warp_penalty_update_decrease():
    ...
    """
    num_registrations = 4
    params = PenaltyParams(1, 4, 1, num_registrations, 1.1, 0.9, 0.5)
    pm = PenaltyManager(params)
...
def test_does_not_update_penalties_before_sufficient_registrations():
    ...
    """
    num_registrations = 4
    params = PenaltyParams(4, 4, 1, num_registrations, 1.1, 0.9, 0.5)
    pm = PenaltyManager(params)
