...
class WorkspaceAccessControl:
    ...
    def search_workspace_users(workspace_id, username, pageNumber, limit, group_id=None):
        try:
            url = f"{config.YEEDU_RESTAPI_URL}/ac/workspace/{workspace_id}/users/search/{username}"
    ...
    def search_workspace_groups(workspace_id, groupname, pageNumber, limit, user_id=None):
        try:
            url = f"{config.YEEDU_RESTAPI_URL}/ac/workspace/{workspace_id}/groups/search/{groupname}"
