from yeedu.openapi.resource.boot_disk_image_configuration import BootDiskImageConfiguration
from yeedu.openapi.resource.volume_configuration import VolumeConfiguration
from yeedu.openapi.resource.network_configuration import NetworkConfiguration
from yeedu.openapi.resource.cloud_environment import CloudEnvironment
from yeedu.openapi.resource.credentials_config import CredentialsConfig
from yeedu.openapi.resource.object_storage_manager import ObjectStorageManager
from yeedu.openapi.resource.object_storage_manager_files import ObjectStorageManagerFiles
from yeedu.openapi.resource.hive_metastore_configuration import HiveMetastoreConfiguration
from yeedu.openapi.resource.lookup import Lookup
...
def create_hive_metastore_config(args):
    try:
        ...
        json_data["name"] = trim_json_data.get('name')
...
def edit_hive_metastore_config(args):
    try:
        ...
        if hasattr(args, 'name') and trim_json_data.get('name') != None:
            json_data["name"] = trim_json_data.get('name')
