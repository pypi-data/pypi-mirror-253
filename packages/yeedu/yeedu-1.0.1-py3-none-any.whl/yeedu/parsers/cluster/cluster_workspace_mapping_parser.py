...
from yeedu.constants import SPARK_JOB_TYPE
...
class ClusterWorkspaceMappingParser:
    def cluster_workspace_mapping_parser(subparser):
        associate_workspace = subparser.add_parser(
            'associate-workspace',
            help='Associate cluster with a workspace',
        ...
        dissociate_workspace = subparser.add_parser(
            ...
            help='Dissociate cluster with a workspace',
            formatter_class=ArgumentDefaultsHelpFormatter)
        ...
        list_workspaces = subparser.add_parser(
            'list-workspaces',
            help='List all the Workspaces having access to a cluster.',
            formatter_class=ArgumentDefaultsHelpFormatter)
        ...
        list_workspace_clusters = subparser.add_parser(
            ...
            help='List all the Clusters that have access to a workspace.',
            formatter_class=ArgumentDefaultsHelpFormatter)
        ...
        search_workspace_clusters = subparser.add_parser(
            ...
            help='Search clusters by cluster name that have access to a workspace.',
            formatter_class=ArgumentDefaultsHelpFormatter)
