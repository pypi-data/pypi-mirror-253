...
# COMPUTE TYPES
COMPUTE_TYPES_LIST = ['compute_optimized',
                      'memory_optimized', 'general_purpose', 'gpu_accelerated']
...
CLUSTER_LIST = ['create-conf', 'list-confs', 'search-confs', 'get-conf', 'edit-conf', 'delete-conf', 'create', 'list', 'search', 'get', 'edit', 'destroy', 'start', 'stop', 'get-stats',
                'list-status', 'logs', 'associate-workspace', 'dissociate-workspace', 'list-workspaces', 'list-workspace-clusters', 'search-workspace-clusters', 'get-user-access', 'get-group-access']

# WORKSPACE SUBCOMMANDS LIST
WORKSPACE_LIST = ['create', 'list', 'search', 'get', 'edit', 'enable', 'disable', 'create-user-access', 'create-group-access', 'delete-user-access', 'delete-group-access',
...
NOTEBOOK_LIST = ['create-conf', 'get-conf', 'list-confs', 'search-confs', 'edit-conf', 'enable-conf', 'disable-conf',
                 'start', 'kernel-start', 'kernel-interrupt', 'kernel-restart', 'get', 'search', 'list', 'stop', 'logs']
...
VARCHAR_ARRAY_COLUMN_FULL_LIST = ['labels', 'conf', 'conf_secret', 'env_var', 'env_var_secret',
                                  'network_tags', 'files', 'properties_file', 'packages', 'repositories', 'jars', 'archives']
