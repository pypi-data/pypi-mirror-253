from yeedu.openapi.cluster.cluster_configuration import ClusterConfiguration
from yeedu.openapi.cluster.cluster_instance import ClusterInstance
from yeedu.openapi.cluster.download_cluster_instance_logs import DownloadClusterInstanceLogs
from yeedu.openapi.cluster.cluster_workspace_mapping import ClusterWorkspaceMapping
...
def search_cluster_config(args):
    try:
        ...
        response_json, status_code = ClusterConfiguration.search_cluster_config(
            json_data.get("cluster_conf_name"),
            json_data.get("page_number"),
            json_data.get("limit"),
            json_data.get('cloud_provider'),
...
def delete_cluster_config(args):
    try:
        ...
        response_json, status_code = ClusterConfiguration.delete_cluster_config_by_id_or_name(
            json_data.get('cluster_conf_id'),
            json_data.get('cluster_conf_name')
        )
        confirm_output(response_json, status_code, json_data)
...
def search_instance(args):
    try:
        ...
        response_json, status_code = ClusterInstance.search_cluster_instance_by_name(
...
def list_instance_status(args):
    try:
        ...
        response_json, status_code = ClusterInstance.list_cluster_status_by_cluster_instance_id_or_name(
            json_data.get('page_number'),
            json_data.get('limit'),
            json_data.get('cluster_id'),
            json_data.get('cluster_name')
...
def associate_workspace(args):
    try:
        ...
        response_json, status_code = ClusterWorkspaceMapping.associate_workspace(
...
def dissociate_workspace(args):
    try:
        ...
        response_json, status_code = ClusterWorkspaceMapping.dissociate_workspace(
            json_data.get('workspace_id'),
            json_data.get('cluster_id')
        )
        confirm_output(response_json, status_code, json_data)
...
def list_cluster_workspaces(args):
    try:
        ...
        response_json, status_code = ClusterWorkspaceMapping.list_cluster_workspaces(
            json_data.get('cluster_id'),
            json_data.get('page_number'),
            json_data.get('limit')
        )
...
def list_workspace_clusters(args):
    try:
        ...
        response_json, status_code = ClusterWorkspaceMapping.list_workspace_clusters(
            json_data.get('workspace_id'),
            json_data.get('page_number'),
            json_data.get('limit'),
            json_data.get('cluster_status'),
...
def search_workspace_clusters(args):
    try:
        ...
        response_json, status_code = ClusterWorkspaceMapping.search_workspace_clusters(
            json_data.get('workspace_id'),
            json_data.get('cluster_name'),
            json_data.get('page_number'),
            json_data.get('limit'),
