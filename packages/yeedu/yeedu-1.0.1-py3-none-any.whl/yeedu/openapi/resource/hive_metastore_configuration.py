from yeedu.utility.json_utils import response_validator, readFileContent
...
class HiveMetastoreConfiguration:
    ...
    def search_hive_metastore_config(hive_metastore_conf_name, page_number, limit):
        try:
            url = f"{config.YEEDU_RESTAPI_URL}/hive_metastore_configs/search/{hive_metastore_conf_name}"
