...
class CredentialsConfig:
    def list_credentials_config(pageNumber, limit, cloud_provider=None):
        try:
            ...
            response = Requests(
                ...
                params={
                    "cloud_provider": str(cloud_provider).upper() if cloud_provider is not None else None,
    ...
    def search_credentials_config(credentials_conf_name, pageNumber, limit, cloud_provider=None):
        try:
            url = f"{config.YEEDU_RESTAPI_URL}/credential_configs/search/{credentials_conf_name}"
