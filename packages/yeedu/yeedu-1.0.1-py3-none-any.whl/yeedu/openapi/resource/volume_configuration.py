...
class VolumeConfiguration:
    def list_volume_config(page_number, limit):
        try:
    ...
    def search_volume_config(volume_conf_name, page_number, limit):
        try:
            url = f"{config.YEEDU_RESTAPI_URL}/machine/volumes/search/{volume_conf_name}"
