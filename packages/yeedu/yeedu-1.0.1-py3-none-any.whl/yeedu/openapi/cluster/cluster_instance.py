...
class ClusterInstance:
        ...
        try:
            ...
            response = Requests(
                ...
                params={
                    ...
                    "cluster_status": cluster_status.split(',') if cluster_status is not None else None,
    ...
    def search_cluster_instance_by_name(cluster_name, pageNumber, limit):
        try:
            url = f"{config.YEEDU_RESTAPI_URL}/clusters/search/{cluster_name}"
