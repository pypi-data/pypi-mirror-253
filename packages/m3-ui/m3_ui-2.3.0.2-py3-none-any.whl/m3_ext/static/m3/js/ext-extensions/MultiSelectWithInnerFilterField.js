 ...
 */
Ext.m3.MultiSelectWithInnerFilterField = Ext.extend(Ext.m3.MultiSelectField, {
    ...
    initComponent:function() {
        ...
        if (!this.tpl) {
             this.tpl = '<tpl for=".">' +
             '<div ext:qtip="{' + this.displayField + '}" style="width: 1000px;" class="x-combo-list-item x-multi-combo-item">' +
