...
function suggestionElement(text) {
    ...
    let iconSrc = "";
    if (text[1]==="Welt") {
       iconSrc = "Welt_Logo.png";
    }else if (text[1] === "Spiegel") {
        iconSrc = "Spiegel_Logo_2.png" ;
    }else if (text[1] === "Focus"){
        iconSrc = "Focus_Logo.png";
    }
    ...
    return (<List.Item style={{padding: "1em"}}>
       ...
       <HtmlTooltip
        title={
          <React.Fragment>
            <Typography color="inherit">Artikel Informationen</Typography>
            <List>
            <List.Item>
            <List.Content>
      ...
      >
        <CustomTextButton>
        <List.Description as='a'>{text[0]}</List.Description>
        <Avatar alt="News Agency" variant="square" sx={{ width: 75, height: 40 }} src={iconSrc} />
        </CustomTextButton>
      </HtmlTooltip>
