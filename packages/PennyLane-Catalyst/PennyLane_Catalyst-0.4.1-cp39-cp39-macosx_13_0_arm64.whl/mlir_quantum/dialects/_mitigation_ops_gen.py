...
try:
  from . import _mitigation_ops_ext as _ods_ext_module
except ImportError:
...
class ZneOp(_ods_ir.OpView):
  ...
  def __init__(self, result, callee, args, scalarFactors, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    operands.extend(_get_op_results_or_values(args))
    operands.append(_get_op_result_or_value(scalarFactors))
