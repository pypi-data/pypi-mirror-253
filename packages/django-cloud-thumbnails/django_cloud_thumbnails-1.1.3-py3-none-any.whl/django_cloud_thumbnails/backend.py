...
from django_cloud_thumbnails.utils import find_or_create_source, find_or_create_thumbnail, pil_image, \
    thumbnail_url
...
class CloudThumbnailsBackend(ImageBackend):
    ...
    def get_thumbnail_url(self, image, thumbnail_options):
        ...
        thumbnail = find_or_create_thumbnail(source, width, height, box)
