...
LOG_FN = os.path.dirname(
    os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))) + '/logs/redis_message.log'
...
if __name__ == '__main__':
    RD_HOST = 'm9038.hw.redis.m.com'
    RD_PORT = '9038'
    RD_PASS = 'W8hmDb*@X&yfuGBC'
