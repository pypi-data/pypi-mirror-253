...
class ModelGroupCollection(APIEngine):
    """
    Collections class for EGP Model Groups.
    """
    ...
    def create(
        ...
        base_model_metadata: Optional[str] = None,
        account_id: Optional[str] = None,
    ) -> str:
        """
        Create a new EGP Model Group.
        ...
        response = self._post(
            ...
            request=ModelGroupRequest(
                name=name,
                description=description if description else "", # TODO <cathy-scale> don't have default once column is made nullable in BE
