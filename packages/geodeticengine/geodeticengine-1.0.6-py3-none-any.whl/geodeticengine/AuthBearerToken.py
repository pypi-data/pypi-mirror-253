...
class AuthBearerToken:
    def __init__(self):
        ...
        client_envs = client_envs.split(separator) if client_envs else ['prod']

        client_ids = os.getenv("EGE_CLIENT_IDS")
        client_ids = client_ids.split(separator) if client_ids else ['c25018ed-b371-4b37-ba4e-4d902aee2b6c']
