...
class UpdateFunction:
    ...
    def support_parameters(self) -> set[ParameterId]:
        ...
    def substitute_all(self, substitution: Mapping[str, UpdateFunction | str] | Mapping[VariableId, UpdateFunction | str]) -> UpdateFunction:
        ...
    def rename_all(self,
                   new_ctx: None | BooleanNetwork,
                   variables: Mapping[str, VariableIdType] | Mapping[VariableId, VariableIdType] | None = None,
                   parameters: Mapping[str, ParameterIdType] | Mapping[ParameterId, ParameterIdType] | None = None,
                   ) -> UpdateFunction: ...
...
class SymbolicSpaceContext(SymbolicContext):
    ...
    def mk_unit_colored_spaces(self, graph: AsynchronousGraph | None = None) -> ColoredSpaceSet: ...
    ...
    def mk_singleton(self, space: Mapping[str, BoolType] | Mapping[VariableId, BoolType]) -> SpaceSet: ...
...
class SpaceSet:
    ...
    def symbolic_size(self) -> int: ...
    def to_bdd(self) -> Bdd: ...
    def items(self, retained: Sequence[str | VariableId] | None = None) -> Iterator[SpaceModel]: ...

class SpaceModel:
    def __ctx__(self) -> SymbolicSpaceContext: ...
    def __str__(self) -> str: ...
    def __len__(self) -> int: ...
    def __getitem__(self, item: str | VariableId) -> bool | None: ...
    def __contains__(self, item: str | VariableId) -> bool | None: ...
    def keys(self) -> list[VariableId]: ...
    def values(self) -> list[bool | None]: ...
    def items(self) -> list[tuple[VariableId, bool | None]]: ...
    def to_dict(self) -> dict[VariableId, bool | None]: ...
    def to_valuation(self) -> BddPartialValuation: ...
