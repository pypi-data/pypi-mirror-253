...
# MCD Agent ECR registry ID. Overwrites config-file
MCD_AGENT_ECR_REGISTRY_ID = os.getenv("MCD_AGENT_ECR_REGISTRY_ID")

# Default MCD Agent ECR registry ID when no env or config file setting is available
MCD_DEFAULT_AGENT_ECR_REGISTRY_ID = "752656882040"

# MCD Agent ECR repository. Overwrites config-file
MCD_AGENT_ECR_REPO = os.getenv("MCD_AGENT_ECR_REPO")

# Default MCD Agent ECR repository when no env or config file setting is available
MCD_DEFAULT_AGENT_ECR_REPO = "mcd-agent"
