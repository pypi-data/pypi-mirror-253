    ...
    def read(self) -> Optional[Config]:
        ...
        try:
            return Config(
                ...
                mcd_agent_ecr_registry_id=settings.MCD_AGENT_ECR_REGISTRY_ID
                or self._config.get(
                    self._profile_name,
                    "mcd_agent_ecr_registry_id",
                    fallback=settings.MCD_DEFAULT_AGENT_ECR_REGISTRY_ID,
                ),
                mcd_agent_ecr_repo=settings.MCD_AGENT_ECR_REPO
                or self._config.get(
                    self._profile_name,
                    "mcd_agent_ecr_repo",
                    fallback=settings.MCD_DEFAULT_AGENT_ECR_REPO,
                ),
            )
