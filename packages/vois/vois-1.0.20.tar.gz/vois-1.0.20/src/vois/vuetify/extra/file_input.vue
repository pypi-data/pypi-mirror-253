<template>
    <div>
        <v-file-input v-model="myfiles" :disabled="disabled" :multiple="multiple" :color="color" show-size show-counter clearable chips :counter="multiple" @change="setFiles"
                      :webkitdirectory="directory" :directory="directory" :accept="accept" :placeholder="placeholder" :label="label" />
        <v-progress-linear
