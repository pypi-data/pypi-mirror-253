...
class Structure_Database:
    ...
    def get_matching_SF_U_T_fixed_region(self,input_pdb, min_prob):
        try:
            ...
            if max_prob_row['prob']< min_prob:
                print(f"No matching SF with prob > {min_prob} found (highest prob: {max_prob_row['prob']})")
                return None,None,None,None,None
    ...
    def initial_and_fixed_Sf_rot_region(self,input_pdb,drop_family_prob):
        sf,u,t,fixed_rot,aligned_region,lddtfull = self.get_matching_SF_U_T_fixed_region(input_pdb,drop_family_prob)
        if sf == None:
        ...
        return sf,sf_fixed_rot_pdb,aligned_region,lddtfull
