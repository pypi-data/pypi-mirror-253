...
def create():    
    ENV_VARS = 'SMTP_HOST='+os.getenv('SMTP_HOST')+' SMTP_PORT='+os.getenv('SMTP_PORT') #tbd add other or load them dynamically: https://www.baeldung.com/linux/load-env-variables-in-cron-job
