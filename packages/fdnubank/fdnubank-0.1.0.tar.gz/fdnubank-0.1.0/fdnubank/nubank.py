...
from fdnubank.utils.http import HttpClient
from fdnubank.utils.discovery import Discovery
from fdnubank.utils.graphql import prepare_request_body
from fdnubank.auth_mode import AuthMode, requires_auth_mode
from fdnubank.exception import NuMissingCreditCard
from fdnubank.utils.parsing import parse_float, parse_pix_transaction, parse_generic_transaction
...
class Nubank:
    ...
    def authenticate_with_cert(self, cpf: str, password: str, cert_path: str|None = None,
    ...
    def authenticate_with_refresh_token(self, refresh_token: str, cert_path: str|None = None,
