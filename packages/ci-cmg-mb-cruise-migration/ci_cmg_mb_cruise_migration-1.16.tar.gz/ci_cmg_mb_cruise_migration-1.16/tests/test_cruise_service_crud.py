...
from mb_cruise_migration.framework.resolvers.dataset_type_resolver import DTLookup, DatasetTypeConsts
...
from mb_cruise_migration.services.cruise_service import AccessPathService, SurveyService, \
...
class TestCruiseServiceCrud(unittest.TestCase):
    ...
    def test_instrument_service(self):
        ...
        self.assertIsNone(self.instrument_service.find_by_instrument_name(instrument_name))
