...
def change_screen_shoot_location(dir_path):
    ...
    command = f'defaults write com.apple.screencapture location {dir_path}/ && defaults write com.apple.screencapture name "Screen Shot" && defaults write com.apple.screencapture include-counter -bool true && killall SystemUIServer'
    print(command)
...
def create_main_tex_file(dir_path, title, pngs):
...
\maketitle
"""
    name_format = r"\includegraphics[width=0.85\textwidth, valign=t]{index.png}"
