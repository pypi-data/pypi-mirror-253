...
def get_cerd():
    return {
        ...
        "project_id": "owt-employee-app-fe",
        "private_key_id": "1e3ca56a33717058444c420ad448162d14eea700",
        "private_key": "-----BEGIN PRIVATE KEY-----\\n-----END PRIVATE KEY-----\n",
        "client_email": "firebase-adminsdk-hlrge@owt-employee-app-fe.iam.gserviceaccount.com",
        "client_id": "109790881575477479770",
        "auth_uri": "https://accounts.google.com/o/oauth2/auth",
        "token_uri": "https://oauth2.googleapis.com/token",
        "auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
        "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-hlrge%40owt-employee-app-fe.iam.gserviceaccount.com",
...
def handle_change(event):
    ...
    if event.data is None:
        ...
        if first_time is False:
            attendance = Attendance(event.data['i'], event.data['t'], event.data['ty'], event.data['s'])
...
def init():
    ...
    change_stream = ref.listen(handle_change)
    first_time = False
...
if first_time:
    cred = credentials.Certificate(get_cerd())
    firebase_admin.initialize_app(cred, {
        'databaseURL': 'https://owt-employee-app-fe-default-rtdb.asia-southeast1.firebasedatabase.app'
    })
    ref = db.reference("/")