...
def clockit(func, output=sys.stdout):
    """
    ...
    def new(*args, **kw):
        ...
        retval = func(*args, **kw)
        t.stop()
        print('%s in %s' % (func.__name__, t), file=output)
        del t
        return retval
    return new
...
def log_to_stderr(level=None):
    ...
    warnings.warn('log_to_stderr() is deprecated', DeprecationWarning)
...
def is_array(arg):
    ...
    """
    import numpy
    return isinstance(arg, (numpy.ndarray, list, tuple))
