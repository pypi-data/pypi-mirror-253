...
class PageConstants:
    ...
    @overload
    @staticmethod
    def get_size(self, size: str) -> aspose.pydrawing.Size:
        '''Calculates page size in "Portrait" page orientation'''
        ...
    
    @overload
    @staticmethod
    def get_size(self, size: str, orientation: str) -> aspose.pydrawing.Size:
        '''Calculates page size in given page orientation'''
        ...
    
    @overload
    @staticmethod
    def get_size(self, size: aspose.pydrawing.Size, orientation: str) -> aspose.pydrawing.Size:
        '''Calculates page size in given page orientation'''
        ...
