...
class CoinPair(BaseModel):
    ...
    buy_count_all_time = Column(Integer, nullable=True)
    sell_count_all_time = Column(Integer, nullable=True)
    buy_volume_all_time = Column(Integer, nullable=True)
    sell_volume_all_time = Column(Integer, nullable=True)
...
class Candle(BaseModel):
    ...
    exchange = Column(VARCHAR(36), nullable=True)
...
class CoinArticle(BaseModel):
    ...
    net = Column(VARCHAR(92), nullable=True)
