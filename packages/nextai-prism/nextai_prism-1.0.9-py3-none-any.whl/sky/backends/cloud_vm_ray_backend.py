...
def _get_cluster_config_template(cloud):
    cloud_to_template = {
        ...
        clouds.GCPNextAI: 'gcp-ray.yml.j2',
...
class CloudVmRayResourceHandle(backends.backend.ResourceHandle):
    ...
    def _update_cluster_region(self):
        ...
        elif cloud.is_same_cloud(clouds.GCP()) or cloud.is_same_cloud(clouds.GCPNextAI()) or cloud.is_same_cloud(
                clouds.AWS()):
...
class CloudVmRayBackend(backends.Backend['CloudVmRayResourceHandle']):
        ...
        with timeline.FileLockEvent(lock_path):
            ...
            while True:
                ...
                try:
                    ...
                    if retry_until_up and attempt_cnt < MAX_RETRY_COUNT:
    ...
    def _teardown(self,
        ...
        try:
            backend_utils.check_owner_identity(cluster_name)
        except (exceptions.CloudUserIdentityError, exceptions.ClusterOwnerIdentityMismatchError) as e:
            if purge:
                logger.error(e)
