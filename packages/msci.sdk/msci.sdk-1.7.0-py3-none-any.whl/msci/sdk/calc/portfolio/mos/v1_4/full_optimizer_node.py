...
class TaxOptimizationSetting(BaseDataClassValidator):
    ...
    Args:
        ...
        washSaleGroupAttribute (str): (optional) Attribute used to identified substantially identical assets for wash sale purposes. Not supported in multiple account optimization.
