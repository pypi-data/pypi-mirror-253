...
class MOSSession:
    ...
    def upload_portfolio(self, as_of_date, asset_id, portfolio_id='BasePortfolio',
        ...
        allowed_asset_types = ['ISIN', 'CUSIP', 'MDSUID', 'TICKER']
        ...
        validate_portfolio_details(asset_id, not_null_cols, positions, positions_col, allowed_asset_types)
    ...
    def upload_taxlot_portfolio(self, as_of_date, asset_id, portfolio_id='BasePortfolio',
        ...
        Args:
            ...
            taxlot_df (dataFrame): Taxlot data in pandas dataframe format with mandatory columns
                ...
                Example is pd.DataFrame([{"openTradeDate": "2016-12-30", "ISIN": "US02079K3059", "quantity": 1000, "openCostBasis": 792.45},
                {"openTradeDate": "2016-12-30", "ISIN": "US0231351067", "quantity": 450, "openCostBasis": 749.87},
                {"openTradeDate": "2016-12-30", "ISIN": "US30303M1027", "quantity": 900, "openCostBasis": 115.05}])
    ...
    def upload_bulk_portfolios(self, portfolios: Union[List[TaxLotPortfolio], List[SimplePortfolio]]):
