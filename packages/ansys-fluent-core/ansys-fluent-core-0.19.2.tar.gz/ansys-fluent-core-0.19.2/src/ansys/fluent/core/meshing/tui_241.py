    ...
    class preferences(TUIMenu):
        ...
        class mat_pro_app(TUIMenu):
            ...
            def tracking(self, *args, **kwargs):
                ...
                .
                """
                return PyMenu(self._service, self._version, self._mode, "/preferences/mat_pro_app/tracking").execute(*args, **kwargs)
        ...
        class appearance(TUIMenu):
            ...
            class selections(TUIMenu):
                ...
                def __init__(self, service, version, mode, path):
                    ...
                    self._path = path
                    super().__init__(service, version, mode, path)
                def enable_highlight_edge_transparency(self, *args, **kwargs):
                    """
                    .
                    """
                    return PyMenu(self._service, self._version, self._mode, "/preferences/appearance/selections/enable_highlight_edge_transparency").execute(*args, **kwargs)
        ...
        class graphics(TUIMenu):
            ...
            class hardcopy_settings(TUIMenu):
                ...
                def __init__(self, service, version, mode, path):
                    ...
                    self._path = path
                    super().__init__(service, version, mode, path)
                def retain_colormap_pos_for_avz(self, *args, **kwargs):
                    """
                    .
                    """
                    return PyMenu(self._service, self._version, self._mode, "/preferences/graphics/hardcopy_settings/retain_colormap_pos_for_avz").execute(*args, **kwargs)
        ...
        class general(TUIMenu):
            ...
            class startup_messages(TUIMenu):
                ...
                def __init__(self, service, version, mode, path):
                    ...
                    self._path = path
                    super().__init__(service, version, mode, path)
                def color_theme_change_message(self, *args, **kwargs):
                    """
                    .
                    """
                    return PyMenu(self._service, self._version, self._mode, "/preferences/general/startup_messages/color_theme_change_message").execute(*args, **kwargs)
                def qaservice_message(self, *args, **kwargs):
                    """
                    .
                    """
                    return PyMenu(self._service, self._version, self._mode, "/preferences/general/startup_messages/qaservice_message").execute(*args, **kwargs)
                def key_behavioral_changes_message(self, *args, **kwargs):
                    """
                    .
                    """
                    return PyMenu(self._service, self._version, self._mode, "/preferences/general/startup_messages/key_behavioral_changes_message").execute(*args, **kwargs)
        ...
        class meshing_workflow(TUIMenu):
            ...
            def save_wft_file_with_mesh(self, *args, **kwargs):
                """
                .
                """
                return PyMenu(self._service, self._version, self._mode, "/preferences/meshing_workflow/save_wft_file_with_mesh").execute(*args, **kwargs)
    ...
    class mesh(TUIMenu):
        ...
        class scoped_prisms(TUIMenu):
            ...
            def __init__(self, service, version, mode, path):
                ...
                self._path = path
                super().__init__(service, version, mode, path)
            def tet_prism_stairstep_exposed_quads(self, *args, **kwargs):
                """
                Tet-Prism Stairstep exposed quad.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/scoped_prisms/tet_prism_stairstep_exposed_quads").execute(*args, **kwargs)
            ...
            class controls(TUIMenu):
                ...
                class normal(TUIMenu):
                    ...
                    def __init__(self, service, version, mode, path):
                        ...
                        self._path = path
                        super().__init__(service, version, mode, path)
                    def smooth_relaxation_factor(self, *args, **kwargs):
                        """
                        Normal Smooth Relaxation factor.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/normal/smooth_relaxation_factor").execute(*args, **kwargs)
        ...
        class rapid_octree(TUIMenu):
            ...
            def boundary_mesh_optimization_scheme(self, *args, **kwargs):
                """
                Set optimization scheme for boundary mesh optimization in projection meshing.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/boundary_mesh_optimization_scheme").execute(*args, **kwargs)
            ...
            class mesh_sizing(TUIMenu):
                ...
                def smooth_mesh_coarsening(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/mesh_sizing/smooth_mesh_coarsening").execute(*args, **kwargs)
            ...
            class advanced_meshing_options(TUIMenu):
                ...
                def improved_proximity_for_projection(self, *args, **kwargs):
                    """
                    Activate the imporved version of proximity refinement for projection boundary treatment.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/advanced_meshing_options/improved_proximity_for_projection").execute(*args, **kwargs)
                ...
                def extract_refinement_levels(self, *args, **kwargs):
                    """
                    Enables computation of refinement levels for PUMA.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/advanced_meshing_options/extract_refinement_levels").execute(*args, **kwargs)
        ...
        class thin_volume_mesh(TUIMenu):
            ...
            def controls(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/thin_volume_mesh/controls").execute(*args, **kwargs)
            ...
            class scoped_prism(TUIMenu):
                ...
                class set(TUIMenu):
                    ...
                    def tet_prism_stairstep_exposed_quads(self, *args, **kwargs):
                        ...
                        Tet-Prism Stairstep exposed quad.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/scoped_prism/set/tet_prism_stairstep_exposed_quads").execute(*args, **kwargs)
                    def growth_options(self, *args, **kwargs):
                        """
    ...
    class display(TUIMenu):
        ...
        class set(TUIMenu):
            ...
            class rendering_options(TUIMenu):
                ...
                def front_faces_transparent(self, *args, **kwargs):
                    """
                    Make the front faces transparent.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/display/set/rendering_options/front_faces_transparent").execute(*args, **kwargs)
