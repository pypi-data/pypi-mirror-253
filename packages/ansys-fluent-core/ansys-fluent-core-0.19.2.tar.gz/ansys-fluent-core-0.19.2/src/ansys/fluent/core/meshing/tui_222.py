        ...
        class modify(TUIMenu):
            ...
            class patch_options(TUIMenu):
                ...
                def remesh(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/modify/patch_options/remesh").execute(*args, **kwargs)
                def separate(self, *args, **kwargs):
                    """
                    Separates newly added patches.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/modify/patch_options/separate").execute(*args, **kwargs)
    ...
    class preferences(TUIMenu):
        ...
        class appearance(TUIMenu):
            ...
            def startup_page(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/preferences/appearance/startup_page").execute(*args, **kwargs)
        ...
        class graphics(TUIMenu):
            ...
            def new_material_infra(self, *args, **kwargs):
                ...
                .
                """
                return PyMenu(self._service, self._version, self._mode, "/preferences/graphics/new_material_infra").execute(*args, **kwargs)
            ...
            class export_video_settings(TUIMenu):
                ...
                class advanced_video_quality_options(TUIMenu):
                    ...
                    def key_frames(self, *args, **kwargs):
                        ...
                        .
                        """
                        return PyMenu(self._service, self._version, self._mode, "/preferences/graphics/export_video_settings/advanced_video_quality_options/key_frames").execute(*args, **kwargs)
        ...
        class prj_app(TUIMenu):
            ...
            def advanced_flag(self, *args, **kwargs):
                ...
                .
                """
                return PyMenu(self._service, self._version, self._mode, "/preferences/prj_app/advanced_flag").execute(*args, **kwargs)
            def beta_flag(self, *args, **kwargs):
                """
                .
                """
                return PyMenu(self._service, self._version, self._mode, "/preferences/prj_app/beta_flag").execute(*args, **kwargs)
            def cffoutput(self, *args, **kwargs):
                """
                .
                """
                return PyMenu(self._service, self._version, self._mode, "/preferences/prj_app/cffoutput").execute(*args, **kwargs)
            def default_folder(self, *args, **kwargs):
                """
                .
                """
                return PyMenu(self._service, self._version, self._mode, "/preferences/prj_app/default_folder").execute(*args, **kwargs)
            def display_mesh_after_case_load(self, *args, **kwargs):
                """
                .
                """
                return PyMenu(self._service, self._version, self._mode, "/preferences/prj_app/display_mesh_after_case_load").execute(*args, **kwargs)
            def multi_console(self, *args, **kwargs):
                """
                .
                """
                return PyMenu(self._service, self._version, self._mode, "/preferences/prj_app/multi_console").execute(*args, **kwargs)
            def ncpu(self, *args, **kwargs):
                """
                .
                """
                return PyMenu(self._service, self._version, self._mode, "/preferences/prj_app/ncpu").execute(*args, **kwargs)
            def session_color(self, *args, **kwargs):
                """
                .
                """
                return PyMenu(self._service, self._version, self._mode, "/preferences/prj_app/session_color").execute(*args, **kwargs)
            def show_fluent_window(self, *args, **kwargs):
                """
                .
                """
                return PyMenu(self._service, self._version, self._mode, "/preferences/prj_app/show_fluent_window").execute(*args, **kwargs)
            def use_default_folder(self, *args, **kwargs):
                """
                .
                """
                return PyMenu(self._service, self._version, self._mode, "/preferences/prj_app/use_default_folder").execute(*args, **kwargs)
            def use_fluent_graphics(self, *args, **kwargs):
                """
                .
                """
                return PyMenu(self._service, self._version, self._mode, "/preferences/prj_app/use_fluent_graphics").execute(*args, **kwargs)
            def use_launcher(self, *args, **kwargs):
                """
                .
                """
                return PyMenu(self._service, self._version, self._mode, "/preferences/prj_app/use_launcher").execute(*args, **kwargs)
    ...
    class mesh(TUIMenu):
        ...
        class rapid_octree(TUIMenu):
            ...
            def projection_mesh_optimization(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/projection_mesh_optimization").execute(*args, **kwargs)
            ...
            class mesh_sizing(TUIMenu):
                ...
                def prism_layers(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/mesh_sizing/prism_layers").execute(*args, **kwargs)
                def clear_prism_layer_settings(self, *args, **kwargs):
                    """
                    Delete all settings for prismatic layers in the domain.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/mesh_sizing/clear_prism_layer_settings").execute(*args, **kwargs)
                    ...
                    class type_name(TUIMenu):
                        ...
                        class axis(TUIMenu):
                            ...
                            def color(self, *args, **kwargs):
                                ...
                                """
                                return PyMenu(self._service, self._version, self._mode, "/display/set/colors/by_type/type_name/axis/color").execute(*args, **kwargs)
                            def material(self, *args, **kwargs):
                                """
                                Set a material for the selected boundary type.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/display/set/colors/by_type/type_name/axis/material").execute(*args, **kwargs)
                        ...
                        class far_field(TUIMenu):
                            ...
                            def color(self, *args, **kwargs):
                                ...
                                Set a color for the selected boundary type.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/display/set/colors/by_type/type_name/far_field/color").execute(*args, **kwargs)
                            def material(self, *args, **kwargs):
                                """
                                Set a material for the selected boundary type.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/display/set/colors/by_type/type_name/far_field/material").execute(*args, **kwargs)
                        ...
                        class free_surface(TUIMenu):
                            ...
                            def color(self, *args, **kwargs):
                                ...
                                Set a color for the selected boundary type.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/display/set/colors/by_type/type_name/free_surface/color").execute(*args, **kwargs)
                            def material(self, *args, **kwargs):
                                """
                                Set a material for the selected boundary type.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/display/set/colors/by_type/type_name/free_surface/material").execute(*args, **kwargs)
                        ...
                        class inlet(TUIMenu):
                            ...
                            def color(self, *args, **kwargs):
                                ...
                                Set a color for the selected boundary type.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/display/set/colors/by_type/type_name/inlet/color").execute(*args, **kwargs)
                            def material(self, *args, **kwargs):
                                """
                                Set a material for the selected boundary type.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/display/set/colors/by_type/type_name/inlet/material").execute(*args, **kwargs)
                        ...
                        class interface(TUIMenu):
                            ...
                            def color(self, *args, **kwargs):
                                ...
                                Set a color for the selected boundary type.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/display/set/colors/by_type/type_name/interface/color").execute(*args, **kwargs)
                            def material(self, *args, **kwargs):
                                """
                                Set a material for the selected boundary type.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/display/set/colors/by_type/type_name/interface/material").execute(*args, **kwargs)
                        ...
                        class interior(TUIMenu):
                            ...
                            def color(self, *args, **kwargs):
                                ...
                                Set a color for the selected boundary type.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/display/set/colors/by_type/type_name/interior/color").execute(*args, **kwargs)
                            def material(self, *args, **kwargs):
                                """
                                Set a material for the selected boundary type.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/display/set/colors/by_type/type_name/interior/material").execute(*args, **kwargs)
                        ...
                        class internal(TUIMenu):
                            ...
                            def color(self, *args, **kwargs):
                                ...
                                Set a color for the selected boundary type.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/display/set/colors/by_type/type_name/internal/color").execute(*args, **kwargs)
                            def material(self, *args, **kwargs):
                                """
                                Set a material for the selected boundary type.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/display/set/colors/by_type/type_name/internal/material").execute(*args, **kwargs)
                        ...
                        class outlet(TUIMenu):
                            ...
                            def color(self, *args, **kwargs):
                                ...
                                Set a color for the selected boundary type.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/display/set/colors/by_type/type_name/outlet/color").execute(*args, **kwargs)
                            def material(self, *args, **kwargs):
                                """
                                Set a material for the selected boundary type.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/display/set/colors/by_type/type_name/outlet/material").execute(*args, **kwargs)
                        ...
                        class overset(TUIMenu):
                            ...
                            def color(self, *args, **kwargs):
                                ...
                                Set a color for the selected boundary type.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/display/set/colors/by_type/type_name/overset/color").execute(*args, **kwargs)
                            def material(self, *args, **kwargs):
                                """
                                Set a material for the selected boundary type.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/display/set/colors/by_type/type_name/overset/material").execute(*args, **kwargs)
                        ...
                        class periodic(TUIMenu):
                            ...
                            def color(self, *args, **kwargs):
                                ...
                                Set a color for the selected boundary type.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/display/set/colors/by_type/type_name/periodic/color").execute(*args, **kwargs)
                            def material(self, *args, **kwargs):
                                """
                                Set a material for the selected boundary type.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/display/set/colors/by_type/type_name/periodic/material").execute(*args, **kwargs)
                        ...
                        class rans_les_interface(TUIMenu):
                            ...
                            def color(self, *args, **kwargs):
                                ...
                                Set a color for the selected boundary type.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/display/set/colors/by_type/type_name/rans_les_interface/color").execute(*args, **kwargs)
                            def material(self, *args, **kwargs):
                                """
                                Set a material for the selected boundary type.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/display/set/colors/by_type/type_name/rans_les_interface/material").execute(*args, **kwargs)
                        ...
                        class surface(TUIMenu):
                            ...
                            def color(self, *args, **kwargs):
                                ...
                                Set a color for the selected boundary type.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/display/set/colors/by_type/type_name/surface/color").execute(*args, **kwargs)
                            def material(self, *args, **kwargs):
                                """
                                Set a material for the selected boundary type.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/display/set/colors/by_type/type_name/surface/material").execute(*args, **kwargs)
                        ...
                        class symmetry(TUIMenu):
                            ...
                            def color(self, *args, **kwargs):
                                ...
                                Set a color for the selected boundary type.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/display/set/colors/by_type/type_name/symmetry/color").execute(*args, **kwargs)
                            def material(self, *args, **kwargs):
                                """
                                Set a material for the selected boundary type.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/display/set/colors/by_type/type_name/symmetry/material").execute(*args, **kwargs)
                        ...
                        class traction(TUIMenu):
                            ...
                            def color(self, *args, **kwargs):
                                ...
                                Set a color for the selected boundary type.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/display/set/colors/by_type/type_name/traction/color").execute(*args, **kwargs)
                            def material(self, *args, **kwargs):
                                """
                                Set a material for the selected boundary type.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/display/set/colors/by_type/type_name/traction/material").execute(*args, **kwargs)
                        ...
                        class wall(TUIMenu):
                            ...
                            def color(self, *args, **kwargs):
                                ...
                                Set a color for the selected boundary type.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/display/set/colors/by_type/type_name/wall/color").execute(*args, **kwargs)
                            def material(self, *args, **kwargs):
                                """
                                Set a material for the selected boundary type.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/display/set/colors/by_type/type_name/wall/material").execute(*args, **kwargs)
            ...
            class lights(TUIMenu):
                ...
                class lighting_interpolation(TUIMenu):
                    ...
                    def automatic(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/display/set/lights/lighting_interpolation/automatic").execute(*args, **kwargs)
                    def flat(self, *args, **kwargs):
                        """
                        Uses flat shading for meshes and polygons.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/display/set/lights/lighting_interpolation/flat").execute(*args, **kwargs)
                    def gouraud(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/display/set/lights/lighting_interpolation/gouraud").execute(*args, **kwargs)
                    def phong(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/display/set/lights/lighting_interpolation/phong").execute(*args, **kwargs)
            ...
            class windows(TUIMenu):
                ...
                class scale(TUIMenu):
                    ...
                    def alignment(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/display/set/windows/scale/alignment").execute(*args, **kwargs)
