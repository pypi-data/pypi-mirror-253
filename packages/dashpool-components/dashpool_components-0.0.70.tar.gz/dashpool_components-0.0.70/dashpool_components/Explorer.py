...
- nodes (list of dicts; required):
    ...
    _type = 'Explorer'
    @_explicitize_args
    def __init__(self, id=Component.REQUIRED, nodes=Component.REQUIRED, n_refreshed=Component.UNDEFINED, nodeChangeEvent=Component.UNDEFINED, dashpoolEvent=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'dashpoolEvent', 'n_refreshed', 'nodeChangeEvent', 'nodes']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'dashpoolEvent', 'n_refreshed', 'nodeChangeEvent', 'nodes']
