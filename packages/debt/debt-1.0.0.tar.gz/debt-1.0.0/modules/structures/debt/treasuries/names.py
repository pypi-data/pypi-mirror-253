...
'''
	import debt.ganglia.list as debt_ganglia_list
	debt_ganglia_list.start ()
'''
...
def start (
	...
	treasuries = debt_climate.find ("treasuries")	
	...
	if (len (issues) >= 1):
		...
		raise Exception (f"Issues were found with the debt directory.")
