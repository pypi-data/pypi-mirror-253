...
'''
	import debt.climate.scan as debt_climate_scan
	debt_ganglia = debt_climate_scan.start ("debt ganglia")
'''
...
'''
	...
	looks in each directory for a debt.JSON file
...
def start ():
	...
	while (search_directory != "/"):
		...
		debt_JSON_exists = os.path.isfile (search_file_path) 
		if (debt_JSON_exists):
			print ("debt.JSON found:", search_file_path)
...
A "debt.JSON" file was not found.
