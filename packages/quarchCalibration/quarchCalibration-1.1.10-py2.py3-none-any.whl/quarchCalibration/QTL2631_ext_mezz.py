...
class QTL2631 (PowerModule):
    ...
    'POWER_1_SHUNT'                         : 1/((1/24)+(1/10000)),   # the cal board has a 24R resistor on it which is in parallel with a 10k resistor on the mezzanine
    'POWER_2_SHUNT'                         : 1/((1/24)+(1/10000)),   # the cal board has a 24R resistor on it which is in parallel with a 10k resistor on the mezzanine
    'POWER_3_SHUNT'                         : 1/((1/24)+(1/10000)),   # the cal board has a 24R resistor on it which is in parallel with a 10k resistor on the mezzanine
    'POWER_4_SHUNT'                         : 1/((1/24)+(1/10000))   # the cal board has a 24R resistor on it which is in parallel with a 10k resistor on the mezzanine
	}
