...
import moneti.modules.EEC448.public_key.form as form_EEC448_public_key
import moneti.modules.EEC448.public_key.write as write_EEC448_public_key
...
def smoothly (
	...
	'''
		private key
	'''
	private_key = EEC448_private_key_creator.create (
		utilizes ["seed"], 
	...
	'''
		public key
	'''
	public_key = form_EEC448_public_key.smoothly (
