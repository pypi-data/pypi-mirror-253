...
class BaseCrawlingStrategy(object):
    ...
    :class:`Request <new_frontera.core.models.Request>` with state of the URL. Pleases refer for the states to HBaseBackend
    implementation.
    ...
    def __init__(self, manager, args, scheduled_stream, states_context):
        ...
        Args:
            manager: is an instance of :class: `Backend <new_frontera.core.manager.FrontierManager>` instance
    ...
    def request_error(self, request, error):
        ...
        :param object request: The fetched with error :class:`Request <new_frontera.core.models.Request>` object.
    ...
    def filter_extracted_links(self, request, links):
        ...
        going ot use in :method:`links_extracted <new_frontera.worker.strategies.BaseCrawlingStrategy.links_extracted>
        handler.

        :param object request: The :class:`Request <new_frontera.core.models.Request>` object for the crawled page.
        :param list links: A list of :class:`Request <new_frontera.core.models.Request>` objects generated from \
        the links extracted for the crawled page.

        :return: A subset of :class:`Request <new_frontera.core.models.Request>` input objects.
        """
    ...
    def schedule(self, request, score=1.0, dont_queue=False):
        ...
        :param request: A :class:`Request <new_frontera.core.models.Request>` object.
    ...
    def create_request(
        ...
        :param meta: dict
        :param body: str
        :return: :class:`Request <new_frontera.core.models.Request>`
        """
        return self._manager.create_request(
    ...
    def refresh_states(self, requests):
        ...
        if requests is not a list of :class:`Request <new_frontera.core.models.Request>` objects.
        :param requests: list(:class:`Request <new_frontera.core.models.Request>`) or a single :class:`Request <new_frontera.core.models.Request>`
        """
