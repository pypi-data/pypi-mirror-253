...
from new_frontera.core.components import CanonicalSolver
...
class BasicCanonicalSolver(CanonicalSolver):
    ...
    It allows easily to avoid leaking of requests in new_frontera (e.g. when request issued by
    :attr:`get_next_requests() <new_frontera.core.manager.FrontierManager.get_next_requests>` never matched in
    :attr:`page_crawled() <new_frontera.core.manager.FrontierManager.page_crawled>`) at the price of duplicating
    records in new_frontera for pages having more than one URL or complex redirects chains.
    """
