...
from new_frontera.core.models import Response as FrontierResponse
from new_frontera.utils.converters import BaseRequestConverter, BaseResponseConverter


class RequestConverter(BaseRequestConverter):
    """Converts between new_frontera and Requests request objects"""
...
class ResponseConverter(BaseResponseConverter):
    """Converts between new_frontera and Scrapy response objects"""
