...
from new_frontera.core.components import DomainMetadata
from new_frontera.contrib.backends.hbase.utils import HardenedBatch
from new_frontera.utils.msgpack import restruct_for_pack
    ...
    def __getitem__(self, key):
        ...
        try:
            ...
            try:
                ...
                self.__setitem__(key, value)
                if (
                    key in self._second_gen
                ):  # the second gen clean up could be triggered during set in first gen
        ...
        while data and tries > 0:
            try:
                ...
                self.logger.exception(
                    "Exception happened during item storing, %d tries left", tries
                )
