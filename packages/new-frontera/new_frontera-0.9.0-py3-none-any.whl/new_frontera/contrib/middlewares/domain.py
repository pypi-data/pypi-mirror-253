...
from new_frontera.core.components import Middleware
from new_frontera.utils.url import parse_domain_from_url_fast, parse_domain_from_url
...
class DomainMiddleware(Middleware):
    """
    This :class:`Middleware <new_frontera.core.components.Middleware>` will add a ``domain`` info field for every
    :attr:`Request.meta <new_frontera.core.models.Request.meta>` and
    :attr:`Response.meta <new_frontera.core.models.Response.meta>` if is activated.
    ...
    An example for a :class:`Request <new_frontera.core.models.Request>` object::
    ...
    def _add_domain(self, obj):
        ...
        if b"redirect_urls" in obj.meta:
            obj.meta[b"redirect_domains"] = [
                self._parse_domain_info(url) for url in obj.meta[b"redirect_urls"]
            ]
        return obj
