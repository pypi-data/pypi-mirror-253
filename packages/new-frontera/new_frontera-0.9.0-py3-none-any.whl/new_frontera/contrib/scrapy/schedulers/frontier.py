...
from new_frontera.contrib.scrapy.manager import ScrapyFrontierManager
from new_frontera.contrib.scrapy.settings_adapter import ScrapySettingsAdapter
import six

STATS_PREFIX = "new_frontera"


class StatsManager(object):
    """
    'new_frontera/crawled_pages_count': 489,
    'new_frontera/crawled_pages_count/200': 382,
    'new_frontera/crawled_pages_count/301': 37,
    'new_frontera/crawled_pages_count/302': 58,
    'new_frontera/crawled_pages_count/400': 5,
    'new_frontera/crawled_pages_count/403': 1,
    'new_frontera/crawled_pages_count/404': 1,
    'new_frontera/crawled_pages_count/999': 5,
    'new_frontera/iterations': 5,
    'new_frontera/links_extracted_count': 39805,
    'new_frontera/pending_requests_count': 0,
    'new_frontera/redirected_requests_count': 273,
    'new_frontera/request_errors_count': 11,
    'new_frontera/request_errors_count/DNSLookupError': 1,
    'new_frontera/request_errors_count/ResponseNeverReceived': 9,
    'new_frontera/request_errors_count/TimeoutError': 1,
    'new_frontera/returned_requests_count': 500,
    """
...
class new_fronteraScheduler(Scheduler):
    ...
    def close(self, reason):
        ...
        self.frontier.stop()
        self.stats_manager.set_iterations(
            getattr(self.frontier.manager, "iteration", 0)
        )
