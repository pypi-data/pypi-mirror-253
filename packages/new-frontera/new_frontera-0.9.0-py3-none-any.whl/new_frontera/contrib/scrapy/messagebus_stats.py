...
from new_frontera.utils.misc import utc_timestamp, load_object
...
class StatsExporterToMessageBus(object):
    ...
    def __init__(self, crawler):
        ...
        # preliminary changes in new_frontera itself.
    ...
    def spider_opened(self, spider):
        def errback_export_stats(failure):
            ...
            self._export_stats_task.start(self._stats_interval).addErrback(
