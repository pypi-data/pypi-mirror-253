...
class Metadata(StartStopMixin):
    ...
    def links_extracted(self, request, links):
        ...
        :param object request: The original :class:`Request <new_frontera.core.models.Request>` object for the crawled page.
        :param list links: A list of :class:`Request <new_frontera.core.models.Request>` objects containing extracted links.
        """
        pass
...
class States(StartStopMixin):
    ...
    def update_cache(self, objs):
        ...
        :param objs: list or tuple of :class:`Request <new_frontera.core.models.Request>` objects.
        """
...
class Component(Metadata):
    ...
    The :class:`Component <new_frontera.core.components.Component>` object is the base class for frontier
    :class:`Middleware <new_frontera.core.components.Middleware>` and
    :class:`Backend <new_frontera.core.components.Backend>` objects.

    :class:`FrontierManager <new_frontera.core.manager.FrontierManager>` communicates with the active components
    using the hook methods listed below.

    Implementations are different for :class:`Middleware <new_frontera.core.components.Middleware>` and
    :class:`Backend <new_frontera.core.components.Backend>` objects, therefore methods are not fully described here
    ...
    def from_manager(cls, manager):
        """
        Class method called from :class:`FrontierManager <new_frontera.core.manager.FrontierManager>` passing the
        manager itself.
...
class Middleware(Component):
    ...
    def create_request(self, request):
        ...
        :param reqeust: :class:`Request <new_frontera.core.models.Request>` object
        :return: an instance of :class:`Request <new_frontera.core.models.Request>` object.
        """
        pass
...
class CanonicalSolver(Middleware):
    """Interface definition for a new_frontera Canonical Solver"""
...
class PropertiesMixin(object):
    ...
    def queue(self):
        """
        :return: associated :class:`Queue <new_frontera.core.components.Queue>` object
        """
        raise NotImplementedError
    ...
    def metadata(self):
        """
        :return: associated :class:`Metadata <new_frontera.core.components.Metadata>` object
        """
        raise NotImplementedError
    ...
    def states(self):
        """
        :return: associated :class:`States <new_frontera.core.components.States>` object
        """
        raise NotImplementedError
    ...
    def domain_metadata(self):
        """
        :return: associated :class:`DomainMetadata <new_frontera.core.components.DomainMetadata>` object
        """
        raise NotImplementedError
...
class DistributedBackend(Backend):
    ...
    def get_stats(self):
        ...
        Called by :class:`StatsExportMixin <new_frontera.contrib.messagebus.stats.StatsExportMixin>` for workers.
