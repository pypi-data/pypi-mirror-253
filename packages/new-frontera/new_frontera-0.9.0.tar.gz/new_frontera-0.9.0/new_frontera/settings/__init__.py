...
class BaseSettings(object):
    ...
    as settings in new_frontera.
    """

    def __init__(self, module=None, attributes=None):
        """
        :param object/string module: A :class:`Settings <new_frontera.settings.Settings>` object or a path string.
    ...
    def object_from(cls, settings):
        ...
        :class:`BaseSettings <new_frontera.settings.BaseSettings>` object instance.
        """
