...
DOMAIN_FINGERPRINT_FUNCTION = "new_frontera.utils.fingerprint.sha1"
...
MAX_REQUESTS = 0
MESSAGE_BUS = "new_frontera.contrib.messagebus.zeromq.MessageBus"
MESSAGE_BUS_CODEC = "new_frontera.contrib.backends.remote.codecs.msgpack"
MIDDLEWARES = [
...
REDIS_BACKEND_CODEC = "new_frontera.contrib.backends.remote.codecs.msgpack"
...
SQLALCHEMYBACKEND_MODELS = {
    ...
    "DomainMetadataModel": "new_frontera.contrib.backends.sqlalchemy.models.DomainMetadataModel",
}
...
URL_FINGERPRINT_FUNCTION = "new_frontera.utils.fingerprint.sha1"
USER_AGENT = "new_fronteraDiscoveryBot"
