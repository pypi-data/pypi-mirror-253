...
from new_frontera.contrib.messagebus.kafka.offsets_fetcher import OffsetsFetcherAsync
...
class SpiderFeedStream(BaseSpiderFeedStream):
    ...
    def consumer(self, partition_id):
        ...
        assert (
            len(c._consumer.partitions_for_topic(self._topic)) == self._partitions
