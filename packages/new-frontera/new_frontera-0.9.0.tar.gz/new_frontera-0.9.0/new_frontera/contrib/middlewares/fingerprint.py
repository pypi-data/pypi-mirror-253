...
class UrlFingerprintMiddleware(BaseFingerprintMiddleware):
    """
    This :class:`Middleware <new_frontera.core.components.Middleware>` will add a ``fingerprint`` field for every
...
class DomainFingerprintMiddleware(BaseFingerprintMiddleware):
    ...
    This :class:`Middleware <new_frontera.core.components.Middleware>` will add a ``fingerprint`` field for every
    :attr:`Request.meta <new_frontera.core.models.Request.meta>` and
    :attr:`Response.meta <new_frontera.core.models.Response.meta>` ``domain`` fields if is activated.
