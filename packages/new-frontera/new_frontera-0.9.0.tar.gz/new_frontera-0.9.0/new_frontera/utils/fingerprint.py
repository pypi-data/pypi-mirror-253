...
from new_frontera.utils.misc import get_crc32
from new_frontera.utils.url import parse_url
...
def hostname_local_fingerprint(key):
    ...
    combined = (
        hostname + result.path + ";" + result.params + result.query + result.fragment
    )
