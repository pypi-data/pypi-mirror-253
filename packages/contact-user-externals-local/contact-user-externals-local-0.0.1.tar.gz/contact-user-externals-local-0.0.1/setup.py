...
PACKAGE_NAME = "contact-user-externals-local"
...
setuptools.setup(
    ...
    url="https://github.com/circles-zone/contact-user-external-local-python-package",  # https://pypi.org/project/contact-user-external-local/
