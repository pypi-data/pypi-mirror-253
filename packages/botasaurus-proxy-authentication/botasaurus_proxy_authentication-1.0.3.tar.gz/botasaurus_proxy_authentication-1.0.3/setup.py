...
def check_node():
   try:
       ...
       if major_version < MIN_VER:
           raise Exception(f"Your Node.js version is {major_version}, which is less than {MIN_VER}. To use the stealth and auth proxy features of Botasaurus, you need Node.js 18, Kindly install it by visiting https://nodejs.org/")
        #    sys.exit(1)
   except Exception as e:
       raise Exception("You do not have node installed on your system, Kindly install it by visiting https://nodejs.org/")
    #    sys.exit(1)
