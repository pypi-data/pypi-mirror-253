...
setup(
    ...
    package_dir={"flowpytertask": "src"},
    py_modules=["flowpytertask"],
    entry_points={"airflow.plugins": ["flowpytertask = flowpytertask.plugins:FptMacros"],
                  "console_scripts":["hello_plugin = flowpytertask.plugins:hello_plugin"]},
    install_requires=[
        "apache_airflow==2.8.1",
