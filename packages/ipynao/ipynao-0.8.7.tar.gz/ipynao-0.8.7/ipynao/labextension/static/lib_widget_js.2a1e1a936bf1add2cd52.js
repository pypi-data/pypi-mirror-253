...
class NaoRobotModel extends base_1.DOMWidgetModel {
    ...
    checkConnection(requestID) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.qiSession.isConnected()) {
                this.disconnect();
                yield this.connect(this._ipAddress, requestID, "");
            }
            return true;
        });
    }
