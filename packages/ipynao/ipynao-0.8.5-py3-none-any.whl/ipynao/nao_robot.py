...
class NaoRobotWidget(DOMWidget):
    ...
    def connect(self, ip_address=''):
        ...
        data['authToken'] = os.getenv("AUTH_TOKEN", default="")
...
class Robot(NaoRobotWidget):
    def __init__(self, widget, service_name, output=Output(), autoconnect=True):
        super().__init__(self, widget, service_name, output)
        # then autoconnect
        if autoconnect:
            self.connect()
