...
from standup_face_recognition2.Facebox_detector import FaceboxDetector
...
def main():
    ...
    parser.add_argument("--face-recognizer", type=str, default='casia',
                        help="Path to the folder with images that are to be anonymized.")
    parser.add_argument("--output-path", type=str, help="Path where the blurred images are to be saved.")
    parser.add_argument("--debug-visualize-boxes", action='store_true',
