...
if system() == 'Darwin':
    ...
    extra_link_args.append('libs\\win\\libsaxon-pec-12.4.2.lib')
else:
...
ext_modules = [Extension(
                       ...
                       libraries=['libs\\win\\saxon-pec-12.4.2']
                        ),
                ]
setup(
    name='saxoncpe',
    version='12.4.2',
    description='Official Saxonica python package for the SaxonC-PE 12.4.2 processor: for XSLT 3.0, XQuery 3.1, XPath 3.1 and XML Schema processing.',
