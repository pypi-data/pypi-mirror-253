...
class FileManager:
    ...
    def get_file(self, filename: str, default: str = None):
        try:
    ...
    def write(self, filename: str, data: str):
        self.set_file(filename, data)

    def read(self, filename: str, default: str = None):
        return self.get_file(filename, default)
