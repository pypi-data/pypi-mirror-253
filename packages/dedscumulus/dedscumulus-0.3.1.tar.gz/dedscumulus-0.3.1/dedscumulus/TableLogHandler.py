...
class TableLogHandler(logging.Handler):
    def __init__(self, account_name, account_key, table_name, instrumentation_key=None)#, ingestion_endpoint=None):
        ...
        try:
            ...
            if instrumentation_key is not None:
                ...
                #;IngestionEndpoint=https://germanywestcentral-1.in.applicationinsights.azure.com/;LiveEndpoint=https://germanywestcentral.livediagnostics.monitor.azure.com/'))
            ...
            if self.self_logging:
                logger.debug(f'Creating TableServiceClient for table {table_name}')
            ...
            if self.self_logging:
                logger.exception(f'Failed creating TableServiceClient for table {table_name}: {ex}')
    ...
    def emit(self, record):
        try:
            ...
            entity['hostname'] = record.hostname#self.hostname
