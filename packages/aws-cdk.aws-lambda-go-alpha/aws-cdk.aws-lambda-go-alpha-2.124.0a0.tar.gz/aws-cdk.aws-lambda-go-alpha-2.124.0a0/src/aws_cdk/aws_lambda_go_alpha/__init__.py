...
class GoFunctionProps(_aws_cdk_aws_lambda_ceddda9d.FunctionOptions):
    ...
    def log_retention_retry_options(
        ...
        '''(deprecated) When log retention is specified, a custom resource attempts to create the CloudWatch log group.
    ...
    def log_retention_role(self) -> typing.Optional[_aws_cdk_aws_iam_ceddda9d.IRole]:
        '''(deprecated) The IAM role for the Lambda function associated with the custom resource that sets the retention policy.
