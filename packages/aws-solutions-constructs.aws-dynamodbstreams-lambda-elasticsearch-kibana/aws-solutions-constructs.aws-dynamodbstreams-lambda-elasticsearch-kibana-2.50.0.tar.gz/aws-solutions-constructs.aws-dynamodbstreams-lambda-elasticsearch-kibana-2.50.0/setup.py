    ...
    """
{
    ...
    "package_data": {
        "aws_solutions_constructs.aws_dynamodbstreams_lambda_elasticsearch_kibana._jsii": [
            "aws-dynamodbstreams-lambda-elasticsearch-kibana@2.50.0.jsii.tgz"
        ],
        "aws_solutions_constructs.aws_dynamodbstreams_lambda_elasticsearch_kibana": [
            "py.typed"
        ]
    ...
    "install_requires": [
        "aws-cdk-lib==2.118.0",
        "aws-solutions-constructs.aws-dynamodbstreams-lambda==2.50.0",
        "aws-solutions-constructs.aws-lambda-elasticsearch-kibana==2.50.0",
        "aws-solutions-constructs.core==2.50.0",
        "constructs==10.0.0",
        "jsii>=1.94.0, <2.0.0",
        "publication>=0.0.3",
        "typeguard~=2.13.3"
