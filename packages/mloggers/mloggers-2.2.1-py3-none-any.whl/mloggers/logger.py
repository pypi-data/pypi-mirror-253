...
class Logger(ABC):
    def __init__(self, default_mask: list[LoggerType] = []):
        """
    ...
    def _log_impl(
        ...
        level: str = "INFO",
        mask: Optional[list[LoggerType]] = None,
    ):
    ...
    def log(
        ...
        self._log_impl(message, level, mask)
    ...
    def debug(
        ...
        """
        Wrapper for calling logger.log with level="DEBUG".
