...
from pyakri_de_filters.utils.file_utils import copy_file
from pyakri_de_filters.utils.file_utils import create_directory
from pyakri_de_filters.utils.file_utils import get_dest_file_path
from pyakri_de_filters.utils.file_utils import get_input_files_batch
from pyakri_de_filters.utils.image_utils import ImageUtils
    ...
    def run_from_input_dir(self, src_dir, dst_dir):
        ...
        for files in files_generator:
            ...
            for file in files:
                ...
                np_images_list.append(ImageUtils.get_image_array(img))
            ...
            for i in range(len(processed_images)):
                ...
                image = ImageUtils.get_image_from_array(processed_images[i])
                os.makedirs(os.path.dirname(dest_file_path), exist_ok=True)
                image.save(dest_file_path, format=self.DST_FILE_FORMAT)
