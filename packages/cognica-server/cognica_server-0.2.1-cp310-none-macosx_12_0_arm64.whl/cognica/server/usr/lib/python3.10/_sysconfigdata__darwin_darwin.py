...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/opt/homebrew/opt/python@3.10/Frameworks/Python.framework/Versions/3.10/bin',
 'BINLIBDEST': '/opt/homebrew/opt/python@3.10/Frameworks/Python.framework/Versions/3.10/lib/python3.10',
 'BLDLIBRARY': '',
 ...
 'CONFIGURE_CFLAGS': '-isysroot '
                     '/Library/Developer/CommandLineTools/SDKs/MacOSX12.sdk',
 'CONFIGURE_CFLAGS_NODIST': '-I/opt/homebrew/include -flto -std=c99 -Wextra '
 ...
 'CONFIG_ARGS': "'--prefix=/opt/homebrew/opt/python@3.10' "
                "'--enable-ipv6' "
                "'--datarootdir=/opt/homebrew/opt/python@3.10/share' "
                "'--datadir=/opt/homebrew/opt/python@3.10/share' "
                "'--without-ensurepip' '--enable-loadable-sqlite-extensions' "
                "'--with-openssl=/opt/homebrew/opt/openssl@3' "
                "'--with-dbmliborder=gdbm:ndbm' '--enable-optimizations' "
                "'--with-system-expat' '--with-system-libmpdec' '--with-lto' "
                "'--enable-framework=/opt/homebrew/opt/python@3.10/Frameworks' "
                "'--with-dtrace' 'MACOSX_DEPLOYMENT_TARGET=12' "
                "'CFLAGS=-isysroot "
                "/Library/Developer/CommandLineTools/SDKs/MacOSX12.sdk' "
                ...
                "'CPPFLAGS=-I/opt/homebrew/include' 'CC=clang' "
 ...
 'CONFINCLUDEDIR': '/opt/homebrew/opt/python@3.10/Frameworks/Python.framework/Versions/3.10/include',
 'CONFINCLUDEPY': '/opt/homebrew/opt/python@3.10/Frameworks/Python.framework/Versions/3.10/include/python3.10',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/private/tmp/pythonA3.10-20231101-5047-j4ttuf/Python-3.10.13/coverage.info',
 'COVERAGE_REPORT': '/private/tmp/pythonA3.10-20231101-5047-j4ttuf/Python-3.10.13/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include -I/opt/homebrew/include',
 'CXX': 'clang++',
 'DESTDIRS': '/opt/homebrew/opt/python@3.10/Frameworks/Python.framework/Versions/3.10 '
             '/opt/homebrew/opt/python@3.10/Frameworks/Python.framework/Versions/3.10/lib '
             '/opt/homebrew/opt/python@3.10/Frameworks/Python.framework/Versions/3.10/lib/python3.10 '
             '/opt/homebrew/opt/python@3.10/Frameworks/Python.framework/Versions/3.10/lib/python3.10/lib-dynload',
 'DESTLIB': '/opt/homebrew/opt/python@3.10/Frameworks/Python.framework/Versions/3.10/lib/python3.10',
 'DESTPATH': '',
 'DESTSHARED': '/opt/homebrew/opt/python@3.10/Frameworks/Python.framework/Versions/3.10/lib/python3.10/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/opt/homebrew/opt/python@3.10/Frameworks/Python.framework/Versions/3.10/include '
                   '/opt/homebrew/opt/python@3.10/Frameworks/Python.framework/Versions/3.10/include '
                   '/opt/homebrew/opt/python@3.10/Frameworks/Python.framework/Versions/3.10/include/python3.10 '
                   '/opt/homebrew/opt/python@3.10/Frameworks/Python.framework/Versions/3.10/include/python3.10',
 'INCLUDEDIR': '/opt/homebrew/opt/python@3.10/Frameworks/Python.framework/Versions/3.10/include',
 'INCLUDEPY': '/opt/homebrew/opt/python@3.10/Frameworks/Python.framework/Versions/3.10/include/python3.10',
 ...
 'LDVERSION': '3.10',
 'LIBC': '',
 'LIBDEST': '/opt/homebrew/opt/python@3.10/Frameworks/Python.framework/Versions/3.10/lib/python3.10',
 'LIBDIR': '/opt/homebrew/opt/python@3.10/Frameworks/Python.framework/Versions/3.10/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/opt/homebrew/opt/python@3.10/Frameworks/Python.framework/Versions/3.10/lib/pkgconfig',
 'LIBPL': '/opt/homebrew/opt/python@3.10/Frameworks/Python.framework/Versions/3.10/lib/python3.10/config-3.10-darwin',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'darwin',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/opt/homebrew/opt/python@3.10/Frameworks/Python.framework/Versions/3.10/lib/python3.10',
 'MACOSX_DEPLOYMENT_TARGET': '12',
 'MAINCC': 'clang',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/opt/homebrew/opt/python@3.10/share/man',
 ...
 'PYTHONFRAMEWORKINSTALLDIR': '/opt/homebrew/opt/python@3.10/Frameworks/Python.framework',
 'PYTHONFRAMEWORKPREFIX': '/opt/homebrew/opt/python@3.10/Frameworks',
 'PYTHONPATH': '',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wno-unused-result -Wsign-compare '
                             ...
                             '/Library/Developer/CommandLineTools/SDKs/MacOSX12.sdk '
                             '-I/opt/homebrew/include -flto -std=c99 -Wextra '
                             '-Wno-unused-result -Wno-unused-parameter '
                             '-Wno-missing-field-initializers '
                             '-Wstrict-prototypes '
                             '-Werror=implicit-function-declaration '
 ...
 'PY_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code '
              ...
              '/Library/Developer/CommandLineTools/SDKs/MacOSX12.sdk',
 'PY_CFLAGS_NODIST': '-I/opt/homebrew/include -flto -std=c99 -Wextra '
                     '-Wno-unused-result -Wno-unused-parameter '
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code '
                   ...
                   '-I. -I./Include -I/opt/homebrew/include -DPy_BUILD_CORE',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'DYLD_FRAMEWORK_PATH=/private/tmp/pythonA3.10-20231101-5047-j4ttuf/Python-3.10.13',
 'SCRIPTDIR': '/opt/homebrew/opt/python@3.10/Frameworks/Python.framework/Versions/3.10/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'DYLD_FRAMEWORK_PATH=/private/tmp/pythonA3.10-20231101-5047-j4ttuf/Python-3.10.13 '
               './python.exe',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'DYLD_FRAMEWORK_PATH=/private/tmp/pythonA3.10-20231101-5047-j4ttuf/Python-3.10.13 '
 ...
 'abs_builddir': '/private/tmp/pythonA3.10-20231101-5047-j4ttuf/Python-3.10.13',
 'abs_srcdir': '/private/tmp/pythonA3.10-20231101-5047-j4ttuf/Python-3.10.13',
 'datarootdir': '/opt/homebrew/opt/python@3.10/share',
 'exec_prefix': '/opt/homebrew/opt/python@3.10/Frameworks/Python.framework/Versions/3.10',
 'prefix': '/opt/homebrew/opt/python@3.10/Frameworks/Python.framework/Versions/3.10',
 'srcdir': '.'}
