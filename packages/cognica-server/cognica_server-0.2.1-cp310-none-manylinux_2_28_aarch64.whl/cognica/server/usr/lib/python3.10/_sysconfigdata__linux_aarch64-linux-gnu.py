...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CONFIG_ARGS': "'--enable-optimizations' '--disable-test-modules' "
                "'--enable-shared' '--prefix=/app' 'CFLAGS=-fPIC' "
                "'PKG_CONFIG_PATH=/usr/local/lib/pkgconfig'",
 'CONFINCLUDEDIR': '/app/include',
 'CONFINCLUDEPY': '/app/include/python3.10',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/app/tmp/Python-3.10.12/coverage.info',
 'COVERAGE_REPORT': '/app/tmp/Python-3.10.12/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include',
 'CXX': 'g++ -pthread',
 'DESTDIRS': '/app /app/lib /app/lib/python3.10 '
             '/app/lib/python3.10/lib-dynload',
 'DESTLIB': '/app/lib/python3.10',
 'DESTPATH': '',
 'DESTSHARED': '/app/lib/python3.10/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/app/include /app/include /app/include/python3.10 '
                   '/app/include/python3.10',
 'INCLUDEDIR': '/app/include',
 'INCLUDEPY': '/app/include/python3.10',
 ...
 'LIBPL': '/app/lib/python3.10/config-3.10-aarch64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/app/lib/python3.10',
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 '
                   '-Wall -fPIC -fPIC -fno-semantic-interposition -std=c99 '
 ...
 'PY_STDMODULE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv '
                        '-O3 -Wall -fPIC -fPIC -fno-semantic-interposition '
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/app/tmp/Python-3.10.12:/opt/rh/gcc-toolset-12/root/usr/lib64:/opt/rh/gcc-toolset-12/root/usr/lib:/opt/rh/gcc-toolset-12/root/usr/lib64/dyninst:/opt/rh/gcc-toolset-12/root/usr/lib/dyninst',
 'SCRIPTDIR': '/app/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/app/tmp/Python-3.10.12:/opt/rh/gcc-toolset-12/root/usr/lib64:/opt/rh/gcc-toolset-12/root/usr/lib:/opt/rh/gcc-toolset-12/root/usr/lib64/dyninst:/opt/rh/gcc-toolset-12/root/usr/lib/dyninst '
               './python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/app/tmp/Python-3.10.12:/opt/rh/gcc-toolset-12/root/usr/lib64:/opt/rh/gcc-toolset-12/root/usr/lib:/opt/rh/gcc-toolset-12/root/usr/lib64/dyninst:/opt/rh/gcc-toolset-12/root/usr/lib/dyninst '
 ...
 'abs_builddir': '/app/tmp/Python-3.10.12',
 'abs_srcdir': '/app/tmp/Python-3.10.12',
