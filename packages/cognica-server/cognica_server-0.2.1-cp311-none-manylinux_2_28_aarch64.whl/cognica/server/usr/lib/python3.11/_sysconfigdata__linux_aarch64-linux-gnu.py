...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CC': 'gcc -pthread',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -fPIC -fPIC',
 ...
 'CONFIG_ARGS': "'--enable-optimizations' '--disable-test-modules' "
                "'--enable-shared' '--prefix=/app' "
                "'PKG_CONFIG_PATH=/usr/local/lib/pkgconfig' 'CFLAGS=-fPIC'",
 'CONFINCLUDEDIR': '/app/include',
 'CONFINCLUDEPY': '/app/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/app/tmp/Python-3.11.5/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/app/tmp/Python-3.11.5/lcov-report',
 ...
 'DESTDIRS': '/app /app/lib /app/lib/python3.11 '
             '/app/lib/python3.11/lib-dynload',
 'DESTLIB': '/app/lib/python3.11',
 'DESTPATH': '',
 'DESTSHARED': '/app/lib/python3.11/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/app/include /app/include /app/include/python3.11 '
                   '/app/include/python3.11',
 'INCLUDEDIR': '/app/include',
 'INCLUDEPY': '/app/include/python3.11',
 ...
 'LDVERSION': '3.11',
 'LIBC': '',
 'LIBDEST': '/app/lib/python3.11',
 'LIBDIR': '/app/lib',
 'LIBEXPAT_A': 'Modules/expat/libexpat.a',
 'LIBEXPAT_CFLAGS': '-I./Modules/expat -DNDEBUG -g -fwrapv -O3 -Wall -fPIC '
                    '-fPIC -fno-semantic-interposition -std=c11 '
 ...
 'LIBMPDEC_CFLAGS': '-I./Modules/_decimal/libmpdec -DCONFIG_64=1 -DANSI=1 '
                    '-DHAVE_UINT128_T=1 -DNDEBUG -g -fwrapv -O3 -Wall -fPIC '
                    '-fPIC -fno-semantic-interposition -std=c11 '
                    '-Werror=implicit-function-declaration -fvisibility=hidden '
                    '-fprofile-use -fprofile-correction -I./Include/internal '
                    '-I. -I./Include -fPIC -fPIC',
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/app/lib/pkgconfig',
 'LIBPL': '/app/lib/python3.11/config-3.11-aarch64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/app/lib/python3.11',
 ...
 'MODULE__SQLITE3_CFLAGS': '-I/usr/local/include  -I./Modules/_sqlite',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -fPIC -fPIC '
 ...
 'PY_STDMODULE_CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -fPIC -fPIC '
                        '-fno-semantic-interposition -std=c11 '
                        '-Werror=implicit-function-declaration '
                        '-fvisibility=hidden -fprofile-use '
                        '-fprofile-correction -I./Include/internal -I. '
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/app/tmp/Python-3.11.5:/opt/rh/gcc-toolset-12/root/usr/lib64:/opt/rh/gcc-toolset-12/root/usr/lib:/opt/rh/gcc-toolset-12/root/usr/lib64/dyninst:/opt/rh/gcc-toolset-12/root/usr/lib/dyninst',
 'SCRIPTDIR': '/app/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/app/tmp/Python-3.11.5:/opt/rh/gcc-toolset-12/root/usr/lib64:/opt/rh/gcc-toolset-12/root/usr/lib:/opt/rh/gcc-toolset-12/root/usr/lib64/dyninst:/opt/rh/gcc-toolset-12/root/usr/lib/dyninst '
               './python -E',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/app/tmp/Python-3.11.5:/opt/rh/gcc-toolset-12/root/usr/lib64:/opt/rh/gcc-toolset-12/root/usr/lib:/opt/rh/gcc-toolset-12/root/usr/lib64/dyninst:/opt/rh/gcc-toolset-12/root/usr/lib/dyninst '
 ...
 'VERSION': '3.11',
 'WASM_ASSETS_DIR': './app',
 'WASM_STDLIB': './app/lib/python3.11/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 0,
 ...
 'abs_builddir': '/app/tmp/Python-3.11.5',
 'abs_srcdir': '/app/tmp/Python-3.11.5',
