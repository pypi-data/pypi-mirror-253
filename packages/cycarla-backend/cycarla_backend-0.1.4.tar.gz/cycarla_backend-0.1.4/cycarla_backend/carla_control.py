...
from cycarla_backend.filters import RoadGradientEstimator

# ==============================================================================
# -- CyCARLA replacement for KeyboardControl  ----------------------------------
# ==============================================================================

class ControlCarlaWithCyclingBLE():
    '''
    Class that handles BLE input from the cycling accessories to control CARLA vehicles.
    '''
...
class World(object):
    def __init__(self, carla_world, reporter, args):
    ...
    def restart(self):
        ...
        while self.player is None:
            ...
            self.modify_vehicle_physics(self.player)
        # Set up the sensors.
        self.collision_sensor = CollisionSensor(self.player, self.reporter)
        self.lane_invasion_sensor = LaneInvasionSensor(self.player, self.reporter)
...
class Reporter():
    ...
    '''
    def __init__(self, width, height, socketio: SocketIO):
        ...
        self.road_gradient_offset = 0.0 # percent gradient user has set in UI
...
class CollisionSensor(object):
    def __init__(self, parent_actor, reporter):
        self.sensor = None
        self.history = []
    ...
    def _on_collision(weak_self, event):
        ...
        self.reporter.notification('Collision with %r' % actor_type)
...
class LaneInvasionSensor(object):
    ...
    def _on_invasion(weak_self, event):
        ...
        self.reporter.notification('Crossed line %s' % ' and '.join(text))
