...
class Methods(Helper):
    ...
    SET_MESSAGE_REACTION = Item()  # setMessageReaction
    ...
    SET_STICKER_EMOJI_LIST = Item()  # setStickerEmojiList
    SET_STICKER_KEYWORDS = Item()  # setStickerKeywords
    SET_STICKER_MASK_POSITION = Item()  # setStickerMaskPosition
