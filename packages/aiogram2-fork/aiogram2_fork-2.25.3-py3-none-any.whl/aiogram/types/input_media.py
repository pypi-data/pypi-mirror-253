...
class InputMedia(base.TelegramObject):
    ...
    thumbnail: typing.Union[base.InputFile, base.String] = fields.Field(alias='thumbnail', on_change='_thumb_changed')
    ...
    def __init__(self, *args, **kwargs):
        ...
        if isinstance(thumbnail, (io.IOBase, InputFile)):
            self.thumb_file = thumbnail
    ...
    def thumb_file(self, file: io.IOBase):
        self.thumbnail = 'attach://' + secrets.token_urlsafe(16)
