...
class Bot(BaseBot, DataMixin, ContextInstanceMixin):
    ...
    async def send_audio(self,
        ...
        reply_markup = prepare_arg(reply_markup)
        caption_entities = prepare_arg(caption_entities)
        payload = generate_payload(**locals(), exclude=['audio', 'thumbnail'])
        if self.parse_mode and caption_entities is None:
            payload.setdefault('parse_mode', self.parse_mode)
        if self.protect_content is not None:
            payload.setdefault('protect_content', self.protect_content)
        ...
        prepare_attachment(payload, files, 'thumbnail', thumbnail)
    ...
    async def send_video(self, chat_id: typing.Union[base.Integer, base.String],
        ...
        reply_markup = prepare_arg(reply_markup)
        caption_entities = prepare_arg(caption_entities)
        payload = generate_payload(**locals(), exclude=['video', 'thumbnail'])
        if self.parse_mode and caption_entities is None:
            payload.setdefault('parse_mode', self.parse_mode)
        if self.protect_content is not None:
            payload.setdefault('protect_content', self.protect_content)
    ...
    async def send_animation(self,
        ...
        reply_markup = prepare_arg(reply_markup)
        caption_entities = prepare_arg(caption_entities)
        payload = generate_payload(**locals(), exclude=["animation", "thumbnail"])
        if self.parse_mode and caption_entities is None:
            payload.setdefault('parse_mode', self.parse_mode)
        if self.protect_content is not None:
            payload.setdefault('protect_content', self.protect_content)
    ...
    async def set_my_description(self,
        ...
        :param description: New bot description; 0-512 characters.
            Pass an empty string to remove the dedicated
            description for the given language.
        :type description: :obj: `typing.Optional[base.String]`

        :param language_code: A two-letter ISO 639-1 language code. If
            empty, the description will be applied to all users for whose
            language there is no dedicated description.
        :type language_code: :obj: `typing.Optional[base.String]`

        :return: Returns True on success.
        :rtype: :obj:`typing.Boolean`
        """
        payload = generate_payload(**locals())
    ...
    async def set_my_short_description(self,
        ...
        which is shown on the bot's profile page and is sent
        ...
        Pass an empty string to remove the dedicated short
        description for the given language.
    ...
    async def get_my_short_description(self,
        ...
        :return: Returns BotShortDescription.
    ...
    #                                  needs_repainting: typing.Optional[base.Boolean] = None) -> base.Boolean:
    #     """
    ...
    #     :type sticker_type: :obj:`base.String`
    #     :param needs_repainting: Pass True if stickers in the sticker set must be repainted to the
    #         color of text when used in messages, the accent color if used as emoji status,
    #         white on chat photos, or another appropriate color based on context;
    #         for custom emoji sticker sets only
    #     :type needs_repainting: :obj:`base.Boolean`
    #     :return: Returns True on success
    #     :rtype: :obj:`base.Boolean`
    #     """
    #
    #     # TODO: Доделать! Не работает добавление стикера через файл
    #
    #     payload = generate_payload(**locals(), exclude=['stickers'])
    #     files_and_stickers = prepare_stickers(stickers)
    #
    #     # files = {'stickers': f'{files_and_stickers["files"][0]}'}
    #
    #     payload['stickers'] = prepare_arg(files_and_stickers['stickers'])
    #
    #     return await self.request(api.Methods.CREATE_NEW_STICKER_SET, payload)

    @deprecated("This method is outdated (Telegram Bot API 6.5) and will be updated in the future")
    async def create_new_sticker_set(self,
                                     user_id: base.Integer,
                                     name: base.String,
                                     title: base.String,
    ...
    async def set_sticker_set_thumbnail(self,
                                    name: base.String,
                                    user_id: base.Integer,
                                    thumbnail: typing.Union[base.InputFile, base.String] = None) -> base.Boolean:
        """
    ...
    async def set_custom_emoji_sticker_set_thumbnail(self,
                                                 name: base.String,
                                                 custom_emoji_id: typing.Optional[base.String] = None) -> base.Boolean:
        ...
        :param name: Sticker set name
        :type name: :obj:`base.String`
        :param custom_emoji_id: Custom emoji identifier of a sticker from the sticker set;
            pass an empty string to drop the thumbnail and use the first sticker as the thumbnail.
        :type custom_emoji_id: :obj:`base.String`
        :return: Returns True on success
        :rtype: :obj:`base.Boolean`
        """
    ...
    async def set_sticker_set_title(self, name: base.String, title: base.String) -> base.Boolean:
    ...
    async def set_sticker_emoji_list(self, sticker: base.String, emoji_list: typing.List[base.String]) -> base.Boolean:
        ...
        :type emoji_list: :obj:`typing.List[base.String]`
        :return: Returns True on success
        :rtype: :obj:`base.Boolean`
        """

        emoji_list = prepare_arg(emoji_list)
        payload = generate_payload(**locals())

        return await self.request(api.Methods.SET_STICKER_EMOJI_LIST, payload)

    async def set_sticker_keywords(self, sticker: base.String,
                                   keywords: typing.Optional[typing.List[base.String]] = None) -> base.Boolean:
        ...
        :type keywords: :obj:`typing.List[base.String]`
        :return: Returns True on success
        :rtype: :obj:`base.Boolean`
        """

        keywords = prepare_arg(keywords)
        payload = generate_payload(**locals())

        return await self.request(api.Methods.SET_STICKER_KEYWORDS, payload)

    async def set_sticker_mask_position(self, sticker: base.String,
                                        mask_position: typing.Optional[types.MaskPosition] = None) -> base.Boolean:
        ...
        :type mask_position: :obj:`typing.List[base.String]`
        :return: Returns True on success
        :rtype: :obj:`base.Boolean`
        """
