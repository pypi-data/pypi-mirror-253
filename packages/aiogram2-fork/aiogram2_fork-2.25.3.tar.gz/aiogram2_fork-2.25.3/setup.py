...
setup(
    ...
    url='https://github.com/febdaynik/aiogram2_fork',
    license='MIT',
    ...
    python_requires='>=3.7',
    description='Is a pretty simple and fully asynchronous framework for Telegram Bot API (unofficial. fork aiogram 2)',
