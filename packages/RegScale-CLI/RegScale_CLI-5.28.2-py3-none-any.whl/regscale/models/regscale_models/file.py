...
class File(BaseModel):
    ...
    fullPath: str
    uploadedById: str
    uploadDate: Optional[str] = Field(get_current_datetime(), alias="uploadedDate")
    ...
    class Config:
        """Allow the file model to be populated by field name and/or alias"""
        ...
        def _create_regscale_file(
            ...
            try:
                ...
                if file_type == ".xlsx":
                    ...
                    api.logger.warning(
                        f"Unacceptable file type for upload: {file_type}"
                    )
                    return None
