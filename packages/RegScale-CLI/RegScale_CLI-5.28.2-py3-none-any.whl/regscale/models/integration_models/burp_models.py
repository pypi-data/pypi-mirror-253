...
class BurpResponse(BaseModel):
    ...
    dataString: Optional[Base64String] = None
    ...
    @classmethod
    def is_base64(cls, sb) -> bool:
        """
        Check if string is base64 encoded

        :param sb: String to check
...
class RequestResponse(BaseModel):
    ...
    request: Optional[BurpRequest]
    response: Optional[BurpResponse]
