...
## What's Changed
* Updated python version dependency to 3.9 by @yesseruser in https://github.com/Yesser-Studios/ypkgupgr/pull/30
* Implement Click package for CLI functionality by @yesseruser in https://github.com/Yesser-Studios/ypkgupgr/pull/34

### Important changes
`--ignore` and `--unignore` need to be called once for each package.  
You can use `ypkgupgr ignore` and `ypkgupgr unignore` instead.  
See the [Wiki page](https://github.com/Yesser-Studios/ypkgupgr/wiki/Options-&-Commands) for more info.

**Full Changelog**: https://github.com/Yesser-Studios/ypkgupgr/compare/1.10.5...1.11.0
