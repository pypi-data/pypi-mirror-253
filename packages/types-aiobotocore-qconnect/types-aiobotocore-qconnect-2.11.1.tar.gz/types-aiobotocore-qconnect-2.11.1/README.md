...
[aiobotocore.QConnect 2.11.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/qconnect.html#QConnect)
...
```python
from types_aiobotocore_qconnect.type_defs import AppIntegrationsConfigurationPaginatorTypeDef
