...
Thank you for your help improving **Pypackage Skeleton**!

**Pypackage Skeleton** uses `nox <https://nox.thea.codes/en/stable/>`__ to automate several development-related tasks.
...
First off, you'll need your own copy of **Pypackage Skeleton** codebase. You can clone it for local development like so:
...
.. code-block:: console
   ...
   git clone https://github.com/<YOUR USERNAME>/pypackage-skeleton
   cd pypackage-skeleton
...
This will install the **Pypackage Skeleton** library, together with two additional tools:
