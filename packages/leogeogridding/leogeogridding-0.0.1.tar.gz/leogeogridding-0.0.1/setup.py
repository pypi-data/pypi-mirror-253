...
# Setting up
setup(
    name = 'leogeogridding',         # Package name
    packages = ['leogeogridding'],   
    version = '0.0.1',      
    ...
    author_email = 'v.kiliyanpilakkil@gmail.com',     
    url = 'https://github.com/pkv0/leogeo-gridding',   # github repository  
    keywords = ['data fusion', 'satellite', 'L2', 'L3'],   # Keywords
    #packages = find_packages(),
    entry_points ={
        'console_scripts': [
            'leogeogridding = leogeogridding.gtools:main',
        ],
    },
    install_requires=[    
            'pyhdf',        
