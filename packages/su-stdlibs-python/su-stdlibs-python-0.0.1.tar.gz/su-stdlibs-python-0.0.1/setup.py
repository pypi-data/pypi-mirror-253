...
stdlib_modules=['color', 'instream', 'outstream',
        'picture', 'stdarray', 'stdaudio',
        'stddraw', 'stdio', 'stdrandom', 'stdstats'
        ]
...
setup(
    name="su-stdlibs-python",
    version="0.0.1",
    description='Stellenbosch University Python 3 code for "Introduction to Programming in Python, 1st Edition" by Sedgewick and Wayne',
