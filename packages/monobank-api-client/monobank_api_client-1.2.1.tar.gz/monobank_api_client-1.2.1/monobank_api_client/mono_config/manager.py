...
class BaseMonoManager:
    ...
    def create_success(self) -> Dict:
        try:
            response = self.mono_response(
                self.mono_create_success_code,
                self.mono_create_success_detail
            )
            return response
        except Exception as exc:
            exception = {"detail": str(exc)}
    ...
    def update_success(self) -> Dict:
        try:
            response = self.mono_response(
                self.mono_update_success_code,
                self.mono_update_success_detail
            )
            return response
        except Exception as exc:
            exception = {"detail": str(exc)}
    ...
    def delete_success(self) -> Dict:
        try:
            response = self.mono_response(
                self.mono_delete_success_code,
                self.mono_delete_success_detail
            )
            return response
        except Exception as exc:
            exception = {"detail": str(exc)}
    ...
    def exists_exception(self) -> Dict:
        try:
            response = self.mono_response(
                self.mono_exsists_exception_code,
                self.mono_exsists_exception_detail
            )
            return response
        except Exception as exc:
            exception = {"detail": str(exc)}
