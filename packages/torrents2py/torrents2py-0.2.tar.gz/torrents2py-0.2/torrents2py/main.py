...
def get_torrents(search_query, current_page=1, min_seeds=0, min_peers=0, max_pages=None, min_size=None, max_size=None, exclude_keywords=None):
    """
...
def search_torrents(search_query, filters=None):
    ...
    try:
        torrent_details, internal_magnet_links = get_torrents(
            search_query, page, min_seeds, min_peers, max_pages, min_size=min_size, max_size=max_size, exclude_keywords=exclude_keywords
        )
