...
from modelscope_gradio_components.components.Markdown import \
  CustomComponentDict
from modelscope_gradio_components.components.MultimodalInput import \
  MultimodalInputData
...
class ChatbotData(GradioRootModel):
    root: List[Tuple[Optional[Union[MultimodalMessage, MultimodalInputData,
                                    dict, str]],
                     Optional[Union[MultimodalMessage, MultimodalInputData,
                                    dict, str]]]]
    ...
    def __init__(
        ...
        | None = None,
            *,
            ...
            avatar_images: tuple[str | Path | None | dict,
                                 str | Path | None | dict]
        | None = None,
        ...
        Parameters:
            ...
            avatar_images: Tuple of two avatar image paths or URLs or dict("avatar" and "name") for user and bot (in that order). Pass None for either the user or bot image to skip. Must be within the working directory of the Gradio app or an external URL and use `gr.update` to update.
            ...
            llm_thinking_presets: llm presets, imported from modelscope_gradio_components.Chatbot.llm_thinking_presets .
        ...
        if _force_update and hasattr(self, '_constructor_args'):
            _constructor_args = self._constructor_args
            del self._constructor_args
        super().__init__(
            label=label,
            every=every,
