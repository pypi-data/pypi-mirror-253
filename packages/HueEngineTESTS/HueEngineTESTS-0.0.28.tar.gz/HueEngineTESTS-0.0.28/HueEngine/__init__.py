...
from .components.__init__ import *
from .processors.__init__ import *
...
def init():
    addProcessor(EventProcessor(), 0)
    addProcessor(TransformProcessor(), 1)
    addProcessor(RenderProcessor(), 2)
    addProcessor(HueScriptProcessor(), 3)
