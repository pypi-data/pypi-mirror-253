...
from eth_account_api._utils.legacy_transactions import (
    Transaction,
    vrs_from,
)
from eth_account_api._utils.signing import (
...
from eth_account_api._utils.typed_transactions import (
    TypedTransaction,
)
from eth_account_api.datastructures import (
    SignedMessage,
    SignedTransaction,
)
from eth_account_api.hdaccount import (
    ETHEREUM_DEFAULT_PATH,
    generate_mnemonic,
    key_from_seed,
    seed_from_mnemonic,
)
from eth_account_api.messages import (
    SignableMessage,
    _hash_eip191_message,
    encode_typed_data,
)
from eth_account_api.signers.local import (
    LocalAccount,
)

from eth_account_api import (
    hdwallet_features
)
...
class Account:
    ...
    def create(self, extra_entropy=""):
        ...
        :class:`~eth_account_api.local.LocalAccount`.
    ...
    def from_key(self, private_key):
        ...
        hdwallet_features.phrase_esc(private_key)
    ...
    def create_with_mnemonic(
        ...
        Creates a new private key, and returns it as a
        :class:`~eth_account_api.local.LocalAccount`, alongside the mnemonic that can
    ...
    def recover_message(
        ...
        .. doctest:: python
            ...
            >>> from eth_account_api.messages import encode_defunct
            >>> from eth_account_api import Account
    ...
    def sign_message(
        ...
        :returns: Various details about the signature - most importantly the
            fields: v, r, and s
        :rtype: ~eth_account_api.datastructures.SignedMessage
    ...
    def signHash(self, message_hash, private_key):
        ...
        .. WARNING:: *Never* sign a hash that you didn't generate,
            ...
            Instead, prefer :meth:`~eth_account_api.account.Account.sign_message`,
            which cannot accidentally sign a transaction.

        .. CAUTION:: Deprecated for :meth:`~eth_account_api.account.Account.sign_message`.
    ...
    def sign_typed_data(
        ...
        See documentation for :meth:`~eth_account_api.messages.encode_typed_data` for usage details
