...
class BaseAccount(ABC):
    ...
    def sign_message(self, signable_message: SignableMessage) -> SignedMessage:
        ...
        as in :meth:`~eth_account_api.account.Account.sign_message`
    ...
    def signHash(self, message_hash):
        ...
        This uses the same structure
        as in :meth:`~eth_account_api.account.Account.signHash`
        but without specifying the private key.

        .. CAUTION:: Deprecated for
            :meth:`~eth_account_api.signers.base.BaseAccount.sign_message`.
    ...
    def signTransaction(self, transaction_dict):
        ...
        :meth:`~eth_account_api.account.Account.sign_transaction`
        but without specifying the private key.

        .. CAUTION:: Deprecated for
            :meth:`~eth_account_api.account.signers.local.sign_transaction`.
