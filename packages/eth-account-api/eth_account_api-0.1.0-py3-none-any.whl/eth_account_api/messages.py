...
def encode_structured_data(
    ...
    *,
    ...
    .. doctest:: python
        ...
        >>> from eth_account_api.messages import encode_structured_data
...
def defunct_hash_message(
    ...
    .. CAUTION:: Intended for use with the deprecated
        :meth:`eth_account_api.account.Account.signHash`.
...
def encode_typed_data(
    ...
    .. doctest:: python
        ...
        >>> from eth_account_api import Account
        >>> from eth_account_api.messages import encode_typed_data
        >>> # 3-argument usage
