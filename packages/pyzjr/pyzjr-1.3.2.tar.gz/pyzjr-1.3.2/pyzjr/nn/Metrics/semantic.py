...
__all__ = ["Miou", "Recall", "Precision", "F1Score", "DiceCoefficient", "SegmentationIndex",
           "AIU"]
...
class SegmentationIndex(object):
    ...
    def update(self, pred, true):
        ...
        return miou_value, recall_value, precision_value, f1score_value, dice_value
...
if __name__ == "__main__":
    batch_size, num_classes, height, width = 2, 2, 3, 3
    ...
    print(true.shape)
    miou = Miou(num_classes, ignore=2)(pred, true)
    recall = Recall(num_classes, ignore=2)(pred, true)
    precision = Precision(num_classes, ignore=2)(pred, true)
    accuracy = Accuracy(num_classes, ignore=2)(pred, true)
    f1score = F1Score(num_classes, ignore=2)(pred, true)
    dice = DiceCoefficient(num_classes, ignore=2)(pred, true)
    aiu = AIU(num_classes, ignore=2)(pred, true)

    print("Mean IoU:", miou, type(miou))
    print("Recall:", recall, type(recall))
    print("Precision:", precision, type(precision))
    print("Accuracy:", accuracy, type(accuracy))
    print("F1Score:", f1score, type(f1score))
    print("DiceCoefficient:", dice, type(dice))
    print("AIU:", aiu, type(aiu))

    segmentation_index = SegmentationIndex(num_classes, ignore=2)
