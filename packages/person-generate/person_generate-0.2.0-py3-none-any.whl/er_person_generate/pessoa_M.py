...
"""Código que gera uma pessoa aleatória.
    Este código gera um nome aleatório, um e-mail, um número de telefone, um número de CPF,
    uma data de nascimento, uma cidade e um estado, uma altura, um peso e um tipo sanguíneo.
...
def gerar_nome():
    ...
    A função escolhe um nome aleatório da lista de nomes masculinos e dois sobrenomes aleatórios,
    e retorna o nome completo formatado como uma string.

    Returns:
        str: Um nome aleatório masculino completo.
    """
...
def gerar_email():
    """Função que gera um e-mail de acordo com o nome sorteado.
    ...
    Returns:
        str: Um e-mail aleatório de acordo com o nome sorteado.
    """
    global nome_sorteado
...
def gerar_numero_aleatorio():
    ...
    Returns:
        str: Um número de CPF aleatório.
    """
    while True:
...
def gerar_endereco_brasil():
    """Função que gera um endereço aleatório no Brasil.
    
    A função usa a biblioteca Faker para gerar um estado e um endereço aleatórios.

    Returns:
        str: estado e endereço aleatórios.
    """
    fake = Faker('pt_BR')  
...
def pessoaM():
    ...
    email = gerar_email()
    senha = gerar_senha()
    uf, endereco = gerar_endereco_brasil()
    telefone = gerar_telefone(uf)
    altura = gerar_altura()
    peso = gerar_peso()
