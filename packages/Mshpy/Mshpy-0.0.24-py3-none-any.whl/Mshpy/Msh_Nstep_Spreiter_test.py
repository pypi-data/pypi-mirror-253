...
#    print(np.shape(pts[:,3]),mpd,bsd)
    ...
    n1=np.loadtxt(pkg_resources.resource_filename('Mshpy',f'data/Msh_n'))
    T1=np.loadtxt(pkg_resources.resource_filename('Mshpy',f'data/Msh_T'))
    V1=np.loadtxt(pkg_resources.resource_filename('Mshpy',f'data/Msh_V'))
