...
#    al=[]
    ...
    for i in range(0,7):
        bx1=np.load('./data/modeling/cn/Msh_Bx_%d.npy'%i)
        by1=np.load('./data/modeling/cn/Msh_By_%d.npy'%i)
        bz1=np.load('./data/modeling/cn/Msh_Bz_%d.npy'%i)
        rr1=np.load('./data/modeling/cn/Msh_n_%d.npy'%i)
        pp1=np.load('./data/modeling/cn/Msh_pp_%d.npy'%i)
        T1=72429*pp1/rr1/11600
        vx1=np.load('./data/modeling/cn/Msh_Vx_%d.npy'%i)
        vy1=np.load('./data/modeling/cn/Msh_Vy_%d.npy'%i)
        vz1=np.load('./data/modeling/cn/Msh_Vz_%d.npy'%i)
    ...
    for i in range(0,7):
        bx1=np.load('./data/modeling/cs/Msh_Bx_%d.npy'%i)
        by1=np.load('./data/modeling/cs/Msh_By_%d.npy'%i)
        bz1=np.load('./data/modeling/cs/Msh_Bz_%d.npy'%i)
        rr1=np.load('./data/modeling/cs/Msh_n_%d.npy'%i)
        pp1=np.load('./data/modeling/cs/Msh_pp_%d.npy'%i)
        T1=72429*pp1/rr1/11600
        vx1=np.load('./data/modeling/cs/Msh_Vx_%d.npy'%i)
        vy1=np.load('./data/modeling/cs/Msh_Vy_%d.npy'%i)
        vz1=np.load('./data/modeling/cs/Msh_Vz_%d.npy'%i)
