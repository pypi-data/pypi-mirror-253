...
[aiobotocore.Amplify 2.11.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/amplify.html#Amplify)
...
```python
from types_aiobotocore_amplify.type_defs import AutoBranchCreationConfigPaginatorTypeDef
