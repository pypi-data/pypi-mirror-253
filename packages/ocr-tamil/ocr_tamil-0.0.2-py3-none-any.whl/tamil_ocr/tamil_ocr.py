...
from tamil_ocr.strhub.data.module import SceneTextDataModule
from tamil_ocr.strhub.models.utils import load_from_checkpoint

from tamil_ocr.craft_text_detector import (
    load_craftnet_model,
    get_prediction,
