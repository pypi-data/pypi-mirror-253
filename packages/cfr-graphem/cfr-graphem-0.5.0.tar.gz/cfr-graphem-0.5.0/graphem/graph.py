...
class Graph:
    ...
    def plot_neighbors_corr(self, idx, time_idx_range=None, figsize=(5, 5), ms=50, title=None,
        stat='corr', target_clr='k', edge_clr='w', marker='o',
        cbar_pad=0.1, cbar_orientation='horizontal', cbar_aspect=10,
        cbar_fraction=0.15, cbar_shrink=0.5, plot_cbar=True, ax=None):
        ''' Plot the location of the neighbors according to the adjacency matrix
