...
"""
    ...
    def test_parse_yaml_file(self):
        ...
        self.assertEqual(
            config.parse_yaml_file(tf.name), self.result_yaml_dict
        )
    ...
    def test_parse_json_file(self):
        ...
        self.assertEqual(
            config.parse_json_file(tf.name), self.result_json_dict
        )
...
class TestSanitizeConfig(TestConfig):
    ...
    def test_multi_tokens_dict(self):
        orig_dict = {
            ...
            "oiuzxc": {
                "tokens": {
                    "something": "ouxcbvyoiowew",
                    "else": "youiwermnxbcv",
                },
                "real": "should not change",
                "token": "iouxcbvuoizxcbuio",
            },
        }
        result_dict = {
            "asdf": {"password": "REDACTED", "more_token": "REDACTED"},
