...
class MultiRulesRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["default_chain", b"default_chain"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["default_chain", b"default_chain", "rules", b"rules"]) -> None: ...
...
class Rule(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["checkRuleRequest", b"checkRuleRequest", "noMessageRule", b"noMessageRule", "one_rule", b"one_rule", "sequenceRule", b"sequenceRule"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["checkRuleRequest", b"checkRuleRequest", "noMessageRule", b"noMessageRule", "one_rule", b"one_rule", "sequenceRule", b"sequenceRule"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["one_rule", b"one_rule"]) -> typing_extensions.Literal["checkRuleRequest", "sequenceRule", "noMessageRule"] | None: ...
