...
class AwsCustomResource(
    ...
    def __init__(
        ...
        *,
        ...
        :param log_group: The Log Group used for logging of events emitted by the custom resource's lambda function. Default: - a default log group created by AWS Lambda
        :param log_retention: (deprecated) The number of days log events of the singleton Lambda function implementing this custom resource are kept in CloudWatch Logs. Default: logs.RetentionDays.INFINITE
...
class AwsCustomResourceProps:
    ...
    def log_retention(self) -> typing.Optional[_RetentionDays_070f99f0]:
        '''(deprecated) The number of days log events of the singleton Lambda function implementing this custom resource are kept in CloudWatch Logs.
...
class Provider(
    ...
    def __init__(
        ...
        *,
        ...
        :param log_group: The Log Group used for logging of events emitted by the custom resource's lambda function. Default: - a default log group created by AWS Lambda
        :param log_retention: (deprecated) The number of days framework log events are kept in CloudWatch Logs. When updating this property, unsetting it doesn't remove the log retention policy. To remove the retention policy, set the value to ``INFINITE``. Default: logs.RetentionDays.INFINITE
...
class ProviderProps:
    ...
    @builtins.property
    def log_retention(self) -> typing.Optional[_RetentionDays_070f99f0]:
        '''(deprecated) The number of days framework log events are kept in CloudWatch Logs.
