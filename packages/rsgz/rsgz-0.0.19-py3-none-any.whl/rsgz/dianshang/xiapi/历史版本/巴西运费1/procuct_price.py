...
from rsgz.dianshang.xiapi.巴西运费1.baxi_kuajing_yunfei import baxi_yunfei
from rsgz.dianshang.xiapi.巴西运费1.settings import *
...
def start(国家,套餐):
    ...
    # 运费
    藏价 = 跨境物流成本_藏价 = laoban_yunfei  # 老板跨境运费成本
    ...
    print("|{:-<21}{:-<18}///>>>{:<}<<<\\\\\\".format('建议设置:', '%.2f'%(折前售价-跨境物流成本_藏价), '%.2f'%(折前售价/汇率-跨境物流成本_藏价/汇率)))
    ...
    # print("尺寸-->克重-->价格")
    # print("S-->", weight_list[0], "-->",)
    # print("M-->", weight_list[1])
    # print("L-->", weight_list[2])
    # print("XL-->", weight_list[3])
    # print("2XL-->", weight_list[4])
    # print("3XL-->", weight_list[5])
    # print("4XL-->", weight_list[6])
    # print("5XL-->", weight_list[7])
    print('------------------------------------------------------------------')
