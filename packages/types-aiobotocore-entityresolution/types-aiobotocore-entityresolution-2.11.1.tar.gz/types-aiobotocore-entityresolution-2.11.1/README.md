...
[aiobotocore.EntityResolution 2.11.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/entityresolution.html#EntityResolution)
...
Install `types-aiobotocore-lite[entityresolution]` in your environment:
