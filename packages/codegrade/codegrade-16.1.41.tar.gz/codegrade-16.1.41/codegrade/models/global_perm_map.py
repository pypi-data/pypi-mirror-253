        ...
        lambda: rqa.FixedMapping(
            ...
            rqa.RequiredArgument(
                ...
                doc=(
                    ...
                    " site, this means they can see all other users on the"
                    " site."
                ),
            ),
            rqa.RequiredArgument(
            ...
            rqa.RequiredArgument(
                ...
                rqa.SimpleValue.bool,
                doc=(
                    "Determines whether the user will see announcement"
                    " reserved for non student users in the announcement"
                    " center within the sidebar"
                ),
            ),
            rqa.RequiredArgument(
                ...
                rqa.SimpleValue.bool,
                doc=(
                    "Users with this permission can see the items in the"
                    " community library."
                ),
            ),
            rqa.RequiredArgument(
                ...
                rqa.SimpleValue.bool,
                doc=(
                    "Users with this permission can see all the items in the"
                    " community library, even those not published to their"
                    " tenant."
                ),
            ),
            rqa.RequiredArgument(
                ...
                rqa.SimpleValue.bool,
                doc=(
                    "Users with this permission can create new community"
                    " library items."
                ),
            ),
            rqa.RequiredArgument(
                ...
                rqa.SimpleValue.bool,
                doc=(
                    "Users that have this permission globally can delete any"
                    " community library item. Users that have this permission"
                    " only in their tenant can delete any community library"
                    " item within their tenant. Users without this permission"
                    " can still delete community library items they created"
                    " themselves. You will always need permission to view an"
                    " item to be able to delete it."
                ),
            ),
