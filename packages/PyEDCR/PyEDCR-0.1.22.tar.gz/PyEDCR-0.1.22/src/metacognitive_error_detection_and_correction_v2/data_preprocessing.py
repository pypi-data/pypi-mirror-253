...
true_fine_data = np.load(r'src/metacognitive_error_detection_and_correction_v2/test_fine/test_true_fine.npy')
true_coarse_data = np.load(r'src/metacognitive_error_detection_and_correction_v2/test_coarse/test_true_coarse.npy')
