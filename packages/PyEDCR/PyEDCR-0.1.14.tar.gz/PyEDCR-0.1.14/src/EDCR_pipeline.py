...
from src import vit_pipeline
from src import utils
from src import data_preprocessing
from src import context_handlers
...
def get_binary_condition_values(example_index: int,
    ...
    for fine_i, fine_cls in enumerate(fine_cla_datas[:, example_index].astype(int)):
        for coarse_i, coarse_cls in enumerate(coarse_cla_datas[:, example_index].astype(int)):
            ...
            consistent = int(pred & (data_preprocessing.fine_to_coarse_idx[fine_i] == coarse_i))
            res += [pred, consistent]
...
def load_priors(main_lr,
    ...
    if combined:
        main_model_fine_path = f'vit_b_16_lr0.0001_LTN_soft_marginal_beta_0.1_batch_size_512_step_size_1_scheduler_gamma_0.1_fine_pred.npy'
        main_model_coarse_path = f'vit_b_16_lr0.0001_LTN_soft_marginal_beta_0.1_batch_size_512_step_size_1_scheduler_gamma_0.1_coarse_pred.npy'
    else:
    ...
    secondary_model_fine_path = (f'vit_b_16_lr0.0001_LTN_soft_marginal_beta_0.1_batch_size_512_step_size_1_scheduler_gamma_0.1_fine_pred.npy')
    secondary_model_coarse_path = (f'vit_b_16_lr0.0001_LTN_soft_marginal_beta_0.1_batch_size_512_step_size_1_scheduler_gamma_0.1_coarse_pred.npy')
...
def get_conditions_data(main_fine_data: np.array,
    ...
    for main_or_secondary in ['main',
        ...
        derived_coarse = np.array([data_preprocessing.fine_to_coarse_idx[fine_grain_prediction]
