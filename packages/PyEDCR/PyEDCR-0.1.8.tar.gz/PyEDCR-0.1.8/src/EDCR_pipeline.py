...
def load_priors(main_lr,
    ...
    if combined:
        main_model_fine_path = f'/combined_results/vit_b_16_lr0.0001_LTN_soft_marginal_beta_0.1_batch_size_512_step_size_1_scheduler_gamma_0.1_fine_pred.npy'
        main_model_coarse_path = f'combined_results/vit_b_16_lr0.0001_LTN_soft_marginal_beta_0.1_batch_size_512_step_size_1_scheduler_gamma_0.1_coarse_pred.npy'
    else:
    ...
    secondary_model_fine_path = (f'/combined_results/vit_b_16_lr0.0001_LTN_soft_marginal_beta_0.1_batch_size_512_step_size_1_scheduler_gamma_0.1_fine_pred.npy')
    secondary_model_coarse_path = (f'combined_results/vit_b_16_lr0.0001_LTN_soft_marginal_beta_0.1_batch_size_512_step_size_1_scheduler_gamma_0.1_coarse_pred.npy')
