...
class Manager:
    ...
    def writeStepToJson(self, parameters,step,embryo_folder="."):
        parameters["step"] = step
        addDictToMetadata(embryo_folder,parameters)
    ...
    def name_embryo(self, parameters):
        ...
        self.writeStepToJson(parameters, "name_embryo", embryo_folder=".")
    ...
    def apply_downscaling(self,parameters):
        downscale_contour = bool(parameters["downscale_contour"])
        if not "embryo_name" in parameters:
        ...
        voxelname = str(voxel_size).replace(".","")
        embryo_folder = "."
        input_folder = os.path.join(embryo_folder, "FUSE/FUSE_" + str(parameters["EXP_FUSE"]))
    ...
    def start_fusion(self,parameters,run_now=True,keep_temp=False,channel_count=1,one_stack_only=False,stack_chosen=0):
        ...
        if run_now:
            ...
            self.writeStepToJson(real_parameters,"fusion",".")
    ...
    def compute_fusion_movie(self,parameters):
        ...
        try:
            ...
            self.start_running(thread_number=1)
            self.writeStepToJson(real_parameters,"intrareg_movie",".")
    ...
    def start_mars(self,parameters):
        ...
        self.writeStepToJson(real_parameters,"mars",".")
    ...
    def test_segmentation(self,parameters):
        ...
        self.writeStepToJson(parameters,"segmentation_test",".")
        ...
        self.writeStepToJson(parameters,"post_correction_test",".")
        parameters["EXP_SEG"] = 'test_addition_glace'
    ...
    def start_segmentation(self,parameters,run_now=True):
        ...
        if run_now:
            ...
            self.writeStepToJson(real_parameters,"segmentation",".")
    ...
    def start_post_correction(self,parameters,run_now=True):
        ...
        if run_now:
            self.start_running(thread_number=1)
            real_parameters["uploaded_on_omero"] = (omero_config_file is not None)
            self.writeStepToJson(real_parameters,"post_correction",".")
    ...
    def apply_intrareg(self,parameters):
        ...
        try:
            ...
            self.start_running(thread_number=1)
            real_parameters["uploaded_on_omero"] = (omero_config_file is not None)
            self.writeStepToJson(real_parameters, "intraregistration", ".")
        except Exception as e:
            strlog = traceback.format_exc()
    ...
    def compute_properties(self,parameters):
        ...
        try:
            ...
            self.start_running(thread_number=1)
            self.writeStepToJson(parameters,"embryo_properties",".")
        except Exception as e:
            strlog = traceback.format_exc()
