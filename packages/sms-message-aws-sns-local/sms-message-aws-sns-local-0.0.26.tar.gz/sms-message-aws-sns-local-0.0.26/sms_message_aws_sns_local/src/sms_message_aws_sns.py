...
class SmsMessageAwsSnsLocal(MessageLocal):
    ...
    def send(self, body: str = None, compound_message_dict: dict = None, to_recipients: List[Recipient] = None,
