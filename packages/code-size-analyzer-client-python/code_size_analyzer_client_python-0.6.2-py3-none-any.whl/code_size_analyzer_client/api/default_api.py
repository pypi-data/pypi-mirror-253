...
class DefaultApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.metrics_metrics_get_endpoint = _Endpoint(
            settings={
    ...
    def metrics_metrics_get(
        ...
        **kwargs
        ...
        >>> thread = api.metrics_metrics_get(async_req=True)
        >>> result = thread.get()
        ...
        return self.metrics_metrics_get_endpoint.call_with_http_info(**kwargs)
