"""
This module, app.py, serves as the primary entry point to the Program Agnostic CDC Data Hub LAVA (CDH) application. It initializes the application and sets up the endpoints for various services, including Alation.
...
import cdh_dav_python.alation_service.db_schema as alation_schema
