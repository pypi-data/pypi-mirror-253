...
from cdh_dav_python.cdc_admin_service import (
    environment_tracing as cdh_env_tracing,
    environment_logging as cdh_env_logging,
)
    ...
    def get_api_token_from_config(self, config):
        ...
        with tracer.start_as_current_span("get_api_token_from_config"):
            try:
                ...
                cdh_env_tracing.TracerSingleton.log_to_console = False
                tracer_singleton = cdh_env_tracing.TracerSingleton.instance(
                    NAMESPACE_NAME, SERVICE_NAME
                )
                ...
                alation_refresh_token = az_key_vault.get_secret(
                    az_kv_edc_refresh_secret_key, cdh_databricks_kv_scope
                )
