...
# python -m pytest cdh_dav_python/cdh_dav_python/tests
# Load the .env file
...
def test_convert_to_windows_dir():
    """_summary_"""
    unix_dir = "/Users/zfi4/OneDrive - CDC/Documents/DMI PH Infrastructure/Program-Agnostic Data Ecosystem (CDH)/data-ecosystem-services/cdh_dav_python/ocio/wonder_metadata_dev/config/config.dev.json"
