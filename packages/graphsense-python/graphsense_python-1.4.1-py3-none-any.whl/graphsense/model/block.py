...
class Block(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, block_hash, currency, height, no_txs, timestamp, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, block_hash, currency, height, no_txs, timestamp, *args, **kwargs):  # noqa: E501
        """Block - a model defined in OpenAPI
