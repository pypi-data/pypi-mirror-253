...
from . import metal
from . import random
__all__ = ['Device', 'DeviceType', 'Dtype', 'Inf', 'Infinity', 'NAN', 'NINF', 'NZERO', 'NaN', 'PINF', 'PZERO', 'Stream', 'abs', 'add', 'addmm', 'all', 'allclose', 'any', 'arange', 'arccos', 'arccosh', 'arcsin', 'arcsinh', 'arctan', 'arctanh', 'argmax', 'argmin', 'argpartition', 'argsort', 'array', 'array_equal', 'as_strided', 'bfloat16', 'bool_', 'broadcast_to', 'ceil', 'clip', 'complex64', 'concatenate', 'conv1d', 'conv2d', 'convolve', 'cos', 'cosh', 'cpu', 'cummax', 'cummin', 'cumprod', 'cumsum', 'default_device', 'default_stream', 'dequantize', 'divide', 'divmod', 'e', 'equal', 'erf', 'erfinv', 'euler_gamma', 'eval', 'exp', 'expand_dims', 'export_to_dot', 'eye', 'fft', 'flatten', 'float16', 'float32', 'floor', 'floor_divide', 'full', 'gpu', 'grad', 'greater', 'greater_equal', 'identity', 'inf', 'infty', 'inner', 'int16', 'int32', 'int64', 'int8', 'isinf', 'isnan', 'isneginf', 'isposinf', 'jvp', 'less', 'less_equal', 'linalg', 'linspace', 'load', 'log', 'log10', 'log1p', 'log2', 'logaddexp', 'logical_and', 'logical_not', 'logical_or', 'logsumexp', 'matmul', 'max', 'maximum', 'mean', 'metal', 'min', 'minimum', 'moveaxis', 'multiply', 'nan', 'negative', 'new_stream', 'newaxis', 'not_equal', 'ones', 'ones_like', 'outer', 'pad', 'partition', 'pi', 'power', 'prod', 'quantize', 'quantized_matmul', 'random', 'reciprocal', 'remainder', 'repeat', 'reshape', 'round', 'rsqrt', 'save', 'save_gguf', 'save_safetensors', 'savez', 'savez_compressed', 'set_default_device', 'set_default_stream', 'sigmoid', 'sign', 'simplify', 'sin', 'sinh', 'softmax', 'sort', 'split', 'sqrt', 'square', 'squeeze', 'stack', 'stop_gradient', 'subtract', 'sum', 'swapaxes', 'take', 'take_along_axis', 'tan', 'tanh', 'tensordot', 'tile', 'topk', 'transpose', 'tri', 'tril', 'triu', 'uint16', 'uint32', 'uint64', 'uint8', 'value_and_grad', 'var', 'vjp', 'vmap', 'where', 'zeros', 'zeros_like']
class Device:
