...
import grpc_cotea.cotea_pb2 as cotea__pb2
...
class CoteaGatewayStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetVar = channel.unary_unary(
                '/CoteaGateway/GetVar',
                request_serializer=cotea__pb2.AnsibleVarMsg.SerializeToString,
                response_deserializer=cotea__pb2.AnsibleVar.FromString,
                )
        self.GetStats = channel.unary_unary(
                '/CoteaGateway/GetStats',
                request_serializer=cotea__pb2.SessionID.SerializeToString,
                response_deserializer=cotea__pb2.String.FromString,
                )
        self.CloseSession = channel.unary_unary(
                '/CoteaGateway/CloseSession',
                request_serializer=cotea__pb2.SessionID.SerializeToString,
                response_deserializer=cotea__pb2.Status.FromString,
                )
...
def add_CoteaGatewayServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetVar': grpc.unary_unary_rpc_method_handler(
                    servicer.GetVar,
                    request_deserializer=cotea__pb2.AnsibleVarMsg.FromString,
                    response_serializer=cotea__pb2.AnsibleVar.SerializeToString,
            ),
            'GetStats': grpc.unary_unary_rpc_method_handler(
                    servicer.GetStats,
                    request_deserializer=cotea__pb2.SessionID.FromString,
                    response_serializer=cotea__pb2.String.SerializeToString,
            ),
...
class CoteaGateway(object):
    ...
    def GetVar(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/CoteaGateway/GetVar',
            cotea__pb2.AnsibleVarMsg.SerializeToString,
            cotea__pb2.AnsibleVar.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetStats(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/CoteaGateway/GetStats',
            cotea__pb2.SessionID.SerializeToString,
            cotea__pb2.String.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def CloseSession(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/CoteaGateway/CloseSession',
            cotea__pb2.SessionID.SerializeToString,
            cotea__pb2.Status.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
...
class CoteaWorkerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetStats = channel.unary_unary(
                '/CoteaWorker/GetStats',
                request_serializer=cotea__pb2.EmptyMsg.SerializeToString,
                response_deserializer=cotea__pb2.String.FromString,
                )
        self.CloseSession = channel.unary_unary(
                '/CoteaWorker/CloseSession',
                request_serializer=cotea__pb2.EmptyMsg.SerializeToString,
                response_deserializer=cotea__pb2.Status.FromString,
                )
...
class CoteaWorker(object):
    ...
    def StartSession(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/CoteaWorker/StartSession',
            cotea__pb2.SessionID.SerializeToString,
            cotea__pb2.Status.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetVar(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/CoteaWorker/GetVar',
            cotea__pb2.AnsibleVarMsg.SerializeToString,
            cotea__pb2.AnsibleVar.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetStats(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/CoteaWorker/GetStats',
            cotea__pb2.EmptyMsg.SerializeToString,
            cotea__pb2.String.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def CloseSession(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/CoteaWorker/CloseSession',
            cotea__pb2.EmptyMsg.SerializeToString,
            cotea__pb2.Status.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
