...
class TestZPyWallet(unittest.TestCase):
    ...
    def test_000_permutation(self):
        ...
        """.replace(' ', '').replace('\n', '').lower()
        assert hexlify(bytes(s.get_bytes())).decode() == state_after_rounds_on_zero
        ...
        """.replace(' ', '').replace('\n', '').lower()
        assert hexlify(bytes(s.get_bytes())).decode() == state_after_rounds_on_previous

    def test_001_ror_rol(self):
    ...
    def test_002_sponge(self):
        ...
        """.lower().strip()
        assert hexlify(bytes(s.squeeze(512))).decode() == squeezed

    def test_003_hash(self):
        pt = bytes.fromhex('cc')
    ...
    def test_004_multipart(self):
        pt = bytes.fromhex('41fb')
    ...
    def test_005_long(self):
        pt = bytes.fromhex('')
