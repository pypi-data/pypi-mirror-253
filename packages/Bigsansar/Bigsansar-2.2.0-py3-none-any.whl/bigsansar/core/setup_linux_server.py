...
def deploy_server():
    ...
    cmd2 = "sudo apt install openssh-server ufw apache2 libapache2-mod-wsgi-py3 postgresql postgresql-contrib libpq-dev python3-tk -y"
    os.system(cmd2)
    ...
    get_full_path = package_dir + 'core/config_chroot.sh'
    # make
