...
[aiobotocore.PinpointSMSVoiceV2 2.11.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/pinpoint-sms-voice-v2.html#PinpointSMSVoiceV2)
...
async with session.create_client("pinpoint-sms-voice-v2") as client:
    ...
    describe_registration_field_definitions_paginator: (
        DescribeRegistrationFieldDefinitionsPaginator
    ...
    describe_registration_type_definitions_paginator: (
        DescribeRegistrationTypeDefinitionsPaginator
