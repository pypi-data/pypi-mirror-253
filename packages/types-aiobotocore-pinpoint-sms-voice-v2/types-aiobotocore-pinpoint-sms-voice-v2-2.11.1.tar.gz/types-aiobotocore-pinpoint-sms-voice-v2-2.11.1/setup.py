...
setup(
    ...
    description="Type annotations for aiobotocore.PinpointSMSVoiceV2 2.11.1 service generated with mypy-boto3-builder 7.23.1",
    classifiers=[
    ...
    keywords="aiobotocore pinpoint-sms-voice-v2 type-annotations botocore mypy typeshed autocomplete",
