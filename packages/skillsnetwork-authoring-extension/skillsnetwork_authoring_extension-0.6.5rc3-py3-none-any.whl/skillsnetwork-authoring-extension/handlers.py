...
class ConfigurationEndpointHandler(AppHandler):
  ...
  def get(self) -> None:
    ...
    self.finish({"ATLAS_BASE_URL": self.config.atlas_base_url, "SN_FILE_LIBRARY_URL": self.config.sn_file_library_url, "SN_V2_FILE_LIBRARY_URL": self.config.sn_v2_file_library_url, "AWB_BASE_URL": self.config.awb_base_url})
