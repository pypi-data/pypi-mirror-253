...
class TmkCheckBytLs(DataMapping):
    ...
    async def async_request(
        ...
        query: str = "TmkCheckBytLs",
        id_service: Any = None,
    ):
        """Query request: TmkCheckBytLs
    ...
    byt_only: bool = attr.ib(converter=bool)


@attr.s(kw_only=True, frozen=True, slots=True)
class TmkCheckPayAvail(DataMapping):
    returns_single: ClassVar[bool] = True
    ...
    async def async_request(
        ...
        api: "BaseEnergosbytAPI",
        data: Optional[Mapping[str, Any]] = None,
        query: str = "TmkCheckPayAvail",
        id_service: Any = None,
    ):
        """Query request: TmkCheckPayAvail
...
@attr.s(kw_only=True, frozen=True, slots=True)
class TmkPayAddress(DataMapping):
    @classmethod
    async def async_request(
        cls,
        api: "BaseEnergosbytAPI",
        data: Optional[Mapping[str, Any]] = None,
        query: str = "TmkPayAddress",
    ):
        """Query request: TmkPayAddress
