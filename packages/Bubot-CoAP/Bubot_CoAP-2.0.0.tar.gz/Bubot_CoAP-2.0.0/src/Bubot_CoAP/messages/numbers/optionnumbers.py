...
from ...messages import optiontypes
...
OptionNumber.OCF_ACCEPT_CONTENT_FORMAT_VERSION.format = optiontypes.UintOption
OptionNumber.OCF_CONTENT_FORMAT_VERSION.format = optiontypes.UintOption
