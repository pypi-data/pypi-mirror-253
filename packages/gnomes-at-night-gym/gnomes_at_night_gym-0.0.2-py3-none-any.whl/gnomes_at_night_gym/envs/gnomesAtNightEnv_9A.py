...
class GnomesAtNightEnv9A(gym.Env):
    ...
    def __init__(self, render_mode=None, round=1):
        ...
        self.treasure_pos_this_round = treasures[round-1]
        self.treasure = {'onWhichSide': 0, 'pos': np.array(self.treasure_pos_this_round)}
    ...
    def get_valid_actions(self, current_player):
        ...
        for action in range(5):
            if self.is_action_valid(current_player, action):
    ...
    def _get_rewards(self, action):
        ...
        # Scaled reward based on distance to treasure
        # reward -= 0.2*np.linalg.norm(self.token_pos - self.treasure['pos'], ord=1)
