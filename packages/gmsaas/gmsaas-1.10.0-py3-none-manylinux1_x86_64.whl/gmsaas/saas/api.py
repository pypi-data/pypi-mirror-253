...
def get_instances_adb_access_url(instance_uuid):
    """
    Return URL to request a JWT allowed to access the instance
    """
    return f"{INSTANCES_V1_URL}/{instance_uuid}/adb-access"
