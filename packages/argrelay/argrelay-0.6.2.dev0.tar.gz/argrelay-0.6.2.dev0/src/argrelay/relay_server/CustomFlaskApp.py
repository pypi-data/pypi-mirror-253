...
def configure_project_git_conf_dir_url(
    ...
    *   `project_current_config_path` points under `argrelay_dir`
    ...
    eprint(f"project_git_files_by_commit_id_url_prefix: {project_git_files_by_commit_id_url_prefix}")
    ...
    eprint(f"project_git_commit_id: {project_git_commit_id}")
    ...
    eprint(f"project_git_repo_relative_argrelay_dir: {project_git_repo_relative_argrelay_dir}")
    ...
    eprint(f"project_current_config_path: {project_current_config_path}")
