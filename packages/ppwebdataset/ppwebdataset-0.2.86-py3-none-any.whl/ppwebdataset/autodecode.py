...
def paddle_loads(data: bytes):
    """Function: paddle_loads
...
decoders = {
    ...
    "pth": lambda data: paddle_loads(data),
    "ten": tenbin_loads,
    "tb": tenbin_loads,
    "mp": msgpack_loads,
    "msg": msgpack_loads,
...
def paddle_autdio(key, data):
    """Decode audio using the paddle.audio library.
