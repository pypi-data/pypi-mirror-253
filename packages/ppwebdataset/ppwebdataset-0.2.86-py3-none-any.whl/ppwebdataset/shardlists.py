...
"""Train paddle models directly from POSIX tar archive.
...
def split_by_node(src, group=None):
    """Split the input sequence by paddle distributed rank."""
...
def split_by_worker(src):
    """Split the input sequence by paddle DataLoader worker."""
...
class ResampledShards(IterableDataset):
    ...
    def __init__(
        ...
        self.worker_seed = (
            utils.paddle_worker_seed if worker_seed is None else worker_seed
        )
