# FragPipe (21.0) runtime properties


# Please edit the following path to point to the correct location.
# In Windows, please replace single '\' with '\\'
database.db-path=/mnt/PUMA/ProjectSQ/ASchmidt/KlemensErwinFrohlich_568/20230131-143622_Analysis/ProteoBench/proteobench/Module_2_DDA_quantification/FASTA/2023-12-16-decoys-BenchmarkFASTAModule2_DDA.fasta.fas
...
fragpipe-config.bin-diann=/mnt/DATA/software/fragpipe/tools/diann/1.8.2_beta_8/linux/diann-1.8.1.8
fragpipe-config.bin-ionquant=/mnt/DATA/software/fragpipe/tools/IonQuant-1.10.12.jar
fragpipe-config.bin-msfragger=/mnt/DATA/software/fragpipe/tools/MSFragger-4.0/MSFragger-4.0.jar
fragpipe-config.bin-philosopher=/mnt/DATA/software/fragpipe/tools/philosopher_v5.1.0_linux_amd64/philosopher
fragpipe-config.bin-python=/mnt/DATA/software/anaconda/bin/python3
freequant.mz-tol=10
...
workdir=/home/pcfuser/ProjectSQ/ASchmidt/KlemensErwinFrohlich_568/20230131-143622_Analysis/ProteoBench/own_analyses/DDA_FragPipe_LFQ_MBR_Opt_FileName
