...
class Connector:
    ...
    def reconnect(self):
        ...
        try:
            ...
            logger.error(f"Coudn't connect to the database {self}", object={"exception": exception})
            logger.end()
            raise
    ...
    def close(self) -> None:
        ...
        try:
            ...
            logger.error(f"connection.py close() {self}", object={"exception": exception})
    ...
    def set_schema(self, new_schema: str | None) -> None:
        ...
        if self.connection and self.connection.is_connected():
            ...
            try:
                ...
                logger.error(f"sql_statement: {use_query} at {self}", object={"exception": exception})
                logger.end()
                raise
        else:
            logger.error(
