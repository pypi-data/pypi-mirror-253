...
class GenericCRUD:
    ...
    def insert(self, *, schema_name: str = None, table_name: str = None, data_json: dict = None,
        ...
        if table_name in table_definition:
            ...
            logger.warning(f"Table {table_name} not found in database-mysql-local.table_definition_table")
        ...
        try:
            ...
            logger.exception(self._log_error_message(
        ...
        try:
            ...
            logger.exception(
                self._log_error_message(message="Error while deleting",
                                        sql_statement=update_query, schema_name=schema_name), object=exception)
            logger.end()
            raise
