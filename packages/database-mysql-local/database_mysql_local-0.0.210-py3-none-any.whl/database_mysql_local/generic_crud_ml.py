...
logger = Logger.create_logger(object=LOGGER_CRUD_ML_CODE_OBJECT)
...
class GenericCRUDML(GenericCRUD):
    ...
    def get_id_by_name(self, name: str, lang_code: LangCode = None,
        ...
        try:
            ...
            logger.warning("select_one_tuple_by_where was not successful for name and lang_code. "
    ...
    def delete_by_name(self, name: str,
        ...
        try:
            ...
            logger.warning("delete_by_where was not successful for name and lang_code Error: " + str(exception),
    ...
    @staticmethod
    def _generate_id_column_name(id_column_name: str | None, table_name: str) -> str:
        try:
            ...
            logger.error(message, object={"exception": exception})
            logger.end()
    ...
    def select_one_by_value_with_none_option(
        ...
        logger.warning("this method is deprecated, use select_one_tuple_by_id instead")
        ...
        try:
            ...
            logger.error(self._log_error_message(message="Error selecting data_json",
                                                 sql_statement=select_query, schema_name=self.schema_name),
    ...
    def select_multi_tuple_by_value_with_none_option(self,
        ...
        logger.start(
            object={"table_name": view_table_name,
                    ...
                    "condition_column_name": condition_column_name,
                    "condition_column_value": condition_column_value})
        logger.warning("this method is deprecated, use select_multi_tuple_by_id instead")
        validate_select_table_name(view_table_name)
        select_query = f"SELECT {select_column_name} " f"FROM {self.schema_name}.{view_table_name} " + (
            f"WHERE `{condition_column_name}` = \"{condition_column_value}\" " if (condition_column_name and
                                                                                   condition_column_value)
