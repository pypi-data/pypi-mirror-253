...
<template>
  <div class="card bg-light">
    <div class="card-header py-2" v-if="currentSearch">
      <div class="form-row align-items-center" v-if="!editing">
        <div class="col-8">
        ...
        <div class="col-4 d-flex justify-content-end">
          <div class="btn-group btn-group-sm">
            <button type="button" class="btn btn-light fixed-btn" :title="$t('Edit search')" @click="startEditing">
              <i class="fa-solid fa-pencil"></i>
            </button>
            <button type="button" class="btn btn-danger fixed-btn" :title="$t('Remove search')" @click="removeSearch">
    ...
    <div class="card-body py-3">
      <div class="form-row" v-if="!saving">
        ...
        <div class="col-3">
          <button type="button" class="btn btn-sm btn-block btn-light" :title="$t('New search')" @click="saving = true">
