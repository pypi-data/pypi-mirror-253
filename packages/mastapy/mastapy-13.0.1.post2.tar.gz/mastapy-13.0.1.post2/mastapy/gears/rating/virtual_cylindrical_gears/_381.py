...
class HypoidVirtualCylindricalGearISO10300MethodB2(
    ...
    _CastSelf = TypeVar(
        "_CastSelf", bound="_Cast_HypoidVirtualCylindricalGearISO10300MethodB2"
    )
    ...
    class _Cast_HypoidVirtualCylindricalGearISO10300MethodB2:
        ...
        def __init__(
            self: "HypoidVirtualCylindricalGearISO10300MethodB2._Cast_HypoidVirtualCylindricalGearISO10300MethodB2",
            parent: "HypoidVirtualCylindricalGearISO10300MethodB2",
        ):
            self._parent = parent
    ...
    def __init__(
        self: Self,
        instance_to_wrap: "HypoidVirtualCylindricalGearISO10300MethodB2.TYPE",
    ):
    ...
    def cast_to(
        self: Self,
    ) -> "HypoidVirtualCylindricalGearISO10300MethodB2._Cast_HypoidVirtualCylindricalGearISO10300MethodB2":
