...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6954, _6955
...
class SpiralBevelGearSetLoadCase(_6830.BevelGearSetLoadCase):
    """SpiralBevelGearSetLoadCase
    ...
    @property
    def gears(self: Self) -> "List[_6954.SpiralBevelGearLoadCase]":
    ...
    def spiral_bevel_gears_load_case(
        self: Self,
    ) -> "List[_6954.SpiralBevelGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.SpiralBevelGearLoadCase]
    ...
    def spiral_bevel_meshes_load_case(
        self: Self,
    ) -> "List[_6955.SpiralBevelGearMeshLoadCase]":
