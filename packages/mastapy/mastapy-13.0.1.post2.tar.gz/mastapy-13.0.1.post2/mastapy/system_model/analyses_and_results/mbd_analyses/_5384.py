...
class AssemblyMultibodyDynamicsAnalysis(
    ...
    @property
    def bearings(self: Self) -> "List[_5385.BearingMultibodyDynamicsAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_5388.BeltDriveMultibodyDynamicsAnalysis]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_5397.BoltedJointMultibodyDynamicsAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_5398.BoltMultibodyDynamicsAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_5420.CVTMultibodyDynamicsAnalysis]":
    ...
    @property
    def clutches(self: Self) -> "List[_5401.ClutchMultibodyDynamicsAnalysis]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_5422.CycloidalAssemblyMultibodyDynamicsAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_5435.FEPartMultibodyDynamicsAnalysis]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_5434.FaceGearSetMultibodyDynamicsAnalysis]":
    ...
    @property
    def gear_sets(self: Self) -> "List[_5440.GearSetMultibodyDynamicsAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_5455.KlingelnbergCycloPalloidHypoidGearSetMultibodyDynamicsAnalysis]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_5459.MassDiscMultibodyDynamicsAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_5466.OilSealMultibodyDynamicsAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_5470.PartToPartShearCouplingMultibodyDynamicsAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_5474.PointLoadMultibodyDynamicsAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_5475.PowerLoadMultibodyDynamicsAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_5477.RingPinsMultibodyDynamicsAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_5479.RollingRingAssemblyMultibodyDynamicsAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_5486.ShaftMultibodyDynamicsAnalysis]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_5495.SpringDamperMultibodyDynamicsAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_5501.StraightBevelGearSetMultibodyDynamicsAnalysis]":
