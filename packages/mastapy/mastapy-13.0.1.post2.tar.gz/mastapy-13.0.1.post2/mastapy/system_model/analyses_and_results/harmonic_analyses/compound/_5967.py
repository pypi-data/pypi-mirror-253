...
class PulleyCompoundHarmonicAnalysis(_5918.CouplingHalfCompoundHarmonicAnalysis):
    """PulleyCompoundHarmonicAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_5798.PulleyHarmonicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_5798.PulleyHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.PulleyHarmonicAnalysis]
