...
class MassDiscCompoundHarmonicAnalysis(_6001.VirtualComponentCompoundHarmonicAnalysis):
    """MassDiscCompoundHarmonicAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_5784.MassDiscHarmonicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_5784.MassDiscHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.MassDiscHarmonicAnalysis]
