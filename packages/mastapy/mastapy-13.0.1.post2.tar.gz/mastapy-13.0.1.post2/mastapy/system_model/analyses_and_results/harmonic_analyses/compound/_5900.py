...
class ClutchCompoundHarmonicAnalysis(_5916.CouplingCompoundHarmonicAnalysis):
    """ClutchCompoundHarmonicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_5702.ClutchHarmonicAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_5702.ClutchHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.ClutchHarmonicAnalysis]
