...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses import _5781, _5782
...
class KlingelnbergCycloPalloidSpiralBevelGearSetHarmonicAnalysis(
    ...
    def gears_harmonic_analysis(
        self: Self,
    ) -> "List[_5781.KlingelnbergCycloPalloidSpiralBevelGearHarmonicAnalysis]":
    ...
    def meshes_harmonic_analysis(
        self: Self,
    ) -> "List[_5782.KlingelnbergCycloPalloidSpiralBevelGearMeshHarmonicAnalysis]":
