...
class RollingRingCompoundPowerFlow(_4206.CouplingHalfCompoundPowerFlow):
    """RollingRingCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4130.RollingRingPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4130.RollingRingPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.RollingRingPowerFlow]
