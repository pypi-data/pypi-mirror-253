...
class ConceptGearSetCompoundPowerFlow(_4227.GearSetCompoundPowerFlow):
    """ConceptGearSetCompoundPowerFlow
    ...
    def concept_gears_compound_power_flow(
        self: Self,
    ) -> "List[_4196.ConceptGearCompoundPowerFlow]":
    ...
    def concept_meshes_compound_power_flow(
        self: Self,
    ) -> "List[_4197.ConceptGearMeshCompoundPowerFlow]":
