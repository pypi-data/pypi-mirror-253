...
class GuideDxfModelCompoundPowerFlow(_4192.ComponentCompoundPowerFlow):
    """GuideDxfModelCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4096.GuideDxfModelPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4096.GuideDxfModelPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.GuideDxfModelPowerFlow]
