...
class AssemblyPowerFlow(_4032.AbstractAssemblyPowerFlow):
    ...
    @property
    def fe_parts(self: Self) -> "List[_4091.FEPartPowerFlow]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_4092.FlexiblePinAssemblyPowerFlow]":
    ...
    @property
    def hypoid_gear_sets(self: Self) -> "List[_4099.HypoidGearSetPowerFlow]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_4106.KlingelnbergCycloPalloidHypoidGearSetPowerFlow]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_4109.KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow]":
    ...
    @property
    def loaded_gear_sets(self: Self) -> "List[_4095.GearSetPowerFlow]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_4110.MassDiscPowerFlow]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_4113.OilSealPowerFlow]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_4117.PartToPartShearCouplingPowerFlow]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_4120.PlanetCarrierPowerFlow]":
    ...
    @property
    def point_loads(self: Self) -> "List[_4121.PointLoadPowerFlow]":
    ...
    @property
    def power_loads(self: Self) -> "List[_4124.PowerLoadPowerFlow]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_4126.RingPinsPowerFlow]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_4128.RollingRingAssemblyPowerFlow]":
    ...
    @property
    def shaft_hub_connections(self: Self) -> "List[_4132.ShaftHubConnectionPowerFlow]":
    ...
    @property
    def shafts(self: Self) -> "List[_4133.ShaftPowerFlow]":
    ...
    @property
    def spiral_bevel_gear_sets(self: Self) -> "List[_4138.SpiralBevelGearSetPowerFlow]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_4141.SpringDamperPowerFlow]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_4147.StraightBevelGearSetPowerFlow]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_4152.SynchroniserPowerFlow]":
    ...
    @property
    def torque_converters(self: Self) -> "List[_4156.TorqueConverterPowerFlow]":
    ...
    @property
    def unbalanced_masses(self: Self) -> "List[_4159.UnbalancedMassPowerFlow]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_4163.WormGearSetPowerFlow]":
    ...
    @property
    def zerol_bevel_gear_sets(self: Self) -> "List[_4166.ZerolBevelGearSetPowerFlow]":
