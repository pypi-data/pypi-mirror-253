...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.dynamic_analyses import _6405, _6406
...
class ZerolBevelGearSetDynamicAnalysis(_6295.BevelGearSetDynamicAnalysis):
    """ZerolBevelGearSetDynamicAnalysis
