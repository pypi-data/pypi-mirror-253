...
class AssemblyCompoundDynamicAnalysis(_6408.AbstractAssemblyCompoundDynamicAnalysis):
    """AssemblyCompoundDynamicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_6284.AssemblyDynamicAnalysis]":
    ...
    @property
    def bearings(self: Self) -> "List[_6416.BearingCompoundDynamicAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_6418.BeltDriveCompoundDynamicAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_6421.BevelDifferentialGearSetCompoundDynamicAnalysis]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_6428.BoltedJointCompoundDynamicAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_6427.BoltCompoundDynamicAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_6449.CVTCompoundDynamicAnalysis]":
    ...
    @property
    def clutches(self: Self) -> "List[_6429.ClutchCompoundDynamicAnalysis]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_6434.ConceptCouplingCompoundDynamicAnalysis]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_6439.ConceptGearSetCompoundDynamicAnalysis]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_6451.CycloidalAssemblyCompoundDynamicAnalysis]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_6453.CycloidalDiscCompoundDynamicAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_6457.CylindricalGearSetCompoundDynamicAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_6464.FEPartCompoundDynamicAnalysis]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_6463.FaceGearSetCompoundDynamicAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_6465.FlexiblePinAssemblyCompoundDynamicAnalysis]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_6472.HypoidGearSetCompoundDynamicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_6479.KlingelnbergCycloPalloidHypoidGearSetCompoundDynamicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        ...
        "List[_6482.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundDynamicAnalysis]"
    ):
    ...
    @property
    def mass_discs(self: Self) -> "List[_6483.MassDiscCompoundDynamicAnalysis]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_6484.MeasurementComponentCompoundDynamicAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_6486.OilSealCompoundDynamicAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_6488.PartToPartShearCouplingCompoundDynamicAnalysis]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_6493.PlanetCarrierCompoundDynamicAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_6494.PointLoadCompoundDynamicAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_6495.PowerLoadCompoundDynamicAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_6497.RingPinsCompoundDynamicAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_6499.RollingRingAssemblyCompoundDynamicAnalysis]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_6504.ShaftHubConnectionCompoundDynamicAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_6503.ShaftCompoundDynamicAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_6509.SpiralBevelGearSetCompoundDynamicAnalysis]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_6510.SpringDamperCompoundDynamicAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_6515.StraightBevelDiffGearSetCompoundDynamicAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_6518.StraightBevelGearSetCompoundDynamicAnalysis]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_6521.SynchroniserCompoundDynamicAnalysis]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_6525.TorqueConverterCompoundDynamicAnalysis]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_6529.UnbalancedMassCompoundDynamicAnalysis]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_6533.WormGearSetCompoundDynamicAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_6536.ZerolBevelGearSetCompoundDynamicAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_6284.AssemblyDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.AssemblyDynamicAnalysis]
