...
class FaceGearSetCompoundDynamicAnalysis(_6468.GearSetCompoundDynamicAnalysis):
    """FaceGearSetCompoundDynamicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_6334.FaceGearSetDynamicAnalysis]":
    ...
    def face_gears_compound_dynamic_analysis(
        self: Self,
    ) -> "List[_6461.FaceGearCompoundDynamicAnalysis]":
    ...
    def face_meshes_compound_dynamic_analysis(
        self: Self,
    ) -> "List[_6462.FaceGearMeshCompoundDynamicAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_6334.FaceGearSetDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.FaceGearSetDynamicAnalysis]
