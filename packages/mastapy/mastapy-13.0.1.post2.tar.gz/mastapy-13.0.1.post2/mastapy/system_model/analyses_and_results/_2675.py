...
class CompoundMultibodyDynamicsAnalysis(_2619.CompoundAnalysis):
    ...
    ) -> "Iterable[_5632.SpringDamperConnectionCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5647.TorqueConverterConnectionCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5530.AbstractShaftCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5529.AbstractAssemblyCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5531.AbstractShaftOrHousingCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5537.BearingCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5548.BoltCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5549.BoltedJointCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5554.ComponentCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5565.ConnectorCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5580.DatumCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5581.ExternalCADModelCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5585.FEPartCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5586.FlexiblePinAssemblyCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5536.AssemblyCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5590.GuideDxfModelCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5604.MassDiscCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5605.MeasurementComponentCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5606.MountableComponentCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5607.OilSealCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5608.PartCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5614.PlanetCarrierCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5615.PointLoadCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5616.PowerLoadCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5623.RootAssemblyCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5627.SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5650.UnbalancedMassCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5651.VirtualComponentCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5624.ShaftCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5558.ConceptGearCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5560.ConceptGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5582.FaceGearCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5584.FaceGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5533.AGMAGleasonConicalGearCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5535.AGMAGleasonConicalGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5540.BevelDifferentialGearCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5542.BevelDifferentialGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5543.BevelDifferentialPlanetGearCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5544.BevelDifferentialSunGearCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5545.BevelGearCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5547.BevelGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5561.ConicalGearCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5563.ConicalGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5576.CylindricalGearCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5578.CylindricalGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5579.CylindricalPlanetGearCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5587.GearCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5589.GearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5591.HypoidGearCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5593.HypoidGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5595.KlingelnbergCycloPalloidConicalGearCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5597.KlingelnbergCycloPalloidConicalGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5598.KlingelnbergCycloPalloidHypoidGearCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5600.KlingelnbergCycloPalloidHypoidGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5601.KlingelnbergCycloPalloidSpiralBevelGearCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5603.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5613.PlanetaryGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5628.SpiralBevelGearCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5630.SpiralBevelGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5634.StraightBevelDiffGearCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5636.StraightBevelDiffGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5637.StraightBevelGearCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5639.StraightBevelGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5640.StraightBevelPlanetGearCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5641.StraightBevelSunGearCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5652.WormGearCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5654.WormGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5655.ZerolBevelGearCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5657.ZerolBevelGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5572.CycloidalAssemblyCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5574.CycloidalDiscCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5618.RingPinsCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5609.PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5611.PartToPartShearCouplingHalfCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5539.BeltDriveCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5550.ClutchCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5552.ClutchHalfCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5555.ConceptCouplingCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5557.ConceptCouplingHalfCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5566.CouplingCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5568.CouplingHalfCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5570.CVTCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5571.CVTPulleyCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5617.PulleyCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5625.ShaftHubConnectionCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5621.RollingRingCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5620.RollingRingAssemblyCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5631.SpringDamperCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5633.SpringDamperHalfCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5642.SynchroniserCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5643.SynchroniserHalfCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5644.SynchroniserPartCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5645.SynchroniserSleeveCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5646.TorqueConverterCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5648.TorqueConverterPumpCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5649.TorqueConverterTurbineCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5626.ShaftToMountableComponentConnectionCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5569.CVTBeltConnectionCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5538.BeltConnectionCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5553.CoaxialConnectionCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5564.ConnectionCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5594.InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5612.PlanetaryConnectionCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5622.RollingRingConnectionCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5532.AbstractShaftToMountableComponentConnectionCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5541.BevelDifferentialGearMeshCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5559.ConceptGearMeshCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5583.FaceGearMeshCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5635.StraightBevelDiffGearMeshCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5546.BevelGearMeshCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5562.ConicalGearMeshCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5534.AGMAGleasonConicalGearMeshCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5577.CylindricalGearMeshCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5592.HypoidGearMeshCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5596.KlingelnbergCycloPalloidConicalGearMeshCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5599.KlingelnbergCycloPalloidHypoidGearMeshCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5602.KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5629.SpiralBevelGearMeshCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5638.StraightBevelGearMeshCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5653.WormGearMeshCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5656.ZerolBevelGearMeshCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5588.GearMeshCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5573.CycloidalDiscCentralBearingConnectionCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5575.CycloidalDiscPlanetaryBearingConnectionCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5619.RingPinsToDiscConnectionCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5610.PartToPartShearCouplingConnectionCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5551.ClutchConnectionCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5556.ConceptCouplingConnectionCompoundMultibodyDynamicsAnalysis]":
    ...
    ) -> "Iterable[_5567.CouplingConnectionCompoundMultibodyDynamicsAnalysis]":
