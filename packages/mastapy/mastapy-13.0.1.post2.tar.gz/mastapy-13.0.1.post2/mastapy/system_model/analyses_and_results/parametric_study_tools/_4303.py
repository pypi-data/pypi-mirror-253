...
class AssemblyParametricStudyTool(_4296.AbstractAssemblyParametricStudyTool):
    """AssemblyParametricStudyTool
    ...
    def all_duty_cycle_results(
        self: Self,
    ) -> "List[_4350.DutyCycleResultsForAllComponents]":
    ...
    @property
    def bearings(self: Self) -> "List[_4304.BearingParametricStudyTool]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_4306.BeltDriveParametricStudyTool]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_4315.BoltedJointParametricStudyTool]":
    ...
    @property
    def bolts(self: Self) -> "List[_4316.BoltParametricStudyTool]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_4337.CVTParametricStudyTool]":
    ...
    @property
    def clutches(self: Self) -> "List[_4319.ClutchParametricStudyTool]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_4324.ConceptCouplingParametricStudyTool]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_4327.ConceptGearSetParametricStudyTool]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_4341.CycloidalDiscParametricStudyTool]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_4345.CylindricalGearSetParametricStudyTool]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_4359.FEPartParametricStudyTool]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_4358.FaceGearSetParametricStudyTool]":
    ...
    @property
    def hypoid_gear_sets(self: Self) -> "List[_4367.HypoidGearSetParametricStudyTool]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_4378.MassDiscParametricStudyTool]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_4382.OilSealParametricStudyTool]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_4399.PlanetCarrierParametricStudyTool]":
    ...
    @property
    def point_loads(self: Self) -> "List[_4400.PointLoadParametricStudyTool]":
    ...
    @property
    def power_loads(self: Self) -> "List[_4401.PowerLoadParametricStudyTool]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_4403.RingPinsParametricStudyTool]":
    ...
    @property
    def shafts(self: Self) -> "List[_4410.ShaftParametricStudyTool]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_4415.SpiralBevelGearSetParametricStudyTool]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_4418.SpringDamperParametricStudyTool]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_4421.StraightBevelDiffGearSetParametricStudyTool]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_4424.StraightBevelGearSetParametricStudyTool]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_4428.SynchroniserParametricStudyTool]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_4432.TorqueConverterParametricStudyTool]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_4435.UnbalancedMassParametricStudyTool]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_4439.WormGearSetParametricStudyTool]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_4442.ZerolBevelGearSetParametricStudyTool]":
