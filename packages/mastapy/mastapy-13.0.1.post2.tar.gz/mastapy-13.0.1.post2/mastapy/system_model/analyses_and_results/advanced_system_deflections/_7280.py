...
class AssemblyAdvancedSystemDeflection(_7270.AbstractAssemblyAdvancedSystemDeflection):
    """AssemblyAdvancedSystemDeflection
    ...
    @property
    def bearings(self: Self) -> "List[_7281.BearingAdvancedSystemDeflection]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_7283.BeltDriveAdvancedSystemDeflection]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_7293.BoltedJointAdvancedSystemDeflection]":
    ...
    @property
    def bolts(self: Self) -> "List[_7292.BoltAdvancedSystemDeflection]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_7314.CVTAdvancedSystemDeflection]":
    ...
    @property
    def clutches(self: Self) -> "List[_7294.ClutchAdvancedSystemDeflection]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_7299.ConceptCouplingAdvancedSystemDeflection]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_7317.CycloidalAssemblyAdvancedSystemDeflection]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_7323.CylindricalGearSetAdvancedSystemDeflection]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_7331.FEPartAdvancedSystemDeflection]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_7330.FaceGearSetAdvancedSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        ...
        "List[_7349.KlingelnbergCycloPalloidSpiralBevelGearSetAdvancedSystemDeflection]"
    ):
    ...
    @property
    def mass_discs(self: Self) -> "List[_7351.MassDiscAdvancedSystemDeflection]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_7354.OilSealAdvancedSystemDeflection]":
    ...
    @property
    def point_loads(self: Self) -> "List[_7362.PointLoadAdvancedSystemDeflection]":
    ...
    @property
    def power_loads(self: Self) -> "List[_7363.PowerLoadAdvancedSystemDeflection]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_7365.RingPinsAdvancedSystemDeflection]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_7372.ShaftHubConnectionAdvancedSystemDeflection]":
    ...
    @property
    def shafts(self: Self) -> "List[_7371.ShaftAdvancedSystemDeflection]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_7377.SpiralBevelGearSetAdvancedSystemDeflection]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_7389.SynchroniserAdvancedSystemDeflection]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_7402.WormGearSetAdvancedSystemDeflection]":
