...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.modal_analyses import _4711, _4710
...
class WormGearSetModalAnalysis(_4637.GearSetModalAnalysis):
    """WormGearSetModalAnalysis
    ...
    @property
    def worm_gears_modal_analysis(self: Self) -> "List[_4711.WormGearModalAnalysis]":
    ...
    def worm_meshes_modal_analysis(
        self: Self,
    ) -> "List[_4710.WormGearMeshModalAnalysis]":
