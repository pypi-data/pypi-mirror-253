...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4716
...
class AssemblyModalAnalysis(_4572.AbstractAssemblyModalAnalysis):
    """AssemblyModalAnalysis
    ...
    @property
    def bearings(self: Self) -> "List[_4580.BearingModalAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_4582.BeltDriveModalAnalysis]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_4591.BoltedJointModalAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_4592.BoltModalAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_4614.CVTModalAnalysis]":
    ...
    def calculate_full_fe_results_by_mode(
        self: Self,
    ) -> "List[_4716.CalculateFullFEResultsForMode]":
    ...
    @property
    def clutches(self: Self) -> "List[_4595.ClutchModalAnalysis]":
    ...
    @property
    def concept_couplings(self: Self) -> "List[_4600.ConceptCouplingModalAnalysis]":
    ...
    @property
    def concept_gear_sets(self: Self) -> "List[_4603.ConceptGearSetModalAnalysis]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_4616.CycloidalAssemblyModalAnalysis]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_4618.CycloidalDiscModalAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_4632.FEPartModalAnalysis]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_4631.FaceGearSetModalAnalysis]":
    ...
    def full_fe_meshes_for_calculating_modes(
        self: Self,
    ) -> "List[_4632.FEPartModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FEPartModalAnalysis]
    ...
    @property
    def hypoid_gear_sets(self: Self) -> "List[_4641.HypoidGearSetModalAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_4648.KlingelnbergCycloPalloidHypoidGearSetModalAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_4651.KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysis]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_4652.MassDiscModalAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_4660.OilSealModalAnalysis]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_4668.PlanetCarrierModalAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_4669.PointLoadModalAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_4670.PowerLoadModalAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_4672.RingPinsModalAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_4674.RollingRingAssemblyModalAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_4679.ShaftModalAnalysis]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_4688.SpringDamperModalAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_4691.StraightBevelDiffGearSetModalAnalysis]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_4698.SynchroniserModalAnalysis]":
    ...
    @property
    def torque_converters(self: Self) -> "List[_4702.TorqueConverterModalAnalysis]":
    ...
    @property
    def unbalanced_masses(self: Self) -> "List[_4705.UnbalancedMassModalAnalysis]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_4712.WormGearSetModalAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_4715.ZerolBevelGearSetModalAnalysis]":
