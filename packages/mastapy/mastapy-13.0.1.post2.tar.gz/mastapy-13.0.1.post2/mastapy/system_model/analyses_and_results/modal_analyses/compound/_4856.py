...
class ZerolBevelGearSetCompoundModalAnalysis(_4746.BevelGearSetCompoundModalAnalysis):
    """ZerolBevelGearSetCompoundModalAnalysis
    ...
    def zerol_bevel_gears_compound_modal_analysis(
        self: Self,
    ) -> "List[_4854.ZerolBevelGearCompoundModalAnalysis]":
    ...
    def zerol_bevel_meshes_compound_modal_analysis(
        self: Self,
    ) -> "List[_4855.ZerolBevelGearMeshCompoundModalAnalysis]":
