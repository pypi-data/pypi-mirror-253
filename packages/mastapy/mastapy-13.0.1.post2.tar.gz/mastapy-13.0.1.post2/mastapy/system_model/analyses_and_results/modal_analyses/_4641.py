...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.modal_analyses import _4640, _4639
...
class HypoidGearSetModalAnalysis(_4578.AGMAGleasonConicalGearSetModalAnalysis):
    """HypoidGearSetModalAnalysis
    ...
    def hypoid_gears_modal_analysis(
        self: Self,
    ) -> "List[_4640.HypoidGearModalAnalysis]":
    ...
    def hypoid_meshes_modal_analysis(
        self: Self,
    ) -> "List[_4639.HypoidGearMeshModalAnalysis]":
