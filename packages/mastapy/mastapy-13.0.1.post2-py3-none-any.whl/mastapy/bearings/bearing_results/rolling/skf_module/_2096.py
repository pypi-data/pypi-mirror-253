...
class SKFCalculationResult(_0.APIBase):
    ...
    class _Cast_SKFCalculationResult:
        ...
        def adjusted_speed(self: "SKFCalculationResult._Cast_SKFCalculationResult"):
            ...
            return self._parent._cast(_2076.AdjustedSpeed)
        ...
        def bearing_loads(self: "SKFCalculationResult._Cast_SKFCalculationResult"):
            ...
            return self._parent._cast(_2078.BearingLoads)
        ...
        def bearing_rating_life(
            ...
            return self._parent._cast(_2079.BearingRatingLife)
        ...
        def dynamic_axial_load_carrying_capacity(
            ...
            return self._parent._cast(_2080.DynamicAxialLoadCarryingCapacity)
        ...
        def frequencies(self: "SKFCalculationResult._Cast_SKFCalculationResult"):
            ...
            return self._parent._cast(_2081.Frequencies)
        ...
        def friction(self: "SKFCalculationResult._Cast_SKFCalculationResult"):
            ...
            return self._parent._cast(_2083.Friction)
        ...
        def grease(self: "SKFCalculationResult._Cast_SKFCalculationResult"):
            ...
            return self._parent._cast(_2086.Grease)
        ...
        def grease_life_and_relubrication_interval(
            ...
            return self._parent._cast(_2087.GreaseLifeAndRelubricationInterval)
        ...
        def grease_quantity(self: "SKFCalculationResult._Cast_SKFCalculationResult"):
            ...
            return self._parent._cast(_2088.GreaseQuantity)
        ...
        def initial_fill(self: "SKFCalculationResult._Cast_SKFCalculationResult"):
            ...
            return self._parent._cast(_2089.InitialFill)
        ...
        def life_model(self: "SKFCalculationResult._Cast_SKFCalculationResult"):
            ...
            return self._parent._cast(_2090.LifeModel)
        ...
        def minimum_load(self: "SKFCalculationResult._Cast_SKFCalculationResult"):
            ...
            return self._parent._cast(_2091.MinimumLoad)
        ...
        def static_safety_factors(
            ...
            return self._parent._cast(_2099.StaticSafetyFactors)
        ...
        def viscosities(self: "SKFCalculationResult._Cast_SKFCalculationResult"):
            ...
            return self._parent._cast(_2100.Viscosities)
