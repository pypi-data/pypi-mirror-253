...
class ShaftCompoundHarmonicAnalysis(_5880.AbstractShaftCompoundHarmonicAnalysis):
    """ShaftCompoundHarmonicAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_5806.ShaftHarmonicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_5806.ShaftHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.ShaftHarmonicAnalysis]
