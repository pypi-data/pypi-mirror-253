...
class PointLoadCompoundHarmonicAnalysis(_6001.VirtualComponentCompoundHarmonicAnalysis):
    """PointLoadCompoundHarmonicAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_5796.PointLoadHarmonicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_5796.PointLoadHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.PointLoadHarmonicAnalysis]
