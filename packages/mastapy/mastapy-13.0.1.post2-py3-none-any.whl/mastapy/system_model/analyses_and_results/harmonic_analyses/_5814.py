...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses import _5812, _5813
...
class SpiralBevelGearSetHarmonicAnalysis(_5697.BevelGearSetHarmonicAnalysis):
    """SpiralBevelGearSetHarmonicAnalysis
    ...
    def meshes_harmonic_analysis(
        self: Self,
    ) -> "List[_5813.SpiralBevelGearMeshHarmonicAnalysis]":
