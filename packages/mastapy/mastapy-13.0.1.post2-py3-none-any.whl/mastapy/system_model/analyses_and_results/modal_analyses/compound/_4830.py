...
class SpringDamperCompoundModalAnalysis(_4765.CouplingCompoundModalAnalysis):
    """SpringDamperCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4688.SpringDamperModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4688.SpringDamperModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.SpringDamperModalAnalysis]
