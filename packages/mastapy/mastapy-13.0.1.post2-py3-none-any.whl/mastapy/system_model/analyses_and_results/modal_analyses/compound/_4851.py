...
class WormGearCompoundModalAnalysis(_4786.GearCompoundModalAnalysis):
    """WormGearCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4711.WormGearModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4711.WormGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.WormGearModalAnalysis]
