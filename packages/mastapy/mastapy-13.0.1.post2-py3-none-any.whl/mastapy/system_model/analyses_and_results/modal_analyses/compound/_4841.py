...
class SynchroniserCompoundModalAnalysis(_4826.SpecialisedAssemblyCompoundModalAnalysis):
    """SynchroniserCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4698.SynchroniserModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4698.SynchroniserModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.SynchroniserModalAnalysis]
