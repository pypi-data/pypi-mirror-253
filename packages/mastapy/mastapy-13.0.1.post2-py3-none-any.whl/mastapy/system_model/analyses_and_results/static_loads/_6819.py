...
class AssemblyLoadCase(_6807.AbstractAssemblyLoadCase):
    """AssemblyLoadCase
    ...
    @property
    def bearings(self: Self) -> "List[_6820.BearingLoadCase]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_6822.BeltDriveLoadCase]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_6825.BevelDifferentialGearSetLoadCase]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_6831.BoltedJointLoadCase]":
    ...
    @property
    def bolts(self: Self) -> "List[_6832.BoltLoadCase]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_6856.CVTLoadCase]":
    ...
    @property
    def clutch_connections(self: Self) -> "List[_6833.ClutchConnectionLoadCase]":
    ...
    @property
    def clutches(self: Self) -> "List[_6835.ClutchLoadCase]":
    ...
    @property
    def concept_couplings(self: Self) -> "List[_6841.ConceptCouplingLoadCase]":
    ...
    @property
    def concept_gear_sets(self: Self) -> "List[_6844.ConceptGearSetLoadCase]":
    ...
    @property
    def cycloidal_assemblies(self: Self) -> "List[_6858.CycloidalAssemblyLoadCase]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_6860.CycloidalDiscLoadCase]":
    ...
    @property
    def cylindrical_gear_sets(self: Self) -> "List[_6866.CylindricalGearSetLoadCase]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_6888.FEPartLoadCase]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_6887.FaceGearSetLoadCase]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_6889.FlexiblePinAssemblyLoadCase]":
    ...
    @property
    def gear_meshes(self: Self) -> "List[_6893.GearMeshLoadCase]":
    ...
    @property
    def hypoid_gear_sets(self: Self) -> "List[_6908.HypoidGearSetLoadCase]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_6918.KlingelnbergCycloPalloidHypoidGearSetLoadCase]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_6921.KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_6922.MassDiscLoadCase]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_6923.MeasurementComponentLoadCase]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_6927.OilSealLoadCase]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_6932.PartToPartShearCouplingLoadCase]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_6936.PlanetCarrierLoadCase]":
    ...
    @property
    def point_loads(self: Self) -> "List[_6939.PointLoadLoadCase]":
    ...
    @property
    def power_loads(self: Self) -> "List[_6940.PowerLoadLoadCase]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_6944.RingPinsLoadCase]":
    ...
    def ring_pins_to_cycloidal_disc_connections(
        self: Self,
    ) -> "List[_6945.RingPinsToDiscConnectionLoadCase]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_6946.RollingRingAssemblyLoadCase]":
    ...
    @property
    def shaft_hub_connections(self: Self) -> "List[_6950.ShaftHubConnectionLoadCase]":
    ...
    @property
    def shafts(self: Self) -> "List[_6951.ShaftLoadCase]":
    ...
    @property
    def shafts_and_housings(self: Self) -> "List[_6809.AbstractShaftOrHousingLoadCase]":
    ...
    @property
    def spiral_bevel_gear_sets(self: Self) -> "List[_6956.SpiralBevelGearSetLoadCase]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_6959.SpringDamperLoadCase]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_6962.StraightBevelDiffGearSetLoadCase]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_6965.StraightBevelGearSetLoadCase]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_6969.SynchroniserLoadCase]":
    ...
    @property
    def torque_converters(self: Self) -> "List[_6974.TorqueConverterLoadCase]":
    ...
    @property
    def unbalanced_masses(self: Self) -> "List[_6981.UnbalancedMassLoadCase]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_6985.WormGearSetLoadCase]":
    ...
    @property
    def zerol_bevel_gear_sets(self: Self) -> "List[_6988.ZerolBevelGearSetLoadCase]":
