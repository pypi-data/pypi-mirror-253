...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.mbd_analyses import _5500, _5499
...
class StraightBevelGearSetMultibodyDynamicsAnalysis(
    ...
    @property
    def gears(self: Self) -> "List[_5500.StraightBevelGearMultibodyDynamicsAnalysis]":
