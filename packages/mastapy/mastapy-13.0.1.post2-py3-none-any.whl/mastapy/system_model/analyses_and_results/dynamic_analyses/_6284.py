...
class AssemblyDynamicAnalysis(_6277.AbstractAssemblyDynamicAnalysis):
    """AssemblyDynamicAnalysis
    ...
    @property
    def bearings(self: Self) -> "List[_6285.BearingDynamicAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_6287.BeltDriveDynamicAnalysis]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_6297.BoltedJointDynamicAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_6296.BoltDynamicAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_6318.CVTDynamicAnalysis]":
    ...
    @property
    def clutches(self: Self) -> "List[_6299.ClutchDynamicAnalysis]":
    ...
    @property
    def concept_couplings(self: Self) -> "List[_6304.ConceptCouplingDynamicAnalysis]":
    ...
    @property
    def concept_gear_sets(self: Self) -> "List[_6308.ConceptGearSetDynamicAnalysis]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_6322.CycloidalDiscDynamicAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_6335.FEPartDynamicAnalysis]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_6334.FaceGearSetDynamicAnalysis]":
    ...
    @property
    def hypoid_gear_sets(self: Self) -> "List[_6343.HypoidGearSetDynamicAnalysis]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_6354.MassDiscDynamicAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_6357.OilSealDynamicAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_6360.PartToPartShearCouplingDynamicAnalysis]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_6364.PlanetCarrierDynamicAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_6365.PointLoadDynamicAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_6366.PowerLoadDynamicAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_6368.RingPinsDynamicAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_6374.ShaftDynamicAnalysis]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_6382.SpringDamperDynamicAnalysis]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_6392.SynchroniserDynamicAnalysis]":
    ...
    @property
    def torque_converters(self: Self) -> "List[_6397.TorqueConverterDynamicAnalysis]":
    ...
    @property
    def unbalanced_masses(self: Self) -> "List[_6400.UnbalancedMassDynamicAnalysis]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_6404.WormGearSetDynamicAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_6407.ZerolBevelGearSetDynamicAnalysis]":
