...
class DatumCompoundDynamicAnalysis(_6433.ComponentCompoundDynamicAnalysis):
    """DatumCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_6328.DatumDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_6328.DatumDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.DatumDynamicAnalysis]
