...
class ClutchCompoundDynamicAnalysis(_6445.CouplingCompoundDynamicAnalysis):
    """ClutchCompoundDynamicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_6299.ClutchDynamicAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_6299.ClutchDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.ClutchDynamicAnalysis]
