...
class BoltCompoundDynamicAnalysis(_6433.ComponentCompoundDynamicAnalysis):
    """BoltCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_6296.BoltDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_6296.BoltDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.BoltDynamicAnalysis]
