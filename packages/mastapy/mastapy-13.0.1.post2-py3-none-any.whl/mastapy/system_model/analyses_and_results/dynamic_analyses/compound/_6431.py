...
class ClutchHalfCompoundDynamicAnalysis(_6447.CouplingHalfCompoundDynamicAnalysis):
    """ClutchHalfCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_6300.ClutchHalfDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_6300.ClutchHalfDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.ClutchHalfDynamicAnalysis]
