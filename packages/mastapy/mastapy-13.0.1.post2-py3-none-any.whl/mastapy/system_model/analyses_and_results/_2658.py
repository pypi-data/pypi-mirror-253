...
class CompoundAdvancedSystemDeflectionAnalysis(_2619.CompoundAnalysis):
    ...
    ) -> "Iterable[_7509.SpringDamperConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7524.TorqueConverterConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7407.AbstractShaftCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7406.AbstractAssemblyCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7408.AbstractShaftOrHousingCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7414.BearingCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7425.BoltCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7426.BoltedJointCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7431.ComponentCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7442.ConnectorCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7457.DatumCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7458.ExternalCADModelCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7462.FEPartCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7463.FlexiblePinAssemblyCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7413.AssemblyCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7467.GuideDxfModelCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7481.MassDiscCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7482.MeasurementComponentCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7483.MountableComponentCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7484.OilSealCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7485.PartCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7491.PlanetCarrierCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7492.PointLoadCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7493.PowerLoadCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7500.RootAssemblyCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7504.SpecialisedAssemblyCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7527.UnbalancedMassCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7528.VirtualComponentCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7501.ShaftCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7435.ConceptGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7437.ConceptGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7459.FaceGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7461.FaceGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7410.AGMAGleasonConicalGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7412.AGMAGleasonConicalGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7417.BevelDifferentialGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7419.BevelDifferentialGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7420.BevelDifferentialPlanetGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7421.BevelDifferentialSunGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7422.BevelGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7424.BevelGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7438.ConicalGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7440.ConicalGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7453.CylindricalGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7455.CylindricalGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7456.CylindricalPlanetGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7464.GearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7466.GearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7468.HypoidGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7470.HypoidGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7472.KlingelnbergCycloPalloidConicalGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7474.KlingelnbergCycloPalloidConicalGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7475.KlingelnbergCycloPalloidHypoidGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7477.KlingelnbergCycloPalloidHypoidGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7478.KlingelnbergCycloPalloidSpiralBevelGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7480.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7490.PlanetaryGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7505.SpiralBevelGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7507.SpiralBevelGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7511.StraightBevelDiffGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7513.StraightBevelDiffGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7514.StraightBevelGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7516.StraightBevelGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7517.StraightBevelPlanetGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7518.StraightBevelSunGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7529.WormGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7531.WormGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7532.ZerolBevelGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7534.ZerolBevelGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7449.CycloidalAssemblyCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7451.CycloidalDiscCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7495.RingPinsCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7486.PartToPartShearCouplingCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7488.PartToPartShearCouplingHalfCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7416.BeltDriveCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7427.ClutchCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7429.ClutchHalfCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7432.ConceptCouplingCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7434.ConceptCouplingHalfCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7443.CouplingCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7445.CouplingHalfCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7447.CVTCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7448.CVTPulleyCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7494.PulleyCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7502.ShaftHubConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7498.RollingRingCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7497.RollingRingAssemblyCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7508.SpringDamperCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7510.SpringDamperHalfCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7519.SynchroniserCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7520.SynchroniserHalfCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7521.SynchroniserPartCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7522.SynchroniserSleeveCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7523.TorqueConverterCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7525.TorqueConverterPumpCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7526.TorqueConverterTurbineCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7503.ShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7446.CVTBeltConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7415.BeltConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7430.CoaxialConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7441.ConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7471.InterMountableComponentConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7489.PlanetaryConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7499.RollingRingConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7409.AbstractShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7418.BevelDifferentialGearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7436.ConceptGearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7460.FaceGearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7512.StraightBevelDiffGearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7423.BevelGearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7439.ConicalGearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7411.AGMAGleasonConicalGearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7454.CylindricalGearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7469.HypoidGearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7473.KlingelnbergCycloPalloidConicalGearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7476.KlingelnbergCycloPalloidHypoidGearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7479.KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7506.SpiralBevelGearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7515.StraightBevelGearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7530.WormGearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7533.ZerolBevelGearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7465.GearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7450.CycloidalDiscCentralBearingConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7452.CycloidalDiscPlanetaryBearingConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7496.RingPinsToDiscConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7487.PartToPartShearCouplingConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7428.ClutchConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7433.ConceptCouplingConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7444.CouplingConnectionCompoundAdvancedSystemDeflection]":
