...
class WormGearSetCompoundPowerFlow(_4227.GearSetCompoundPowerFlow):
    """WormGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self: Self) -> "List[_4163.WormGearSetPowerFlow]":
    ...
    def worm_gears_compound_power_flow(
        self: Self,
    ) -> "List[_4290.WormGearCompoundPowerFlow]":
    ...
    def worm_meshes_compound_power_flow(
        self: Self,
    ) -> "List[_4291.WormGearMeshCompoundPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4163.WormGearSetPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearSetPowerFlow]
