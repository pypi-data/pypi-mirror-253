...
class AssemblyCompoundAdvancedTimeSteppingAnalysisForModulation(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_7017.AssemblyAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def bearings(
        self: Self,
    ) -> "List[_7149.BearingCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def belt_drives(
        self: Self,
    ) -> "List[_7151.BeltDriveCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_7154.BevelDifferentialGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def bolted_joints(
        self: Self,
    ) -> "List[_7161.BoltedJointCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def bolts(
        self: Self,
    ) -> "List[_7160.BoltCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def cv_ts(
        self: Self,
    ) -> "List[_7182.CVTCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def clutches(
        self: Self,
    ) -> "List[_7162.ClutchCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_7167.ConceptCouplingCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_7172.ConceptGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def cycloidal_assemblies(
        ...
        "List[_7184.CycloidalAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation]"
    ):
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_7186.CycloidalDiscCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_7190.CylindricalGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def fe_parts(
        self: Self,
    ) -> "List[_7197.FEPartCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_7196.FaceGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_7198.FlexiblePinAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_7205.HypoidGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_7212.KlingelnbergCycloPalloidHypoidGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_7215.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def mass_discs(
        self: Self,
    ) -> "List[_7216.MassDiscCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_7217.MeasurementComponentCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def oil_seals(
        self: Self,
    ) -> "List[_7219.OilSealCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_7221.PartToPartShearCouplingCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_7226.PlanetCarrierCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def point_loads(
        self: Self,
    ) -> "List[_7227.PointLoadCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def power_loads(
        self: Self,
    ) -> "List[_7228.PowerLoadCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def ring_pins(
        self: Self,
    ) -> "List[_7230.RingPinsCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_7232.RollingRingAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_7237.ShaftHubConnectionCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def shafts(
        self: Self,
    ) -> "List[_7236.ShaftCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_7242.SpiralBevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_7243.SpringDamperCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_7248.StraightBevelDiffGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_7251.StraightBevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_7254.SynchroniserCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_7258.TorqueConverterCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_7262.UnbalancedMassCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_7266.WormGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def zerol_bevel_gear_sets(
        ...
        "List[_7269.ZerolBevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]"
    ):
