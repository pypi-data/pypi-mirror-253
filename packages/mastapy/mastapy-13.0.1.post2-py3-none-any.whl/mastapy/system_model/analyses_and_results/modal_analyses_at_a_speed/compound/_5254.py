...
class AssemblyCompoundModalAnalysisAtASpeed(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_5124.AssemblyModalAnalysisAtASpeed]":
    ...
    @property
    def bearings(self: Self) -> "List[_5255.BearingCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_5257.BeltDriveCompoundModalAnalysisAtASpeed]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_5260.BevelDifferentialGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def bolted_joints(
        self: Self,
    ) -> "List[_5267.BoltedJointCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def bolts(self: Self) -> "List[_5266.BoltCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_5288.CVTCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def clutches(self: Self) -> "List[_5268.ClutchCompoundModalAnalysisAtASpeed]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_5273.ConceptCouplingCompoundModalAnalysisAtASpeed]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_5278.ConceptGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_5290.CycloidalAssemblyCompoundModalAnalysisAtASpeed]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_5292.CycloidalDiscCompoundModalAnalysisAtASpeed]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_5296.CylindricalGearSetCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_5303.FEPartCompoundModalAnalysisAtASpeed]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_5302.FaceGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_5304.FlexiblePinAssemblyCompoundModalAnalysisAtASpeed]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_5311.HypoidGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        ...
        "List[_5318.KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysisAtASpeed]"
    ):
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_5321.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_5322.MassDiscCompoundModalAnalysisAtASpeed]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_5323.MeasurementComponentCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_5325.OilSealCompoundModalAnalysisAtASpeed]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_5327.PartToPartShearCouplingCompoundModalAnalysisAtASpeed]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_5332.PlanetCarrierCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def point_loads(self: Self) -> "List[_5333.PointLoadCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def power_loads(self: Self) -> "List[_5334.PowerLoadCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_5336.RingPinsCompoundModalAnalysisAtASpeed]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_5338.RollingRingAssemblyCompoundModalAnalysisAtASpeed]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_5343.ShaftHubConnectionCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def shafts(self: Self) -> "List[_5342.ShaftCompoundModalAnalysisAtASpeed]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_5348.SpiralBevelGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_5349.SpringDamperCompoundModalAnalysisAtASpeed]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_5354.StraightBevelDiffGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_5357.StraightBevelGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_5360.SynchroniserCompoundModalAnalysisAtASpeed]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_5364.TorqueConverterCompoundModalAnalysisAtASpeed]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_5368.UnbalancedMassCompoundModalAnalysisAtASpeed]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_5372.WormGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_5375.ZerolBevelGearSetCompoundModalAnalysisAtASpeed]":
