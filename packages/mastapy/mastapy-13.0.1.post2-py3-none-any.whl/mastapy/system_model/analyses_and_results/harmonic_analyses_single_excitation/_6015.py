...
class AssemblyHarmonicAnalysisOfSingleExcitation(
    ...
    @property
    def bearings(self: Self) -> "List[_6016.BearingHarmonicAnalysisOfSingleExcitation]":
    ...
    @property
    def bolts(self: Self) -> "List[_6028.BoltHarmonicAnalysisOfSingleExcitation]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_6049.CVTHarmonicAnalysisOfSingleExcitation]":
    ...
    @property
    def clutches(self: Self) -> "List[_6031.ClutchHarmonicAnalysisOfSingleExcitation]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_6051.CycloidalAssemblyHarmonicAnalysisOfSingleExcitation]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_6057.CylindricalGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_6064.FEPartHarmonicAnalysisOfSingleExcitation]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_6063.FaceGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_6073.HypoidGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_6083.KlingelnbergCycloPalloidSpiralBevelGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def oil_seals(
        self: Self,
    ) -> "List[_6088.OilSealHarmonicAnalysisOfSingleExcitation]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_6092.PartToPartShearCouplingHarmonicAnalysisOfSingleExcitation]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_6095.PlanetCarrierHarmonicAnalysisOfSingleExcitation]":
    ...
    def point_loads(
        self: Self,
    ) -> "List[_6096.PointLoadHarmonicAnalysisOfSingleExcitation]":
    ...
    def power_loads(
        self: Self,
    ) -> "List[_6097.PowerLoadHarmonicAnalysisOfSingleExcitation]":
    ...
    def ring_pins(
        self: Self,
    ) -> "List[_6099.RingPinsHarmonicAnalysisOfSingleExcitation]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_6101.RollingRingAssemblyHarmonicAnalysisOfSingleExcitation]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_6106.ShaftHubConnectionHarmonicAnalysisOfSingleExcitation]":
    ...
    @property
    def shafts(self: Self) -> "List[_6105.ShaftHarmonicAnalysisOfSingleExcitation]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_6111.SpiralBevelGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_6114.SpringDamperHarmonicAnalysisOfSingleExcitation]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_6117.StraightBevelDiffGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_6120.StraightBevelGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_6124.SynchroniserHarmonicAnalysisOfSingleExcitation]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_6128.TorqueConverterHarmonicAnalysisOfSingleExcitation]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_6131.UnbalancedMassHarmonicAnalysisOfSingleExcitation]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_6135.WormGearSetHarmonicAnalysisOfSingleExcitation]":
