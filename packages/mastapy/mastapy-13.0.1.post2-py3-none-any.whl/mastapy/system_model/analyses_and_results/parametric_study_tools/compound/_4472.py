...
class ConceptGearCompoundParametricStudyTool(_4501.GearCompoundParametricStudyTool):
    """ConceptGearCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: Self) -> "_6842.ConceptGearLoadCase":
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4326.ConceptGearParametricStudyTool]":
