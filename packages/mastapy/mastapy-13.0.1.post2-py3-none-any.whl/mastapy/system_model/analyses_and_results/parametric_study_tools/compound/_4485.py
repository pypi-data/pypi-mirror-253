...
class CVTPulleyCompoundParametricStudyTool(_4531.PulleyCompoundParametricStudyTool):
    """CVTPulleyCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: Self) -> "_6857.CVTPulleyLoadCase":
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4338.CVTPulleyParametricStudyTool]":
