...
class CompoundPowerFlowAnalysis(_2619.CompoundAnalysis):
    ...
    ) -> "Iterable[_4270.SpringDamperConnectionCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4285.TorqueConverterConnectionCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4168.AbstractShaftCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4167.AbstractAssemblyCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4169.AbstractShaftOrHousingCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4175.BearingCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4186.BoltCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4187.BoltedJointCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4192.ComponentCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4203.ConnectorCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4218.DatumCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4219.ExternalCADModelCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4223.FEPartCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4224.FlexiblePinAssemblyCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4174.AssemblyCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4228.GuideDxfModelCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4242.MassDiscCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4243.MeasurementComponentCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4244.MountableComponentCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4245.OilSealCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4246.PartCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4252.PlanetCarrierCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4253.PointLoadCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4254.PowerLoadCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4261.RootAssemblyCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4265.SpecialisedAssemblyCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4288.UnbalancedMassCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4289.VirtualComponentCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4262.ShaftCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4196.ConceptGearCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4198.ConceptGearSetCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4220.FaceGearCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4222.FaceGearSetCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4171.AGMAGleasonConicalGearCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4173.AGMAGleasonConicalGearSetCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4178.BevelDifferentialGearCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4180.BevelDifferentialGearSetCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4181.BevelDifferentialPlanetGearCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4182.BevelDifferentialSunGearCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4183.BevelGearCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4185.BevelGearSetCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4199.ConicalGearCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4201.ConicalGearSetCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4214.CylindricalGearCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4216.CylindricalGearSetCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4217.CylindricalPlanetGearCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4225.GearCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4227.GearSetCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4229.HypoidGearCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4231.HypoidGearSetCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4233.KlingelnbergCycloPalloidConicalGearCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4235.KlingelnbergCycloPalloidConicalGearSetCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4236.KlingelnbergCycloPalloidHypoidGearCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4238.KlingelnbergCycloPalloidHypoidGearSetCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4239.KlingelnbergCycloPalloidSpiralBevelGearCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4241.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4251.PlanetaryGearSetCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4266.SpiralBevelGearCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4268.SpiralBevelGearSetCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4272.StraightBevelDiffGearCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4274.StraightBevelDiffGearSetCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4275.StraightBevelGearCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4277.StraightBevelGearSetCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4278.StraightBevelPlanetGearCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4279.StraightBevelSunGearCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4290.WormGearCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4292.WormGearSetCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4293.ZerolBevelGearCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4295.ZerolBevelGearSetCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4210.CycloidalAssemblyCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4212.CycloidalDiscCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4256.RingPinsCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4247.PartToPartShearCouplingCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4249.PartToPartShearCouplingHalfCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4177.BeltDriveCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4188.ClutchCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4190.ClutchHalfCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4193.ConceptCouplingCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4195.ConceptCouplingHalfCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4204.CouplingCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4206.CouplingHalfCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4208.CVTCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4209.CVTPulleyCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4255.PulleyCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4263.ShaftHubConnectionCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4259.RollingRingCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4258.RollingRingAssemblyCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4269.SpringDamperCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4271.SpringDamperHalfCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4280.SynchroniserCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4281.SynchroniserHalfCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4282.SynchroniserPartCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4283.SynchroniserSleeveCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4284.TorqueConverterCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4286.TorqueConverterPumpCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4287.TorqueConverterTurbineCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4264.ShaftToMountableComponentConnectionCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4207.CVTBeltConnectionCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4176.BeltConnectionCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4191.CoaxialConnectionCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4202.ConnectionCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4232.InterMountableComponentConnectionCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4250.PlanetaryConnectionCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4260.RollingRingConnectionCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4170.AbstractShaftToMountableComponentConnectionCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4179.BevelDifferentialGearMeshCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4197.ConceptGearMeshCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4221.FaceGearMeshCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4273.StraightBevelDiffGearMeshCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4184.BevelGearMeshCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4200.ConicalGearMeshCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4172.AGMAGleasonConicalGearMeshCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4215.CylindricalGearMeshCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4230.HypoidGearMeshCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4234.KlingelnbergCycloPalloidConicalGearMeshCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4237.KlingelnbergCycloPalloidHypoidGearMeshCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4240.KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4267.SpiralBevelGearMeshCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4276.StraightBevelGearMeshCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4291.WormGearMeshCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4294.ZerolBevelGearMeshCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4226.GearMeshCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4211.CycloidalDiscCentralBearingConnectionCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4213.CycloidalDiscPlanetaryBearingConnectionCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4257.RingPinsToDiscConnectionCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4248.PartToPartShearCouplingConnectionCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4189.ClutchConnectionCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4194.ConceptCouplingConnectionCompoundPowerFlow]":
    ...
    ) -> "Iterable[_4205.CouplingConnectionCompoundPowerFlow]":
