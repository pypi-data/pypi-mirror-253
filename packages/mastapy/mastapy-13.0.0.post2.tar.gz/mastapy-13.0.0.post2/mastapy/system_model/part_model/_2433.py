...
if TYPE_CHECKING:
    ...
    from mastapy.bearings import _1896, _1869
...
class Assembly(_2434.AbstractAssembly):
    """Assembly
    ...
    @property
    def oil_level_specification(self: Self) -> "_2465.OilLevelSpecification":
    ...
    @property
    def bearings(self: Self) -> "List[_2439.Bearing]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_2443.BoltedJoint]":
    ...
    @property
    def component_details(self: Self) -> "List[_2444.Component]":
    ...
    @property
    def components_with_unknown_scalar_mass(self: Self) -> "List[_2444.Component]":
        """List[mastapy.system_model.part_model.Component]
    ...
    @property
    def fe_parts(self: Self) -> "List[_2453.FEPart]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_2529.FaceGearSet]":
    ...
    @property
    def hypoid_gear_sets(self: Self) -> "List[_2535.HypoidGearSet]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_2466.OilSeal]":
    ...
    @property
    def point_loads(self: Self) -> "List[_2471.PointLoad]":
    ...
    @property
    def power_loads(self: Self) -> "List[_2472.PowerLoad]":
    ...
    @property
    def shaft_hub_connections(self: Self) -> "List[_2598.ShaftHubConnection]":
    ...
    @property
    def shafts(self: Self) -> "List[_2482.Shaft]":
    ...
    @property
    def spiral_bevel_gear_sets(self: Self) -> "List[_2544.SpiralBevelGearSet]":
    ...
    @property
    def straight_bevel_gear_sets(self: Self) -> "List[_2548.StraightBevelGearSet]":
    ...
    def get_part_named(self: Self, name: "str") -> "_2468.Part":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_bearing(self: Self, name: "str") -> "_2439.Bearing":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_bolt(self: Self, name: "str") -> "_2442.Bolt":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_component(self: Self, name: "str") -> "_2444.Component":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_connector(self: Self, name: "str") -> "_2447.Connector":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_datum(self: Self, name: "str") -> "_2448.Datum":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_fe_part(self: Self, name: "str") -> "_2453.FEPart":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_mass_disc(self: Self, name: "str") -> "_2462.MassDisc":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_oil_seal(self: Self, name: "str") -> "_2466.OilSeal":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_point_load(self: Self, name: "str") -> "_2471.PointLoad":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_power_load(self: Self, name: "str") -> "_2472.PowerLoad":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_shaft(self: Self, name: "str") -> "_2482.Shaft":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_bevel_gear(self: Self, name: "str") -> "_2519.BevelGear":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_face_gear(self: Self, name: "str") -> "_2528.FaceGear":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_gear(self: Self, name: "str") -> "_2530.Gear":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_gear_set(self: Self, name: "str") -> "_2532.GearSet":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_worm_gear(self: Self, name: "str") -> "_2551.WormGear":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_ring_pins(self: Self, name: "str") -> "_2570.RingPins":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_belt_drive(self: Self, name: "str") -> "_2576.BeltDrive":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_clutch(self: Self, name: "str") -> "_2578.Clutch":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_coupling(self: Self, name: "str") -> "_2583.Coupling":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_cvt(self: Self, name: "str") -> "_2586.CVT":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_cvt_pulley(self: Self, name: "str") -> "_2587.CVTPulley":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_pulley(self: Self, name: "str") -> "_2590.Pulley":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def add_bearing(self: Self, name: "str") -> "_2439.Bearing":
        """mastapy.system_model.part_model.Bearing
    ...
    def add_bearing_with_name_and_rolling_bearing_type(
        self: Self, name: "str", type_: "_1896.RollingBearingType"
    ) -> "_2439.Bearing":
        """mastapy.system_model.part_model.Bearing
    ...
    def add_bearing_with_name_rolling_bearing_type_and_designation(
        self: Self, name: "str", type_: "_1896.RollingBearingType", designation: "str"
    ) -> "_2439.Bearing":
        """mastapy.system_model.part_model.Bearing
    ...
    def add_belt_drive_with_options(
        self: Self, belt_creation_options: Optional["_2571.BeltCreationOptions"] = None
    ) -> "_2576.BeltDrive":
    ...
    @enforce_parameter_types
    def add_cvt(self: Self, name: "str" = "CVT") -> "_2586.CVT":
    ...
    @enforce_parameter_types
    def add_clutch(self: Self, name: "str" = "Clutch") -> "_2578.Clutch":
    ...
    @enforce_parameter_types
    def add_datum(self: Self, name: "str" = "Datum") -> "_2448.Datum":
    ...
    @enforce_parameter_types
    def add_fe_part(self: Self, name: "str" = "FE Part") -> "_2453.FEPart":
    ...
    @enforce_parameter_types
    def add_linear_bearing(self: Self, name: "str", width: "float") -> "_2439.Bearing":
        """mastapy.system_model.part_model.Bearing
    ...
    @enforce_parameter_types
    def add_mass_disc(self: Self, name: "str" = "Mass Disc") -> "_2462.MassDisc":
    ...
    @enforce_parameter_types
    def add_oil_seal(self: Self, name: "str" = "Oil Seal") -> "_2466.OilSeal":
    ...
    @enforce_parameter_types
    def add_point_load(self: Self, name: "str" = "Point Load") -> "_2471.PointLoad":
    ...
    @enforce_parameter_types
    def add_power_load(self: Self, name: "str" = "Power Load") -> "_2472.PowerLoad":
    ...
    def add_rolling_bearing_from_catalogue(
        self: Self, catalogue: "_1869.BearingCatalog", designation: "str", name: "str"
    ) -> "_2439.Bearing":
        """mastapy.system_model.part_model.Bearing
    ...
    def add_shaft_with_options(
        self: Self, shaft_creation_options: "_2575.ShaftCreationOptions"
    ) -> "_2482.Shaft":
    ...
    @enforce_parameter_types
    def add_shaft_hub_connection(self: Self, name: "str") -> "_2598.ShaftHubConnection":
