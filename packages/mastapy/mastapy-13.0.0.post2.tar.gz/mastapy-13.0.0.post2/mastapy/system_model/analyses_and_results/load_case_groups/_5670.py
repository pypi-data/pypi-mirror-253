...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results.static_loads import _6805, _6817
    from mastapy.system_model.analyses_and_results import _2675, _2619
...
class TimeSeriesLoadCaseGroup(_5658.AbstractLoadCaseGroup):
    """TimeSeriesLoadCaseGroup
    ...
    @property
    def load_cases(self: Self) -> "List[_6805.TimeSeriesLoadCase]":
