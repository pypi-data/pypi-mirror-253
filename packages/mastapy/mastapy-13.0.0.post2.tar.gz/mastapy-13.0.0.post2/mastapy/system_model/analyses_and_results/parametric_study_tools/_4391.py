...
class ParametricStudyVariable(_2648.AnalysisCaseVariable):
    ...
    @property
    def dimension(self: Self) -> "_4382.ParametricStudyDimension":
    ...
    def dimension(self: Self, value: "_4382.ParametricStudyDimension"):
    ...
    @property
    def distribution(self: Self) -> "_4379.MonteCarloDistribution":
    ...
    @distribution.setter
    @enforce_parameter_types
    def distribution(self: Self, value: "_4379.MonteCarloDistribution"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ParametricStudyTools.MonteCarloDistribution",
        )
    ...
    @property
    def doe_variable_setter(self: Self) -> "_4347.DesignOfExperimentsVariableSetter":
