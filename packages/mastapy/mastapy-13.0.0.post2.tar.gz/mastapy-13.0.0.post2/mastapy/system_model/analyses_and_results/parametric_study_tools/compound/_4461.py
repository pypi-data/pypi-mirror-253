...
class BoltCompoundParametricStudyTool(_4467.ComponentCompoundParametricStudyTool):
    """BoltCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: Self) -> "_6831.BoltLoadCase":
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4315.BoltParametricStudyTool]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4315.BoltParametricStudyTool]":
        """List[mastapy.system_model.analyses_and_results.parametric_study_tools.BoltParametricStudyTool]
