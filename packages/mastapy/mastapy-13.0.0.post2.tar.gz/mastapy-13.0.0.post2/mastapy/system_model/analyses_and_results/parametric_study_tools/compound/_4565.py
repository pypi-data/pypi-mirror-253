...
class WormGearCompoundParametricStudyTool(_4500.GearCompoundParametricStudyTool):
    """WormGearCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: Self) -> "_6982.WormGearLoadCase":
