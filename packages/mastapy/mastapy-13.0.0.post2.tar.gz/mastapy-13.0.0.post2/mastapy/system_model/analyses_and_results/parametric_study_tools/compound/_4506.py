...
class HypoidGearSetCompoundParametricStudyTool(
    ...
    @property
    def properties_changing_all_load_cases(self: Self) -> "_6907.HypoidGearSetLoadCase":
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4366.HypoidGearSetParametricStudyTool]":
    ...
    def hypoid_gears_compound_parametric_study_tool(
        self: Self,
    ) -> "List[_4504.HypoidGearCompoundParametricStudyTool]":
    ...
    def hypoid_meshes_compound_parametric_study_tool(
        self: Self,
    ) -> "List[_4505.HypoidGearMeshCompoundParametricStudyTool]":
