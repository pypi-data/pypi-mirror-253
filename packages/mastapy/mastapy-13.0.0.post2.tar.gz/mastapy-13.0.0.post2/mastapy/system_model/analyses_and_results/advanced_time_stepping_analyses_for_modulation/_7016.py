...
class AssemblyAdvancedTimeSteppingAnalysisForModulation(
    ...
    def bearings(
        self: Self,
    ) -> "List[_7018.BearingAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def bolts(
        self: Self,
    ) -> "List[_7029.BoltAdvancedTimeSteppingAnalysisForModulation]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_7050.CVTAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def clutches(
        self: Self,
    ) -> "List[_7031.ClutchAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_7041.ConceptGearSetAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_7053.CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_7059.CylindricalGearSetAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_7067.FlexiblePinAssemblyAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_7082.KlingelnbergCycloPalloidHypoidGearSetAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_7085.KlingelnbergCycloPalloidSpiralBevelGearSetAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def mass_discs(
        self: Self,
    ) -> "List[_7086.MassDiscAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def oil_seals(
        self: Self,
    ) -> "List[_7089.OilSealAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_7103.RollingRingAssemblyAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def straight_bevel_diff_gear_sets(
        ...
        "List[_7118.StraightBevelDiffGearSetAdvancedTimeSteppingAnalysisForModulation]"
    ):
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_7124.SynchroniserAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_7136.WormGearSetAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_7139.ZerolBevelGearSetAdvancedTimeSteppingAnalysisForModulation]":
