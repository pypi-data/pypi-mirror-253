...
class WormGearSetCompoundSystemDeflection(_2912.GearSetCompoundSystemDeflection):
    """WormGearSetCompoundSystemDeflection
    ...
    def worm_gears_compound_system_deflection(
        self: Self,
    ) -> "List[_2976.WormGearCompoundSystemDeflection]":
    ...
    def worm_meshes_compound_system_deflection(
        self: Self,
    ) -> "List[_2977.WormGearMeshCompoundSystemDeflection]":
