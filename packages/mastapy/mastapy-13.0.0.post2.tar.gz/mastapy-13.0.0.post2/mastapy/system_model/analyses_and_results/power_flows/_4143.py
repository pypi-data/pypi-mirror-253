...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.power_flows import _4142, _4141
...
class StraightBevelDiffGearSetPowerFlow(_4050.BevelGearSetPowerFlow):
    """StraightBevelDiffGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self: Self) -> "List[_4142.StraightBevelDiffGearPowerFlow]":
    ...
    def meshes_power_flow(
        self: Self,
    ) -> "List[_4141.StraightBevelDiffGearMeshPowerFlow]":
