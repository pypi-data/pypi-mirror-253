...
class AssemblyCompoundSteadyStateSynchronousResponseOnAShaft(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_3252.AssemblySteadyStateSynchronousResponseOnAShaft]":
    ...
    def bearings(
        self: Self,
    ) -> "List[_3383.BearingCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def belt_drives(
        self: Self,
    ) -> "List[_3385.BeltDriveCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_3388.BevelDifferentialGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def bolted_joints(
        self: Self,
    ) -> "List[_3395.BoltedJointCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def bolts(
        self: Self,
    ) -> "List[_3394.BoltCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def cv_ts(
        self: Self,
    ) -> "List[_3416.CVTCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def clutches(
        self: Self,
    ) -> "List[_3396.ClutchCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_3401.ConceptCouplingCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_3406.ConceptGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_3418.CycloidalAssemblyCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_3420.CycloidalDiscCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_3424.CylindricalGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def fe_parts(
        self: Self,
    ) -> "List[_3431.FEPartCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_3430.FaceGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def flexible_pin_assemblies(
        ...
        "List[_3432.FlexiblePinAssemblyCompoundSteadyStateSynchronousResponseOnAShaft]"
    ):
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_3439.HypoidGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_3446.KlingelnbergCycloPalloidHypoidGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_3449.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def mass_discs(
        self: Self,
    ) -> "List[_3450.MassDiscCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def measurement_components(
        ...
        "List[_3451.MeasurementComponentCompoundSteadyStateSynchronousResponseOnAShaft]"
    ):
    ...
    def oil_seals(
        self: Self,
    ) -> "List[_3453.OilSealCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_3455.PartToPartShearCouplingCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_3460.PlanetCarrierCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def point_loads(
        self: Self,
    ) -> "List[_3461.PointLoadCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def power_loads(
        self: Self,
    ) -> "List[_3462.PowerLoadCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def ring_pins(
        self: Self,
    ) -> "List[_3464.RingPinsCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def rolling_ring_assemblies(
        ...
        "List[_3466.RollingRingAssemblyCompoundSteadyStateSynchronousResponseOnAShaft]"
    ):
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_3471.ShaftHubConnectionCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def shafts(
        self: Self,
    ) -> "List[_3470.ShaftCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_3476.SpiralBevelGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_3477.SpringDamperCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_3482.StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def straight_bevel_gear_sets(
        ...
        "List[_3485.StraightBevelGearSetCompoundSteadyStateSynchronousResponseOnAShaft]"
    ):
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_3488.SynchroniserCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_3492.TorqueConverterCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_3496.UnbalancedMassCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_3500.WormGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_3503.ZerolBevelGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
