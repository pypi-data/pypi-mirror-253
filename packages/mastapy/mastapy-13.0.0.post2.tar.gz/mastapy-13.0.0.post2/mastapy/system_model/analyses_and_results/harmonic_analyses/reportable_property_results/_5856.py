...
class FEPartHarmonicAnalysisResultsPropertyAccessor(
    ...
    class _Cast_FEPartHarmonicAnalysisResultsPropertyAccessor:
        ...
        def harmonic_analysis_results_property_accessor(
            ...
            return self._parent._cast(_5864.HarmonicAnalysisResultsPropertyAccessor)
    ...
    @property
    def combined_orders(self: Self) -> "_5866.ResultsForMultipleOrdersForFESurface":
    ...
    def excitations(
        self: Self,
    ) -> "List[_5857.FEPartSingleWhineAnalysisResultsPropertyAccessor]":
    ...
    def orders_for_combined_excitations(
        self: Self,
    ) -> "List[_5871.ResultsForOrderIncludingSurfaces]":
