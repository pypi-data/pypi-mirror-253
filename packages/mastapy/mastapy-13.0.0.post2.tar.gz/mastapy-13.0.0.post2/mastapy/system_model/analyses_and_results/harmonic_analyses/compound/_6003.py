...
class WormGearSetCompoundHarmonicAnalysis(_5938.GearSetCompoundHarmonicAnalysis):
    """WormGearSetCompoundHarmonicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_5839.WormGearSetHarmonicAnalysis]":
    ...
    def worm_gears_compound_harmonic_analysis(
        self: Self,
    ) -> "List[_6001.WormGearCompoundHarmonicAnalysis]":
    ...
    def worm_meshes_compound_harmonic_analysis(
        self: Self,
    ) -> "List[_6002.WormGearMeshCompoundHarmonicAnalysis]":
