...
class ConceptGearCompoundModalAnalysis(_4785.GearCompoundModalAnalysis):
    """ConceptGearCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4601.ConceptGearModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4601.ConceptGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.ConceptGearModalAnalysis]
