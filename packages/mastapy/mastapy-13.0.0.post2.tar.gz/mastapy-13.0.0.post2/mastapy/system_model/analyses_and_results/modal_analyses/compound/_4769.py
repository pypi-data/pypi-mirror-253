...
class CVTPulleyCompoundModalAnalysis(_4815.PulleyCompoundModalAnalysis):
    """CVTPulleyCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4614.CVTPulleyModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4614.CVTPulleyModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.CVTPulleyModalAnalysis]
