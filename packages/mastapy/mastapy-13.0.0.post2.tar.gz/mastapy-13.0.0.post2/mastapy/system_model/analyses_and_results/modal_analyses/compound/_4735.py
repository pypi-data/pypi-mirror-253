...
class BearingCompoundModalAnalysis(_4763.ConnectorCompoundModalAnalysis):
    """BearingCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4579.BearingModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4579.BearingModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.BearingModalAnalysis]
