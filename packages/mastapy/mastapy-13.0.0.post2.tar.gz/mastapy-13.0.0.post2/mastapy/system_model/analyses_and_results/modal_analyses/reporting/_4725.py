...
class SingleExcitationResultsModalAnalysis(_4718.DesignEntityModalAnalysisGroupResults):
    """SingleExcitationResultsModalAnalysis
    ...
    class _Cast_SingleExcitationResultsModalAnalysis:
        ...
        def design_entity_modal_analysis_group_results(
            ...
            return self._parent._cast(_4718.DesignEntityModalAnalysisGroupResults)
    ...
    def all_rigidly_connected_groups(
        ...
        "List[_4721.RigidlyConnectedDesignEntityGroupForSingleExcitationModalAnalysis]"
    ):
