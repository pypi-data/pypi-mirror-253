...
class ConceptGearSetCompoundModalAnalysis(_4787.GearSetCompoundModalAnalysis):
    """ConceptGearSetCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4602.ConceptGearSetModalAnalysis]":
    ...
    def concept_gears_compound_modal_analysis(
        self: Self,
    ) -> "List[_4756.ConceptGearCompoundModalAnalysis]":
    ...
    def concept_meshes_compound_modal_analysis(
        self: Self,
    ) -> "List[_4757.ConceptGearMeshCompoundModalAnalysis]":
