...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.modal_analyses import _4639, _4638
...
class HypoidGearSetModalAnalysis(_4577.AGMAGleasonConicalGearSetModalAnalysis):
    """HypoidGearSetModalAnalysis
    ...
    def hypoid_gears_modal_analysis(
        self: Self,
    ) -> "List[_4639.HypoidGearModalAnalysis]":
    ...
    def hypoid_meshes_modal_analysis(
        self: Self,
    ) -> "List[_4638.HypoidGearMeshModalAnalysis]":
