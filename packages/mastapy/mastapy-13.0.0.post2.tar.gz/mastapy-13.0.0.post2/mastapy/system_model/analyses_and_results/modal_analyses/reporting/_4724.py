...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4717
...
class ShaftPerModeResult(_4717.ComponentPerModeResult):
    """ShaftPerModeResult
    ...
    class _Cast_ShaftPerModeResult:
        ...
        def component_per_mode_result(
            ...
            return self._parent._cast(_4717.ComponentPerModeResult)
