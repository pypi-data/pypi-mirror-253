...
class FaceGearCompoundDynamicAnalysis(_6465.GearCompoundDynamicAnalysis):
    """FaceGearCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_6331.FaceGearDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_6331.FaceGearDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.FaceGearDynamicAnalysis]
