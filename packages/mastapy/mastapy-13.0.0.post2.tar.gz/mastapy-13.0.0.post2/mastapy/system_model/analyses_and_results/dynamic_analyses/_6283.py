...
class AssemblyDynamicAnalysis(_6276.AbstractAssemblyDynamicAnalysis):
    """AssemblyDynamicAnalysis
    ...
    @property
    def bearings(self: Self) -> "List[_6284.BearingDynamicAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_6286.BeltDriveDynamicAnalysis]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_6296.BoltedJointDynamicAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_6295.BoltDynamicAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_6317.CVTDynamicAnalysis]":
    ...
    @property
    def clutches(self: Self) -> "List[_6298.ClutchDynamicAnalysis]":
    ...
    @property
    def concept_couplings(self: Self) -> "List[_6303.ConceptCouplingDynamicAnalysis]":
    ...
    @property
    def concept_gear_sets(self: Self) -> "List[_6307.ConceptGearSetDynamicAnalysis]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_6321.CycloidalDiscDynamicAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_6334.FEPartDynamicAnalysis]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_6333.FaceGearSetDynamicAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_6335.FlexiblePinAssemblyDynamicAnalysis]":
    ...
    @property
    def hypoid_gear_sets(self: Self) -> "List[_6342.HypoidGearSetDynamicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_6352.KlingelnbergCycloPalloidSpiralBevelGearSetDynamicAnalysis]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_6353.MassDiscDynamicAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_6356.OilSealDynamicAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_6359.PartToPartShearCouplingDynamicAnalysis]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_6363.PlanetCarrierDynamicAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_6364.PointLoadDynamicAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_6365.PowerLoadDynamicAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_6367.RingPinsDynamicAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_6369.RollingRingAssemblyDynamicAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_6373.ShaftDynamicAnalysis]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_6381.SpringDamperDynamicAnalysis]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_6391.SynchroniserDynamicAnalysis]":
    ...
    @property
    def torque_converters(self: Self) -> "List[_6396.TorqueConverterDynamicAnalysis]":
    ...
    @property
    def unbalanced_masses(self: Self) -> "List[_6399.UnbalancedMassDynamicAnalysis]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_6403.WormGearSetDynamicAnalysis]":
