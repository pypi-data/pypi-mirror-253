...
class AssemblyMultibodyDynamicsAnalysis(
    ...
    @property
    def bearings(self: Self) -> "List[_5384.BearingMultibodyDynamicsAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_5387.BeltDriveMultibodyDynamicsAnalysis]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_5396.BoltedJointMultibodyDynamicsAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_5397.BoltMultibodyDynamicsAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_5419.CVTMultibodyDynamicsAnalysis]":
    ...
    @property
    def clutches(self: Self) -> "List[_5400.ClutchMultibodyDynamicsAnalysis]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_5406.ConceptCouplingMultibodyDynamicsAnalysis]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_5421.CycloidalAssemblyMultibodyDynamicsAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_5434.FEPartMultibodyDynamicsAnalysis]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_5433.FaceGearSetMultibodyDynamicsAnalysis]":
    ...
    @property
    def gear_sets(self: Self) -> "List[_5439.GearSetMultibodyDynamicsAnalysis]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_5458.MassDiscMultibodyDynamicsAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_5465.OilSealMultibodyDynamicsAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_5469.PartToPartShearCouplingMultibodyDynamicsAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_5473.PointLoadMultibodyDynamicsAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_5474.PowerLoadMultibodyDynamicsAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_5476.RingPinsMultibodyDynamicsAnalysis]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_5484.ShaftHubConnectionMultibodyDynamicsAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_5485.ShaftMultibodyDynamicsAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_5500.StraightBevelGearSetMultibodyDynamicsAnalysis]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_5513.UnbalancedMassMultibodyDynamicsAnalysis]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_5518.WormGearSetMultibodyDynamicsAnalysis]":
