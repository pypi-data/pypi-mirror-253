...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.mbd_analyses import _5432, _5431
...
class FaceGearSetMultibodyDynamicsAnalysis(_5439.GearSetMultibodyDynamicsAnalysis):
    """FaceGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self: Self) -> "List[_5432.FaceGearMultibodyDynamicsAnalysis]":
