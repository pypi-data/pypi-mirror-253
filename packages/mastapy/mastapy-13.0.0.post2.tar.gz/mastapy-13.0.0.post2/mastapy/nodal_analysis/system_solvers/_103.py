...
class DynamicSolver(_117.StiffnessSolver):
    ...
    class _Cast_DynamicSolver:
        ...
        @property
        def stiffness_solver(self: "DynamicSolver._Cast_DynamicSolver"):
            return self._parent._cast(_117.StiffnessSolver)

        @property
        def solver(self: "DynamicSolver._Cast_DynamicSolver"):
        ...
        @property
        def newmark_transient_solver(self: "DynamicSolver._Cast_DynamicSolver"):
            from mastapy.nodal_analysis.system_solvers import _108

            return self._parent._cast(_108.NewmarkTransientSolver)

        @property
        def semi_implicit_transient_solver(self: "DynamicSolver._Cast_DynamicSolver"):
