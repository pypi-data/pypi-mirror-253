...
from mastapy.system_model.analyses_and_results.static_loads import _6977, _6981
...
class PowerLoadLoadCase(_6981.VirtualComponentLoadCase):
    """PowerLoadLoadCase
    ...
    @enforce_parameter_types
    def system_deflection_torque_method(
        self: Self, value: "_6977.TorqueSpecificationForSystemDeflection"
    ):
    ...
    @property
    def wheel_slip_model(self: Self) -> "_5515.WheelSlipType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.mbd_analyses._5515",
            "WheelSlipType",
        )(value)

    @wheel_slip_model.setter
    @enforce_parameter_types
    def wheel_slip_model(self: Self, value: "_5515.WheelSlipType"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.WheelSlipType",
        )
