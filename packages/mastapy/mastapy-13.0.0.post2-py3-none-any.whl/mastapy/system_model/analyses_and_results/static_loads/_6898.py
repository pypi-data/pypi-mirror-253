...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results.static_loads import _6868, _6880
...
class HarmonicLoadDataCSVImport(_6902.HarmonicLoadDataImportFromMotorPackages[T]):
    """HarmonicLoadDataCSVImport
    ...
    def electric_machine_data_per_speed(
        self: Self,
    ) -> "List[_6868.DataFromMotorPackagePerSpeed]":
