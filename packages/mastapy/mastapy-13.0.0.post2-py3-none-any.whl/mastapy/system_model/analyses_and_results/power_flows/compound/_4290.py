...
class WormGearMeshCompoundPowerFlow(_4225.GearMeshCompoundPowerFlow):
    """WormGearMeshCompoundPowerFlow
    ...
    def connection_analysis_cases_ready(
        self: Self,
    ) -> "List[_4160.WormGearMeshPowerFlow]":
    ...
    @property
    def connection_analysis_cases(self: Self) -> "List[_4160.WormGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearMeshPowerFlow]
