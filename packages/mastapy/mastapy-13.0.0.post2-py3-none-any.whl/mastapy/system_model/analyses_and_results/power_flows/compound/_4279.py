...
class SynchroniserCompoundPowerFlow(_4264.SpecialisedAssemblyCompoundPowerFlow):
    """SynchroniserCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4151.SynchroniserPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4151.SynchroniserPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.SynchroniserPowerFlow]
