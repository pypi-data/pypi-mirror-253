...
class WormGearSetCompoundPowerFlow(_4226.GearSetCompoundPowerFlow):
    """WormGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self: Self) -> "List[_4162.WormGearSetPowerFlow]":
    ...
    def worm_gears_compound_power_flow(
        self: Self,
    ) -> "List[_4289.WormGearCompoundPowerFlow]":
    ...
    def worm_meshes_compound_power_flow(
        self: Self,
    ) -> "List[_4290.WormGearMeshCompoundPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4162.WormGearSetPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearSetPowerFlow]
