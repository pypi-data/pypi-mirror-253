...
class AssemblyCompoundModalAnalysisAtASpeed(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_5123.AssemblyModalAnalysisAtASpeed]":
    ...
    @property
    def bearings(self: Self) -> "List[_5254.BearingCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_5256.BeltDriveCompoundModalAnalysisAtASpeed]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_5259.BevelDifferentialGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def bolted_joints(
        self: Self,
    ) -> "List[_5266.BoltedJointCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def bolts(self: Self) -> "List[_5265.BoltCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_5287.CVTCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def clutches(self: Self) -> "List[_5267.ClutchCompoundModalAnalysisAtASpeed]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_5272.ConceptCouplingCompoundModalAnalysisAtASpeed]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_5277.ConceptGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_5289.CycloidalAssemblyCompoundModalAnalysisAtASpeed]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_5291.CycloidalDiscCompoundModalAnalysisAtASpeed]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_5295.CylindricalGearSetCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_5302.FEPartCompoundModalAnalysisAtASpeed]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_5301.FaceGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_5303.FlexiblePinAssemblyCompoundModalAnalysisAtASpeed]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_5310.HypoidGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        ...
        "List[_5317.KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysisAtASpeed]"
    ):
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_5320.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_5321.MassDiscCompoundModalAnalysisAtASpeed]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_5322.MeasurementComponentCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_5324.OilSealCompoundModalAnalysisAtASpeed]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_5326.PartToPartShearCouplingCompoundModalAnalysisAtASpeed]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_5331.PlanetCarrierCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def point_loads(self: Self) -> "List[_5332.PointLoadCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def power_loads(self: Self) -> "List[_5333.PowerLoadCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_5335.RingPinsCompoundModalAnalysisAtASpeed]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_5337.RollingRingAssemblyCompoundModalAnalysisAtASpeed]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_5342.ShaftHubConnectionCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def shafts(self: Self) -> "List[_5341.ShaftCompoundModalAnalysisAtASpeed]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_5347.SpiralBevelGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_5348.SpringDamperCompoundModalAnalysisAtASpeed]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_5353.StraightBevelDiffGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_5356.StraightBevelGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_5359.SynchroniserCompoundModalAnalysisAtASpeed]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_5363.TorqueConverterCompoundModalAnalysisAtASpeed]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_5367.UnbalancedMassCompoundModalAnalysisAtASpeed]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_5371.WormGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_5374.ZerolBevelGearSetCompoundModalAnalysisAtASpeed]":
