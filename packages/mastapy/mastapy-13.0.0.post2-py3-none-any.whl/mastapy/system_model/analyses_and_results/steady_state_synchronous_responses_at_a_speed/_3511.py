...
class AssemblySteadyStateSynchronousResponseAtASpeed(
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_3516.BevelDifferentialGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    @property
    def bolts(self: Self) -> "List[_3524.BoltSteadyStateSynchronousResponseAtASpeed]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_3546.CVTSteadyStateSynchronousResponseAtASpeed]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_3534.ConceptGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_3547.CycloidalAssemblySteadyStateSynchronousResponseAtASpeed]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_3552.CylindricalGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_3574.KlingelnbergCycloPalloidHypoidGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_3580.MeasurementComponentSteadyStateSynchronousResponseAtASpeed]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_3586.PartToPartShearCouplingSteadyStateSynchronousResponseAtASpeed]":
    ...
    def ring_pins(
        self: Self,
    ) -> "List[_3593.RingPinsSteadyStateSynchronousResponseAtASpeed]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_3599.ShaftHubConnectionSteadyStateSynchronousResponseAtASpeed]":
    ...
    @property
    def shafts(self: Self) -> "List[_3600.ShaftSteadyStateSynchronousResponseAtASpeed]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_3604.SpiralBevelGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_3608.SpringDamperSteadyStateSynchronousResponseAtASpeed]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_3611.StraightBevelDiffGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_3624.TorqueConverterSteadyStateSynchronousResponseAtASpeed]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_3629.WormGearSetSteadyStateSynchronousResponseAtASpeed]":
