...
class AssemblyCompoundSteadyStateSynchronousResponseAtASpeed(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_3511.AssemblySteadyStateSynchronousResponseAtASpeed]":
    ...
    def bearings(
        self: Self,
    ) -> "List[_3642.BearingCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def belt_drives(
        self: Self,
    ) -> "List[_3644.BeltDriveCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_3647.BevelDifferentialGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def bolted_joints(
        self: Self,
    ) -> "List[_3654.BoltedJointCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def bolts(
        self: Self,
    ) -> "List[_3653.BoltCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cv_ts(
        self: Self,
    ) -> "List[_3675.CVTCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def clutches(
        self: Self,
    ) -> "List[_3655.ClutchCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_3660.ConceptCouplingCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_3665.ConceptGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_3677.CycloidalAssemblyCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_3679.CycloidalDiscCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_3683.CylindricalGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def fe_parts(
        self: Self,
    ) -> "List[_3690.FEPartCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_3689.FaceGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def flexible_pin_assemblies(
        ...
        "List[_3691.FlexiblePinAssemblyCompoundSteadyStateSynchronousResponseAtASpeed]"
    ):
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_3698.HypoidGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_3705.KlingelnbergCycloPalloidHypoidGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_3708.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def mass_discs(
        self: Self,
    ) -> "List[_3709.MassDiscCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def measurement_components(
        ...
        "List[_3710.MeasurementComponentCompoundSteadyStateSynchronousResponseAtASpeed]"
    ):
    ...
    def oil_seals(
        self: Self,
    ) -> "List[_3712.OilSealCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_3714.PartToPartShearCouplingCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_3719.PlanetCarrierCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def point_loads(
        self: Self,
    ) -> "List[_3720.PointLoadCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def power_loads(
        self: Self,
    ) -> "List[_3721.PowerLoadCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def ring_pins(
        self: Self,
    ) -> "List[_3723.RingPinsCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def rolling_ring_assemblies(
        ...
        "List[_3725.RollingRingAssemblyCompoundSteadyStateSynchronousResponseAtASpeed]"
    ):
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_3730.ShaftHubConnectionCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def shafts(
        self: Self,
    ) -> "List[_3729.ShaftCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_3735.SpiralBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_3736.SpringDamperCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_3741.StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def straight_bevel_gear_sets(
        ...
        "List[_3744.StraightBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed]"
    ):
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_3747.SynchroniserCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_3751.TorqueConverterCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_3755.UnbalancedMassCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_3759.WormGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_3762.ZerolBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
