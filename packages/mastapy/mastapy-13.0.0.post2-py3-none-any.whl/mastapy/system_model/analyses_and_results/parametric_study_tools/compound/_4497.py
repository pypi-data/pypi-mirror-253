...
class FaceGearSetCompoundParametricStudyTool(_4502.GearSetCompoundParametricStudyTool):
    """FaceGearSetCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: Self) -> "_6886.FaceGearSetLoadCase":
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4357.FaceGearSetParametricStudyTool]":
    ...
    def face_gears_compound_parametric_study_tool(
        self: Self,
    ) -> "List[_4495.FaceGearCompoundParametricStudyTool]":
    ...
    def face_meshes_compound_parametric_study_tool(
        self: Self,
    ) -> "List[_4496.FaceGearMeshCompoundParametricStudyTool]":
