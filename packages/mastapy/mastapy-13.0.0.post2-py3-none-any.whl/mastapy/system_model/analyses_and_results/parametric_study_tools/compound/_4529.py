...
class PowerLoadCompoundParametricStudyTool(
    ...
    @property
    def properties_changing_all_load_cases(self: Self) -> "_6939.PowerLoadLoadCase":
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4400.PowerLoadParametricStudyTool]":
    ...
    @property
    def load_cases(self: Self) -> "List[_6939.PowerLoadLoadCase]":
