...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses import _5689, _5690
...
class BevelDifferentialGearSetHarmonicAnalysis(_5696.BevelGearSetHarmonicAnalysis):
    """BevelDifferentialGearSetHarmonicAnalysis
    ...
    def meshes_harmonic_analysis(
        self: Self,
    ) -> "List[_5690.BevelDifferentialGearMeshHarmonicAnalysis]":
