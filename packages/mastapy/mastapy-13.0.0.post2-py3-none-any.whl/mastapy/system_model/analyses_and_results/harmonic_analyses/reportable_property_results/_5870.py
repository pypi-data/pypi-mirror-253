...
class ResultsForOrderIncludingNodes(_5868.ResultsForOrder):
    """ResultsForOrderIncludingNodes
    ...
    class _Cast_ResultsForOrderIncludingNodes:
        ...
        def results_for_order_including_surfaces(
            ...
            return self._parent._cast(_5871.ResultsForOrderIncludingSurfaces)
    ...
    def node_results_global_coordinate_system(
        self: Self,
    ) -> "List[_5862.HarmonicAnalysisResultsBrokenDownByNodeWithinAHarmonic]":
