...
class GearMeshExcitationDetail(_5678.AbstractPeriodicExcitationDetail):
    """GearMeshExcitationDetail
    ...
    @property
    def gear_mesh(self: Self) -> "_2759.GearMeshSystemDeflection":
    ...
    def get_compliance_and_force_data(self: Self) -> "_5703.ComplianceAndForceData":
