...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.dynamic_analyses import _6340, _6341
...
class HypoidGearSetDynamicAnalysis(_6282.AGMAGleasonConicalGearSetDynamicAnalysis):
    """HypoidGearSetDynamicAnalysis
    ...
    def hypoid_gears_dynamic_analysis(
        self: Self,
    ) -> "List[_6340.HypoidGearDynamicAnalysis]":
