...
class AssemblyCompoundDynamicAnalysis(_6407.AbstractAssemblyCompoundDynamicAnalysis):
    """AssemblyCompoundDynamicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_6283.AssemblyDynamicAnalysis]":
    ...
    @property
    def bearings(self: Self) -> "List[_6415.BearingCompoundDynamicAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_6417.BeltDriveCompoundDynamicAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_6420.BevelDifferentialGearSetCompoundDynamicAnalysis]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_6427.BoltedJointCompoundDynamicAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_6426.BoltCompoundDynamicAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_6448.CVTCompoundDynamicAnalysis]":
    ...
    @property
    def clutches(self: Self) -> "List[_6428.ClutchCompoundDynamicAnalysis]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_6433.ConceptCouplingCompoundDynamicAnalysis]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_6438.ConceptGearSetCompoundDynamicAnalysis]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_6450.CycloidalAssemblyCompoundDynamicAnalysis]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_6452.CycloidalDiscCompoundDynamicAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_6456.CylindricalGearSetCompoundDynamicAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_6463.FEPartCompoundDynamicAnalysis]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_6462.FaceGearSetCompoundDynamicAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_6464.FlexiblePinAssemblyCompoundDynamicAnalysis]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_6471.HypoidGearSetCompoundDynamicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_6478.KlingelnbergCycloPalloidHypoidGearSetCompoundDynamicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        ...
        "List[_6481.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundDynamicAnalysis]"
    ):
    ...
    @property
    def mass_discs(self: Self) -> "List[_6482.MassDiscCompoundDynamicAnalysis]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_6483.MeasurementComponentCompoundDynamicAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_6485.OilSealCompoundDynamicAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_6487.PartToPartShearCouplingCompoundDynamicAnalysis]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_6492.PlanetCarrierCompoundDynamicAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_6493.PointLoadCompoundDynamicAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_6494.PowerLoadCompoundDynamicAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_6496.RingPinsCompoundDynamicAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_6498.RollingRingAssemblyCompoundDynamicAnalysis]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_6503.ShaftHubConnectionCompoundDynamicAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_6502.ShaftCompoundDynamicAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_6508.SpiralBevelGearSetCompoundDynamicAnalysis]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_6509.SpringDamperCompoundDynamicAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_6514.StraightBevelDiffGearSetCompoundDynamicAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_6517.StraightBevelGearSetCompoundDynamicAnalysis]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_6520.SynchroniserCompoundDynamicAnalysis]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_6524.TorqueConverterCompoundDynamicAnalysis]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_6528.UnbalancedMassCompoundDynamicAnalysis]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_6532.WormGearSetCompoundDynamicAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_6535.ZerolBevelGearSetCompoundDynamicAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_6283.AssemblyDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.AssemblyDynamicAnalysis]
