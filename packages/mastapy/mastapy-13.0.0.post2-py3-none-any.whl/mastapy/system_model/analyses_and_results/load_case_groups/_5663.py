...
class DutyCycle(_5659.AbstractStaticLoadCaseGroup):
    """DutyCycle
    ...
    def duty_cycle_design_states(
        self: Self,
    ) -> "List[_5666.SubGroupInSingleDesignState]":
    ...
    @property
    def time_series_importer(self: Self) -> "_7001.TimeSeriesImporter":
    ...
    def add_static_load(self: Self, static_load: "_6804.StaticLoadCase"):
        """Method does not return.
    ...
    def remove_design_state_sub_group(
        self: Self, sub_group: "_5666.SubGroupInSingleDesignState"
    ):
        """Method does not return.
