...
class CompoundAdvancedSystemDeflectionAnalysis(_2619.CompoundAnalysis):
    """CompoundAdvancedSystemDeflectionAnalysis
    ...
    ) -> "Iterable[_7508.SpringDamperConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7523.TorqueConverterConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7406.AbstractShaftCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7405.AbstractAssemblyCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7407.AbstractShaftOrHousingCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7413.BearingCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7424.BoltCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7425.BoltedJointCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7430.ComponentCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7441.ConnectorCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7456.DatumCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7457.ExternalCADModelCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7461.FEPartCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7462.FlexiblePinAssemblyCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7412.AssemblyCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7466.GuideDxfModelCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7480.MassDiscCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7481.MeasurementComponentCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7482.MountableComponentCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7483.OilSealCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7484.PartCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7490.PlanetCarrierCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7491.PointLoadCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7492.PowerLoadCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7499.RootAssemblyCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7503.SpecialisedAssemblyCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7526.UnbalancedMassCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7527.VirtualComponentCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7500.ShaftCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7434.ConceptGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7436.ConceptGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7458.FaceGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7460.FaceGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7409.AGMAGleasonConicalGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7411.AGMAGleasonConicalGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7416.BevelDifferentialGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7418.BevelDifferentialGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7419.BevelDifferentialPlanetGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7420.BevelDifferentialSunGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7421.BevelGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7423.BevelGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7437.ConicalGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7439.ConicalGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7452.CylindricalGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7454.CylindricalGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7455.CylindricalPlanetGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7463.GearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7465.GearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7467.HypoidGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7469.HypoidGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7471.KlingelnbergCycloPalloidConicalGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7473.KlingelnbergCycloPalloidConicalGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7474.KlingelnbergCycloPalloidHypoidGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7476.KlingelnbergCycloPalloidHypoidGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7477.KlingelnbergCycloPalloidSpiralBevelGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7479.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7489.PlanetaryGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7504.SpiralBevelGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7506.SpiralBevelGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7510.StraightBevelDiffGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7512.StraightBevelDiffGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7513.StraightBevelGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7515.StraightBevelGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7516.StraightBevelPlanetGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7517.StraightBevelSunGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7528.WormGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7530.WormGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7531.ZerolBevelGearCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7533.ZerolBevelGearSetCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7448.CycloidalAssemblyCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7450.CycloidalDiscCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7494.RingPinsCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7485.PartToPartShearCouplingCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7487.PartToPartShearCouplingHalfCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7415.BeltDriveCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7426.ClutchCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7428.ClutchHalfCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7431.ConceptCouplingCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7433.ConceptCouplingHalfCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7442.CouplingCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7444.CouplingHalfCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7446.CVTCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7447.CVTPulleyCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7493.PulleyCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7501.ShaftHubConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7497.RollingRingCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7496.RollingRingAssemblyCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7507.SpringDamperCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7509.SpringDamperHalfCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7518.SynchroniserCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7519.SynchroniserHalfCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7520.SynchroniserPartCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7521.SynchroniserSleeveCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7522.TorqueConverterCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7524.TorqueConverterPumpCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7525.TorqueConverterTurbineCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7502.ShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7445.CVTBeltConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7414.BeltConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7429.CoaxialConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7440.ConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7470.InterMountableComponentConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7488.PlanetaryConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7498.RollingRingConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7408.AbstractShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7417.BevelDifferentialGearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7435.ConceptGearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7459.FaceGearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7511.StraightBevelDiffGearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7422.BevelGearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7438.ConicalGearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7410.AGMAGleasonConicalGearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7453.CylindricalGearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7468.HypoidGearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7472.KlingelnbergCycloPalloidConicalGearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7475.KlingelnbergCycloPalloidHypoidGearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7478.KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7505.SpiralBevelGearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7514.StraightBevelGearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7529.WormGearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7532.ZerolBevelGearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7464.GearMeshCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7449.CycloidalDiscCentralBearingConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7451.CycloidalDiscPlanetaryBearingConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7495.RingPinsToDiscConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7486.PartToPartShearCouplingConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7427.ClutchConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7432.ConceptCouplingConnectionCompoundAdvancedSystemDeflection]":
    ...
    ) -> "Iterable[_7443.CouplingConnectionCompoundAdvancedSystemDeflection]":
