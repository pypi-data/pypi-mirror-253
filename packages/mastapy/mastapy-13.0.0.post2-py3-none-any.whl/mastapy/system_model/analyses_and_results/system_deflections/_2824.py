...
class SynchroniserSystemDeflection(_2806.SpecialisedAssemblySystemDeflection):
    """SynchroniserSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4151.SynchroniserPowerFlow":
    ...
    @property
    def cones(self: Self) -> "List[_2821.SynchroniserHalfSystemDeflection]":
