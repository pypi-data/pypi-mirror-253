...
class CompoundModalAnalysis(_2619.CompoundAnalysis):
    ...
    ) -> "Iterable[_4830.SpringDamperConnectionCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4845.TorqueConverterConnectionCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4728.AbstractShaftCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4727.AbstractAssemblyCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4729.AbstractShaftOrHousingCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4735.BearingCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4746.BoltCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4747.BoltedJointCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4752.ComponentCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4763.ConnectorCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4778.DatumCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4779.ExternalCADModelCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4783.FEPartCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4784.FlexiblePinAssemblyCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4734.AssemblyCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4788.GuideDxfModelCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4802.MassDiscCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4803.MeasurementComponentCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4804.MountableComponentCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4805.OilSealCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4806.PartCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4812.PlanetCarrierCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4813.PointLoadCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4814.PowerLoadCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4821.RootAssemblyCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4825.SpecialisedAssemblyCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4848.UnbalancedMassCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4849.VirtualComponentCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4822.ShaftCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4756.ConceptGearCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4758.ConceptGearSetCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4780.FaceGearCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4782.FaceGearSetCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4731.AGMAGleasonConicalGearCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4733.AGMAGleasonConicalGearSetCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4738.BevelDifferentialGearCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4740.BevelDifferentialGearSetCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4741.BevelDifferentialPlanetGearCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4742.BevelDifferentialSunGearCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4743.BevelGearCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4745.BevelGearSetCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4759.ConicalGearCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4761.ConicalGearSetCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4774.CylindricalGearCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4776.CylindricalGearSetCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4777.CylindricalPlanetGearCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4785.GearCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4787.GearSetCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4789.HypoidGearCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4791.HypoidGearSetCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4793.KlingelnbergCycloPalloidConicalGearCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4795.KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4796.KlingelnbergCycloPalloidHypoidGearCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4798.KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4799.KlingelnbergCycloPalloidSpiralBevelGearCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4801.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4811.PlanetaryGearSetCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4826.SpiralBevelGearCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4828.SpiralBevelGearSetCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4832.StraightBevelDiffGearCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4834.StraightBevelDiffGearSetCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4835.StraightBevelGearCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4837.StraightBevelGearSetCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4838.StraightBevelPlanetGearCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4839.StraightBevelSunGearCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4850.WormGearCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4852.WormGearSetCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4853.ZerolBevelGearCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4855.ZerolBevelGearSetCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4770.CycloidalAssemblyCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4772.CycloidalDiscCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4816.RingPinsCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4807.PartToPartShearCouplingCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4809.PartToPartShearCouplingHalfCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4737.BeltDriveCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4748.ClutchCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4750.ClutchHalfCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4753.ConceptCouplingCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4755.ConceptCouplingHalfCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4764.CouplingCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4766.CouplingHalfCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4768.CVTCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4769.CVTPulleyCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4815.PulleyCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4823.ShaftHubConnectionCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4819.RollingRingCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4818.RollingRingAssemblyCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4829.SpringDamperCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4831.SpringDamperHalfCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4840.SynchroniserCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4841.SynchroniserHalfCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4842.SynchroniserPartCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4843.SynchroniserSleeveCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4844.TorqueConverterCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4846.TorqueConverterPumpCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4847.TorqueConverterTurbineCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4824.ShaftToMountableComponentConnectionCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4767.CVTBeltConnectionCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4736.BeltConnectionCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4751.CoaxialConnectionCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4762.ConnectionCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4792.InterMountableComponentConnectionCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4810.PlanetaryConnectionCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4820.RollingRingConnectionCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4730.AbstractShaftToMountableComponentConnectionCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4739.BevelDifferentialGearMeshCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4757.ConceptGearMeshCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4781.FaceGearMeshCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4833.StraightBevelDiffGearMeshCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4744.BevelGearMeshCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4760.ConicalGearMeshCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4732.AGMAGleasonConicalGearMeshCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4775.CylindricalGearMeshCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4790.HypoidGearMeshCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4794.KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4797.KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4800.KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4827.SpiralBevelGearMeshCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4836.StraightBevelGearMeshCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4851.WormGearMeshCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4854.ZerolBevelGearMeshCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4786.GearMeshCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4771.CycloidalDiscCentralBearingConnectionCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4773.CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4817.RingPinsToDiscConnectionCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4808.PartToPartShearCouplingConnectionCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4749.ClutchConnectionCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4754.ConceptCouplingConnectionCompoundModalAnalysis]":
    ...
    ) -> "Iterable[_4765.CouplingConnectionCompoundModalAnalysis]":
