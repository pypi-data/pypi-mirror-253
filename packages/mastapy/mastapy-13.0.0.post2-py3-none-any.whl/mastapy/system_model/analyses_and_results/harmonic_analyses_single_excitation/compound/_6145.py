...
class AssemblyCompoundHarmonicAnalysisOfSingleExcitation(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_6014.AssemblyHarmonicAnalysisOfSingleExcitation]":
    ...
    def bearings(
        self: Self,
    ) -> "List[_6146.BearingCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def belt_drives(
        self: Self,
    ) -> "List[_6148.BeltDriveCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def bevel_differential_gear_sets(
        ...
        "List[_6151.BevelDifferentialGearSetCompoundHarmonicAnalysisOfSingleExcitation]"
    ):
    ...
    def bolted_joints(
        self: Self,
    ) -> "List[_6158.BoltedJointCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def bolts(
        self: Self,
    ) -> "List[_6157.BoltCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def cv_ts(
        self: Self,
    ) -> "List[_6179.CVTCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def clutches(
        self: Self,
    ) -> "List[_6159.ClutchCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_6164.ConceptCouplingCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_6169.ConceptGearSetCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_6181.CycloidalAssemblyCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_6183.CycloidalDiscCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_6187.CylindricalGearSetCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def fe_parts(
        self: Self,
    ) -> "List[_6194.FEPartCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_6193.FaceGearSetCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_6195.FlexiblePinAssemblyCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_6202.HypoidGearSetCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_6209.KlingelnbergCycloPalloidHypoidGearSetCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_6212.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def mass_discs(
        self: Self,
    ) -> "List[_6213.MassDiscCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_6214.MeasurementComponentCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def oil_seals(
        self: Self,
    ) -> "List[_6216.OilSealCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def part_to_part_shear_couplings(
        ...
        "List[_6218.PartToPartShearCouplingCompoundHarmonicAnalysisOfSingleExcitation]"
    ):
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_6223.PlanetCarrierCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def point_loads(
        self: Self,
    ) -> "List[_6224.PointLoadCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def power_loads(
        self: Self,
    ) -> "List[_6225.PowerLoadCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def ring_pins(
        self: Self,
    ) -> "List[_6227.RingPinsCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_6229.RollingRingAssemblyCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_6234.ShaftHubConnectionCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def shafts(
        self: Self,
    ) -> "List[_6233.ShaftCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_6239.SpiralBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_6240.SpringDamperCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def straight_bevel_diff_gear_sets(
        ...
        "List[_6245.StraightBevelDiffGearSetCompoundHarmonicAnalysisOfSingleExcitation]"
    ):
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_6248.StraightBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_6251.SynchroniserCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_6255.TorqueConverterCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_6259.UnbalancedMassCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_6263.WormGearSetCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_6266.ZerolBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation]":
