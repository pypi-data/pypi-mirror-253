...
class AssemblyHarmonicAnalysisOfSingleExcitation(
    ...
    @property
    def bearings(self: Self) -> "List[_6015.BearingHarmonicAnalysisOfSingleExcitation]":
    ...
    def belt_drives(
        self: Self,
    ) -> "List[_6017.BeltDriveHarmonicAnalysisOfSingleExcitation]":
    ...
    @property
    def bolts(self: Self) -> "List[_6027.BoltHarmonicAnalysisOfSingleExcitation]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_6048.CVTHarmonicAnalysisOfSingleExcitation]":
    ...
    @property
    def clutches(self: Self) -> "List[_6030.ClutchHarmonicAnalysisOfSingleExcitation]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_6038.ConceptGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_6050.CycloidalAssemblyHarmonicAnalysisOfSingleExcitation]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_6052.CycloidalDiscHarmonicAnalysisOfSingleExcitation]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_6063.FEPartHarmonicAnalysisOfSingleExcitation]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_6062.FaceGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_6064.FlexiblePinAssemblyHarmonicAnalysisOfSingleExcitation]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_6072.HypoidGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def mass_discs(
        self: Self,
    ) -> "List[_6083.MassDiscHarmonicAnalysisOfSingleExcitation]":
    ...
    def ring_pins(
        self: Self,
    ) -> "List[_6098.RingPinsHarmonicAnalysisOfSingleExcitation]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_6100.RollingRingAssemblyHarmonicAnalysisOfSingleExcitation]":
    ...
    @property
    def shafts(self: Self) -> "List[_6104.ShaftHarmonicAnalysisOfSingleExcitation]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_6110.SpiralBevelGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_6116.StraightBevelDiffGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_6119.StraightBevelGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_6127.TorqueConverterHarmonicAnalysisOfSingleExcitation]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_6134.WormGearSetHarmonicAnalysisOfSingleExcitation]":
