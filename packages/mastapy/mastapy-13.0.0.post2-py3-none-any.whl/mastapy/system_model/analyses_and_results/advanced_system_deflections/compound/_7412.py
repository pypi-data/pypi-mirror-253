...
class AssemblyCompoundAdvancedSystemDeflection(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_7279.AssemblyAdvancedSystemDeflection]":
    ...
    @property
    def bearings(self: Self) -> "List[_7413.BearingCompoundAdvancedSystemDeflection]":
    ...
    def belt_drives(
        self: Self,
    ) -> "List[_7415.BeltDriveCompoundAdvancedSystemDeflection]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_7418.BevelDifferentialGearSetCompoundAdvancedSystemDeflection]":
    ...
    def bolted_joints(
        self: Self,
    ) -> "List[_7425.BoltedJointCompoundAdvancedSystemDeflection]":
    ...
    @property
    def bolts(self: Self) -> "List[_7424.BoltCompoundAdvancedSystemDeflection]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_7446.CVTCompoundAdvancedSystemDeflection]":
    ...
    @property
    def clutches(self: Self) -> "List[_7426.ClutchCompoundAdvancedSystemDeflection]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_7431.ConceptCouplingCompoundAdvancedSystemDeflection]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_7436.ConceptGearSetCompoundAdvancedSystemDeflection]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_7448.CycloidalAssemblyCompoundAdvancedSystemDeflection]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_7450.CycloidalDiscCompoundAdvancedSystemDeflection]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_7454.CylindricalGearSetCompoundAdvancedSystemDeflection]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_7461.FEPartCompoundAdvancedSystemDeflection]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_7460.FaceGearSetCompoundAdvancedSystemDeflection]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_7462.FlexiblePinAssemblyCompoundAdvancedSystemDeflection]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_7469.HypoidGearSetCompoundAdvancedSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_7476.KlingelnbergCycloPalloidHypoidGearSetCompoundAdvancedSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_7479.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundAdvancedSystemDeflection]":
    ...
    def mass_discs(
        self: Self,
    ) -> "List[_7480.MassDiscCompoundAdvancedSystemDeflection]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_7481.MeasurementComponentCompoundAdvancedSystemDeflection]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_7483.OilSealCompoundAdvancedSystemDeflection]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_7485.PartToPartShearCouplingCompoundAdvancedSystemDeflection]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_7490.PlanetCarrierCompoundAdvancedSystemDeflection]":
    ...
    def point_loads(
        self: Self,
    ) -> "List[_7491.PointLoadCompoundAdvancedSystemDeflection]":
    ...
    def power_loads(
        self: Self,
    ) -> "List[_7492.PowerLoadCompoundAdvancedSystemDeflection]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_7494.RingPinsCompoundAdvancedSystemDeflection]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_7496.RollingRingAssemblyCompoundAdvancedSystemDeflection]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_7501.ShaftHubConnectionCompoundAdvancedSystemDeflection]":
    ...
    @property
    def shafts(self: Self) -> "List[_7500.ShaftCompoundAdvancedSystemDeflection]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_7506.SpiralBevelGearSetCompoundAdvancedSystemDeflection]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_7507.SpringDamperCompoundAdvancedSystemDeflection]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_7512.StraightBevelDiffGearSetCompoundAdvancedSystemDeflection]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_7515.StraightBevelGearSetCompoundAdvancedSystemDeflection]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_7518.SynchroniserCompoundAdvancedSystemDeflection]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_7522.TorqueConverterCompoundAdvancedSystemDeflection]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_7526.UnbalancedMassCompoundAdvancedSystemDeflection]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_7530.WormGearSetCompoundAdvancedSystemDeflection]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_7533.ZerolBevelGearSetCompoundAdvancedSystemDeflection]":
