...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.modal_analyses import _4629, _4628
...
class FaceGearSetModalAnalysis(_4636.GearSetModalAnalysis):
    """FaceGearSetModalAnalysis
    ...
    @property
    def face_gears_modal_analysis(self: Self) -> "List[_4629.FaceGearModalAnalysis]":
    ...
    def face_meshes_modal_analysis(
        self: Self,
    ) -> "List[_4628.FaceGearMeshModalAnalysis]":
