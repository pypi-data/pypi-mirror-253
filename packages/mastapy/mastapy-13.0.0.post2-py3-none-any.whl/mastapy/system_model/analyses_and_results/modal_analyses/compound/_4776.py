...
class CylindricalGearSetCompoundModalAnalysis(_4787.GearSetCompoundModalAnalysis):
    """CylindricalGearSetCompoundModalAnalysis
    ...
    def cylindrical_gears_compound_modal_analysis(
        self: Self,
    ) -> "List[_4774.CylindricalGearCompoundModalAnalysis]":
    ...
    def cylindrical_meshes_compound_modal_analysis(
        self: Self,
    ) -> "List[_4775.CylindricalGearMeshCompoundModalAnalysis]":
