...
class ShaftCompoundModalAnalysis(_4728.AbstractShaftCompoundModalAnalysis):
    """ShaftCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4678.ShaftModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4678.ShaftModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.ShaftModalAnalysis]
