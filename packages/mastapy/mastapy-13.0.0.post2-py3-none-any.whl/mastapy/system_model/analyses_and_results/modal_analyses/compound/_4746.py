...
class BoltCompoundModalAnalysis(_4752.ComponentCompoundModalAnalysis):
    """BoltCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4591.BoltModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4591.BoltModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.BoltModalAnalysis]
