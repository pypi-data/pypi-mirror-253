...
NAME = "diadem"
DESC = "Diadem extends Idem's capabilities, focusing on organizing, parametrizing, and visualizing SLS files across multi-cloud environments."

# Version info -- read without importing
_locals = {}
with pathlib.Path("diadem", "version.py").open() as fp:
...
setup(
    ...
    url="https://gitlab.com/akm0d/diadem",
    version=VERSION,
