...
class ContractApi(object):
    ...
    def get_order_book_statistics(self, delivery_area, **kwargs):  # noqa: E501
        ...
        :param portfolio_id: Providing a portfolio ID that corresponds with a shadow trading portfolio will result in the application of order book changes according to shadow trades made with the given portfolio. Shadow orders will also be added to the respective side of the order book and included in the calculation. A error is returned if a non shadow trading portfolio ID is given.
