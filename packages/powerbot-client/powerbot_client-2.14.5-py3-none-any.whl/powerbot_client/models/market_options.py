...
class MarketOptions(object):
    ...
    def __init__(self, internal_trading=None, internal_trading_cross_area=None, internal_trading_cross_area_lead_time=None, internal_trading_include_external_orders=None, default_delivery_area_id=None, restrict_safe_mode=None, throttling_user_action=None, enable_mfa=None, show_all_account_orders=None, local_vars_configuration=None):  # noqa: E501
