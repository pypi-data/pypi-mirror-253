...
option_5 = StrOption(name="variable", doc="No change", properties=frozenset({"standard"}))
option_3 = StrOption(name="mode_conteneur_actif", doc="No change", default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_rougail.general.mode_conteneur_actif"), '__internal_type': ParamValue("string"), '__internal_multi': ParamValue(False), '__information.rougail.general.od.variable.test_information': ParamInformation("test_information", None, option=option_5)})), properties=frozenset({"standard"}))
optiondescription_4 = OptionDescription(name="od", doc="od", children=[option_5], properties=frozenset({"standard"}))
