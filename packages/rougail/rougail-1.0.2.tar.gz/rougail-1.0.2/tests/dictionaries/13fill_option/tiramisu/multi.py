...
option_6 = StrOption(name="variable", doc="No change", properties=frozenset({"standard"}))
option_4 = StrOption(name="mode_conteneur_actif", doc="No change", default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_1.rougail.general.mode_conteneur_actif"), '__internal_type': ParamValue("string"), '__internal_multi': ParamValue(False), '__information.rougail.general.od.variable.test_information': ParamInformation("test_information", None, option=option_6)})), properties=frozenset({"standard"}))
optiondescription_5 = OptionDescription(name="od", doc="od", children=[option_6], properties=frozenset({"standard"}))
...
option_12 = StrOption(name="variable", doc="No change", properties=frozenset({"standard"}))
option_10 = StrOption(name="mode_conteneur_actif", doc="No change", default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_2.rougail.general.mode_conteneur_actif"), '__internal_type': ParamValue("string"), '__internal_multi': ParamValue(False), '__information.rougail.general.od.variable.test_information': ParamInformation("test_information", None, option=option_12)})), properties=frozenset({"standard"}))
optiondescription_11 = OptionDescription(name="od", doc="od", children=[option_12], properties=frozenset({"standard"}))
