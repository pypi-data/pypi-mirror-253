...
option_5 = ChoiceOption(name="enumvar2", doc="multi", values=("a", "b", "c"), default="c", properties=frozenset({"advanced", "mandatory"}))
option_6 = ChoiceOption(name="enumvar", doc="multi", values=("a", "c"), default="c", properties=frozenset({"advanced", "mandatory"}))
