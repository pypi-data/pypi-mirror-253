...
option_4 = ChoiceOption(name="mode_conteneur_actif", doc="No change", values=("a", "b", "c"), default="b", properties=frozenset({"mandatory", "standard"}))
...
option_8 = ChoiceOption(name="mode_conteneur_actif", doc="No change", values=("a", "b", "c"), default="b", properties=frozenset({"mandatory", "standard"}))
