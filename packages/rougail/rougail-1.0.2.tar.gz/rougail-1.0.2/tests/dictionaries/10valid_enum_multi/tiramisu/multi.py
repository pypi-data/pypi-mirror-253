...
option_5 = ChoiceOption(name="multi", doc="multi", values=("a", "b", "c"), multi=True, default=["a"], default_multi="a", properties=frozenset({"mandatory", "notempty", "standard"}))
...
option_9 = StrOption(name="mode_conteneur_actif", doc="No change", default="non", properties=frozenset({"mandatory", "standard"}))
option_10 = ChoiceOption(name="multi", doc="multi", values=("a", "b", "c"), multi=True, default=["a"], default_multi="a", properties=frozenset({"mandatory", "notempty", "standard"}))
