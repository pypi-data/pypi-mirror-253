...
option_3 = PortOption(name="toto1", doc="Port d'écoute du proxy", default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_rougail.proxy_authentifie.toto1"), '__internal_type': ParamValue("port"), '__internal_multi': ParamValue(False)})), allow_private=True, properties=frozenset({"advanced"}))
option_4 = PortOption(name="toto2", doc="Port d'écoute du proxy NTLM", default="3127", allow_private=True, properties=frozenset({"advanced", "mandatory"}))
optiondescription_2 = OptionDescription(name="proxy_authentifie", doc="proxy authentifié", children=[option_3, option_4], properties=frozenset({"advanced"}))
optiondescription_1 = OptionDescription(name="rougail", doc="rougail", children=[optiondescription_2], properties=frozenset({"advanced"}))
