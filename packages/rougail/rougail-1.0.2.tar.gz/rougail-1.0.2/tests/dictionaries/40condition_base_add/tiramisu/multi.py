...
option_5 = StrOption(name="condition", doc="No change", default="non", properties=frozenset({"standard"}))
...
option_12 = StrOption(name="condition", doc="No change", default="non", properties=frozenset({"standard"}))
