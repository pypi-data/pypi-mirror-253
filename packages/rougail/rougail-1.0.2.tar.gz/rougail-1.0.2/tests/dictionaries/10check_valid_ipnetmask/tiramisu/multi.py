...
option_5 = IPOption(name="adresse_ip_eth0", doc="Adresse IP de la carte", allow_reserved=True, properties=frozenset({"basic", "mandatory"}))
...
option_10 = StrOption(name="mode_conteneur_actif", doc="No change", default="oui", properties=frozenset({"mandatory", "standard"}))
option_11 = IPOption(name="adresse_ip_eth0", doc="Adresse IP de la carte", allow_reserved=True, properties=frozenset({"basic", "mandatory"}))
