...
option_3 = StrOption(name="condition", doc="No change", default="yes", properties=frozenset({"mandatory", "standard"}))
option_4 = StrOption(name="condition2", doc="No change", default="yes", properties=frozenset({"mandatory", "standard"}))
