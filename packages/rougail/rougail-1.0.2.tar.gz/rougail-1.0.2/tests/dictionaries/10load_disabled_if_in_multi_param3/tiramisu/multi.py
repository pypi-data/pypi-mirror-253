...
option_4 = StrOption(name="condition", doc="No change", default="no", properties=frozenset({"mandatory", "standard"}))
...
option_10 = StrOption(name="condition", doc="No change", default="no", properties=frozenset({"mandatory", "standard"}))
