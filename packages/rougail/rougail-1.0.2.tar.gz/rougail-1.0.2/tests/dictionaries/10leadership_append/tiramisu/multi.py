...
optiondescription_6 = Leadership(name="leader", doc="leader", children=[option_7, option_8, option_9, option_10], properties=frozenset({"standard"}))
...
option_18 = StrOption(name="follower1", doc="follower1", multi=True, default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_2.rougail.general1.leader.follower1"), '__internal_type': ParamValue("string"), '__internal_multi': ParamValue(False)})), properties=frozenset({"standard"}))
option_19 = StrOption(name="follower2", doc="follower2", multi=True, default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_2.rougail.general1.leader.follower2"), '__internal_type': ParamValue("string"), '__internal_multi': ParamValue(False), 'rougail.general1.leader.follower1': ParamOption(option_18)})), properties=frozenset({"standard"}))
option_20 = StrOption(name="follower3", doc="follower3", multi=True, properties=frozenset({"standard"}))
optiondescription_16 = Leadership(name="leader", doc="leader", children=[option_17, option_18, option_19, option_20], properties=frozenset({"standard"}))
