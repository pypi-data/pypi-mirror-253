...
option_6 = StrOption(name="vardyn", doc="No change", default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_1.rougail.dyn.vardyn"), '__internal_type': ParamValue("string"), '__internal_multi': ParamValue(False), '__suffix': ParamSuffix()})), properties=frozenset({"standard"}))
...
option_8 = StrOption(name="newvar", doc="No change", properties=frozenset({"standard"}))
...
option_12 = StrOption(name="varname", doc="No change", multi=True, default=["val1", "val2"], default_multi="val1", properties=frozenset({"mandatory", "notempty", "standard"}))
optiondescription_11 = OptionDescription(name="general", doc="general", children=[option_12], properties=frozenset({"standard"}))
option_14 = StrOption(name="vardyn", doc="No change", default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_2.rougail.dyn.vardyn"), '__internal_type': ParamValue("string"), '__internal_multi': ParamValue(False), '__suffix': ParamSuffix()})), properties=frozenset({"standard"}))
...
option_16 = StrOption(name="newvar", doc="No change", properties=frozenset({"standard"}))
