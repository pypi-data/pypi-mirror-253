...
dict_env['default_1.rougail.new.newvar'] = "{{ rougail.dynval1.grp.vardyn }}"
dict_env['default_2.rougail.new.newvar'] = "{{ rougail.dynval1.grp.vardyn }}"
...
option_7 = StrOption(name="vardyn", doc="vardyn", properties=frozenset({"basic", "mandatory"}))
...
option_9 = StrOption(name="newvar", doc="newvar", default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_1.rougail.new.newvar"), '__internal_type': ParamValue("string"), '__internal_multi': ParamValue(False), 'rougail.dynval1.grp.vardyn': ParamDynOption(option_7, 'dynval1.grp.vardyn', optiondescription_5)})), properties=frozenset({"standard"}))
optiondescription_8 = OptionDescription(name="new", doc="new", children=[option_9], properties=frozenset({"standard"}))
optiondescription_2 = OptionDescription(name="rougail", doc="rougail", children=[optiondescription_3, optiondescription_5, optiondescription_8], properties=frozenset({"basic"}))
optiondescription_1 = OptionDescription(name="1", doc="1", children=[optiondescription_2], properties=frozenset({"basic"}))
option_13 = StrOption(name="varname", doc="varname", multi=True, default=["val1", "val2"], default_multi="val1", properties=frozenset({"mandatory", "notempty", "standard"}))
optiondescription_12 = OptionDescription(name="general", doc="general", children=[option_13], properties=frozenset({"standard"}))
option_16 = StrOption(name="vardyn", doc="vardyn", properties=frozenset({"basic", "mandatory"}))
...
option_18 = StrOption(name="newvar", doc="newvar", default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_2.rougail.new.newvar"), '__internal_type': ParamValue("string"), '__internal_multi': ParamValue(False), 'rougail.dynval1.grp.vardyn': ParamDynOption(option_16, 'dynval1.grp.vardyn', optiondescription_14)})), properties=frozenset({"standard"}))
optiondescription_17 = OptionDescription(name="new", doc="new", children=[option_18], properties=frozenset({"standard"}))
optiondescription_11 = OptionDescription(name="rougail", doc="rougail", children=[optiondescription_12, optiondescription_14, optiondescription_17], properties=frozenset({"basic"}))
