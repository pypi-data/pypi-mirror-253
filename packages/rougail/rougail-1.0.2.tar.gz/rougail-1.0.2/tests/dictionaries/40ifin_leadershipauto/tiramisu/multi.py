...
option_5 = StrOption(name="condition", doc="condition", default="oui", properties=frozenset({"mandatory", "standard"}))
option_7 = StrOption(name="leader", doc="leader", multi=True, default=["a"], properties=frozenset({"mandatory", "notempty", "standard"}))
option_8 = StrOption(name="follower1", doc="follower1", multi=True, default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_1.rougail.general.leader.follower1"), '__internal_type': ParamValue("string"), '__internal_multi': ParamValue(False)})), properties=frozenset({"force_default_on_freeze", "frozen", "hidden", "standard", Calculation(func['jinja_to_property'], Params((ParamValue("disabled")), kwargs={'__internal_jinja': ParamValue("disabled_1.rougail.general.leader.follower1"), '__internal_type': ParamValue("string"), '__internal_multi': ParamValue(False), 'rougail.general.condition': ParamOption(option_5)}), help_function=func['jinja_to_property_help'])}))
...
optiondescription_3 = OptionDescription(name="general", doc="general", children=[option_4, option_5, optiondescription_6], properties=frozenset({"standard"}))
...
option_14 = StrOption(name="condition", doc="condition", default="oui", properties=frozenset({"mandatory", "standard"}))
option_16 = StrOption(name="leader", doc="leader", multi=True, default=["a"], properties=frozenset({"mandatory", "notempty", "standard"}))
...
option_18 = StrOption(name="follower2", doc="follower2", multi=True, properties=frozenset({"standard"}))
...
optiondescription_12 = OptionDescription(name="general", doc="general", children=[option_13, option_14, optiondescription_15], properties=frozenset({"standard"}))
