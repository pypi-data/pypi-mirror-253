...
option_4 = BoolOption(name="condition", doc="condition", default=False, properties=frozenset({"mandatory", "standard"}))
...
option_8 = BoolOption(name="condition", doc="condition", default=False, properties=frozenset({"mandatory", "standard"}))
