...
option_5 = StrOption(name="disable_variable", doc="No change", default="no", properties=frozenset({"mandatory", "standard", Calculation(func['jinja_to_property'], Params((ParamValue("disabled")), kwargs={'__internal_jinja': ParamValue("disabled_1.rougail.general.disable_variable"), '__internal_type': ParamValue("string"), '__internal_multi': ParamValue(False)}), help_function=func['jinja_to_property_help'])}))
...
option_9 = StrOption(name="condition", doc="No change", default="no", properties=frozenset({"mandatory", "standard"}))
