...
option_6 = StrOption(name="leader", doc="leader", multi=True, default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_rougail.leadermode.leader.leader"), '__internal_type': ParamValue("string"), '__internal_multi': ParamValue(True)})), properties=frozenset({"advanced"}))
option_7 = StrOption(name="follower1", doc="follower1", multi=True, properties=frozenset({"advanced"}))
option_8 = StrOption(name="follower2", doc="follower2", multi=True, properties=frozenset({"advanced"}))
optiondescription_5 = Leadership(name="leader", doc="leader", children=[option_6, option_7, option_8], properties=frozenset({"advanced"}))
optiondescription_4 = OptionDescription(name="leadermode", doc="leadermode", children=[optiondescription_5], properties=frozenset({"advanced"}))
