...
option_5 = IntOption(name="int", doc="No change", min_number=0, max_number=100, properties=frozenset({"standard"}))
...
option_10 = IntOption(name="int", doc="No change", min_number=0, max_number=100, properties=frozenset({"standard"}))
