...
option_3 = StrOption(name="variable", doc="variable", properties=frozenset({"standard"}))
...
option_6 = StrOption(name="variable", doc="variable", properties=frozenset({"standard"}))
