...
option_6 = StrOption(name="vardyn", doc="No change", default=Calculation(func['calc_value'], Params((ParamSuffix()))), properties=frozenset({"standard"}))
...
option_14 = StrOption(name="vardyn", doc="No change", default=Calculation(func['calc_value'], Params((ParamSuffix()))), properties=frozenset({"standard"}))
