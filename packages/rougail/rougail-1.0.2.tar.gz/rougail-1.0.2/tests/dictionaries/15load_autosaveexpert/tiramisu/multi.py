...
option_5 = StrOption(name="mode_conteneur_actif", doc="No change", default="non", properties=frozenset({"advanced", "force_store_value", "mandatory"}))
optiondescription_4 = OptionDescription(name="general", doc="général", children=[option_5], properties=frozenset({"advanced"}))
...
option_10 = StrOption(name="mode_conteneur_actif", doc="No change", default="non", properties=frozenset({"advanced", "force_store_value", "mandatory"}))
optiondescription_9 = OptionDescription(name="general", doc="général", children=[option_10], properties=frozenset({"advanced"}))
