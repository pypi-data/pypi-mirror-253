...
option_4 = StrOption(name="condition", doc="No change", default="yes", properties=frozenset({"mandatory", "standard"}))
option_5 = StrOption(name="condition2", doc="No change", default="no", properties=frozenset({"mandatory", "standard"}))
option_6 = StrOption(name="test_variable", doc="No change", default="no", properties=frozenset({"force_default_on_freeze", "frozen", "hidden", "mandatory", "standard", Calculation(func['jinja_to_property'], Params((ParamValue("disabled")), kwargs={'__internal_jinja': ParamValue("disabled_1.rougail.general.test_variable"), '__internal_type': ParamValue("string"), '__internal_multi': ParamValue(False), 'rougail.general.condition': ParamOption(option_4), 'rougail.general.condition2': ParamOption(option_5)}), help_function=func['jinja_to_property_help'])}))
...
option_10 = StrOption(name="condition", doc="No change", default="yes", properties=frozenset({"mandatory", "standard"}))
option_11 = StrOption(name="condition2", doc="No change", default="no", properties=frozenset({"mandatory", "standard"}))
