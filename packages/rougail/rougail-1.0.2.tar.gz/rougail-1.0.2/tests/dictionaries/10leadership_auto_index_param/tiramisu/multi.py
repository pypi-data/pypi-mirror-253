...
option_4 = StrOption(name="leader", doc="leader", multi=True, default=["a", "b", "c"], properties=frozenset({"mandatory", "notempty", "standard"}))
option_5 = IntOption(name="follower1", doc="follower1", multi=True, default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_1.rougail.leader.follower1"), '__internal_type': ParamValue("number"), '__internal_multi': ParamValue(False), '__index': ParamIndex()})), properties=frozenset({"standard"}))
...
option_9 = StrOption(name="leader", doc="leader", multi=True, default=["a", "b", "c"], properties=frozenset({"mandatory", "notempty", "standard"}))
option_10 = IntOption(name="follower1", doc="follower1", multi=True, default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_2.rougail.leader.follower1"), '__internal_type': ParamValue("number"), '__internal_multi': ParamValue(False), '__index': ParamIndex()})), properties=frozenset({"standard"}))
