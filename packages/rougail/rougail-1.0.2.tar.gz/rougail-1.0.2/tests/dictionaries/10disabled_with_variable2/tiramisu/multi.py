...
option_3 = BoolOption(name="condition", doc="condition", default=False, properties=frozenset({"mandatory", "standard"}))
...
option_7 = BoolOption(name="condition", doc="condition", default=False, properties=frozenset({"mandatory", "standard"}))
