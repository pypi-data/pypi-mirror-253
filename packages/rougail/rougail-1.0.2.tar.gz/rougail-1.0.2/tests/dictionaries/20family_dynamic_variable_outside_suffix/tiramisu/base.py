...
option_4 = StrOption(name="my_dyn_var", doc="my_dyn_var", default=Calculation(func['calc_value'], Params((ParamSuffix()))), properties=frozenset({"standard"}))
optiondescription_3 = ConvertDynOptionDescription(name="my_dyn_family_", doc="Describe ", suffixes=Calculation(func['calc_value'], Params((ParamOption(option_2, notraisepropertyerror=True)))), children=[option_4], properties=frozenset({"standard"}))
option_5 = StrOption(name="all_dyn_var", doc="all_dyn_var", default=Calculation(func['calc_value'], Params((ParamDynOption(option_4, 'my_dyn_family_val1.my_dyn_var', optiondescription_3)))), properties=frozenset({"standard"}))
