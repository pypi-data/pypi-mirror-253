...
option_5 = StrOption(name="mode_conteneur_actif", doc="No change", default=Calculation(func['calc_value'], Params((ParamInformation("test_information", None, option=option_4)))), properties=frozenset({"standard"}))
...
option_10 = StrOption(name="mode_conteneur_actif", doc="No change", default=Calculation(func['calc_value'], Params((ParamInformation("test_information", None, option=option_9)))), properties=frozenset({"standard"}))
