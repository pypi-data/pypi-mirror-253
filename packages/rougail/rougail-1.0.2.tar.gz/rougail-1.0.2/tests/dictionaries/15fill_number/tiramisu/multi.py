...
option_4 = IntOption(name="mode_conteneur_actif", doc="No change", default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_1.rougail.general.mode_conteneur_actif"), '__internal_type': ParamValue("number"), '__internal_multi': ParamValue(False)})), properties=frozenset({"force_default_on_freeze", "frozen", "hidden", "standard"}))
...
option_9 = IntOption(name="mode_conteneur_actif", doc="No change", default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_2.rougail.general.mode_conteneur_actif"), '__internal_type': ParamValue("number"), '__internal_multi': ParamValue(False)})), properties=frozenset({"force_default_on_freeze", "frozen", "hidden", "standard"}))
