...
option_6 = ChoiceOption(name="enumvar", doc="multi", values=("a", "b", None), default="b", properties=frozenset({"advanced"}))
...
option_12 = ChoiceOption(name="enumvar", doc="multi", values=("a", "b", None), default="b", properties=frozenset({"advanced"}))
