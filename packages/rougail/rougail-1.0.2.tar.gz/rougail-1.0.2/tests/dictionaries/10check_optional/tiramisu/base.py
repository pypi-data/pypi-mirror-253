...
option_3 = StrOption(name="mode_conteneur_actif", doc="No change", default="b", properties=frozenset({"mandatory", "standard"}))
option_5 = IntOption(name="int2", doc="No change", properties=frozenset({"standard"}))
option_4 = IntOption(name="int", doc="No change", validators=[Calculation(func['valid_with_jinja'], Params((), kwargs={'__internal_jinja': ParamValue("validators_rougail.general.int"), '__internal_type': ParamValue("string"), '__internal_multi': ParamValue(False), 'rougail.general.int2': ParamOption(option_5), 'rougail.general.int': ParamSelfOption(whole=False)})), Calculation(func['valid_with_jinja'], Params((), kwargs={'__internal_jinja': ParamValue("validators_rougail.general.int_0"), '__internal_type': ParamValue("string"), '__internal_multi': ParamValue(False), 'rougail.general.int': ParamSelfOption(whole=False)}))], properties=frozenset({"standard"}))
