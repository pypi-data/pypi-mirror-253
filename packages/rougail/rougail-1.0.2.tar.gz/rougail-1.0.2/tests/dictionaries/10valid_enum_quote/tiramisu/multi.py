...
option_6 = ChoiceOption(name="enumvar", doc="multi", values=("quote'", "quote\"", "quote\"'"), default="quote'", properties=frozenset({"advanced", "mandatory"}))
...
option_12 = ChoiceOption(name="enumvar", doc="multi", values=("quote'", "quote\"", "quote\"'"), default="quote'", properties=frozenset({"advanced", "mandatory"}))
