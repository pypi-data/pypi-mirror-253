...
option_4 = StrOption(name="my_dyn_var_", doc="my_dyn_var_", default=Calculation(func['calc_value'], Params((ParamSuffix()))), properties=frozenset({"standard"}))
...
option_5 = StrOption(name="all_dyn_var", doc="all_dyn_var", multi=True, default=Calculation(func['calc_value'], Params((ParamOption(option_4)), kwargs={'allow_none': ParamValue(True)})), properties=frozenset({"standard"}))
