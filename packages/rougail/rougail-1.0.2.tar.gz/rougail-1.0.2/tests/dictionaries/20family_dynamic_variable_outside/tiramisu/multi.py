...
option_5 = StrOption(name="my_dyn_var_", doc="my_dyn_var_", default=Calculation(func['calc_value'], Params((ParamSuffix()))), properties=frozenset({"standard"}))
...
option_6 = StrOption(name="all_dyn_var", doc="all_dyn_var", multi=True, default=Calculation(func['calc_value'], Params((ParamOption(option_5)), kwargs={'allow_none': ParamValue(True)})), properties=frozenset({"standard"}))
...
option_11 = StrOption(name="my_dyn_var_", doc="my_dyn_var_", default=Calculation(func['calc_value'], Params((ParamSuffix()))), properties=frozenset({"standard"}))
...
option_12 = StrOption(name="all_dyn_var", doc="all_dyn_var", multi=True, default=Calculation(func['calc_value'], Params((ParamOption(option_11)), kwargs={'allow_none': ParamValue(True)})), properties=frozenset({"standard"}))
