...
option_3 = StrOption(name="my_var", doc="my_var", default="rougail", properties=frozenset({"mandatory", "standard"}))
optiondescription_2 = OptionDescription(name="rougail", doc="rougail", children=[option_3], properties=frozenset({"standard"}))
option_5 = StrOption(name="my_var", doc="my_var", default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_1.extra.my_var"), '__internal_type': ParamValue("string"), '__internal_multi': ParamValue(False)})), properties=frozenset({"standard"}))
optiondescription_4 = OptionDescription(name="extra", doc="extra", children=[option_5], properties=frozenset({"standard"}))
...
option_8 = StrOption(name="my_var", doc="my_var", default="rougail", properties=frozenset({"mandatory", "standard"}))
optiondescription_7 = OptionDescription(name="rougail", doc="rougail", children=[option_8], properties=frozenset({"standard"}))
option_10 = StrOption(name="my_var", doc="my_var", default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_2.extra.my_var"), '__internal_type': ParamValue("string"), '__internal_multi': ParamValue(False)})), properties=frozenset({"standard"}))
optiondescription_9 = OptionDescription(name="extra", doc="extra", children=[option_10], properties=frozenset({"standard"}))
