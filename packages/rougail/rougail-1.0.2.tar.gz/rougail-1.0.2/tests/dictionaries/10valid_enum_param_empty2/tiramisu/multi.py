...
option_6 = ChoiceOption(name="enumvar", doc="multi", values=(None,), properties=frozenset({"advanced"}))
...
option_12 = ChoiceOption(name="enumvar", doc="multi", values=(None,), properties=frozenset({"advanced"}))
