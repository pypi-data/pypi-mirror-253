...
option_7 = ChoiceOption(name="follower1", doc="follower1", values=("a", "b", "c"), multi=True, default_multi="a", properties=frozenset({"mandatory", "standard"}))
...
option_15 = ChoiceOption(name="follower1", doc="follower1", values=("a", "b", "c"), multi=True, default_multi="a", properties=frozenset({"mandatory", "standard"}))
