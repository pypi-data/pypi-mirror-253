...
optiondescription_6 = Leadership(name="leader", doc="other description", children=[option_7, option_8, option_9], properties=frozenset({"standard"}))
...
option_18 = StrOption(name="follower2", doc="follower2", multi=True, default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_2.rougail.general1.leader.follower2"), '__internal_type': ParamValue("string"), '__internal_multi': ParamValue(False), 'rougail.general1.leader.follower1': ParamOption(option_17)})), properties=frozenset({"standard"}))
optiondescription_15 = Leadership(name="leader", doc="other description", children=[option_16, option_17, option_18], properties=frozenset({"standard"}))
