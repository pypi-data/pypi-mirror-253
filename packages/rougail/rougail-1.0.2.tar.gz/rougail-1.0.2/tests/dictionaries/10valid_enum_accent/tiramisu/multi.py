...
option_6 = ChoiceOption(name="enumvar", doc="multi", values=("a", "b", "c", "é"), default="c", properties=frozenset({"advanced", "mandatory"}))
...
option_12 = ChoiceOption(name="enumvar", doc="multi", values=("a", "b", "c", "é"), default="c", properties=frozenset({"advanced", "mandatory"}))
