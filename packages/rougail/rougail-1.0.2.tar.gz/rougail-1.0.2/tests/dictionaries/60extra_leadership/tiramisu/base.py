...
option_9 = StrOption(name="mode", doc="mode", multi=True, default_multi="pre", properties=frozenset({"mandatory", "standard"}))
optiondescription_7 = Leadership(name="leadership", doc="description", children=[option_8, option_9], properties=frozenset({"standard"}))
