...
option_6 = ChoiceOption(name="enumvar", doc="enumvar", values=("a", "b", "c", None), default="c", properties=frozenset({"advanced"}))
...
option_12 = ChoiceOption(name="enumvar", doc="enumvar", values=("a", "b", "c", None), default="c", properties=frozenset({"advanced"}))
