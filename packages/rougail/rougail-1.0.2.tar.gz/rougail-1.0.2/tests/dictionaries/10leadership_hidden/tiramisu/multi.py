...
option_7 = StrOption(name="leader", doc="leader", multi=True, default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_1.rougail.leadermode.leader.leader"), '__internal_type': ParamValue("string"), '__internal_multi': ParamValue(True)})), properties=frozenset({"force_default_on_freeze", "frozen", "standard"}))
option_8 = StrOption(name="follower1", doc="follower1", multi=True, properties=frozenset({"force_default_on_freeze", "frozen", "standard"}))
option_9 = StrOption(name="follower2", doc="follower2", multi=True, properties=frozenset({"force_default_on_freeze", "frozen", "standard"}))
optiondescription_6 = Leadership(name="leader", doc="leader", children=[option_7, option_8, option_9], properties=frozenset({"hidden", "standard"}))
...
option_16 = StrOption(name="leader", doc="leader", multi=True, default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_2.rougail.leadermode.leader.leader"), '__internal_type': ParamValue("string"), '__internal_multi': ParamValue(True)})), properties=frozenset({"force_default_on_freeze", "frozen", "standard"}))
option_17 = StrOption(name="follower1", doc="follower1", multi=True, properties=frozenset({"force_default_on_freeze", "frozen", "standard"}))
option_18 = StrOption(name="follower2", doc="follower2", multi=True, properties=frozenset({"force_default_on_freeze", "frozen", "standard"}))
optiondescription_15 = Leadership(name="leader", doc="leader", children=[option_16, option_17, option_18], properties=frozenset({"hidden", "standard"}))
