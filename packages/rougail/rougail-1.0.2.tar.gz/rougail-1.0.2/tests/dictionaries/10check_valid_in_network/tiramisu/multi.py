...
option_5 = IPOption(name="adresse_ip_eth0", doc="Adresse IP de la carte", allow_reserved=True, private_only=True, warnings_only=True, properties=frozenset({"basic", "mandatory"}))
...
option_12 = IPOption(name="adresse_ip_eth0", doc="Adresse IP de la carte", allow_reserved=True, private_only=True, warnings_only=True, properties=frozenset({"basic", "mandatory"}))
