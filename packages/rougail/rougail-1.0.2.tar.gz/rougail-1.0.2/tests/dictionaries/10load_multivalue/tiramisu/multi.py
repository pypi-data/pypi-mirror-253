...
option_4 = StrOption(name="mode_conteneur_actif", doc="No change", multi=True, default=["non", "oui"], default_multi="non", properties=frozenset({"force_default_on_freeze", "frozen", "hidden", "mandatory", "notempty", "standard"}))
...
option_8 = StrOption(name="mode_conteneur_actif", doc="No change", multi=True, default=["non", "oui"], default_multi="non", properties=frozenset({"force_default_on_freeze", "frozen", "hidden", "mandatory", "notempty", "standard"}))
