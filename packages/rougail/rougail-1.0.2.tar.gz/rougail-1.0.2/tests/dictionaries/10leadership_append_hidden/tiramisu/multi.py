...
option_7 = StrOption(name="leader", doc="leader", multi=True, properties=frozenset({"force_default_on_freeze", "frozen", "standard"}))
option_8 = StrOption(name="follower1", doc="follower1", multi=True, default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_1.rougail.general1.leader.follower1"), '__internal_type': ParamValue("string"), '__internal_multi': ParamValue(False)})), properties=frozenset({"force_default_on_freeze", "frozen", "standard"}))
option_9 = StrOption(name="follower2", doc="follower2", multi=True, default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_1.rougail.general1.leader.follower2"), '__internal_type': ParamValue("string"), '__internal_multi': ParamValue(False), 'rougail.general1.leader.follower1': ParamOption(option_8)})), properties=frozenset({"force_default_on_freeze", "frozen", "standard"}))
option_10 = StrOption(name="follower3", doc="follower3", multi=True, properties=frozenset({"force_default_on_freeze", "frozen", "standard"}))
optiondescription_6 = Leadership(name="leader", doc="leader", children=[option_7, option_8, option_9, option_10], properties=frozenset({"hidden", "standard"}))
...
option_14 = StrOption(name="mode_conteneur_actif", doc="No change", default="non", properties=frozenset({"mandatory", "standard"}))
optiondescription_13 = OptionDescription(name="general", doc="general", children=[option_14], properties=frozenset({"standard"}))
option_17 = StrOption(name="leader", doc="leader", multi=True, properties=frozenset({"force_default_on_freeze", "frozen", "standard"}))
option_18 = StrOption(name="follower1", doc="follower1", multi=True, default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_2.rougail.general1.leader.follower1"), '__internal_type': ParamValue("string"), '__internal_multi': ParamValue(False)})), properties=frozenset({"force_default_on_freeze", "frozen", "standard"}))
option_19 = StrOption(name="follower2", doc="follower2", multi=True, default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_2.rougail.general1.leader.follower2"), '__internal_type': ParamValue("string"), '__internal_multi': ParamValue(False), 'rougail.general1.leader.follower1': ParamOption(option_18)})), properties=frozenset({"force_default_on_freeze", "frozen", "standard"}))
option_20 = StrOption(name="follower3", doc="follower3", multi=True, properties=frozenset({"force_default_on_freeze", "frozen", "standard"}))
optiondescription_16 = Leadership(name="leader", doc="leader", children=[option_17, option_18, option_19, option_20], properties=frozenset({"hidden", "standard"}))
optiondescription_15 = OptionDescription(name="general1", doc="general1", children=[optiondescription_16], properties=frozenset({"standard"}))
