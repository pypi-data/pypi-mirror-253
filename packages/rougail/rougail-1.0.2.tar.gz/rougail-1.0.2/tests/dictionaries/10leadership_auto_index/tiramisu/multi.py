...
option_5 = IntOption(name="follower1", doc="follower1", multi=True, default=Calculation(func['calc_value'], Params((ParamIndex()))), properties=frozenset({"standard"}))
...
option_10 = IntOption(name="follower1", doc="follower1", multi=True, default=Calculation(func['calc_value'], Params((ParamIndex()))), properties=frozenset({"standard"}))
