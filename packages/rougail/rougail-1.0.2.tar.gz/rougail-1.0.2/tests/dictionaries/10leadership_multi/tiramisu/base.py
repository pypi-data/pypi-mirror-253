...
option_7 = StrOption(name="follower1", doc="follower1", multi=True, default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_rougail.general1.leader.follower1"), '__internal_type': ParamValue("string"), '__internal_multi': ParamValue(False)})), properties=frozenset({"standard"}))
option_8 = StrOption(name="follower2", doc="follower2", multi=True, default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_rougail.general1.leader.follower2"), '__internal_type': ParamValue("string"), '__internal_multi': ParamValue(False), 'rougail.general1.leader.follower1': ParamOption(option_7)})), properties=frozenset({"standard"}))
optiondescription_5 = Leadership(name="leader", doc="leader", children=[option_6, option_7, option_8], properties=frozenset({"standard"}))
option_10 = StrOption(name="leader1", doc="leader", multi=True, properties=frozenset({"standard"}))
option_11 = StrOption(name="follower11", doc="follower1", multi=True, properties=frozenset({"standard"}))
option_12 = StrOption(name="follower21", doc="follower2", multi=True, properties=frozenset({"standard"}))
optiondescription_9 = Leadership(name="leader1", doc="leader", children=[option_10, option_11, option_12], properties=frozenset({"standard"}))
optiondescription_4 = OptionDescription(name="general1", doc="general1", children=[optiondescription_5, optiondescription_9], properties=frozenset({"standard"}))
