...
option_3 = ChoiceOption(name="mode_conteneur_actif", doc="Redefine description", values=("a", "b"), default="a", properties=frozenset({"force_default_on_freeze", "frozen", "hidden", "mandatory", "standard"}))
