...
dict_env['default_1.rougail.new.newvar'] = "{{ rougail.dynval1.vardyn }}"
dict_env['default_2.rougail.new.newvar'] = "{{ rougail.dynval1.vardyn }}"
...
option_16 = StrOption(name="newvar", doc="newvar", default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_2.rougail.new.newvar"), '__internal_type': ParamValue("string"), '__internal_multi': ParamValue(False), 'rougail.dynval1.vardyn': ParamDynOption(option_14, 'dynval1.vardyn', optiondescription_13)})), properties=frozenset({"standard"}))
