...
optiondescription_6 = OptionDescription(name="test", doc="test", children=[option_7], properties=frozenset({"standard"}))
...
option_14 = IntOption(name="delay", doc="délai en minutes avant lancement", default=0, properties=frozenset({"mandatory", "standard"}))
optiondescription_13 = OptionDescription(name="test", doc="test", children=[option_14], properties=frozenset({"standard"}))
