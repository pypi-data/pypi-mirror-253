...
option_5 = StrOption(name="var", doc="New variable", multi=True, default=["a", "b", "c"], default_multi="a", properties=frozenset({"mandatory", "notempty", "standard"}))
option_4 = ChoiceOption(name="mode_conteneur_actif", doc="No change", values=Calculation(func['calc_value'], Params((ParamOption(option_5)))), default="a", properties=frozenset({"mandatory", "standard"}))
...
option_10 = StrOption(name="var", doc="New variable", multi=True, default=["a", "b", "c"], default_multi="a", properties=frozenset({"mandatory", "notempty", "standard"}))
option_9 = ChoiceOption(name="mode_conteneur_actif", doc="No change", values=Calculation(func['calc_value'], Params((ParamOption(option_10)))), default="a", properties=frozenset({"mandatory", "standard"}))
