...
option_3 = StrOption(name="condition", doc="condition", default="no", properties=frozenset({"mandatory", "standard"}))
...
option_5 = StrOption(name="variable2", doc="variable2", default=Calculation(func['calc_value'], Params((ParamOption(option_4, notraisepropertyerror=True)))), properties=frozenset({"standard"}))
