...
option_4 = StrOption(name="condition", doc="condition", default="no", properties=frozenset({"mandatory", "standard"}))
option_5 = StrOption(name="variable1", doc="variable1", properties=frozenset({"standard", Calculation(func['jinja_to_property'], Params((ParamValue("disabled")), kwargs={'__internal_jinja': ParamValue("disabled_1.rougail.general.variable1"), '__internal_type': ParamValue("string"), '__internal_multi': ParamValue(False), 'rougail.general.condition': ParamOption(option_4)}), help_function=func['jinja_to_property_help'])}))
option_6 = StrOption(name="variable2", doc="variable2", default=Calculation(func['calc_value'], Params((ParamOption(option_5, notraisepropertyerror=True)))), properties=frozenset({"standard"}))
...
option_10 = StrOption(name="condition", doc="condition", default="no", properties=frozenset({"mandatory", "standard"}))
...
option_12 = StrOption(name="variable2", doc="variable2", default=Calculation(func['calc_value'], Params((ParamOption(option_11, notraisepropertyerror=True)))), properties=frozenset({"standard"}))
