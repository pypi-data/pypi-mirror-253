...
option_8 = URLOption(name="calc_url", doc="domain", default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_1.extra.test.calc_url"), '__internal_type': ParamValue("web_address"), '__internal_multi': ParamValue(False)})), allow_ip=False, allow_without_dot=True, properties=frozenset({"force_default_on_freeze", "frozen", "hidden", "standard"}))
optiondescription_6 = OptionDescription(name="test", doc="test", children=[option_7, option_8], properties=frozenset({"standard"}))
...
option_16 = URLOption(name="calc_url", doc="domain", default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_2.extra.test.calc_url"), '__internal_type': ParamValue("web_address"), '__internal_multi': ParamValue(False)})), allow_ip=False, allow_without_dot=True, properties=frozenset({"force_default_on_freeze", "frozen", "hidden", "standard"}))
optiondescription_14 = OptionDescription(name="test", doc="test", children=[option_15, option_16], properties=frozenset({"standard"}))
optiondescription_13 = OptionDescription(name="extra", doc="extra", children=[optiondescription_14], properties=frozenset({"standard"}))
optiondescription_9 = OptionDescription(name="2", doc="2", children=[optiondescription_10, optiondescription_13], properties=frozenset({"standard"}))
