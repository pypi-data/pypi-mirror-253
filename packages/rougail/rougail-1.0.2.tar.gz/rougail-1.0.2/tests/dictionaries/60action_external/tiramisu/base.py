...
option_6 = IntOption(name="delay", doc="délai en minutes avant lancement", default=0, properties=frozenset({"mandatory", "standard"}))
option_7 = URLOption(name="calc_url", doc="domain", default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_extra.test.calc_url"), '__internal_type': ParamValue("web_address"), '__internal_multi': ParamValue(False)})), allow_ip=False, allow_without_dot=True, properties=frozenset({"force_default_on_freeze", "frozen", "hidden", "standard"}))
optiondescription_5 = OptionDescription(name="test", doc="test", children=[option_6, option_7], properties=frozenset({"standard"}))
optiondescription_4 = OptionDescription(name="extra", doc="extra", children=[optiondescription_5], properties=frozenset({"standard"}))
