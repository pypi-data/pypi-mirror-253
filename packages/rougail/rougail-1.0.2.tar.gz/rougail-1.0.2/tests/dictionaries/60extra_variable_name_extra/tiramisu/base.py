...
option_6 = StrOption(name="extra", doc="extra", properties=frozenset({"standard"}))
optiondescription_5 = OptionDescription(name="extra", doc="extra", children=[option_6], properties=frozenset({"standard"}))
