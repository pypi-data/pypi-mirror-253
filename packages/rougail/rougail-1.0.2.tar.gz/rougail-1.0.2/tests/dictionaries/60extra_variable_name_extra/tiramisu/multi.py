...
option_7 = StrOption(name="extra", doc="extra", properties=frozenset({"standard"}))
optiondescription_6 = OptionDescription(name="extra", doc="extra", children=[option_7], properties=frozenset({"standard"}))
...
option_12 = StrOption(name="activer_ejabberd", doc="No change", default="non", properties=frozenset({"force_default_on_freeze", "frozen", "hidden", "mandatory", "standard"}))
optiondescription_10 = OptionDescription(name="general", doc="général", children=[option_11, option_12], properties=frozenset({"standard"}))
...
option_14 = StrOption(name="extra", doc="extra", properties=frozenset({"standard"}))
optiondescription_13 = OptionDescription(name="extra", doc="extra", children=[option_14], properties=frozenset({"standard"}))
optiondescription_8 = OptionDescription(name="2", doc="2", children=[optiondescription_9, optiondescription_13], properties=frozenset({"standard"}))
