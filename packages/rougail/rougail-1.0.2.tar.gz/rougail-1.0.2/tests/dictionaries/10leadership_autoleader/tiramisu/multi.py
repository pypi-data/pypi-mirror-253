...
option_8 = StrOption(name="follower2", doc="follower2", multi=True, default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_1.rougail.general.leader.follower2"), '__internal_type': ParamValue("string"), '__internal_multi': ParamValue(False), 'rougail.general.leader.leader': ParamOption(option_6)})), properties=frozenset({"force_default_on_freeze", "frozen", "hidden", "standard"}))
