...
option_6 = ChoiceOption(name="enumvar", doc="multi", values=("a", "b", "c"), default="a", properties=frozenset({"advanced", "mandatory"}))
...
option_12 = ChoiceOption(name="enumvar", doc="multi", values=("a", "b", "c"), default="a", properties=frozenset({"advanced", "mandatory"}))
