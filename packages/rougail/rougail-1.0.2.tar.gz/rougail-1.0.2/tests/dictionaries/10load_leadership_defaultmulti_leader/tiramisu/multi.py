...
option_6 = StrOption(name="leader", doc="leader", multi=True, default=["value"], properties=frozenset({"mandatory", "notempty", "standard"}))
...
option_14 = StrOption(name="leader", doc="leader", multi=True, default=["value"], properties=frozenset({"mandatory", "notempty", "standard"}))
