...
option_16 = StrOption(name="newvar", doc="No change", default=Calculation(func['jinja_to_function'], Params((), kwargs={'__internal_jinja': ParamValue("default_2.rougail.new.newvar"), '__internal_type': ParamValue("string"), '__internal_multi': ParamValue(False), 'vardyn': ParamDynOption(option_14, 'dynval1.vardyn', optiondescription_13)})), properties=frozenset({"mandatory", "standard"}))
