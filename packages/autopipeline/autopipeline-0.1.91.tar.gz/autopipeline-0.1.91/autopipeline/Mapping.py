    ...
    tree = {
        ...
        "extractor": {
            ...
            "causal_extractor": [
            {
                ...
                "description": 
                ''' 
                This function takes in one of the columns of writers' intent as input, get the reader action inferred from the writers' intent of that column, and generate additional an column to include those.
                ''',
                "parameters": {
                    "type": "object",
                    "properties": {"column": {
