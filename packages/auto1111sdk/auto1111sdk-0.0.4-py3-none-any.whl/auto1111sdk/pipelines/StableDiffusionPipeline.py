...
if torch.cuda.is_available():
    os.environ['COMMANDLINE_ARGS'] = "--xformers --skip-torch-cuda-test --no-half-vae interrogate"
else:
    os.environ['COMMANDLINE_ARGS'] = "--use-cpu all --precision full --no-half --skip-torch-cuda-test"
