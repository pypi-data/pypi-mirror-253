...
class ReachApiGatewayV2:
    ...
    def twilio_create_business_phone_number(self, business_id=None, phone_number=None):
        resp = requests.post(
    ...
    def twilio_manage_tollfre_verification_review(
        self, business_id=None, phone_number=None
    ):
        resp = requests.post(
            f"{self.base_url}/twilio/manage-tollfree-verification-review",
            headers=self.gateway_headers,
            params={
                "business_id": business_id,
                "phone_number": phone_number,
    ...
    def twilio_business_phone_verification_details(
        self, business_id=None, phone_number=None
    ):
        resp = requests.get(
            f"{self.base_url}/twilio/business-phone-verification-details",
            headers=self.gateway_headers,
            params={
                "business_id": business_id,
                "phone_number": phone_number,
