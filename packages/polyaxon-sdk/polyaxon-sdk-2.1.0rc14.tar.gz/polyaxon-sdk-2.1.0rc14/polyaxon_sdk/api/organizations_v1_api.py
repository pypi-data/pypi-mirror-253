...
"""
    ...
    The version of the OpenAPI document: 2.1.0-rc14
...
class OrganizationsV1Api(object):
    ...
    @validate_arguments
    def organization_license(self, owner : Annotated[StrictStr, Field(..., description="Owner of the namespace")], body : Annotated[V1Organization, Field(..., description="Organization body")], **kwargs) -> V1Organization:  # noqa: E501
    ...
    @validate_arguments
    def organization_license_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="Owner of the namespace")], body : Annotated[V1Organization, Field(..., description="Organization body")], **kwargs):  # noqa: E501
        """Organization license  # noqa: E501
