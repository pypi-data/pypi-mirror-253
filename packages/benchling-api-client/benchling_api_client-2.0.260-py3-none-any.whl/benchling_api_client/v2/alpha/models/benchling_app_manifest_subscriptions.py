...
from ..models.event_created_message_subscription_v0_alpha import EventCreatedMessageSubscriptionV0Alpha
...
class BenchlingAppManifestSubscriptions:
    ...
    _messages: List[
        Union[EventCreatedMessageSubscriptionV0Beta, EventCreatedMessageSubscriptionV0Alpha, UnknownType]
    ]
        ...
        def get_messages() -> List[
            ...
            for messages_item_data in _messages:
                ...
                def _parse_messages_item(
                    ...
                    EventCreatedMessageSubscriptionV0Beta, EventCreatedMessageSubscriptionV0Alpha, UnknownType
                ]:
                    messages_item: Union[
                        EventCreatedMessageSubscriptionV0Beta,
                        EventCreatedMessageSubscriptionV0Alpha,
                        UnknownType,
                    ]
                    discriminator_value: str = cast(str, data.get("type"))
                    if discriminator_value is not None:
                        if discriminator_value == "v0-alpha.event.created":
                            messages_item = EventCreatedMessageSubscriptionV0Alpha.from_dict(
                                data, strict=False
                            )
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        messages_item = EventCreatedMessageSubscriptionV0Alpha.from_dict(data, strict=True)
