...
import builtins
from typing import Any, Callable, Concatenate, Generator, Generic, Iterable, Optional, ParamSpec, TypeVar
...
class Pipe(Generic[P, T, S]):
    ...
    def __init__(self, function: Callable[Concatenate[T, P], Any]):
...
@Pipe
def take(iterable: Iterable, qte: int):
...
@Pipe
def tail(iterable: Iterable, qte: int) -> deque:
    "Yield qte of elements in the given iterable."
