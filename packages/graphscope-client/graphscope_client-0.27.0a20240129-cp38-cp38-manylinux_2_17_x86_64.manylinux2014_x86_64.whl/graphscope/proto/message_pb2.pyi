...
class ConnectRequest(google.protobuf.message.Message):
    ...
    Protos under the FLEX architecture
...
class ConnectResponse(google.protobuf.message.Message):
    ...
    """We use the solution encompasses the various applications and use cases of the product
    across different industries and business scenarios, e.g. interactive, graphscope insight
    """
    def __init__(
        self,
        *,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["solution", b"solution"]) -> None: ...
