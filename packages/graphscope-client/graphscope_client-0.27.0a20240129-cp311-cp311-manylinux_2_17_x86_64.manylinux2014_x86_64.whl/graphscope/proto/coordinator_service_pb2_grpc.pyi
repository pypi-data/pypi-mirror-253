...
class CoordinatorServiceStub:
    ...
    Connect: grpc.UnaryUnaryMultiCallable[
        message_pb2.ConnectRequest,
        message_pb2.ConnectResponse,
    ]
...
class CoordinatorServiceServicer(metaclass=abc.ABCMeta):
    ...
    def Connect(
        self,
        request: message_pb2.ConnectRequest,
        context: _ServicerContext,
    ) -> typing.Union[message_pb2.ConnectResponse, collections.abc.Awaitable[message_pb2.ConnectResponse]]:
        """service functions under FLEX architecture"""
