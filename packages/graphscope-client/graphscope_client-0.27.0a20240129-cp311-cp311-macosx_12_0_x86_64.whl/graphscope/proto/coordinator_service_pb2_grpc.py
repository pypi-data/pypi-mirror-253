...
class CoordinatorServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Connect = channel.unary_unary(
                '/gs.rpc.CoordinatorService/Connect',
                request_serializer=message__pb2.ConnectRequest.SerializeToString,
                response_deserializer=message__pb2.ConnectResponse.FromString,
                )
...
def add_CoordinatorServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Connect': grpc.unary_unary_rpc_method_handler(
                    servicer.Connect,
                    request_deserializer=message__pb2.ConnectRequest.FromString,
                    response_serializer=message__pb2.ConnectResponse.SerializeToString,
            ),
    }
...
class CoordinatorService(object):
    ...
    def Connect(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/gs.rpc.CoordinatorService/Connect',
            message__pb2.ConnectRequest.SerializeToString,
            message__pb2.ConnectResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
