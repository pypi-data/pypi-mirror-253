...
[aiobotocore.IoT 2.11.1](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/iot.html#IoT)
...
async with session.create_client("iot") as client:
    ...
    list_related_resources_for_audit_finding_paginator: (
        ListRelatedResourcesForAuditFindingPaginator
