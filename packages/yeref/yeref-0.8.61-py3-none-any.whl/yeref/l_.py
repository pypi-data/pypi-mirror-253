...
l_please_subscribe = {
    ...
    'en': "👩🏽‍💻 Sign up for a monthly 💨Subscription",
    'es': "👩🏽‍💻 Regístrate para obtener una 💨Suscripción mensual",
    'fr': "👩🏽‍💻 Inscrivez-vous pour un 💨abonnement mensuel",
    'zh': "👩🏽‍💻 订阅每月💨订阅",
    'ar': "👩🏽‍💻 سجل للحصول على اشتراك 💨 شهري",
}
l_please_subscribe_need = {
    'ru': "👩🏽‍💻 <b>Необходимо</b> 💨Подписка",
    'en': "👩🏽‍💻 <b>It is necessary</b> to subscribe 💨!",
    'es': "👩🏽‍💻 <b>Es necesario</b> suscribirse 💨!",
    'fr': "👩🏽‍💻 <b>Il est nécessaire</b> de s'abonner 💨 !",
    'zh': "👩🏽‍💻<b>有必要</b>订阅💨！",
    'ar': "👩🏽‍💻 <b>ضروري</b> الاشتراك 💨!",
}
l_subscribe_spoiler = {
    'ru': "оформи 💨Подписку",
    'en': "subscribe 💨",
...
l_post_date = {
    'ru': "✏️ <b>Выбери дату</b> на календаре\n\n(<i>или жми «➡️️/Next», чтобы не указывать дату</i>)",
...
l_bot_welcome_instruction = {
    'ru': 'https://telegra.ph/FereyBotBot-11-13',
...
l_add_bot_call = {
    ...
    'es': "➕ Suscríbete 💨para obtener >1 bot o desancla un bot activo para agregar uno nuevo",
    'fr': "➕ Abonnez-vous 💨pour >1 bot ou désépinglez un bot actif pour en ajouter un nouveau",
    'zh': "➕ 订阅 💨>1 个机器人或取消固定活动机器人以添加新机器人",
    'ar': "➕ اشترك 💨 مقابل أكثر من روبوت واحد أو قم بإزالة تثبيت روبوت نشط لإضافة روبوت جديد",
}
l_test_bot_desc = {
...
l_clone_bot_call = {
    ...
    'en': "©️ Subscribe 💨 to clone your competitor's bot",
    'es': "©️ Suscríbete 💨 para clonar el bot de tu competidor",
    'fr': "©️ Abonnez-vous 💨 pour cloner le bot de votre concurrent",
    'zh': "©️ 订阅 💨 克隆竞争对手的机器人",
...
l_addbot_handler = {
    'ru': "➕ <b>Пришли</b> корректный <b>ТОКЕН</b> @tg-бота, полученный с помощью @botFather-бота\n\n👩🏽‍💻 <b>Например</b>, 117783159:BBAD2Kz2h8AQtHYiVtuyyASdMN",
...
l_create_view_web = {
    'ru': "👩🏽‍💻 <b>Скрытая</b> ссылка на веб-страницу: <a href='https://t.me/{0}/web?startapp={1}_{2}'>@{3}/web</a>\n\n👩🏽‍💻 <b>Подлинная</b> телеграм-ссылка: <code>https://t.me/{0}/web?startapp={1}_{2}</code>",
...
l_bot_short_error = {
    'ru': "👩🏽‍💻 <b>Введи</b> текст <i>описания</i> (до 120 символов) профиля @{0}-бота c помощью команды: <code>/short TEXT</code>",
    'en': "👩🏽‍💻 <b>To</b> transfer admin rights to the @{0}-bot, use the command:\n/transfer USER-ID, where the user is: @{0}-bot member and @{1} member-bot (/id)\n\n⚙️ <b>Commands</b> /cmd",
    'es': "👩🏽‍💻 <b>Para</b> transferir derechos de administrador al @{0}-bot, utilice el comando:\n/transfer USER-ID, donde el usuario es: @{0}-bot member y @ {1} miembro-bot (/id)\n\n⚙️ <b>Comandos</b> /cmd",
    'fr': "👩🏽‍💻 <b>Pour</b> transférer les droits d'administrateur au @{0}-bot, utilisez la commande :\n/transfer USER-ID, où l'utilisateur est : @{0}-membre du bot et @ {1} membre-bot (/id)\n\n⚙️ <b>Commandes</b> /cmd",
    'zh': "👩🏽‍💻 <b>要将管理员权限转移给@{0}-bot，请使用命令：\n/transfer USER-ID，其中用户是：@{0}-bot 成员和 @ {1} member-bot (/id)\n\n⚙️ <b>命令</b> /cmd",
...
l_bot_short_success = {
    'ru': "👩🏽‍💻 <b>Текст описания</b> профиля @{0}-бота установлен:\n\n<code>{1}</code>",
    'en': "👩🏽‍💻 <b>To</b> transfer admin rights to the @{0}-bot, use the command:\n/transfer USER-ID, where the user is: @{0}-bot member and @{1} member-bot (/id)\n\n⚙️ <b>Commands</b> /cmd",
    'es': "👩🏽‍💻 <b>Para</b> transferir derechos de administrador al @{0}-bot, utilice el comando:\n/transfer USER-ID, donde el usuario es: @{0}-bot member y @ {1} miembro-bot (/id)\n\n⚙️ <b>Comandos</b> /cmd",
    'fr': "👩🏽‍💻 <b>Pour</b> transférer les droits d'administrateur au @{0}-bot, utilisez la commande :\n/transfer USER-ID, où l'utilisateur est : @{0}-membre du bot et @ {1} membre-bot (/id)\n\n⚙️ <b>Commandes</b> /cmd",
    'zh': "👩🏽‍💻 <b>要将管理员权限转移给@{0}-bot，请使用命令：\n/transfer USER-ID，其中用户是：@{0}-bot 成员和 @ {1} member-bot (/id)\n\n⚙️ <b>命令</b> /cmd",
...
l_bot_desc_error = {
    'ru': "👩🏽‍💻 <b>Введи</b> текст <i>описания</i> (до 512 символов) @{0}-бота перед /start-запуском c помощью команды: <code>/desc TEXT</code>",
    'en': "👩🏽‍💻 <b>To</b> transfer admin rights to the @{0}-bot, use the command:\n/transfer USER-ID, where the user is: @{0}-bot member and @{1} member-bot (/id)\n\n⚙️ <b>Commands</b> /cmd",
    'es': "👩🏽‍💻 <b>Para</b> transferir derechos de administrador al @{0}-bot, utilice el comando:\n/transfer USER-ID, donde el usuario es: @{0}-bot member y @ {1} miembro-bot (/id)\n\n⚙️ <b>Comandos</b> /cmd",
    'fr': "👩🏽‍💻 <b>Pour</b> transférer les droits d'administrateur au @{0}-bot, utilisez la commande :\n/transfer USER-ID, où l'utilisateur est : @{0}-membre du bot et @ {1} membre-bot (/id)\n\n⚙️ <b>Commandes</b> /cmd",
    'zh': "👩🏽‍💻 <b>要将管理员权限转移给@{0}-bot，请使用命令：\n/transfer USER-ID，其中用户是：@{0}-bot 成员和 @ {1} member-bot (/id)\n\n⚙️ <b>命令</b> /cmd",
...
l_bot_desc_success = {
    'ru': "👩🏽‍💻 <b>Текст описания</b> @{0}-бота перед /start-запуском установлен:\n\n<code>{1}</code>",
    'en': "👩🏽‍💻 <b>To</b> transfer admin rights to the @{0}-bot, use the command:\n/transfer USER-ID, where the user is: @{0}-bot member and @{1} member-bot (/id)\n\n⚙️ <b>Commands</b> /cmd",
    'es': "👩🏽‍💻 <b>Para</b> transferir derechos de administrador al @{0}-bot, utilice el comando:\n/transfer USER-ID, donde el usuario es: @{0}-bot member y @ {1} miembro-bot (/id)\n\n⚙️ <b>Comandos</b> /cmd",
    'fr': "👩🏽‍💻 <b>Pour</b> transférer les droits d'administrateur au @{0}-bot, utilisez la commande :\n/transfer USER-ID, où l'utilisateur est : @{0}-membre du bot et @ {1} membre-bot (/id)\n\n⚙️ <b>Commandes</b> /cmd",
    'zh': "👩🏽‍💻 <b>要将管理员权限转移给@{0}-bot，请使用命令：\n/transfer USER-ID，其中用户是：@{0}-bot 成员和 @ {1} member-bot (/id)\n\n⚙️ <b>命令</b> /cmd",
...
# region cneuro_
l_cneuro_text = {
    'ru': "🦾 <b>Жми</b> на ✅/☑️, чтобы <b>Вкл/Выкл</b> нейро-постинг. Генерация текста/медиа на основе постов/описания/контента: <b>{0}</b>",
...
l_cneuro_caption = {
    'ru': "🦾 2. <b>Жми</b> на ✅/☑️, чтобы <b>Вкл/Выкл</b> генерацию <u>текста</u> на основе описания/контента в <b>{0}</b>\n\n👩🏽‍💻 <b>Напиши</b> экстра-промпт, если необходимо\n\n(<i>жми «➡️️/Next», чтобы перейти к следующему шагу</i>)",
...
l_cneuro_isnotpaid = {
    'ru': "🦾 Без подписки доступна генерация:\nтекст/аудио/голосовое",
    'en': "🦾 <b>Error</b> generation: try again or try again later",
    'es': "🦾 Generación de <b>Error</b>: inténtalo de nuevo o inténtalo más tarde",
    'fr': "🦾 Génération de <b>Erreur</b> : réessayez ou réessayez plus tard",
    'zh': "🦾<b>错误</b>生成：重试或稍后重试",
...
l_usr_welcome_instruction = {
    'ru': 'https://telegra.ph/FereyUserBot-11-15',
    'en': 'https://telegra.ph/FereyBotBot-11-13',
    'es': 'https://telegra.ph/FereyBotBot-11-13',
    'fr': 'https://telegra.ph/FereyBotBot-11-13',
    'zh': 'https://telegra.ph/FereyBotBot-11-13',
...
l_chn_welcome_instruction = {
    'ru': 'https://telegra.ph/FereyChannelBot-10-21',
    'en': 'https://telegra.ph/FereyBotBot-11-13',
    'es': 'https://telegra.ph/FereyBotBot-11-13',
    'fr': 'https://telegra.ph/FereyBotBot-11-13',
    'zh': 'https://telegra.ph/FereyBotBot-11-13',
...
l_grp_welcome_instruction = {
    'ru': 'https://telegra.ph/FereyGroupBot-11-13',
    'en': 'https://telegra.ph/FereyBotBot-11-13',
    'es': 'https://telegra.ph/FereyBotBot-11-13',
    'fr': 'https://telegra.ph/FereyBotBot-11-13',
    'zh': 'https://telegra.ph/FereyBotBot-11-13',
...
l_find_welcome_instruction = {
    'ru': 'https://telegra.ph/FereyFindBot-11-15',
    'en': 'https://telegra.ph/FereyBotBot-11-13',
    'es': 'https://telegra.ph/FereyBotBot-11-13',
    'fr': 'https://telegra.ph/FereyBotBot-11-13',
    'zh': 'https://telegra.ph/FereyBotBot-11-13',
...
l_gen_tlg = {
    'ru': "👩🏽‍💻 @tg-канал",
    'en': "👩🏽‍💻 Analysis of @tg-tech channel",
    'es': "👩🏽‍💻 Análisis del canal @tg-tech",
    'fr': "👩🏽‍💻 Analyse de la chaîne @tg-tech",
    'zh': "👩🏽‍💻 @tg-tech频道分析",
    'ar': "👩🏽‍💻تحليل قناة @tg-tech",
}
l_generate_main = {
    'ru': "👩🏽‍💻 <b>Выбери режим</b>",
    'en': "👩🏽‍💻 <b>Select mode</b>",
...
l_generate_chn = {
    ...
    'en': "👩🏽‍💻 <b>Insert</b> link to @tg-tech channel for analyzing financial indicators",
    'es': "👩🏽‍💻 <b>Insertar</b> enlace al canal @tg-tech para analizar indicadores financieros",
    'fr': "👩🏽‍💻 <b>Insérer</b> un lien vers la chaîne @tg-tech pour analyser les indicateurs financiers",
    'zh': "👩🏽‍💻<b>插入</b>链接到@tg-tech频道以分析财务指标",
    'ar': "👩🏽‍💻 <b>أدخل</b> رابط قناة @tg-tech لتحليل المؤشرات المالية",
}
l_generate_wait = {
...
l_generate_subcribe2 = {
    ...
    'en': "👩🏽‍💻 <b>Wait</b> <i>{0}sec or <a href='{1}'>subscribe 💨Subscribe</a></i>",
    'es': "👩🏽‍💻 <b>Espera</b> <i>{0}seg o <a href='{1}'>suscríbete 💨Suscríbete</a></i>",
    'fr': "👩🏽‍💻 <b>Attendez</b> <i>{0}sec ou <a href='{1}'>abonnez-vous 💨Abonnez-vous</a></i>",
    'zh': "👩🏽‍💻<b>等待</b><i>{0}秒或<a href='{1}'>订阅💨订阅</a></i>",
    'ar': "👩🏽‍💻 <b>انتظر</b> <i>{0}ثانية أو <a href='{1}'>اشترك 💨Subscribe</a></i>",
}
l_generate_subcribe_channel = {
    'ru': "👩🏽‍💻 Оформи 💨Подписку, чтобы узнать финансовый потенциал твоего @tg-tech-канала",
    'en': "👩🏽‍💻 Subscribe 💨to find out the financial potential of your @tg-tech channel",
    'es': "👩🏽‍💻 Suscríbete 💨para conocer el potencial financiero de tu canal @tg-tech",
    'fr': "👩🏽‍💻 Abonnez-vous 💨pour découvrir le potentiel financier de votre chaîne @tg-tech",
    'zh': "👩🏽‍💻订阅💨以了解您的@tg-tech频道的财务潜力",
    'ar': "👩🏽‍💻 اشترك 💨 لمعرفة الإمكانيات المالية لقناتك @tg-tech",
}
l_generate_error = {
...
l_tools_welcome_instruction = {
    'ru': 'https://telegra.ph/FereyToolsBot-11-15',
    'en': 'https://telegra.ph/FereyBotBot-11-13',
    'es': 'https://telegra.ph/FereyBotBot-11-13',
    'fr': 'https://telegra.ph/FereyBotBot-11-13',
    'zh': 'https://telegra.ph/FereyBotBot-11-13',
...
l_image_ico_attach = {
    ...
    'es': "👩🏽‍💻 <b>Adjunte</b> foto para convertirla en ico-icono (320x320)",
    'fr': "👩🏽‍💻 <b>Joindre</b> une photo à convertir en ico-icône (320x320)",
...
l_video_thumb_attach = {
    ...
    'es': "👩🏽‍💻 <b>Adjunte</b> video para convertirlo en ícono ico (320x320)",
    'fr': "👩🏽‍💻 <b>Joindre</b> la vidéo à convertir en icône ico (320x320)",
...
l_support_welcome = {
    'ru': "🌱 <b>{0}</b>, добро пожаловать в <i>лендинг-бот</i> службу <b>заботы</b> Ferey-проекта:\n\n▪️<b>задавай</b> вопросы\n▪️<b>присылай</b> любые медиа-файлы",
    'en': "🌱 <b>{0}</b>, welcome to the <i>landing bot</i> <b>Ferey</b>-project:\n\n▪️<b>information</b> about projects\n▪️<b>telegraph</b>-/blog\n\n❗️<b>Regularly</b>-updated /content",
    'es': "🌱 <b>{0}</b>, bienvenido al <i>bot de aterrizaje</i> <b>Ferey</b>-proyecto:\n\n▪️<b>información</b> sobre proyectos\n▪️<b>telegraph</b>-/blog\n\n❗️<b>Actualizado periódicamente</b>/contenido",
    'fr': "🌱 <b>{0}</b>, bienvenue sur le <i>landing bot</i> <b>Ferey</b>-projet :\n\nlessly<b>informations</b> sur les projets\n▪️<b>télégraphe</b>-/blog\n\n❗️<b>Régulièrement</b>-mis à jour /contenu",
    'zh': "🌱<b>{0}</b>，欢迎使用<i>登陆机器人</i><b>Ferey</b>-项目：\n\n▪️有关项目的<b>信息</b>\n▪️<b>电报</b>-/博客\n\n❗️<b>定期</b>-更新/内容",
...
l_codex_welcome = {
    'ru': "🌱 <b>{0}</b>, добро пожаловать в [<b>Кодекс {1}</b>] - лэндинг-бот быстрого погружения в новые @tg-инструменты #нейро-маркетинга:\n\n▪️<b>экспресс</b>-интенсив 23мин\n▪️<b>нейро-инструменты</b> в Telegram",
    'en': "🌱 <b>{0}</b>, welcome to the <i>landing bot</i> <b>Ferey</b>-project:\n\n▪️<b>information</b> about projects\n▪️<b>telegraph</b>-/blog\n\n❗️<b>Regularly</b>-updated /content",
    'es': "🌱 <b>{0}</b>, bienvenido al <i>bot de aterrizaje</i> <b>Ferey</b>-proyecto:\n\n▪️<b>información</b> sobre proyectos\n▪️<b>telegraph</b>-/blog\n\n❗️<b>Actualizado periódicamente</b>/contenido",
    'fr': "🌱 <b>{0}</b>, bienvenue sur le <i>landing bot</i> <b>Ferey</b>-projet :\n\nlessly<b>informations</b> sur les projets\n▪️<b>télégraphe</b>-/blog\n\n❗️<b>Régulièrement</b>-mis à jour /contenu",
    'zh': "🌱<b>{0}</b>，欢迎使用<i>登陆机器人</i><b>Ferey</b>-项目：\n\n▪️有关项目的<b>信息</b>\n▪️<b>电报</b>-/博客\n\n❗️<b>定期</b>-更新/内容",
...
l_codex_caption_3 = {
    'ru': "👩🏽‍💻 <b>Акт #3</b>: <code>мастер автоматизации</code>\n\n00:01 - авто-бан\n00:02 - авто-декор\n00:03 - авто-вход\n00:04 - авто-постинг\n00:05 - авто-подкаст\n00:06 - авто-ответ\n\n<blockquote>Используемые в видео @tg-приложения:</blockquote>\n<a href='https://t.me/FereyChannelBot?start=codex'>@FereyChannelBot</a>\n<a href='https://t.me/FereyGroupBot?start=codex'>@FereyGroupBot</a>\n<a href='https://t.me/FereyBotBot?start=codex'>@FereyBotBot</a>\n<a href='https://t.me/FereyUserBot?start=codex'>@FereyUserBot</a>",
    'en': "<b>👩🏽‍💻 @FereyDemoBot </b>\n\n▪️<b>information</b> about projects\n▪️<b>telegraph</b>-/blog",
    'es': "<b>👩🏽‍💻 @FereyDemoBot </b>\n\n▪️<b>información</b> sobre proyectos\n▪️<b>telegraph</b>-/blog",
    'fr': "<b>👩🏽‍💻 @FereyDemoBot </b>\n\nnounced<b>informations</b> sur les projets\nnounced️<b>télégraphe</b>-/blog",
    'zh': "<b>👩🏽‍💻 @FereyDemoBot </b>\n\n▪️有关项目的<b>信息</b>\n▪️<b>电报</b>-/博客",
...
l_codex_caption_4 = {
    'ru': "👩🏽‍💻 <b>Акт #4</b>: <code>мастер поиска</code>\n\n00:01 - премиум-поиск\n00:02 - пассивный-поиск\n00:03 - встроенный-поиск\n00:04 - поиск-креативов\n00:05 - нейро-поиск\n00:06 - лайк-поиск\n00:07 - гео-поиск\n\n<blockquote>Используемые в видео @tg-приложения:</blockquote>\n<a href='https://t.me/FereyFindBot?start=codex'>@FereyFindBot</a>\n<a href='https://t.me/FereyPostBot?start=codex'>@FereyPostBot</a>\n<a href='https://t.me/FereyMediaBot?start=codex'>@FereyMediaBot</a>\n<a href='https://t.me/FereyAIBot?start=codex'>@FereyAIBot</a>\n<a href='https://t.me/FereyTargetBot?start=codex'>@FereyTargetBot</a>\n<a href='https://t.me/FereyUserBot?start=codex'>@FereyUserBot</a>",
    'en': "<b>👩🏽‍💻 @FereyDemoBot </b>\n\n▪️<b>information</b> about projects\n▪️<b>telegraph</b>-/blog",
    'es': "<b>👩🏽‍💻 @FereyDemoBot </b>\n\n▪️<b>información</b> sobre proyectos\n▪️<b>telegraph</b>-/blog",
    'fr': "<b>👩🏽‍💻 @FereyDemoBot </b>\n\nnounced<b>informations</b> sur les projets\nnounced️<b>télégraphe</b>-/blog",
    'zh': "<b>👩🏽‍💻 @FereyDemoBot </b>\n\n▪️有关项目的<b>信息</b>\n▪️<b>电报</b>-/博客",
...
l_sticker_welcome = {
    'ru': "🌱 <b>{0}</b>, добро пожаловать в <i>лендинг-бот</i> создания эмоджи/стикер паков:\n\n▪️<b>1</b>\n▪️2\n\n❗️<b>Регулярно</b>-обновляемый /content",
    'en': "🌱 <b>{0}</b>, welcome to the <i>landing bot</i> for creating creative posts:\n\n▪️<b>button</b> counter\n▪️inline-<b >telescopes</b>\n▪️parsing/<b>click notifications</b>\n▪️<b>whisper</b>-messages\n\n❗️<b>Regularly</b>-updated / content",
    'es': "🌱 <b>{0}</b>, bienvenido al <i>bot de aterrizaje</i> para crear publicaciones creativas:\n\n▪️<b>botón</b> contador\n▪️inline-<b >telescopios</b>\n▪️análisis/<b>notificaciones de clic</b>\n▪️<b>susurros</b>-mensajes\n\n❗️<b>Regularmente</b>-actualizado/contenido",
    'fr': "🌱 <b>{0}</b>, bienvenue sur le <i>landing bot</i> pour créer des publications créatives :\n\nwithout >télescopes</b>\nƒ️analyse/<b>notifications de clic</b>\nƒ️<b>chuchotement</b>-messages\n\n❗️<b>Régulièrement</b>-mis à jour/contenu",
    'zh': "🌱 <b>{0}</b>，欢迎使用<i>登陆机器人</i>来创建创意帖子：\n\n▪️<b>按钮</b>计数器\n▪️内联-<b >望远镜</b>\n▪️解析/<b>点击通知</b>\n▪️<b>窃窃私语</b>-消息\n\n❗️<b>定期</b>-更新/内容",
...
l_pack_type = {
    'ru': "✏️ 1. <b>Выбери</b> тип создаваемого набора <a href='https://t.me/addstickers/ResistanceDog'>sticker</a>/<a href='https://t.me/addemoji/PumpkinEmoji'>emoji</a>\n\n(<i>жми «➡️️/Next», чтобы перейти к следующему шагу</i>)",
    'en': "✏️ 1. <b>Attach media</b> content for the post: <i>photo/gif/video/audio/document/sticker</i> or write a <i>voice/video note</i> in a circle\n\n(<i>or click “➡️️/Next” to skip this step</i>)",
    'es': "✏️ 1. <b>Adjunte contenido multimedia</b> para la publicación: <i>foto/gif/video/audio/document/sticker</i> o escriba una <i>nota de voz/video</i> en un círculo\n\n(<i>o haga clic en “➡️️/Siguiente” para omitir este paso</i>)",
    'fr': "✏️ 1. <b>Joignez du contenu média</b> pour la publication : <i>photo/gif/video/audio/document/sticker</i> ou écrivez une <i>note vocale/vidéo</i> dans un cercle\n\n(<i>ou cliquez sur « ➡️️/Suivant » pour ignorer cette étape</i>)",
    'zh': "✏️ 1. 为帖子<b>附加媒体</b>内容：<i>照片/gif/视频/音频/文档/贴纸</i>或在其中写入<i>语音/视频注释</i>一个圆圈\n\n（<i>或点击“➡️️/下一步”跳过此步骤</i>）",
...
l_pack_username = {
    'ru': "✏️ 2. <b>Введи</b> @username <b>{0}</b>-набора (до 64 символов), отображаемого в ссылке\n\n<i>или жми «➡️️/Next», чтобы использовать рандомный:\n<blockquote>{1}</blockquote></i>",
    'en': "✏️ 1. <b>Attach media</b> content for the post: <i>photo/gif/video/audio/document/sticker</i> or write a <i>voice/video note</i> in a circle\n\n(<i>or click “➡️️/Next” to skip this step</i>)",
    'es': "✏️ 1. <b>Adjunte contenido multimedia</b> para la publicación: <i>foto/gif/video/audio/document/sticker</i> o escriba una <i>nota de voz/video</i> en un círculo\n\n(<i>o haga clic en “➡️️/Siguiente” para omitir este paso</i>)",
    'fr': "✏️ 1. <b>Joignez du contenu média</b> pour la publication : <i>photo/gif/video/audio/document/sticker</i> ou écrivez une <i>note vocale/vidéo</i> dans un cercle\n\n(<i>ou cliquez sur « ➡️️/Suivant » pour ignorer cette étape</i>)",
    'zh': "✏️ 1. 为帖子<b>附加媒体</b>内容：<i>照片/gif/视频/音频/文档/贴纸</i>或在其中写入<i>语音/视频注释</i>一个圆圈\n\n（<i>或点击“➡️️/下一步”跳过此步骤</i>）",
...
l_item_media = {
    'ru': "✏️ 1. <b>Пришли</b> photo/video/gif/sticker для добавления в [{0}]\n\n<blockquote>или выбери из набора существующий <b>{1}</b> для редактирования/удаления</blockquote>",
    'en': "✏️ 1. <b>Attach media</b> content for the post: <i>photo/gif/video/audio/document/sticker</i> or write a <i>voice/video note</i> in a circle\n\n(<i>or click “➡️️/Next” to skip this step</i>)",
    'es': "✏️ 1. <b>Adjunte contenido multimedia</b> para la publicación: <i>foto/gif/video/audio/document/sticker</i> o escriba una <i>nota de voz/video</i> en un círculo\n\n(<i>o haga clic en “➡️️/Siguiente” para omitir este paso</i>)",
    'fr': "✏️ 1. <b>Joignez du contenu média</b> pour la publication : <i>photo/gif/video/audio/document/sticker</i> ou écrivez une <i>note vocale/vidéo</i> dans un cercle\n\n(<i>ou cliquez sur « ➡️️/Suivant » pour ignorer cette étape</i>)",
    'zh': "✏️ 1. 为帖子<b>附加媒体</b>内容：<i>照片/gif/视频/音频/文档/贴纸</i>或在其中写入<i>语音/视频注释</i>一个圆圈\n\n（<i>或点击“➡️️/下一步”跳过此步骤</i>）",
...
l_item_format = {
    'ru': "✏️ 2. <b>Выбери</b> формат для <b>{0}</b>\n\n(<i>или жми «➡️️/Next», чтобы перейти к следующему шагу</i>)",
    'en': "✏️ 1. <b>Attach media</b> content for the post: <i>photo/gif/video/audio/document/sticker</i> or write a <i>voice/video note</i> in a circle\n\n(<i>or click “➡️️/Next” to skip this step</i>)",
    'es': "✏️ 1. <b>Adjunte contenido multimedia</b> para la publicación: <i>foto/gif/video/audio/document/sticker</i> o escriba una <i>nota de voz/video</i> en un círculo\n\n(<i>o haga clic en “➡️️/Siguiente” para omitir este paso</i>)",
    'fr': "✏️ 1. <b>Joignez du contenu média</b> pour la publication : <i>photo/gif/video/audio/document/sticker</i> ou écrivez une <i>note vocale/vidéo</i> dans un cercle\n\n(<i>ou cliquez sur « ➡️️/Suivant » pour ignorer cette étape</i>)",
    'zh': "✏️ 1. 为帖子<b>附加媒体</b>内容：<i>照片/gif/视频/音频/文档/贴纸</i>或在其中写入<i>语音/视频注释</i>一个圆圈\n\n（<i>或点击“➡️️/下一步”跳过此步骤</i>）",
...
l_item_emoji = {
    'ru': "✏️ 3. <b>Укажи</b> эмоджи (до 20), которые будут ассоциированы с загруженным <b>{0}</b>\n\n(<i>или жми «➡️️/Next», чтобы перейти к следующему шагу</i>)",
    'en': "✏️ 1. <b>Attach media</b> content for the post: <i>photo/gif/video/audio/document/sticker</i> or write a <i>voice/video note</i> in a circle\n\n(<i>or click “➡️️/Next” to skip this step</i>)",
    'es': "✏️ 1. <b>Adjunte contenido multimedia</b> para la publicación: <i>foto/gif/video/audio/document/sticker</i> o escriba una <i>nota de voz/video</i> en un círculo\n\n(<i>o haga clic en “➡️️/Siguiente” para omitir este paso</i>)",
    'fr': "✏️ 1. <b>Joignez du contenu média</b> pour la publication : <i>photo/gif/video/audio/document/sticker</i> ou écrivez une <i>note vocale/vidéo</i> dans un cercle\n\n(<i>ou cliquez sur « ➡️️/Suivant » pour ignorer cette étape</i>)",
    'zh': "✏️ 1. 为帖子<b>附加媒体</b>内容：<i>照片/gif/视频/音频/文档/贴纸</i>或在其中写入<i>语音/视频注释</i>一个圆圈\n\n（<i>或点击“➡️️/下一步”跳过此步骤</i>）",
...
l_item_keyword = {
    'ru': "✏️ 4. <b>Укажи</b> ключевые слова (до 64 символов), которые будут ассоциированы с загруженным <b>{0}</b>\n\n(<i>или жми «➡️️/Next», чтобы перейти к следующему шагу</i>)",
    'en': "✏️ 1. <b>Attach media</b> content for the post: <i>photo/gif/video/audio/document/sticker</i> or write a <i>voice/video note</i> in a circle\n\n(<i>or click “➡️️/Next” to skip this step</i>)",
    'es': "✏️ 1. <b>Adjunte contenido multimedia</b> para la publicación: <i>foto/gif/video/audio/document/sticker</i> o escriba una <i>nota de voz/video</i> en un círculo\n\n(<i>o haga clic en “➡️️/Siguiente” para omitir este paso</i>)",
    'fr': "✏️ 1. <b>Joignez du contenu média</b> pour la publication : <i>photo/gif/video/audio/document/sticker</i> ou écrivez une <i>note vocale/vidéo</i> dans un cercle\n\n(<i>ou cliquez sur « ➡️️/Suivant » pour ignorer cette étape</i>)",
    'zh': "✏️ 1. 为帖子<b>附加媒体</b>内容：<i>照片/gif/视频/音频/文档/贴纸</i>或在其中写入<i>语音/视频注释</i>一个圆圈\n\n（<i>或点击“➡️️/下一步”跳过此步骤</i>）",
...
l_pack_error = {
    'ru': "👩🏽‍💻 <b>Ошибка</b> создания набора: повтори попытку позже или измени @username-набора",
    'en': "✏️ 1. <b>Attach media</b> content for the post: <i>photo/gif/video/audio/document/sticker</i> or write a <i>voice/video note</i> in a circle\n\n(<i>or click “➡️️/Next” to skip this step</i>)",
    'es': "✏️ 1. <b>Adjunte contenido multimedia</b> para la publicación: <i>foto/gif/video/audio/document/sticker</i> o escriba una <i>nota de voz/video</i> en un círculo\n\n(<i>o haga clic en “➡️️/Siguiente” para omitir este paso</i>)",
    'fr': "✏️ 1. <b>Joignez du contenu média</b> pour la publication : <i>photo/gif/video/audio/document/sticker</i> ou écrivez une <i>note vocale/vidéo</i> dans un cercle\n\n(<i>ou cliquez sur « ➡️️/Suivant » pour ignorer cette étape</i>)",
    'zh': "✏️ 1. 为帖子<b>附加媒体</b>内容：<i>照片/gif/视频/音频/文档/贴纸</i>或在其中写入<i>语音/视频注释</i>一个圆圈\n\n（<i>或点击“➡️️/下一步”跳过此步骤</i>）",
...
l_pack_full = {
    'ru': "👩🏽‍💻 {0}-набор уже заполнен ({1}/{2}). Выбери из набора существующий {3} для редактирования/удаления",
    'en': "✏️ 1. <b>Attach media</b> content for the post: <i>photo/gif/video/audio/document/sticker</i> or write a <i>voice/video note</i> in a circle\n\n(<i>or click “➡️️/Next” to skip this step</i>)",
    'es': "✏️ 1. <b>Adjunte contenido multimedia</b> para la publicación: <i>foto/gif/video/audio/document/sticker</i> o escriba una <i>nota de voz/video</i> en un círculo\n\n(<i>o haga clic en “➡️️/Siguiente” para omitir este paso</i>)",
    'fr': "✏️ 1. <b>Joignez du contenu média</b> pour la publication : <i>photo/gif/video/audio/document/sticker</i> ou écrivez une <i>note vocale/vidéo</i> dans un cercle\n\n(<i>ou cliquez sur « ➡️️/Suivant » pour ignorer cette étape</i>)",
    'zh': "✏️ 1. 为帖子<b>附加媒体</b>内容：<i>照片/gif/视频/音频/文档/贴纸</i>或在其中写入<i>语音/视频注释</i>一个圆圈\n\n（<i>或点击“➡️️/下一步”跳过此步骤</i>）",
...
l_item_incorrect = {
    'ru': "👩🏽‍💻 <b>Тип</b> загружаемого <b>{0}-{1}</b> не соответствует типу набора <b>{2}-{3}</b>",
    'en': "✏️ 1. <b>Attach media</b> content for the post: <i>photo/gif/video/audio/document/sticker</i> or write a <i>voice/video note</i> in a circle\n\n(<i>or click “➡️️/Next” to skip this step</i>)",
    'es': "✏️ 1. <b>Adjunte contenido multimedia</b> para la publicación: <i>foto/gif/video/audio/document/sticker</i> o escriba una <i>nota de voz/video</i> en un círculo\n\n(<i>o haga clic en “➡️️/Siguiente” para omitir este paso</i>)",
    'fr': "✏️ 1. <b>Joignez du contenu média</b> pour la publication : <i>photo/gif/video/audio/document/sticker</i> ou écrivez une <i>note vocale/vidéo</i> dans un cercle\n\n(<i>ou cliquez sur « ➡️️/Suivant » pour ignorer cette étape</i>)",
    'zh': "✏️ 1. 为帖子<b>附加媒体</b>内容：<i>照片/gif/视频/音频/文档/贴纸</i>或在其中写入<i>语音/视频注释</i>一个圆圈\n\n（<i>或点击“➡️️/下一步”跳过此步骤</i>）",
...
l_pack_title_edit = {
    'ru': "🏔️ <b>Введи</b> новое название <b>{0}</b>-набора (до 64 символов), отображаемого в заголовке\n\n👩🏽‍💻 <b>Текущее название</b>: {1}\n(<i>отправь <code>0</code>, чтобы очистить название</i>",
    'en': "✏️ 1. <b>Attach media</b> content for the post: <i>photo/gif/video/audio/document/sticker</i> or write a <i>voice/video note</i> in a circle\n\n(<i>or click “➡️️/Next” to skip this step</i>)",
    'es': "✏️ 1. <b>Adjunte contenido multimedia</b> para la publicación: <i>foto/gif/video/audio/document/sticker</i> o escriba una <i>nota de voz/video</i> en un círculo\n\n(<i>o haga clic en “➡️️/Siguiente” para omitir este paso</i>)",
    'fr': "✏️ 1. <b>Joignez du contenu média</b> pour la publication : <i>photo/gif/video/audio/document/sticker</i> ou écrivez une <i>note vocale/vidéo</i> dans un cercle\n\n(<i>ou cliquez sur « ➡️️/Suivant » pour ignorer cette étape</i>)",
    'zh': "✏️ 1. 为帖子<b>附加媒体</b>内容：<i>照片/gif/视频/音频/文档/贴纸</i>或在其中写入<i>语音/视频注释</i>一个圆圈\n\n（<i>或点击“➡️️/下一步”跳过此步骤</i>）",
...
l_item_delete_edit = {
    'ru': "❌ <b>Удалить</b> выбранный {0} из набора {1}",
    'en': "✏️ 1. <b>Attach media</b> content for the post: <i>photo/gif/video/audio/document/sticker</i> or write a <i>voice/video note</i> in a circle\n\n(<i>or click “➡️️/Next” to skip this step</i>)",
    'es': "✏️ 1. <b>Adjunte contenido multimedia</b> para la publicación: <i>foto/gif/video/audio/document/sticker</i> o escriba una <i>nota de voz/video</i> en un círculo\n\n(<i>o haga clic en “➡️️/Siguiente” para omitir este paso</i>)",
    'fr': "✏️ 1. <b>Joignez du contenu média</b> pour la publication : <i>photo/gif/video/audio/document/sticker</i> ou écrivez une <i>note vocale/vidéo</i> dans un cercle\n\n(<i>ou cliquez sur « ➡️️/Suivant » pour ignorer cette étape</i>)",
    'zh': "✏️ 1. 为帖子<b>附加媒体</b>内容：<i>照片/gif/视频/音频/文档/贴纸</i>或在其中写入<i>语音/视频注释</i>一个圆圈\n\n（<i>或点击“➡️️/下一步”跳过此步骤</i>）",
...
l_item_thumb_edit = {
    'ru': "🖼️ <b>Установить</b> выбранный <b>{0}</b> в качестве обложки набора {1}",
    'en': "✏️ 1. <b>Attach media</b> content for the post: <i>photo/gif/video/audio/document/sticker</i> or write a <i>voice/video note</i> in a circle\n\n(<i>or click “➡️️/Next” to skip this step</i>)",
    'es': "✏️ 1. <b>Adjunte contenido multimedia</b> para la publicación: <i>foto/gif/video/audio/document/sticker</i> o escriba una <i>nota de voz/video</i> en un círculo\n\n(<i>o haga clic en “➡️️/Siguiente” para omitir este paso</i>)",
    'fr': "✏️ 1. <b>Joignez du contenu média</b> pour la publication : <i>photo/gif/video/audio/document/sticker</i> ou écrivez une <i>note vocale/vidéo</i> dans un cercle\n\n(<i>ou cliquez sur « ➡️️/Suivant » pour ignorer cette étape</i>)",
    'zh': "✏️ 1. 为帖子<b>附加媒体</b>内容：<i>照片/gif/视频/音频/文档/贴纸</i>或在其中写入<i>语音/视频注释</i>一个圆圈\n\n（<i>或点击“➡️️/下一步”跳过此步骤</i>）",
...
l_item_shift_edit = {
    'ru': "🔛 <b>Жми</b> на ⬅️/➡️, чтобы сдвинуть <b>Влево/Вправо</b> {0} в  наборе {1}",
    'en': "✏️ 1. <b>Attach media</b> content for the post: <i>photo/gif/video/audio/document/sticker</i> or write a <i>voice/video note</i> in a circle\n\n(<i>or click “➡️️/Next” to skip this step</i>)",
    'es': "✏️ 1. <b>Adjunte contenido multimedia</b> para la publicación: <i>foto/gif/video/audio/document/sticker</i> o escriba una <i>nota de voz/video</i> en un círculo\n\n(<i>o haga clic en “➡️️/Siguiente” para omitir este paso</i>)",
    'fr': "✏️ 1. <b>Joignez du contenu média</b> pour la publication : <i>photo/gif/video/audio/document/sticker</i> ou écrivez une <i>note vocale/vidéo</i> dans un cercle\n\n(<i>ou cliquez sur « ➡️️/Suivant » pour ignorer cette étape</i>)",
    'zh': "✏️ 1. 为帖子<b>附加媒体</b>内容：<i>照片/gif/视频/音频/文档/贴纸</i>或在其中写入<i>语音/视频注释</i>一个圆圈\n\n（<i>或点击“➡️️/下一步”跳过此步骤</i>）",
