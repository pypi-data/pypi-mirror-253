...
from datasource_tools.logic.models import (
...
from datasource_tools.logic.exceptions import (
    ValidationError,
    UnregisteredUnitTypeError,
    ParseMetadataError,
)
from datasource_tools.logic import (
    temporal_attributes,
    unit_type_variables,
)
    ...
    def generate(
        ...
        if generate_api_files:
            ...
            for _dfile in config_dict.get('dataFiles'):
                ...
                datafiles_dir, created = check_or_create_directory(directory=TEMPLATE_DATAFILES_DIR)
        ...
        if generate_api_files:
            ...
            out_dir, created = check_or_create_directory(directory=TEMPLATE_METADATAFILES_DIR)
        ...
        write_json(
            filepath=out_dir / "variables_metadata.json", 
            content=variables
        )
        if unit_types:
            write_json(
                filepath=out_dir / "unit_types_metadata.json", 
                content=unit_types
            )
