...
class Environment(_message.Message):
    __slots__ = ["env_managers", "image", "remote"]
    ENV_MANAGERS_FIELD_NUMBER: _ClassVar[int]
    IMAGE_FIELD_NUMBER: _ClassVar[int]
    REMOTE_FIELD_NUMBER: _ClassVar[int]
    env_managers: _containers.RepeatedCompositeFieldContainer[EnvironmentManager]
    image: Image
    remote: Remote
    def __init__(self, remote: _Optional[_Union[Remote, _Mapping]] = ..., image: _Optional[_Union[Image, _Mapping]] = ..., env_managers: _Optional[_Iterable[_Union[EnvironmentManager, _Mapping]]] = ...) -> None: ...

class EnvironmentManager(_message.Message):
    __slots__ = ["name"]
    NAME_FIELD_NUMBER: _ClassVar[int]
    name: str
...
class Remote(_message.Message):
    ...
    hardware: Hardware
    def __init__(self, hardware: _Optional[_Union[Hardware, _Mapping]] = ...) -> None: ...
...
class SetAclsRequest(_message.Message):
    __slots__ = ["add_reader", "visibility", "workspace_id"]
    ...
    visibility: str
    workspace_id: str
    def __init__(self, workspace_id: _Optional[str] = ..., visibility: _Optional[str] = ..., add_reader: _Optional[str] = ...) -> None: ...
