    ...
    with progress:
        ...
        if export_payload:
            ...
            try:
                ...
                iteration = 0
                while not scan_progress.progress_status.value in ending_statuses:
            ...
            if rewrite:
                scan_result.apply_check_result_suggestions(display_level)
            ...
            try:
                formatted_output = scan_result.format_output(output_format, no_color, no_docs_url, no_scan_url, rewrite)
                if output_path:
