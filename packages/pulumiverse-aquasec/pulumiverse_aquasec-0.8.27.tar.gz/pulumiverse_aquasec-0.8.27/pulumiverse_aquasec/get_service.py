...
def get_service(name: Optional[str] = None,
    ...
    return AwaitableGetServiceResult(
        ...
        containers_count=pulumi.get(__ret__, 'containers_count'),
        description=pulumi.get(__ret__, 'description'),
        enforce=pulumi.get(__ret__, 'enforce'),
        evaluated=pulumi.get(__ret__, 'evaluated'),
        id=pulumi.get(__ret__, 'id'),
        is_registered=pulumi.get(__ret__, 'is_registered'),
        lastupdate=pulumi.get(__ret__, 'lastupdate'),
        monitoring=pulumi.get(__ret__, 'monitoring'),
        name=pulumi.get(__ret__, 'name'),
        not_evaluated_count=pulumi.get(__ret__, 'not_evaluated_count'),
        ...
        unregistered_count=pulumi.get(__ret__, 'unregistered_count'),
        vulnerabilities_high=pulumi.get(__ret__, 'vulnerabilities_high'),
        vulnerabilities_low=pulumi.get(__ret__, 'vulnerabilities_low'),
        vulnerabilities_malware=pulumi.get(__ret__, 'vulnerabilities_malware'),
        vulnerabilities_medium=pulumi.get(__ret__, 'vulnerabilities_medium'),
        vulnerabilities_negligible=pulumi.get(__ret__, 'vulnerabilities_negligible'),
        vulnerabilities_score_average=pulumi.get(__ret__, 'vulnerabilities_score_average'),
        vulnerabilities_sensitive=pulumi.get(__ret__, 'vulnerabilities_sensitive'),
        vulnerabilities_total=pulumi.get(__ret__, 'vulnerabilities_total'))
