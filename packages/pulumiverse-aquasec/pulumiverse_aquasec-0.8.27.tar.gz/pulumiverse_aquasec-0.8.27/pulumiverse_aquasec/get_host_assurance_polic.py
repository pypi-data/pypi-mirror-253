...
__all__ = [
    'GetHostAssurancePolicResult',
    'AwaitableGetHostAssurancePolicResult',
    'get_host_assurance_polic',
    'get_host_assurance_polic_output',
]

@pulumi.output_type
class GetHostAssurancePolicResult:
    """
    ...
    def auto_scan_times(self) -> Sequence['outputs.GetHostAssurancePolicAutoScanTimeResult']:
    ...
    def custom_checks(self) -> Sequence['outputs.GetHostAssurancePolicCustomCheckResult']:
        """
    ...
    def forbidden_labels(self) -> Sequence['outputs.GetHostAssurancePolicForbiddenLabelResult']:
    ...
    def packages_black_lists(self) -> Sequence['outputs.GetHostAssurancePolicPackagesBlackListResult']:
        """
    ...
    def packages_white_lists(self) -> Sequence['outputs.GetHostAssurancePolicPackagesWhiteListResult']:
        """
    ...
    def required_labels(self) -> Sequence['outputs.GetHostAssurancePolicRequiredLabelResult']:
    ...
    @property
    @pulumi.getter
    def scopes(self) -> Sequence['outputs.GetHostAssurancePolicScopeResult']:
        return pulumi.get(self, "scopes")

    @property
    @pulumi.getter(name="trustedBaseImages")
    def trusted_base_images(self) -> Sequence['outputs.GetHostAssurancePolicTrustedBaseImageResult']:
        """
...
class AwaitableGetHostAssurancePolicResult(GetHostAssurancePolicResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetHostAssurancePolicResult(
...
def get_host_assurance_polic(maximum_score_exclude_no_fix: Optional[bool] = None,
                             name: Optional[str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetHostAssurancePolicResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('aquasec:index/getHostAssurancePolic:getHostAssurancePolic', __args__, opts=opts, typ=GetHostAssurancePolicResult).value

    return AwaitableGetHostAssurancePolicResult(
...
@_utilities.lift_output_func(get_host_assurance_polic)
def get_host_assurance_polic_output(maximum_score_exclude_no_fix: Optional[pulumi.Input[Optional[bool]]] = None,
                                    name: Optional[pulumi.Input[str]] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetHostAssurancePolicResult]:
    """
    Use this data source to access information about an existing resource.
