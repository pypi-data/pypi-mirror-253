...
class KubernetesAssurancePolicyArgs:
    def __init__(__self__, *,
                 ...
                 kubernetes_controls: Optional[pulumi.Input[Sequence[pulumi.Input['KubernetesAssurancePolicyKubernetesControlArgs']]]] = None,
                 ...
                 policy_settings: Optional[pulumi.Input['KubernetesAssurancePolicyPolicySettingsArgs']] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['KubernetesAssurancePolicyKubernetesControlArgs']]] kubernetes_controls: List of Kubernetes controls.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['KubernetesAssurancePolicyPackagesBlackListArgs']]] packages_black_lists: List of blacklisted images.
    ...
    def kubernetes_controls(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['KubernetesAssurancePolicyKubernetesControlArgs']]]]:
        """
    ...
    def kubernetes_controls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['KubernetesAssurancePolicyKubernetesControlArgs']]]]):
    ...
    def policy_settings(self) -> Optional[pulumi.Input['KubernetesAssurancePolicyPolicySettingsArgs']]:
        return pulumi.get(self, "policy_settings")

    @policy_settings.setter
    def policy_settings(self, value: Optional[pulumi.Input['KubernetesAssurancePolicyPolicySettingsArgs']]):
...
class KubernetesAssurancePolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 images: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 kube_cis_enabled: Optional[pulumi.Input[bool]] = None,
                 kubernetes_controls: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['KubernetesAssurancePolicyKubernetesControlArgs']]]]] = None,
                 kubernetes_controls_avd_ids: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 kubernetes_controls_names: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 labels: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 lastupdate: Optional[pulumi.Input[str]] = None,
                 ...
                 partial_results_image_fail: Optional[pulumi.Input[bool]] = None,
                 permission: Optional[pulumi.Input[str]] = None,
                 policy_settings: Optional[pulumi.Input[pulumi.InputType['KubernetesAssurancePolicyPolicySettingsArgs']]] = None,
                 read_only: Optional[pulumi.Input[bool]] = None,
                 registries: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 registry: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] images: List of images.
        :param pulumi.Input[bool] kube_cis_enabled: Performs a Kubernetes CIS benchmark check for the host.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['KubernetesAssurancePolicyKubernetesControlArgs']]]] kubernetes_controls: List of Kubernetes controls.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] kubernetes_controls_names: List of kubernetes control names and available kubernetes controls are: 'Access to host IPC namespace', 'Access to host PID', 'Access to host network', 'Access to host ports', 'All container images must start with a GCR domain', 'All container images must start with an ECR domain', 'All container images must start with the *.azurecr.io domain', 'CPU not limited', 'CPU requests not specified', 'Can elevate its own privileges', 'ConfigMap with secrets', 'ConfigMap with sensitive content', 'Container images from public registries used', 'Default capabilitiessome containers do not drop all', 'Default capabilitiessome containers do not drop any', 'Delete pod logs', 'Exec into Pods', 'Image tag :latest used', 'Manage EKS IAM Auth ConfigMap', 'Manage Kubernetes RBAC resources', 'Manage Kubernetes networking', 'Manage Kubernetes workloads and pods', 'Manage all resources', 'Manage all resources at the namespace', 'Manage configmaps', 'Manage namespace secrets', 'Manage secrets', 'Manage webhookconfigurations', 'Manages /etc/hosts', 'Memory not limited', 'Memory requests not specified', 'Non-core volume types used.', 'Non-default /proc masks set', 'Privileged', 'Root file system is not read-only', 'Runs as root user', 'Runs with GID <= 10000', 'Runs with UID <= 10000', 'Runs with a root primary or supplementary GID', 'Runtime/Default AppArmor profile not set', 'Runtime/Default Seccomp profile not set', 'SELinux custom options set', 'SYS_ADMIN capability added', 'Seccomp policies disabled', 'Service with External IP', 'Specific capabilities added', 'Unsafe sysctl options set', 'User with admin access', 'Workloads in the default namespace', 'hostPath volume mounted with docker.sock', 'hostPath volumes mounted'
        :param pulumi.Input[Sequence[pulumi.Input[str]]] labels: List of labels.
        :param pulumi.Input[float] maximum_score: Value of allowed maximum score.
        :param pulumi.Input[bool] maximum_score_enabled: Indicates if exceeding the maximum score is scanned.
        ...
        :param pulumi.Input[bool] only_none_root_users: Indicates if raise a warning for images that should only be run as root.
        :param pulumi.Input[bool] packages_black_list_enabled: Indicates if packages blacklist is relevant.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['KubernetesAssurancePolicyPackagesBlackListArgs']]]] packages_black_lists: List of blacklisted images.
        :param pulumi.Input[bool] packages_white_list_enabled: Indicates if packages whitelist is relevant.
    ...
    @property
    @pulumi.getter(name="kubernetesControls")
    def kubernetes_controls(self) -> pulumi.Output[Sequence['outputs.KubernetesAssurancePolicyKubernetesControl']]:
        """
        List of Kubernetes controls.
        """
        return pulumi.get(self, "kubernetes_controls")
    ...
    @property
    @pulumi.getter(name="policySettings")
    def policy_settings(self) -> pulumi.Output['outputs.KubernetesAssurancePolicyPolicySettings']:
        return pulumi.get(self, "policy_settings")
