...
def get_image(registry: Optional[str] = None,
    ...
    return AwaitableGetImageResult(
        ...
        assurance_checks_performeds=pulumi.get(__ret__, 'assurance_checks_performeds'),
        author=pulumi.get(__ret__, 'author'),
        blacklisted=pulumi.get(__ret__, 'blacklisted'),
        comment=pulumi.get(__ret__, 'comment'),
        created=pulumi.get(__ret__, 'created'),
        critical_vulnerabilities=pulumi.get(__ret__, 'critical_vulnerabilities'),
        default_user=pulumi.get(__ret__, 'default_user'),
        digest=pulumi.get(__ret__, 'digest'),
        disallowed=pulumi.get(__ret__, 'disallowed'),
        disallowed_by_assurance_checks=pulumi.get(__ret__, 'disallowed_by_assurance_checks'),
        docker_id=pulumi.get(__ret__, 'docker_id'),
        docker_labels=pulumi.get(__ret__, 'docker_labels'),
        docker_version=pulumi.get(__ret__, 'docker_version'),
        dta_severity_score=pulumi.get(__ret__, 'dta_severity_score'),
        dta_skipped=pulumi.get(__ret__, 'dta_skipped'),
        dta_skipped_reason=pulumi.get(__ret__, 'dta_skipped_reason'),
        environment_variables=pulumi.get(__ret__, 'environment_variables'),
        high_vulnerabilities=pulumi.get(__ret__, 'high_vulnerabilities'),
        ...
        low_vulnerabilities=pulumi.get(__ret__, 'low_vulnerabilities'),
        malware=pulumi.get(__ret__, 'malware'),
        medium_vulnerabilities=pulumi.get(__ret__, 'medium_vulnerabilities'),
        name=pulumi.get(__ret__, 'name'),
        negligible_vulnerabilities=pulumi.get(__ret__, 'negligible_vulnerabilities'),
        newer_image_exists=pulumi.get(__ret__, 'newer_image_exists'),
        os=pulumi.get(__ret__, 'os'),
        os_version=pulumi.get(__ret__, 'os_version'),
        parent=pulumi.get(__ret__, 'parent'),
        partial_results=pulumi.get(__ret__, 'partial_results'),
        pending_disallowed=pulumi.get(__ret__, 'pending_disallowed'),
        permission=pulumi.get(__ret__, 'permission'),
        permission_author=pulumi.get(__ret__, 'permission_author'),
        permission_comment=pulumi.get(__ret__, 'permission_comment'),
        registry=pulumi.get(__ret__, 'registry'),
        registry_type=pulumi.get(__ret__, 'registry_type'),
        repo_digests=pulumi.get(__ret__, 'repo_digests'),
        repository=pulumi.get(__ret__, 'repository'),
        scan_date=pulumi.get(__ret__, 'scan_date'),
        scan_error=pulumi.get(__ret__, 'scan_error'),
        scan_status=pulumi.get(__ret__, 'scan_status'),
        sensitive_data=pulumi.get(__ret__, 'sensitive_data'),
        tag=pulumi.get(__ret__, 'tag'),
        total_vulnerabilities=pulumi.get(__ret__, 'total_vulnerabilities'),
        virtual_size=pulumi.get(__ret__, 'virtual_size'),
        vulnerabilities=pulumi.get(__ret__, 'vulnerabilities'),
        whitelisted=pulumi.get(__ret__, 'whitelisted'))
