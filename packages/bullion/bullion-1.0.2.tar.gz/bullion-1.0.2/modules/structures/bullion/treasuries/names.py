...
'''
	import bullion.ganglia.list as bullion_ganglia_list
	bullion_ganglia_list.start ()
'''
...
def start (
	...
	treasuries = bullion_climate.find ("treasuries")	
	...
	if (len (issues) >= 1):
		...
		raise Exception (f"Issues were found with the bullion directory.")
