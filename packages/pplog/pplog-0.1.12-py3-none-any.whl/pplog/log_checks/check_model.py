...
class OperatorModel:
    ...
    @classmethod
    def from_unhandled_exception(cls) -> "OperatorModel":
        """Converts unhandled exception into stub operator model."""
        return OperatorModel(name="unhandled-exception", function="None")
