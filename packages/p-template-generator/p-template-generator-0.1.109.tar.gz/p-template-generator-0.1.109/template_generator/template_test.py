...
def test(searchPath):
    ...
    template.executeTemplate(config, searchPath, False, False, False, False)
    img_success = False
    ...
    template.generateTemplate(os.path.join(test_template_dir, "param.config"), tp_dir, searchPath, False, False)
