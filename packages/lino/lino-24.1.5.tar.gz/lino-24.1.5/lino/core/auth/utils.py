...
def activate_social_auth_testing(globals_dict, google=True, github=True, wikimedia=True, facebook=True):
    """
    ...
    if github:
        Site.social_auth_backends.append('social_core.backends.github.GithubOAuth2',)
        globals_dict.update(
