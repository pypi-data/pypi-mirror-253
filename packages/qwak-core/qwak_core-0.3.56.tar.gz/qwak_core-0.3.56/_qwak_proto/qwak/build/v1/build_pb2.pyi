...
class Build(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["audit", b"audit", "branchId", b"branchId", "buildConfig", b"buildConfig", "buildId", b"buildId", "build_configuration_message", b"build_configuration_message", "build_destined_image", b"build_destined_image", "build_destined_image_pull_secret", b"build_destined_image_pull_secret", "build_status", b"build_status", "commitId", b"commitId", "end_date", b"end_date", "environment_id", b"environment_id", "failure_reason_code", b"failure_reason_code", "framework_models", b"framework_models", "image_name_tag", b"image_name_tag", "metrics", b"metrics", "model_schema", b"model_schema", "model_uuid", b"model_uuid", "params", b"params", "sdk_version", b"sdk_version", "steps", b"steps", "tags", b"tags"]) -> None: ...
