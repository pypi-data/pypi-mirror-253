...
class JoiningInvitationSpec(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["account_role", b"account_role", "environment_ids", b"environment_ids", "invitee_email", b"invitee_email"]) -> None: ...
...
class UserAccountDescription(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["account_name", b"account_name", "account_role", b"account_role", "environment_ids", b"environment_ids", "is_default_account", b"is_default_account"]) -> None: ...
