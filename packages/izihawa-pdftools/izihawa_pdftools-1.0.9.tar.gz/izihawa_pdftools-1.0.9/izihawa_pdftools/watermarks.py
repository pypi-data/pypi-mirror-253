...
from izihawa_pdftools.text_collector import TextCollector
...
class WatermarkEraser4(BaseWatermarkEraser):
    def __init__(self, regexp, inverted=False, separator="", page_remover: BasePageRemover = None):
        super().__init__(page_remover=page_remover)
        self.regexp = regexp
...
pdf_processors = {
    ...
    "10.1079": WatermarkEraser1(is_watermark_predicate=_is_1079_watermark, watermark_orientations=(0,)),
    ...
    "10.34067": WatermarkEraser4(
        precise_id_regexp, separator=" "
    ),
