...
class AccessPolicyResponse(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, permissions_assignment=None, creation_hooks=None, statements=None, viewset_name=None, customized=None, local_vars_configuration=None):  # noqa: E501
