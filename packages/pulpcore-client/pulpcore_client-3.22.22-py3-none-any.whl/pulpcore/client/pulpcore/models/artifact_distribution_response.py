...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, base_url=None, pulp_created=None, base_path=None, content_guard=None, name=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
