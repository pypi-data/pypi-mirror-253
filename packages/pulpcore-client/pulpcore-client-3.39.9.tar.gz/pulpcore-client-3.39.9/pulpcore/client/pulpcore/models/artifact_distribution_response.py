...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, name=None, base_path=None, hidden=False, pulp_href=None, pulp_created=None, content_guard=None, base_url=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
