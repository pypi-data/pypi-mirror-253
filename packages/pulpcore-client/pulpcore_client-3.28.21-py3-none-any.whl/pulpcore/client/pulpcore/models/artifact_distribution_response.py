...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_path=None, pulp_labels=None, base_url=None, name=None, pulp_href=None, pulp_created=None, content_guard=None, hidden=False, local_vars_configuration=None):  # noqa: E501
