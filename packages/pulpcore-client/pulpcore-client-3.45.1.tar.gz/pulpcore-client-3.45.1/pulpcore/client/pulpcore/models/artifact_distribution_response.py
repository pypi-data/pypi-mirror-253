...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_url=None, pulp_href=None, pulp_labels=None, hidden=False, pulp_created=None, name=None, base_path=None, content_guard=None, local_vars_configuration=None):  # noqa: E501
