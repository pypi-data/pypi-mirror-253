...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_url=None, pulp_href=None, base_path=None, pulp_created=None, hidden=False, name=None, pulp_labels=None, content_guard=None, local_vars_configuration=None):  # noqa: E501
