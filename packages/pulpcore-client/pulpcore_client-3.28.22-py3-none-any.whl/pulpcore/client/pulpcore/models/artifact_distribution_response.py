...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_path=None, base_url=None, pulp_created=None, name=None, content_guard=None, hidden=False, pulp_labels=None, pulp_href=None, local_vars_configuration=None):  # noqa: E501
