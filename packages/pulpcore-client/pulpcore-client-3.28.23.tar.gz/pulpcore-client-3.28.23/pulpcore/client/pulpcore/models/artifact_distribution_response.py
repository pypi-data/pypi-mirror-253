...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, name=None, base_url=None, pulp_created=None, hidden=False, pulp_labels=None, base_path=None, pulp_href=None, content_guard=None, local_vars_configuration=None):  # noqa: E501
