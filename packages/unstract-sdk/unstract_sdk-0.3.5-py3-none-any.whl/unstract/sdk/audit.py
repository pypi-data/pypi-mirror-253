...
from unstract.sdk.constants import PlatformServiceKeys
...
class Audit:
    ...
    def push_usage_data(
        ...
        Raises:
            ...
            usage details.
        """
        platform_host = SdkHelper.get_env_or_die(
            PlatformServiceKeys.PLATFORM_HOST
        )
        platform_port = SdkHelper.get_env_or_die(
            PlatformServiceKeys.PLATFORM_PORT
        )

        base_url = SdkHelper.get_platform_base_url(
            platform_host=platform_host, platform_port=platform_port
        )
        bearer_token = SdkHelper.get_env_or_die(
