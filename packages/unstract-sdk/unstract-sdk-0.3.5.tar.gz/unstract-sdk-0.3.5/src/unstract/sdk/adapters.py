...
import requests
from unstract.sdk.constants import AdapterKeys, LogLevel, PlatformServiceKeys
from unstract.sdk.platform import UnstractPlatformBase
from unstract.sdk.tool.base import UnstractAbstractTool


class UnstractToolAdapter(UnstractPlatformBase):
    ...
    def get_adapter_config(
        tool: UnstractAbstractTool, adapter_instance_id: str
    ) -> Optional[dict[str, Any]]:
        ...
        tool_adapter = UnstractToolAdapter(
            tool=tool,
