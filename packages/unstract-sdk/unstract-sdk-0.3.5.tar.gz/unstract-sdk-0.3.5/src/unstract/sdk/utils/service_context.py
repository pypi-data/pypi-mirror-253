...
class UNServiceContext:
    ...
    def get_service_context(
        ...
        Parameters:
            ...
            llm (Optional[LLMType]): The LLM type. Default is "default".
            embed_model (Optional[Any]): The embedding model. Default is
                                        "default".
        ...
        """
        tokenizer = UnstractToolLLM.get_tokenizer(llm)
