...
class UnstractToolLLMWhisperer(UnstractX2Text):
        ...
        with pdfplumber.open(input_file) as pdf:
            ...
            for page in pages:
                ...
                for dfs in dfs_list:
                    ...
                    if dfs.startswith("-"):
                        ...
                        x = UnstractToolLLMWhisperer.find_first_non_whitespace_location( #noqa
                            t1[i]
                        )
                        if x is not None:
                            if x < min_left_padding:
                                min_left_padding = x
                        x = UnstractToolLLMWhisperer.find_last_non_whitespace_location( #noqa
                            t1[i]
                        )
                        if x is not None:
                            if x > max_width:
            ...
            for line in lines:
                ...
                if (
                    ...
                    and UnstractToolLLMWhisperer.find_first_non_whitespace_location( #noqa
                        prev_line
                    )
                    < 10
                ):
