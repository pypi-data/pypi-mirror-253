...
class StreamableBaseTool:
    ...
    def stream_update(self, message: str, state: str, **kwargs: Any) -> None:
    ...
    def stream_cost(self, cost: float, cost_units: str, **kwargs: Any) -> None:
    ...
    def stream_single_step_message(self, message: str, **kwargs: Any) -> None:
    ...
    def stream_result(self, result: dict[Any, Any], **kwargs: Any) -> None:
