...
class BrowserUtil:
    ...
    Usage:
    To use the `blobToPdf` method, ensure you have the required dependencies installed and a valid path to the ChromeDriver executable.

    Example:
    BrowserUtil.blobToPdf("<html><body><h1>Sample PDF</h1></body></html>", "sample_pdf", "/path/to/chromedriver")
    ...
    @staticmethod
    def blobToPdf(htmlContent, pdfName, chromedriverPath,optionsArgument=None):
        """
        ...
        will have the specified name and can include a full file save path. The method optionally
        ...
        - pdfName (str): The desired name of the saved PDF file. Can include a directory path if needed.
        - chromedriverPath (str): The file path to the ChromeDriver executable.
        ...
        Usage:
        blobToPdf("<html><body><h1>Hello, PDF!</h1></body></html>", "output", "/path/to/chromedriver", ["--disable-gpu"])
