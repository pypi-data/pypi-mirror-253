(function () {
  ...
  function load() {
    ...
    if (inArray(includes, "vector-tile")) {
      ...
      inputCSS("//cdn.jsdelivr.net/npm/jquery.fancytree@2.27/dist/skin-win8/ui.fancytree.min.css");
      inputCSS("//cdn.jsdelivr.net/npm/jquery.fancytree@2.27/dist/skin-win8/ui.fancytree.min.css");
      inputScript("//cdn.jsdelivr.net/npm/jquery.fancytree@2.27/dist/jquery.fancytree-all-deps.min.js");
