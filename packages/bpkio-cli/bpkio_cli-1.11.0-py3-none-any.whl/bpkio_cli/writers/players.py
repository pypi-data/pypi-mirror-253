...
class StreamPlayer:
    ...
    def launch(self, stream_url: str, key: str = None, **kwargs):
        ...
        try:
            ...
            raise BroadpeakIoCliError(f"There is no player template in your config file corresponding to key '{key}'")
    ...
    def prompt_player():
        player = prompt.fuzzy(
            ...
            long_instruction="Use `bic config set default_player <label>` to make your choice permanent"
        )
        return player
