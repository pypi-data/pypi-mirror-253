...
def load_data(input_file):
    try:
        ...
        print(f"Error: File not found - {input_file}. Please provide a valid input file.")
        sys.exit(1)
    except pd.errors.ParserError:
        print(f"Error: Issue parsing the Excel file {input_file}. Please check the file structure.")
        sys.exit(1)
...
def main():
    ...
    print("Nishtha's Topsis Implementation")
    print("Roll Number: 102103604")
    print("Results are saved to", result_file)
