...
[Documentation for the base Tools class](/autocode/azcam/tools/tools.html)
...
[Autogenerated docs for the base Exposure class](/autocode/azcam/tools/exposure.html)
...
[Documentation for the base Controller class](/autocode/azcam/tools/controller.html)
...
[Documentation for the TempCon class](/autocode/azcam/tools/tempcon.html)
...
[Documentation for the Instrument class](/autocode/azcam/tools/instrument.html)

## Telescope Tool

This tool defines the telescope interface. The default tool name is *telescope*.

[Documentation for the Telescope class](/autocode/azcam/tools/telescope.html)
...
print(rois)
```
[Documentation for the Display class](/autocode/azcam/tools/display.html)
