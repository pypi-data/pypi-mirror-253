...
version_dev='0.2.16'  # Giữ nguyên định dạng không được format file có khoảng trống theo Pycharm (version_dev = '1.0.9' là file run.sh sẽ không bắt được current_version)
...
setup(
    ...
    version='0.2.16',  # Required, Phần này cũng không được format file.
