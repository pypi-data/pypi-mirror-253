...
extern "C"{
        ...
        __global__ void Gmove_trn(const InfoStruct *Ginfo, AtomArray *GfragmentInfo, residue *GresidueInfo, 
            ...
            // if (tid == 0 && GTempInfo[blockIdx.x].type == 62){
            //     printf("Energy62: %f\t%f\n", energyTemp, GTempInfo[blockIdx.x].charge);
            // }
        ...
        bool move_trn(const InfoStruct *infoHost, InfoStruct *infoDevice, AtomArray *fragmentInfoHost, AtomArray *fragmentInfoDevice, residue *residueInfoDevice, Atom *atomInfoDevice, const float *gridDevice, const float *ffDevice,
            ...
            Gmove_trn<<<numBlocks, numThreadsPerBlock>>>(infoDevice, fragmentInfoDevice, residueInfoDevice, atomInfoDevice, gridDevice, ffDevice, moveFragType, tempFragDevice, tempInfoDevice, rngStatesDevice);
            ...
            if (needUpdate){
                ...
                GupdateTrn<<<numBlocks, numThreadsPerBlock>>>(fragmentInfoDevice, residueInfoDevice, atomInfoDevice, tempFragDevice, tempInfoDevice, moveFragType);
            }
