...
"""
testcontainers-python-influxdb provides means to spawn an InfluxDB instance within a Docker container.

- this __init__.py module provides the common mechanism to spawn an InfluxDB container.
