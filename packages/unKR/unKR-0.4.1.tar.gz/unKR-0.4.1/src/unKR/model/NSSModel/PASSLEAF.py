...
class PASSLEAF(Model):
    ...
    Attributes:
        ...
        gama: hyper-parameter when calculate the confidence score of rotate
        # TODO 暂定gama就是margin，等会看结果
    ...
    def __init__(self, args):
        ...
        self.gama = self.args.gama_PASSLEAF
    ...
    def score_func(self, head_emb, relation_emb, tail_emb, mode):
        ...
        The formula for calculating the score of DistMult is :math:`h^{\top} \operatorname{diag}(r) t`.

        The formula for calculating the score of ComplEx is :math:`\operatorname{Re}\left(h^{\top} \operatorname{diag}(r) \overline{t}\right)`
