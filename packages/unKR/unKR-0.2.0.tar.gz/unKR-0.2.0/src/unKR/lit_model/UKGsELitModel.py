...
class UKGsELitModel(BaseLitModel):
    ...
    def training_step(self, batch, batch_idx):
        ...
        pos_sample = batch["positive_sample"]  # [[33,44,55, 0.98], [3,4,5, 0.8], ]
        # [[12,44,55, 0], [13,4,5, 0], ]
        neg_sample = batch["negative_sample"]  # [[12],[13],]
        mode = batch["mode"]

        pos_score = self.model(pos_sample)  # 计算三元组得分
