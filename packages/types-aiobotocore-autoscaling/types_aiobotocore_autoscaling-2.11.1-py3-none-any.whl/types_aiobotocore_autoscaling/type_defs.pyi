...
InstanceRequirementsPaginatorTypeDef = TypedDict(
    "InstanceRequirementsPaginatorTypeDef",
    {
...
LaunchTemplateOverridesPaginatorTypeDef = TypedDict(
    "LaunchTemplateOverridesPaginatorTypeDef",
    {
        "InstanceType": NotRequired[str],
        "WeightedCapacity": NotRequired[str],
        "LaunchTemplateSpecification": NotRequired[LaunchTemplateSpecificationTypeDef],
        "InstanceRequirements": NotRequired[InstanceRequirementsPaginatorTypeDef],
    },
)
...
LaunchTemplatePaginatorTypeDef = TypedDict(
    "LaunchTemplatePaginatorTypeDef",
    {
        "LaunchTemplateSpecification": NotRequired[LaunchTemplateSpecificationTypeDef],
        "Overrides": NotRequired[List[LaunchTemplateOverridesPaginatorTypeDef]],
    },
)
...
CustomizedMetricSpecificationTypeDef = TypedDict(
    "CustomizedMetricSpecificationTypeDef",
    {
        ...
        "Unit": NotRequired[str],
        "Metrics": NotRequired[List[TargetTrackingMetricDataQueryTypeDef]],
    },
)
MixedInstancesPolicyPaginatorTypeDef = TypedDict(
    "MixedInstancesPolicyPaginatorTypeDef",
    {
        "LaunchTemplate": NotRequired[LaunchTemplatePaginatorTypeDef],
...
AutoScalingGroupPaginatorTypeDef = TypedDict(
    "AutoScalingGroupPaginatorTypeDef",
    {
        "AutoScalingGroupName": str,
        "MinSize": int,
        ...
        "LaunchConfigurationName": NotRequired[str],
        "LaunchTemplate": NotRequired[LaunchTemplateSpecificationTypeDef],
        "MixedInstancesPolicy": NotRequired[MixedInstancesPolicyPaginatorTypeDef],
...
AutoScalingGroupsTypePaginatorTypeDef = TypedDict(
    "AutoScalingGroupsTypePaginatorTypeDef",
    {
        "AutoScalingGroups": List[AutoScalingGroupPaginatorTypeDef],
        "NextToken": str,
        "ResponseMetadata": ResponseMetadataTypeDef,
    },
)
