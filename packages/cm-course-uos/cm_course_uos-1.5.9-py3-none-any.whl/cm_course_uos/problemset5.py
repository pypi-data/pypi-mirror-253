...
def probabilityDensityFunction(mean, variance,x):
  ...
  Returns:
    ...
    variance (float): The given variance of the function.
...
def test_probabilityDensityFunction(student_function):
    student_function = probabilityDensityFunction
    mean = 0
    variance = 1
...
def multiplyDistributions(mean1, mean2, var1, var2, x):
  ...
  mean1, var1, pdf1 = probabilityDensityFunction(mean1, var1)
  mean2, var2, pdf2 = probabilityDensityFunction(mean2, var2)
