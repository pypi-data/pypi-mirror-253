...
def bayesRule(probHypothesis, probObservation):
 ...
 Returns:
  ...
  jointProb = 0.025
  likelihood = jointProb / probObservation # Your answer here
  probPosterior = likelihood * probHypothesis / probObservation # Your answer here
...
def probabilityDensityFunction(mean, variance,x):
  ...
  pdf = 1 / np.sqrt(2*np.pi*variance) * np.exp(-(x-mean)**2/(2*variance)) # Your answer here
...
def multiplyDistributions(mean1, mean2, var1, var2, x):
  ...
  mean1, var1, pdf1 = probabilityDensityFunction(mean1, var1)  # Your answer here  (0.25 points)
  mean2, var2, pdf2 = probabilityDensityFunction(mean2, var2)  # Your answer here  (0.25 points)

  # Calculate the mean and the variance of the probability density function for the posterior
  meanPosterior = (1/var1 * mean1 + 1/var2 * mean2) / (1/var1 + 1/var2) # Your answer here  (0.25 points)
  varPosterior = 1 / (1/var1 + 1/var2)  # Your answer here  (0.25 points)
