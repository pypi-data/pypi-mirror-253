...
def calculate_10_yr_ascvd_risk(
    ...
    """
    Calculate the 10-year risk of atherosclerotic cardiovascular disease (ASCVD).

    This function uses various health and lifestyle parameters to estimate the risk
    of developing ASCVD over the next 10 years. The input values must fall within
    ...
    Returns:
    float: The estimated 10-year ASCVD risk percentage.
    ...
    ... )
    # Returns: Estimated 10-year ASCVD risk percentage (e.g., 12.3)
    """
...
def calculate_30_yr_ascvd_risk(
    ...
    """
    Calculate the 30-year risk of atherosclerotic cardiovascular disease (ASCVD).

    This function uses various health and lifestyle parameters to estimate the risk
    of developing ASCVD over the next 30 years. The input values must fall within
    specified ranges for the calculation to be valid.
    ...
    Returns:
    float: The estimated 30-year ASCVD risk percentage.

    Raises:
    ValueError: If any of the input parameters are outside their valid ranges.

    Example:
    >>> calculate_30_yr_ascvd_risk(
    ...     sex="male",
    ...     age=45,
    ...     total_cholesterol=210,
    ...     hdl_cholesterol=55,
    ...
    ...     on_cholesterol_meds=False,
    ... )
    # Returns: Estimated 30-year ASCVD risk percentage (e.g., 12.3)
    """
...
def batch_calculate_10_yr_ascvd_risk(
    ...
    **kwargs,
    ...
    Returns:
    list: A list of estimated 10-year ASCVD risk percentages for each individual in the DataFrame.
    ...
    >>> print(risks)
    # Returns: A list of estimated 10-year ASCVD risk percentages
...
def batch_calculate_30_yr_ascvd_risk(
    df: pd.DataFrame,
    sex: str = "sex",
    age: str = "age",
    total_cholesterol: str = "total_cholesterol",
    ...
    **kwargs,
    ...
    """
    Batch calculate the 30-year risk of atherosclerotic cardiovascular disease (ASCVD) for a dataset.

    This function processes a DataFrame with health and lifestyle parameters to estimate
    the 30-year ASCVD risk for each individual in the dataset. The input values must fall
    within specified ranges for the calculation to be valid.
    ...
    Returns:
    list: A list of estimated 30-year ASCVD risk percentages for each individual in the DataFrame.
    ...
    Example:
    >>> df = pd.DataFrame({...})
    >>> risks = batch_calculate_30_yr_ascvd_risk(df, sex='gender', age='patient_age', ...)
    >>> print(risks)
    # Returns: A list of estimated 10-year ASCVD risk percentages
    ...
    ...     'on_cholesterol_meds': 'cholesterol_meds'
    ... }
    >>> risks = batch_calculate_30_yr_ascvd_risk(df, **column_mappings)
    # Returns: A list of estimated 10-year ASCVD risk percentages
    """
    # Default column names
    column_mapping = {
