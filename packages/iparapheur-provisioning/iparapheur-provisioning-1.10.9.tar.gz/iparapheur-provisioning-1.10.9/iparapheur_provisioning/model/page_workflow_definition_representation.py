...
class PageWorkflowDefinitionRepresentation(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["totalElements", "totalPages", "pageable", "numberOfElements", "size", "content", "number", "sort", "first", "last", "empty", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["totalElements", "totalPages", "pageable", "numberOfElements", "size", "content", "number", "sort", "first", "last", "empty", ], str]):
