                ...
                if instance and instance.actor:
                    ...
                    if specificdata['status_before'] == 'all':
                        ...
                        for member in instance.actor.members.all():
                            if member.role:
                                logger.debug("Sending email to {}".format(member.user.email))
                                logger.error("Sending email to {}".format(member.user.email))
                        ...
                        logger.info("Sending email to {}".format(instance.actor.mail))
