...
class Plugin(ad.Plugin):
    ...
    needs_plugins = ['lino.modlib.memo', 'lino_xl.lib.products', 'lino_xl.lib.vat']
    # needs_plugins = ['lino_xl.lib.products']

    print_items_table = "sales.ItemsByInvoicePrint"
    # out-of-the-box alternatives:
    # print_items_table = "sales.ItemsByInvoicePrintNoQtyColumn"
    ...
    def get_quicklinks(self):
        if self.site.get_plugin_setting('ledger', 'has_payment_methods'):
            yield 'sales.CashInvoice.start_new_sale'
