...
if has_payment_methods:
    ...
    class CashInvoiceDetail(InvoiceDetail):
        main = "sales_tab general more ledger"
    ...
    class CashInvoicesByJournal(CashInvoices, ByJournal):
        ...
        user
        """
        detail_layout = 'sales.CashInvoiceDetail'
...
"""
The following two classes are used by the `sales.print_items_table` plugin
setting.
"""
