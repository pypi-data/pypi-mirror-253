...
from lino_xl.lib.sales.models import VatProductInvoice, InvoiceItem
from lino_xl.lib.sales.ui import InvoiceItems, ItemsByInvoice
...
class SubscriptionDetail(dd.DetailLayout):
    ...
    narration user
    sales.InvoiceItemsByGenerator #invoicing.InvoicingsByGenerator InvoicesBySubscription
    """, label=_("More"))
...
# 'lino_xl.lib.sales.models.InvoiceItem'> has fields id, seqno, title,
