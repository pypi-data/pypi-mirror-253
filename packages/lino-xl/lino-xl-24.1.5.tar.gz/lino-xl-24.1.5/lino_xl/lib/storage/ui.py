...
class MovementsByPartner(Movements):
    ...
    order_by = (
        '-value_date', 'voucher__id', 'product__id', 'id')
    column_names = 'value_date voucher_link description \
...
class DeliveryNotes(dd.Table):
    ...
    show_movements = dd.ShowSlaveTable(
...
class FillerDetail(dd.DetailLayout):
    main = """
    partner
    storage_state provision_product min_asset fill_asset #filler_product
    MovementsByFiller
    """
...
class FillersByPartner(Fillers):
    master_key = "partner"
    column_names = "storage_state provision_product min_asset fill_asset #filler_product"

# class FillersByProduct(Fillers):
#     master_key = "provision_product"
#     column_names = "storage_state partner min_asset fill_asset #filler_product"
