...
class Sessions(dd.Table):
    ...
    column_names = 'ticket user start_date start_time end_date end_time '\
                   'break_time summary duration ticket_no ticket__order *'

    detail_layout = """
    ticket:40 user:20 faculty:20 reporting_type:10
    start_date start_time end_date end_time break_time duration
    summary:60 id #is_fixing workflow_buttons:20
    description:30 storage.DeliveriesByGenerator:30
    """
...
class SessionsByReport(Sessions, DurationReport):
    # used in noi/lino_noi/lib/sales/config/sales/VatProductInvoice/default.weasy.html
    ...
    def get_request_queryset(self, ar):
        ...
        if False:
            ...
            spv = dict(start_date=mi.invoicing_min_date, end_date=mi.invoicing_max_date)
...
class TicketsByReport(Tickets, DurationReport):
    ...
    def get_request_queryset(self, ar):
        ...
        pv.update(start_date=mi.invoicing_min_date, end_date=mi.invoicing_max_date)
