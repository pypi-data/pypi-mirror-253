...
from lino_xl.lib.ledger.mixins import (
    Payable, PaymentRelated, ProjectRelated, AccountVoucherItem, Matching)
from lino_xl.lib.sepa.mixins import BankAccount
from lino_xl.lib.ledger.models import Voucher, VoucherStates
from lino.api import dd, _


class AccountInvoice(BankAccount, PaymentRelated, Payable, Voucher, Matching, ProjectRelated):
