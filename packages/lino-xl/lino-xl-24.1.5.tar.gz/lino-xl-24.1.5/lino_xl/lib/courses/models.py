...
class Course(Reservation, Duplicable, Printable, MemoReferrable):
    ...
    print_presence_sheet_html = PrintPresenceSheet(
        ...
        label=format_lazy("{}{}", _("Presence sheet"), _(" (HTML)")))
    ...
    def update_cal_event_type(self):
        ...
        return settings.SITE.site_config.default_event_type
...
class Enrolment(UserAuthored, Certifiable, DateRange):
    ...
    pupil = dd.ForeignKey(
        dd.plugins.courses.pupil_model, verbose_name=_("Participant"),
    ...
    def create_pupil_choice(self, *args, **kwargs):
        # Pupil = dd.resolve_model(pupil_model)
        return dd.plugins.courses.pupil_model.create_from_choice(*args, **kwargs)
