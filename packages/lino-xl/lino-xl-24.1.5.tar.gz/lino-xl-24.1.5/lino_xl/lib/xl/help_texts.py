...
help_texts = {
    ...
    'lino_xl.lib.ledger.LedgerRegistrable.toggle_state' : _("""Toggle between "registered" and "draft" state."""),
    'lino_xl.lib.ledger.LedgerRegistrable.hide_editable_number' : _("""Whether to hide the number that will be used for this voucher in its journal as long as the voucher is in an editable state."""),
    'lino_xl.lib.ledger.ToggleState' : _("""The action behind LedgerRegistrable.toggle_state."""),
