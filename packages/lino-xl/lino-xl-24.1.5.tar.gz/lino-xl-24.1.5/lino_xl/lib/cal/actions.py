...
class RefuseGuestStates(dd.ChangeStateAction):
    ...
    when at least one guest is in a guest state that is forbidden for the target
    entry state.
    ...
    If this is a string, it will be resolved into a set of guest state objects
    at startup.
