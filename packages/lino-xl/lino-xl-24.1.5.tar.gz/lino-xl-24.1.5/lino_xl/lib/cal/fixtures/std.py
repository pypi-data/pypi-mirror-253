...
from lino.modlib.system.choicelists import DurationUnits, Recurrences, WORKDAYS
# from lino_xl.lib.cal.choicelists import SchedulingAreas
...
def objects():
    ...
    # if len(models_by_base(BirthdayGenerator)):
    #     birthdays = event_type(
    #         ref="birthdays",
    #         planner_column=PlannerColumns.external,
    #         is_appointment=False,
    #         fill_presences=False,
    #         max_days=0,
    #         all_rooms=False, **dd.str2kw('name', _("Birthdays")))
    #     yield birthdays
    ...
    yield meeting
    settings.SITE.site_config.update(default_event_type=meeting)
    ...
    def relative_holiday(offset, name):
        return add(
            every_unit=Recurrences.easter, every=1,
