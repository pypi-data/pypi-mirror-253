...
from lino_xl.lib.ledger.mixins import ProjectRelated, Matching, LedgerRegistrable
...
class FinancialVoucher(Voucher, LedgerRegistrable, Certifiable):
...
class DatedFinancialVoucher(FinancialVoucher):
    ...
    def create_ledger_movement(self, item, *args, **kwargs):
        mvt = super().create_ledger_movement(item, *args, **kwargs)
