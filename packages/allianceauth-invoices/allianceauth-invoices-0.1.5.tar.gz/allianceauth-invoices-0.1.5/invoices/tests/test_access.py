...
class TestInvoicesAccessPerms(TestCase):
    def setUp(cls):
        ...
        cls.ci1 = Invoice.objects.create(
            character=char1, amount=5, due_date=timezone.now())
        ...
        char2 = EveCharacter.objects.create(character_id=2,
                                            ...
                                            corporation_name='corporation.name1',
                                            corporation_ticker='ABC')
        cls.ci2 = Invoice.objects.create(
            character=char2, amount=5, due_date=timezone.now())
        CharacterOwnership.objects.create(
        ...
        cls.ci3 = Invoice.objects.create(
            character=char3, amount=5, due_date=timezone.now())
        ...
        char4 = EveCharacter.objects.create(character_id=4,
                                            ...
                                            alliance_name='test alliance2',
                                            alliance_ticker='TEST')
        cls.ci4 = Invoice.objects.create(
            character=char4, amount=5, due_date=timezone.now())
        ...
        char5 = EveCharacter.objects.create(character_id=5,
                                            ...
                                            alliance_name='test alliance2',
                                            alliance_ticker='TEST')
        cls.ci5 = Invoice.objects.create(
            character=char5, amount=5, due_date=timezone.now())
        ...
        cls.ci6 = Invoice.objects.create(
            character=char6, amount=5, due_date=timezone.now())
        ...
        char7 = EveCharacter.objects.create(character_id=7,
                                            ...
                                            alliance_name='test alliance2',
                                            alliance_ticker='TEST2')
        cls.ci7 = Invoice.objects.create(
            character=char7, amount=5, due_date=timezone.now())
        CharacterOwnership.objects.create(
        ...
        char9 = EveCharacter.objects.create(character_id=9,
                                            ...
                                            corporation_name='corporation.name4',
                                            corporation_ticker='ABC4')
        cls.ci9 = Invoice.objects.create(
            character=char9, amount=5, due_date=timezone.now())
