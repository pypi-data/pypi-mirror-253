...
"""
    ...
    The version of the OpenAPI document: 0.19.20
...
class ServiceCreateInstallRequestAwsAccount(BaseModel):
    ...
    def region_validate_enum(cls, value):
        ...
        if value not in ('us-east-1', 'us-east-2', 'us-west-2'):
            raise ValueError("must be one of enum values ('us-east-1', 'us-east-2', 'us-west-2')")
        return value
